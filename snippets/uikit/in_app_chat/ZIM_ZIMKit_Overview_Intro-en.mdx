...
<div style={{width:"100%",display:"flex",gap:"10px"}}>
    <div style={{width:"30%"}}>
        ...
        <img src="https://doc-media.zego.im/sdk-doc/Pics/ZIMKit/ZIMLKit_image1_EN.png" />
        </Frame>
    </div>
    <div style={{width:"30%"}}>
        <Frame width="auto" height="auto" caption="">
        <img src="https://doc-media.zego.im/sdk-doc/Pics/ZIMKit/ZIMLKit_image2_EN.png" />
        </Frame>
    </div>
    <div style={{width:"30%"}}>
        <Frame width="auto" height="auto" caption="">
        <img src="https://doc-media.zego.im/sdk-doc/Pics/ZIMKit/ZIMLKit_image3_EN.png" />
        </Frame>
    </div>
</div>
