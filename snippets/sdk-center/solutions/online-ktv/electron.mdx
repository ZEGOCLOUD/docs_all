...
| 资源 | 下载地址 | 相关文档|
| ---- | ----| ------ |
| SDK | [Express SDK v3.20.2（含版权音乐功能）](https://www.npmjs.com/package/zego-express-engine-electron) | [实时音视频 - 集成](/online-ktv-electron-js/quick-starts/integrate-the-sdk/express-video) |
...
- 本页面提供的 SDK 是基于 Express SDK。
    ...
    - 如需了解 Express SDK 版本变更详情，请参考 [实时音视频 - 发布日志](/online-ktv-electron-js/client-sdk/release-notes)。
