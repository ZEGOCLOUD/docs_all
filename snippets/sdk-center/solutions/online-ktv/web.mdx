...
| 歌词 UI 组件源码 | 在歌曲播放的同时同步显示 KRC（逐字）格式歌词的组件。	| [lyricView](https://artifact-sdk.zego.im/webplatform/ZegoLyricView.zip)| [歌词组件](./zego-content-center/lyrics-display-component.mdx) |
| 评分 UI 组件源码 | 显示音高线和评分效果的组件。| [pitchView](https://artifact-sdk.zego.im/webplatform/ZegoPitchView.zip)| [评分组件](./zego-content-center/scoring-component.mdx) |
