...
export const messagePinStatusChangedMap = {
  'default': <a href='@messagePinStatusChanged' target='_blank'>messagePinStatusChanged</a>,
  'UTS': <a href='@messagePinStatusChanged' target='_blank'>onMessagePinStatusChanged</a>,
  'android,win,window,windows': <a href='@onMessagePinStatusChanged' target='_blank'>onMessagePinStatusChanged</a>,
