...
export const multipleMediaUploadingProgressMap = {
  ...
  'ios': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-group-message-received-info-from-group-id' target='_blank'>multipleMediaUploadingProgress</a>,
  'mac': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-group-message-received-info-from-group-id' target='_blank'>multipleMediaUploadingProgress</a>,
  'flutter': <a href='https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onMultipleMediaUploadingProgress.html' target='_blank'>onMultipleMediaUploadingProgress</a>,
}
