...
如果您使用的是即时通讯（ZIM）服务，请参考 [控制台 - 云市场 - 数美内容审核](https://doc-zh.zego.im/article/18891) 开通权限、完成相关配置，无需其他操作。
...
2. 参考 [控制台 - 云市场 - 数美内容审核](https://doc-zh.zego.im/article/18891)，按照页面指引，自助开通 `数美内容审核` 相关权限。
...
- 已参考 [控制台 - 云市场 - 数美内容审核](https://doc-zh.zego.im/article/18891)，按照页面指引，自助开通 `数美内容审核` 相关权限。
