...
<details class="zg-primary">
    <summary>Android 添加权限</summary>

进入 “app/src/main” 目录，打开 “AndroidManifest.xml” 文件，添加权限。 

<div class = 'mk-hint'> 

如果在构建发行版 APK（flutter build apk）期间启用了混淆（默认启用），则需要配置与 ZEGO 相关的类，防止混淆，请参考 [常见问题](18871#4)。
</div>   
...
3. 权限添加完成后，如图所示：
    ...
    如果使用 Platform View，并且 Flutter 版本低于 1.22，则需要为 iOS 添加其他说明，请参考 [常见问题](18871#4)。
    </div>  
