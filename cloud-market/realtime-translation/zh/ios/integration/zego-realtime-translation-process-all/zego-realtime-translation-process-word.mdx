...
- 对输入的语音识别结果进行翻译
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZegoRealtimeTranslation/ZegoRealtimeTranslation_Sequence_diagram_text1.png" /></Frame>
- 对输入的文本进行翻译
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZegoRealtimeTranslation/ZegoRealtimeTranslation_Sequence_diagram_text2.png" /></Frame>
