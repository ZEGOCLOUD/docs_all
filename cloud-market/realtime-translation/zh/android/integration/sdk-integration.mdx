...
1. 打开 Android Studio，选择菜单 “File > New > New Project”。
    ...
    ![create_new_project](/Pics/RoomKit/Android/newproject.png)

2. 选一个 Empty Activity 项目。

    ![select_template](/Pics/RoomKit/Android/selecttemplate.png)

3. 填写项目的存储路径和项目名称，“Minimum SDK” 选择 “API 26”。

    ![select_template](/Pics/copyrightedvideo/savepath.png)
