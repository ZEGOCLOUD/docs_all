...
ZEGO 提供了 [示例源码\|_blank](https://zego-public.oss-cn-shanghai.aliyuncs.com/zegorealtimetranslation/Android/SourceCode/ZegoRealtimeTranslationDemo.zip)，以供开发者进一步了解 ZEGO 实时传译功能。
...
主持人调用 ZEGO Express SDK 的 [logoutRoom\|_blank](/article/api?doc=Express_Video_SDK_API~java_android~class~ZegoExpressEngine#logout-room) 接口，退出房间。
