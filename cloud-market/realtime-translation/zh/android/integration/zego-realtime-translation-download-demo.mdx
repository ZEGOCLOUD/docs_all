...
![image-20201203142600097](/Pics/GoClass/Android/image-20201203142600097.png)

2. 在打开的 Android Studio 软件中，单击 “Open”。
![image-20201127105738483](/Pics/metaworld/as_open_project.png)

3. 选择下载的示例 Demo ，并单击 “Open”。
![/Pics/metaworld/select_folder.png](/Pics/realtimetranslation/rtt_open_proj.png)
...
4. 修改 “app/src/main/java/im/zego/realtimetranslationdemo” 路径下的 “KeyCenter.java” 文件，填写 SDK 初始化所需的 AppID、AppSign 和实时传译的 License。
    ...
    - License 请使用本文“前提条件”已获取的 License 正确填写。</div>

    ![/Pics/realtimetranslation/rtt_keycenter.png](/Pics/realtimetranslation/rtt_keycenter.png)

5. 选择一台已连接到 Internet 的 Android 真机设备（推荐）或模拟器，当该设备成功开启开发者模式和 USB 调试功能后，可以看到 Android Studio 由下图：

    ![/Pics/realtimetranslation/rtvt_run_1.png](/Pics/realtimetranslation/rtvt_run_1.png)

    变为下图：

    ![/Pics/realtimetranslation/rtvt_run2.png](/Pics/realtimetranslation/rtvt_run2.png)

    说明 Android Studio 软件已成功连接到 Android 设备，可以将示例 Demo 运行到该设备上了。

6. 单击 Android Studio 软件上的 “build and run” 按钮，编译并运行示例源码。

    ![/Pics/realtimetranslation/rtvt_run3.png](/Pics/realtimetranslation/rtvt_run3.png)
...
1. 开发者在使用示例源码或者体验 App 时，首先进入登录界面，用户需要在此界面选择需要进入的房间 ID，单击选择的房间。   
    ...
    <img src="/Pics/realtimetranslation/rtvt_room_list.png" width="30%">
...
2. 在弹窗中，选择角色和用户名，角色可以选择主播和观众，用户昵称可以自己修改也可以使用默认值，设置完成后，单击“进入房间”。
    ...
    <img src="/Pics/realtimetranslation/rtvt_role_select.png" width="30%">
...
3. 进入房间后，即可进入实时传译界面。如果角色选择的是主播，进入实时传译界面后，可以根据需要选择语音识别服务提供商和翻译服务提供商，还可以设置识别语音，以及要实时传译的目标语言。
    ...
    <img src="/Pics/realtimetranslation/rtvt_main_scene.png" width="30%">

4. 参数设置完成后，单击"开启实时语音识别", 即可启动实时传译，识别结果和翻译结果会在两个框中显示出来。
5. 切换到文本翻译的界面，可以在此界面进行纯文本的翻译，选择好翻译提供商，源语言和目标语言，单击"开始文本翻译"即可。
<img src="/Pics/realtimetranslation/rtvt_trans.png" width="30%">
