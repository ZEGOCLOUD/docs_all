  ...
  <div class="sdk-download-item-wrapper">
    ...
    <div class="download-selector">
      <div class="download-select-wrapper" style="padding-right: 0;">
        <a class="download-target-btn" href="https://artifact-demo.zego.im/zegorealtimetranslation/Android/SourceCode/ZegoRealtimeTranslationDemo.zip" target="_blank">本地下载</a>
        <ul class="download-dropdown-list">
          <li data-href="https://artifact-demo.zego.im/zegorealtimetranslation/Android/SourceCode/ZegoRealtimeTranslationDemo.zip"
