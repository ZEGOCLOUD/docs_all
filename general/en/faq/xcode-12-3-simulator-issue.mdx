...
In Xcode 12.3 and above, when [integrating SDK](/real-time-video-ios-oc/quick-start/integrating-sdk) and building a project using iOS simulator, you may receive the following error:
...
ZEGO recommends upgrading your SDK to version 2.8.0 or above. For detailed steps on integrating SDK, please refer to [Quick Start - Integration](/real-time-video-ios-oc/quick-start/integrating-sdk).
