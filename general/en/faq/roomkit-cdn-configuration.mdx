...
2. If the console shows an error "net::ERR_NAME_NOT_RESOLVED", please refer to [Configure Domain CNAME](/console/configure-cname) to check if the domain CNAME is configured.
