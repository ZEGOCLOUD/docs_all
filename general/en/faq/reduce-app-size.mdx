...
- For data on the app size increase relative to apps without SDK integration when integrating the latest version of Native SDK, please refer to [Video Call - Overview](/real-time-video-android-java/introduction/overview).
