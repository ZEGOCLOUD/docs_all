...
## Related Links
1. [Interactive Whiteboard SDK Configuration|\_blank](https://docs.zegocloud.com/article/api?doc=WhiteBoardView_API~java~class~ZegoWhiteboardConfig&jumpType=route#log-path)
2. [File Sharing SDK Configuration|\_blank](https://docs.zegocloud.com/article/api?doc=docsview_API~java~class~ZegoDocsViewConfig#log-folder)
