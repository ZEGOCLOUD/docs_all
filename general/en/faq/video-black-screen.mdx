...
* If the camera is not a problem, you need to confirm whether camera permissions are enabled. Both Android and iOS systems have permission management. Please check in system settings.
    * To enable Android permissions, please refer to [Video Call - Integration](https://www.zegocloud.com/docs/real-time-video-android-java/quick-start/integrating-sdk) in "Setting Permissions", add project permissions, and obtain device permissions.
    * To enable iOS permissions, please refer to [Video Call - Integration](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk) in "Setting Permissions", add media device permissions.
