...
1. Please integrate the SDK according to the "Method 2: Manual integration by copying SDK files" in the [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-android-java/quick-start/integrating-sdk) documentation.
...
2. Please integrate the ASan runtime library that comes with the SDK package into the App.
    ...
    Integrate "wrap.sh" into the App. You can get the "wrap.sh" file from the Android sample code downloaded from [Run Example Code](https://www.zegocloud.com/docs/real-time-video-android-java/quick-start/run-example-code). After decompressing the sample source code, find the "ZegoExpressExample/main/asan/lib" directory and copy the entire `lib` directory to the "app/src/main/resources" directory of your application project. The structure is as follows.
...
1. Please integrate the SDK according to the "Method 3: Manual integration by copying SDK files" in the [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk) documentation.
...
If you get the `wrap.sh` file from [Run Example Code](https://www.zegocloud.com/docs/real-time-video-android-java/quick-start/run-example-code), no additional modifications are needed. The `wrap.sh` provided in the example source code is already modified.
