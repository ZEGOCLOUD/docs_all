...
If you are using SDK version 3.1.0 or above, it is recommended that you use the latest implementation method. Please refer to the [Screen Sharing](https://www.zegocloud.com/docs/real-time-video-ios-oc/video/screen-sharing) documentation.
...
- You have integrated ZEGO Express SDK in your project and implemented basic Video Call functionality. For details, please refer to [Quick Start - Integration](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk) and [Quick Start - Implementing Video Call](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/implementing-video-call).
- You have created a project in [ZEGOCLOUD Console](https://console.zegocloud.com/) and applied for a valid AppID and AppSign. For details, please refer to "Project Information" in [Console - Project Management](https://www.zegocloud.com/docs/console/project-info).
...
- If you don't have an existing project, you can refer to "Create a new project" in [Quick Start - Integration](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk#可选新建项目) to create one.
...
The implementation of the following system callbacks can be found in the "/ZegoExpressExample-iOS-OC/Topics/ScreenCapture/ZegoExpressExample-iOS-OC-Broadcast/SampleHandler.m" file in [Download Example Source Code](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/run-example-code):
...
2. Import ZEGO Express SDK in the Extension. For details, please refer to "Import SDK" in [Quick Start - Integration](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk#导入-sdk).
...
- You have integrated ZEGO Express SDK in your project and implemented basic Video Call functionality. For details, please refer to [Quick Start - Integration](https://www.zegocloud.com/docs/real-time-video-android-java/quick-start/integrating-sdk) and [Quick Start - Implementing Video Call](https://www.zegocloud.com/docs/real-time-video-android-java/quick-start/implementing-video-call).
- You have created a project in [ZEGOCLOUD Console](https://console.zegocloud.com/) and applied for a valid AppID and AppSign. For details, please refer to "Project Information" in [Console - Project Management](https://www.zegocloud.com/docs/console/project-info).
...
This functionality is provided as a plugin. For details, please refer to [ZegoScreenCapture-Windows](https://www.zegocloud.com/docs/article/3167). As a plugin for [zego-express-video-windows ](https://www.zegocloud.com/docs/real-time-video-windows-cpp/client-sdk/download-sdk), the two must be used together to implement screen sharing functionality.
...
Before using screen sharing, please first download the [ScreenCapture SDK ](https://www.zegocloud.com/docs/article/3167) plugin and integrate it in your project.
...
|-|-|-|
|Integrate Plugin|Integrate the screen capture plugin|Please refer to [Integration](https://www.zegocloud.com/docs/article/2371)|
|Capture Entire Screen|Select a screen to capture|Please refer to [Screen Sharing](https://www.zegocloud.com/docs/article/2351)|
|Capture Specified Area|Select an area to capture|Please refer to [Screen Sharing](https://www.zegocloud.com/docs/article/2363)|
|Capture Specified Window|Select a window to capture|Please refer to [Window Sharing](https://www.zegocloud.com/docs/article/2364)|
|Window Thumbnail|Get thumbnail to display in img tag for easy selection of capture target|Please refer to [Window Thumbnail](https://www.zegocloud.com/docs/article/2365)|
...
|Function|Description|Implementation Process|
|-|-|-|
|Integrate Plugin|Integrate the screen capture plugin|Please refer to [Integration](https://www.zegocloud.com/docs/article/2396)|
|Capture Entire Screen|Select a screen to capture|Please refer to [Screen Sharing](https://www.zegocloud.com/docs/article/2397)|
|Capture Specified Area|Select an area to capture|Please refer to [Area Sharing](https://www.zegocloud.com/docs/article/2398)|
|Capture Specified Window|Select a window to capture|Please refer to [Window Sharing](https://www.zegocloud.com/docs/article/2395)|
|Window Thumbnail|Get thumbnail to display in img tag for easy selection of capture target|Please refer to [Window Thumbnail](https://www.zegocloud.com/docs/article/2399)|
