...
We provide [example source code](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/run-example-code) for your reference. Please check the files in the "/ZegoExpressExample/Examples/AdvancedAudioProcessing/AECANSAGC" directory in the code.
...
- Integrated ZEGO Express SDK in the project and implemented basic real-time audio and video functions. For details, please refer to [Quick Start - Integrate](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk) and [Quick Start - Implement Video Call](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/implementing-video-call).
- Created a project in [ZEGOCLOUD Console](https://console.zegocloud.com/) and applied for a valid AppID and AppSign. For details, please refer to "Project Information" in [Console - Project Management](https://www.zegocloud.com/docs/console/project-info).
