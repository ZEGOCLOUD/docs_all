...
[ZegoScreenCapture-Windows SDK](https://www.zegocloud.com/docs/article/3167) combines various capture methods to meet most scenarios and provides multiple mode options for window capture.
