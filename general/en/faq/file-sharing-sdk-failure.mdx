...
1. For SDK initialization, refer to [File Sharing SDK Initialization](https://www.zegocloud.com/docs/article/9395).
2. For error codes returned by the SDK, refer to [File Sharing SDK Error Codes](https://www.zegocloud.com/docs/article/4410).
