...
<tr>
<td>Super Board</td>
<td><ul><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15009#4_2">iOS</a></li><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15010#4_2">Android</a></li><li><a target="_blank" href="/super-board-web/quick-start/user-access-control#42-生成-token">Web</a></li></ul></td>
</tr>
<tr>
<td>Interactive Whiteboard</td>
<td><ul><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15004#4_2">iOS</a></li><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15005#4_2">Android</a></li><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15006#4_2">Web</a></li><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15007#4_2">Electron</a></li></ul></td>
</tr>
<tr>
<td>File Sharing</td>
<td><ul><li><a target="_blank" href="https://www.zegocloud.com/docs/article/14999#4_2">iOS</a></li><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15000#4_2">Android</a></li><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15001#4_2">Web</a></li><li><a target="_blank" href="https://www.zegocloud.com/docs/article/15002#4_2">Electron</a></li></ul></td>
</tr>
</tbody></table>
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-rn/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-android-java/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-android-java/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-windows-cpp/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-windows-cpp/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-u3d-cs/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-u3d-cs/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-flutter/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-flutter/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-rn/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-rn/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-uniapp/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-uniapp/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-electron-js/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-electron-js/quick-start/integrating-sdk).
...
1. Download and integrate the latest version of [SDK](https://www.zegocloud.com/docs/real-time-video-linux-cpp/client-sdk/download-sdk). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/real-time-video-linux-cpp/quick-start/integrating-sdk).
...
2. Call the [InitSDK](https://www.zegocloud.com/docs/API/ServerRecord/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#af8fcc2e5a69e83075637631d68fcf4ea) interface to initialize the SDK and pass the obtained AppID to the parameter "uiAppID".
...
3. Before logging into a room, call the [SetCustomToken](https://www.zegocloud.com/docs/API/ServerRecord/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#a68bdea0d66d62c8bf4d671284707b3ae) interface to pass Token to the SDK.
...
1. Download and integrate the latest version of [ZegoDocsView SDK](https://www.zegocloud.com/docs/article/4408). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/article/4373).
...
1. Download and integrate the latest version of [ZegoDocsView SDK](https://www.zegocloud.com/docs/article/4407). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/article/4347).
...
1. Download and integrate the latest version of [ZegoDocsView SDK](https://www.zegocloud.com/docs/article/6498). For details, please refer to [Integrate SDK](https://www.zegocloud.com/docs/article/6493).
