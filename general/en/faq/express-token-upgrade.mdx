...
2. Call the [InitSDK](https://doc-zh.zego.im/API/ServerRecord-en/html/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#af8fcc2e5a69e83075637631d68fcf4ea) interface to initialize the SDK and pass the obtained AppID to the parameter "uiAppID".
...
3. Before logging into a room, call the [SetToken](https://doc-zh.zego.im/API/ServerRecord-en/html/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#aa0b8eca203fb7b2f40b69f1c853d29f4) interface to pass Token to the SDK.

```cpp
LIVEROOM::SetToken("token"); // Fill in the correct authentication Token here
```
