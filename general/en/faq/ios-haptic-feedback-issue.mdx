...
This configuration must be set via the [setEngineConfig](https://docs.zegocloud.com/article/api?doc=Express_Video_SDK_API~objective-c_ios~class~ZegoExpressEngine#set-engine-config) interface (in the `advancedConfig`) **before** calling [createEngine](https://docs.zegocloud.com/article/api?doc=Express_Video_SDK_API~objective-c_ios~class~ZegoExpressEngine#create-engine) to create the engine.
