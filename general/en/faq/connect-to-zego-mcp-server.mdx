...
<Note title="Note">Only some popular IDE rules file configuration methods are listed here. For other IDEs, please refer to their respective documentation.</Note>

- [Augment Code](https://docs.augmentcode.com/setup-augment/guidelines)
- [Cursor](https://cursor.com/docs/context/rules)
- [CodeBuddy](https://www.codebuddy.ai/docs/ide/Rules)
- [Trae](https://docs.trae.ai/ide/rules?_lang=en)
