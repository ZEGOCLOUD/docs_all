...
![/Pics/macOS/ScreenSharing/CommonProblems/screenSharing_Problems_macOS_1.png](https://doc-media.zego.im/sdk-doc/Pics/macOS/ScreenSharing/CommonProblems/screenSharing_Problems_macOS_2.png)
![/Pics/macOS/ScreenSharing/CommonProblems/screenSharing_Problems_macOS_2.png](https://doc-media.zego.im/sdk-doc/Pics/macOS/ScreenSharing/CommonProblems/screenSharing_Problems_macOS_1.png) 
</details>


### 2. 为什么打开了权限，还是无法截取图片或者报错？

在 macOS 电脑的“设置”中看到的状态，并不是应用真实的状态，建议**使用代码判断权限是否开启**（请参考下文的“4. 如何判断系统权限？”）。
...
请参考此网址设置 “系统相关 URL”：[MacOS System Preference Links\|_blank](https://www.mbsplugins.net/archive/2020-04-05/MacOS_System_Preference_Links/monkeybreadsoftware_blog_archive)。
