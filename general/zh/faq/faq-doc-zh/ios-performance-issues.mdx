...
![/Pics/FAQ/Performance/performance_ios_1.jpeg](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/performance_ios_1.jpeg)
...
![/Pics/FAQ/Performance/xcode_Instruments.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/xcode_Instruments.png)
...
![/Pics/FAQ/Performance/instruments_index.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_index.png)

<details class="zg-primary">
    <summary>Trace 文件介绍</summary>

![/Pics/FAQ/Performance/instruments_Allocations.jpeg](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_Allocations.jpeg)
...
![/Pics/FAQ/Performance/instruments_allocations_symbols.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_allocations_symbols.png)
...
- 对于第三方库，比如 ZegoExpressEngine，符号表是由 ZEGO 保管维护，因此开发者无法直接获取到。
    ...
    ![/Pics/FAQ/Performance/instruments_allocations_symbols_add.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_allocations_symbols_add.png)
...
![/Pics/FAQ/Performance/instruments_allocations_save.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_allocations_save.png)
...
![/Pics/FAQ/Performance/instrument_demo_cpu.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instrument_demo_cpu.png)
...
![/Pics/FAQ/Performance/instruments_demo_cpu_threads.jpeg](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_demo_cpu_threads.jpeg)

再点击右下角的调用栈接口详情，跳转到 Demo 的对应代码位置。

查看代码详情，可以发现是因为此时 SDK 回调了一次推流质量，Demo 更新了 UILabel 的内容，UI 的刷新导致 CPU 消耗增大。

![/Pics/FAQ/Performance/instruments_demo_cpu_code.jpeg](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_demo_cpu_code.jpeg)
...
![/Pics/FAQ/Performance/instruments_allocations_demo.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_allocations_demo.png)
...
![/Pics/FAQ/Performance/instruments_allocations_demo_code.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/instruments_allocations_demo_code.png)
