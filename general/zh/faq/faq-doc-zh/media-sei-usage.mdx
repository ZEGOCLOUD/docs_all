...
![](https://doc-media.zego.im/sdk-doc/Pics/FAQ/NALU_structure.png) 

#### NALU Header 组成结构

NALU Header 由 8 bit 组成，其中最后的 5 bit 表示 NAL Unit Type，具体结构⻅下图： 

![](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Header_structure.png)
...
![](https://doc-media.zego.im/sdk-doc/Pics/FAQ/RBSP_structure.png)
...
![](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Video_driver.png)
...
#### 6. SideInfoZegoDefined 结构

![](https://doc-media.zego.im/sdk-doc/Pics/FAQ/SideInfoZegoDefined_structure.png)

#### 7. 接收端数据封装

为了兼容 SideInfoZegoDefined 的结构，接收端在接收到媒体补充增强信息后，会封装成如下格式：

![](https://doc-media.zego.im/sdk-doc/Pics/FAQ/MediaType_structure.png)
...
- iOS：[媒体补充增强信息\|_blank](#6063)
- Android：[媒体补充增强信息\|_blank](#6064)
- macOS：[媒体补充增强信息\|_blank](#6065)
- Windows：[媒体补充增强信息\|_blank](#6066)
- Flutter：[媒体补充增强信息\|_blank](#10909)
