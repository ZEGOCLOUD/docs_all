...
---
<style>
table th:nth-of-type(1) { min-width: 120px; width: 25%; }
table th:nth-of-type(2) { min-width: 120px; width: 25%; }
table th:nth-of-type(3) { min-width: 120px; width: 25%; }
table th:nth-of-type(4) { min-width: 120px; width: 25%; }
table {width: 100%;}
</style>
