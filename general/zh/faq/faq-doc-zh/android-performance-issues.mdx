...
![/Pics/FAQ/Performance/cpu_top.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/cpu_top.png)
...
![/Pics/FAQ/Performance/cpu_top_p.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/cpu_top_p.png)
...
1. Android Studio 安装 Debug 版本，连接到⼿机设备，打开 Profiler ⼯具，选择要分析的 App 对应的包名。
    ...
    <img src="https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/Profiler.png" width="70%">

2. 点击 CPU，进⼊ CPU 分析⻚⾯。

    - 上半部分可以看到当前 App 占⽤的 CPU ⽐例、以及⼿机上其他进程占⽤的 CPU ⽐例。

    ![/Pics/FAQ/Performance/Profiler_cpu.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/Profiler_cpu.png)
    ...
    ![/Pics/FAQ/Performance/Profiler_cpu_running.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/Profiler_cpu_running.png)


例如：App 的主线程 running 态的时间呈现⼤批绿⾊⻓条，⿏标移动到绿⾊条上，可以看到 running 态的时间很多超过了 1s，可以推测主线程有耗时操作。  

![/Pics/FAQ/Performance/Profiler_cpu_running1.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/Profiler_cpu_running1.png)
...
1. 如需 Debug 主线程或其他上层 Java 线程中的 Java 层 CPU 问题，选择：`Sample Java Methods`，点击 Record，复现 CPU 占⽤⾼的问题。
    ...
    <img src="https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/funcion_record.png" width="70%">

2. 再点击 Stop 停止，Profiler 会⾃动解析该段时间的线程 Java ⽅法调⽤情况。

    ![/Pics/FAQ/Performance/funcion_record_stop.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/funcion_record_stop.png)
...
3. 根据 Java 方法名称，查看线程占用率。例如：下图可以看出主线程⾥⾯的 onClick ⻓度条明显占据 CPU 较⻓时间。
    ...
    ![/Pics/FAQ/Performance/funcion_record_example.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/funcion_record_example.png)

    ![/Pics/FAQ/Performance/funcion_record_example1.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/funcion_record_example1.png)

### C/C++ 层

如果是 C/C++ 层占用 CPU 较高，选择`Sample C/C++ Functions`。

<img src="https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/funcion_record_cpp.png" width="50%">
...
![/Pics/FAQ/Performance/funcion_record_cpp_cpu.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/Performance/funcion_record_cpp_cpu.png)
