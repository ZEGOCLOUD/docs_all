...
1. 从官网下载 [最新的 Android SDK 包](https://doc-zh.zego.im/article/2969)。
...
<img src="https://doc-media.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/android_java_sources_jar.png">
...
<img src="https://doc-media.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/android_studio_choose_sources.png">

5. 加载完成后，可以看到原来反编译的 Java 字节码现在变成了源码，且包含 API 注释文档。
<img src="https://doc-media.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/android_studio_show_source_comment.png">
6. 此时回到项目源代码文件，将鼠标悬停在任意一个 SDK 的类或函数上，可以展示此 API 的文档。
<img src="https://doc-media.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/android_studio_show_api_document.png">
<img src="https://doc-media.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/android_studio_show_callback_document.png">

6. （可选）SDK 包中同时交付了 “javadoc” API 文档，您可以在解压后的 SDK 包的 "Document" 目录中找到 “index.html” 文档，双击打开 "index.html"，即可查看此 SDK 包的 API 文档。
<img src="https://doc-media.zego.im/sdk-doc/Pics/Express/express_api_document_html.png">
