...
## 相关链接
1. [互动白板 SDK 配置|\_blank](/article/api?doc=WhiteBoardView_API~java~class~ZegoWhiteboardConfig&jumpType=route#log-path)
2. [文件共享 SDK 配置|\_blank](/article/api?doc=docsview_API~java~class~ZegoDocsViewConfig#log-folder)
