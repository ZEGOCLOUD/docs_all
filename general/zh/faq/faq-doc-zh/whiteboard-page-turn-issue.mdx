...
以 Web 平台为例，创建宽为 1600 px，高为 900 px，横向有 5 页的 [ZegoWhiteboardView\|_blank](/article/api?doc=WhiteBoardView_API~javascript_web~interface~ZegoWhiteboardView&jumpType=route) 的示例如下：
...
[实现流程 - 互动白板\|_blank](/article/8847#3_3)
