...
<tr>
<td>实时音视频</td>
<td><ul><li><a target="_blank" href="https://doc-zh.zego.im/article/10359#4_2">iOS</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/10360#4_2">Android</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/10361#4_2">macOS</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/10362#4_2">Windows</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14355#4_2">Unity3D</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14350#4_1">Flutter</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14349#4_2">React Native</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/13117#4_2">uni-app</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14353#4_2">Electron</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14351#4_2">Linux（C++）</a></li></ul></td>
</tr>
<tr>
<td>实时语音</td>
<td><ul><li><a target="_blank" href="https://doc-zh.zego.im/article/14045#4_2">iOS</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14046#4_2">Android</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14048#4_2">macOS</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14047#4_2">Windows</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14380#4_2">Unity3D</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14379#4_2">Flutter</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14381#4_2">React Native</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14382#4_2">uni-app</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14488#4_2">Electron</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/14478#4_2">Linux（C++）</a></li></ul></td>
</tr>
<tr>
<td>本地服务端录制</td>
<td><a target="_blank" href="https://doc-zh.zego.im/article/14430#4_2">Linux</a></td>
</tr>
<tr>
<td>超级白板</td>
<td><ul><li><a target="_blank" href="https://doc-zh.zego.im/article/15009#4_2">iOS</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/15010#4_2">Android</a></li><li><a target="_blank" href="https://doc-zh.zego.im/article/15011#4_2">Web</a></li></ul></td>
</tr>
<tr>
<td>互动白板</td>
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/2968)，详情请参考 [集成 SDK](/real-time-video-ios-oc/quick-start/integrating-sdk)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/2969)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/195)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/2972)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/197)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/3618)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/3234)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/5570)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/1241)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/6636)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/4835)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/7776)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/7774)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/5571)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/1240)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/5568)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/7351)。
...
1. 已下载并集成最新版本的 [SDK](https://doc-zh.zego.im/article/2938)，详情请参考 [集成 SDK](https://doc-zh.zego.im/article/2186)。
2. 调用 [InitSDK](/API/ServerRecord/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#af8fcc2e5a69e83075637631d68fcf4ea) 接口初始化 SDK，将申请到的 AppID 传入参数 “uiAppID”。
...
3. 在登录房间之前调用 [SetCustomToken](/API/ServerRecord/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#a68bdea0d66d62c8bf4d671284707b3ae) 接口将 Token 传入 SDK。
...
1. 已下载并集成最新版本的 [ZegoSuperBoard SDK](https://doc-zh.zego.im/article/11303)（已包含 ZegoExpressEngine SDK），详情请参考 [集成 SDK](https://doc-zh.zego.im/article/11319#4)。
...
1. 已下载并集成最新版本的 [ZegoSuperBoard SDK](https://doc-zh.zego.im/article/11304)（已包含 ZegoExpressEngine SDK），详情请参考 [集成 SDK](https://doc-zh.zego.im/article/11320#4)。
