...
该功能以插件形式提供，具体请参考 [ZegoScreenCapture-Windows |\blank](https://doc-zh.zego.im/article/3167)。其作为 [zego-express-video-windows |\blank](/real-time-video-windows-cpp/client-sdk/download-sdk) 的插件，二者结合使用才能实现屏幕共享的功能。
