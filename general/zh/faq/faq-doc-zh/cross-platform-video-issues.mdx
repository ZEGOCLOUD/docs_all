...
1. 调用 [checkSystemRequirements\|_blank](/article/api?doc=Express_Video_SDK_API~javascript_web~class~ZegoExpressEngine#check-system-requirements) 接口检测当前浏览器是否支持 H.264 编码格式，如果不支持该编码，则无法与 Native 平台互通。
...
3. 建议 Web 平台使用最新版本的 Chrome 浏览器，并尝试关闭硬件加速：
    ...
    3. 单击 “Relaunch” 重启浏览器。
![/Pics/FAQ/hardware_disabled.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/hardware_disabled.png)
