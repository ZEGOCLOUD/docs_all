...
- iOS: [互动白板与文件共享的搭配使用\|_blank](/article/9870)
- Android: [互动白板与文件共享的搭配使用\|_blank](/article/9871)
...
具体实现方法请参考 [示例 Demo\|_blank](https://github.com/zegoim/zego-whiteboard-example/tree/release/express/src)
