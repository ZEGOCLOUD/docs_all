...
# 为什么设置 Android minSdkVersion 为 23 后，APK 包体积增大了？
---
...
关于 android:extractNativeLibs 的详情可参考 [官网文档\|_blank](https://developer.android.com/guide/topics/manifest/application-element.html#extractNativeLibs)。
