...
- 集成最新版本的 Native SDK 相对于未集成 SDK 的 App 体积增量数据请参考 [实时音视频 - 概述\|_blank](#5416)。
</div>
...
- iOS：[Express-Audio SDK\|_blank](#3563)
- Android：[Express-Audio SDK\|_blank](#3564)
- macOS：[Express-Audio SDK\|_blank](#3565)
- Windows：[Express-Audio SDK\|_blank](#3566)
</div>
