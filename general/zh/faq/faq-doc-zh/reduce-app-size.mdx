...
- 集成最新版本的 Native SDK 相对于未集成 SDK 的 App 体积增量数据请参考 [实时音视频 - 概述](https://doc-zh.zego.im/article/5416)。
...
- iOS：[Express-Audio SDK](https://doc-zh.zego.im/article/3563)
- Android：[Express-Audio SDK](https://doc-zh.zego.im/article/3564)
- macOS：[Express-Audio SDK](https://doc-zh.zego.im/article/3565)
- Windows：[Express-Audio SDK](https://doc-zh.zego.im/article/3566)
