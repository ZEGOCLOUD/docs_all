...
![/Pics/FAQ/ZegoAudioDeviceMode.png](https://doc-media.zego.im/sdk-doc/Pics/FAQ/ZegoAudioDeviceMode.png)
...
2. 当 [enableHeadphoneAEC](/article/api?doc=Express_Video_SDK_API~java_android~class~ZegoExpressEngine#enable-headphone-aec) 设置为 false 时，插⼊外接设备（如耳机、外置声卡等）后均使用“媒体音量”，音频设备模式（audio_device_mode）设置将不生效。
