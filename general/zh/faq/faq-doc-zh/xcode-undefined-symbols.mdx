...
![/Pics/ZegoEffects/Apple/effects_ios_target_os.png](https://doc-media.zego.im/sdk-doc/Pics/ZegoEffects/Apple/effects_ios_target_os.png)

- 方案二：如果仍需支持 iOS 10、iOS 9 等版本，可在 Target 的 “Build Settings” 中指定 “Architectures (Release)” 为 “arm64”。
![/Pics/ZegoEffects/Apple/effects_ios_release_arch.png](https://doc-media.zego.im/sdk-doc/Pics/ZegoEffects/Apple/effects_ios_release_arch.png)
