...
<Title>调用编译打包后 Roomkit SDK 的接口时报错怎么处理？</Title>

<ArticleMetadata language="zh" product="Roomkit" platform="Web" />
...
建议参考 [集成](/faq/roomkit-go-class-alternatives) 文档通过 script 的方式引入 SDK，不对 sdk 进行编译打包。