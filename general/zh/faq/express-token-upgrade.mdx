...
<ArticleMetadata language="zh" product="Video Call / Audio Call / Live streaming / Interactive whiteboard / File sharing / Local server recording / Screen sharing / 小程序直播 / GO课堂 / Live streaming" platform="iOS / Android / macOS / Windows / Linux / Flutter / Electron / ReactNative / uni-app / Unity3D" />
...
版本信息请参考 [文档导读](https://doc-zh.zego.im/faq/express-token-upgrade?product=ExpressVideo&platform=all#1)。
...
2. 调用 [InitSDK](https://doc-zh.zego.im/API/ServerRecord/html/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#af8fcc2e5a69e83075637631d68fcf4ea) 接口初始化 SDK，将申请到的 AppID 传入参数 “uiAppID”。
...
3. 在登录房间之前调用 [SetToken](https://doc-zh.zego.im/API/ServerRecord/html/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#aa0b8eca203fb7b2f40b69f1c853d29f4) 接口将 Token 传入 SDK。

```cpp
LIVEROOM::SetToken("token"); // 此处填写正确的鉴权 Token
```
