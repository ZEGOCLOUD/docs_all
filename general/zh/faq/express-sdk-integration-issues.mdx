...
<ArticleMetadata language="zh" product="Video Call / Audio Call / Live streaming" platform="iOS / Android / macOS / Windows / Web / Electron" />
...
硬件情况可以通过 [checkSystemRequirements](https://doc-zh.zego.im/zh/api?doc=Express_Video_SDK_API~javascript_web_web~class~ZegoExpressEngine#check-system-requirements) 接口，获取 “CapabilityDetection” 判断。
