...
<ArticleMetadata language="zh" product="Video Call / Audio Call / Live streaming" platform="Windows" />
...
1. 安装 [Debugging Tools for Windows](https://learn.microsoft.com/zh-cn/windows-hardware/drivers/debugger/debugger-download-tools#install-debugging-tools-for-windows)。
...
更多 UMDH 使用说明，请参考 [UMDH 介绍](https://learn.microsoft.com/zh-cn/windows-hardware/drivers/debugger/umdh)、[使用 UMDH 查找用户模式内存泄漏](https://learn.microsoft.com/zh-cn/windows-hardware/drivers/debugger/using-umdh-to-find-a-user-mode-memory-leak)。