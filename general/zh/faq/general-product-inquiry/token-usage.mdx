...
具体实现可参考 [实时音视频 - 用户权限控制](https://doc-zh.zego.im/article/10359)。


## Token 的有效期

Token 的有效期由开发者自行设置，具体实现可参考 [实时音视频 - 用户权限控制](https://doc-zh.zego.im/article/10359) 中的“生成 Token”。 
...
[实时音视频 - 使用 Token 鉴权](https://doc-zh.zego.im/article/10359)