...
<ArticleMetadata language="zh" product="Video Call / Audio Call / Live streaming" platform="iOS / Android" />



---

移动设备（iOS/Android）声音的音量会区分媒体音量和通话音量。在 SDK 的某些配置下，实时音视频服务会使用通话音量，此时调节音量键也会变成控制设备的通话音量。而背景音乐使用媒体通道播放，需要调节媒体音量。两种音量在声音表现、适用场景、音量控制上有所不同，详情请参考 [媒体音量和通话音量有什么区别](https://doc-zh.zego.im/faq/media-vs-call-volume)。
