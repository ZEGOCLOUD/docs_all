...
<ArticleMetadata language="zh" product="Interactive whiteboard / File sharing" platform="iOS / Android" />
...
## 相关链接
1. [互动白板 SDK 配置|](https://doc-zh.zego.im/article/api?doc=WhiteBoardView_API~java~class~ZegoWhiteboardConfig&jumpType=route#log-path)
2. [文件共享 SDK 配置|](https://doc-zh.zego.im/article/api?doc=docsview_API~java~class~ZegoDocsViewConfig#log-folder)
