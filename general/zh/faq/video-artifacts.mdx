...
<ArticleMetadata language="zh" product="Video Call / Audio Call / Live streaming / Interactive whiteboard / Live streaming" platform="iOS / Android / macOS / Windows" />
...
<table>
  ...
  <tr>
    <td>SDK 日志文件，详情请参考 <a target="_blank" href="/faq/express-logs-stacktrace">如何设置和获取 SDK 的日志、堆栈信息</a>。</td>
  </tr>
  <tr>
