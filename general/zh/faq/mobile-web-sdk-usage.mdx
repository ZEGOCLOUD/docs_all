...
- 若主播端与观众端都是用 ZEGO Express Web SDK，通常情况下建议您使⽤ VP8 视频编码格式进⾏推拉流。若出现两端冲突，即⼀端只⽀持 H.264，⼀端只⽀持 VP8（比如 Andriod FireFox 68 与 iOS 11 Safari）的情况，此时建议您使⽤混流转码，具体请参考 [混流转码示例 Demo](https://zegodev.github.io/zego-express-webrtc-sample/vp8/index.html)。
