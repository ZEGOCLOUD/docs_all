...
混流服务会按照您实际的混流时长来收取费用，详情请参考 [服务端混流价格说明](/real-time-video-ios-oc/introduction/pricing/server-side-stream-mixing)。
...
<Warning title="注意">
    ...
    混流转推方式的选择：
    - 若您需要转推到 ZEGO CDN，则选择“转推到 ZEGO CDN”，需要先 [开通 ZEGO CDN](/console/service-configuration/l3) 才能开通混流服务。
...
当 ZEGO 服务器开始或结束混流任务时，会通过该回调地址将对应时间通知给您，方便维护混流状态，详情请参考 [混流开始回调](https://doc-zh.zego.im/real-time-video-server/callback/stream-mixing/started) 和 [混流结束回调](https://doc-zh.zego.im/real-time-video-server/callback/stream-mixing/stopped)。
