...
本文主要介绍 [创建项目\|_blank](#14213) 完成后，项目信息的 [查看流程](12107#1)，以及项目信息涵盖的内容，包括 [基本信息](12107#2_1)、[配置信息](12107#2_2) 和 [辅助工具](12107#2_3)。
...
![/Pics/Consle/1026.png](http://doc.oa.zego.im/Pics/Consle/1026.png)
...
<tr>
<td>AppSign</td>
<td>作为项目的鉴权密钥，用于 SDK。默认不展示，单击右侧小眼睛按钮即可显示详细信息。
<div class="mk-warning">
...
临时 Token 有效期为 24 小时，项目上线前必须生成正式的 Token，详情请参考 [使用 Token 鉴权\|_blank](#10360)。
</div>

![/Pics/Consle/1025.png](http://doc.oa.zego.im/Pics/Consle/1025.png)
