...
本文主要介绍 [创建项目](#14213) 完成后，项目信息的 [查看流程](12107#1)，以及项目信息涵盖的内容，包括 [基本信息](12107#2_1)、[配置信息](12107#2_2) 和 [辅助工具](12107#2_3)。
...
临时 Token 有效期为 24 小时，项目上线前必须生成正式的 Token，详情请参考 [使用 Token 鉴权](#10360)。
</div>
