...
## 配置步骤
本文以在[腾讯云](https://doc-zh.zego.im/article/16138#2_1)、[阿里云](https://doc-zh.zego.im/article/16138#2_2)、[百度云](https://doc-zh.zego.im/article/16138#2_3)配置 TXT 记录为例。操作步骤仅供参考，如与实际配置不符，请以各 DNS 服务商的信息为准。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Consle/Tencent_Domain_Deployment.png" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Consle/Aliyun_Domain_Name_Deployment.png" /></Frame>
...
5. 单击“保存”，配置 TXT 完毕，预计需要10分钟生效。   
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Consle/Baidu_Domain_Name_Deployment.png" /></Frame>
