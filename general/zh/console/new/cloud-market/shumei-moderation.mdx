...
1. 您可以从 2 个入口进入数美账号创建页面。
    ...
    <tr>
    <td><ol><li>在 <a href="https://www.zego.im/cloudmarket" target="_blank">ZEGO 云市场</a> 单击选择一项数美审核产品，进入详情页。<img src="/Pics/console/cloud_market/cloud_market.jpeg" width="80%"></li><li>在详情页上选择“前往开通配置”按钮，进入数美账号创建页面。<img src="/Pics/console/cloud_market/cloud_market_entry.jpeg" width="80%"></li></ol></td>
    <td><ol><li>在 <a href="https://console.zego.im/ProjectManage" target="_blank">ZEGO 控制台 &gt; 项目管理</a> 中选择希望配置数美审核的项目，进入“项目配置”页面。<img src="/Pics/console/cloud_market/details.jpeg" width="80%"></li><li>在“项目配置” &gt; “服务配置”中选择“实时音视频”或“即时通讯”，点击“数美内容审核”的“开通服务”按钮，进入数美账号创建页面。<img src="/Pics/console/cloud_market/service.jpeg" width="80%"></li></ol></td>
    </tr>
    </tbody></table>

2. 进入数美账号创建页面后，提交表单信息，创建数美账号。

    <img src="/Pics/console/cloud_market/info.jpeg" width="80%">
...
1. 进入内容审核服务开通页面。
    ...
    - 当您为首次开通数美账号时，您在“创建数美账号”页面“确认开通”后，即可进入服务开通页面。
        <img src="/Pics/console/cloud_market/step_1.jpeg" width="80%">
        <img src="/Pics/Consle/shumei_01.jpeg" width="80%">
    - 当您已经拥有数美账号时，您需要在 <a href="https://console.zego.im/ProjectManage" target="_blank">ZEGO 控制台 &gt; 项目管理</a> 中选择希望配置数美审核的项目，进入“项目配置”页面。
        <img src="/Pics/console/cloud_market/details.jpeg" width="80%">
      在“项目配置“ &gt; "服务配置" 中选择“实时音视频”或“即时通讯”，点击“数美内容审核”的“开通服务”按钮，进入数美内容审核配置窗口。
        <img src="/Pics/console/cloud_market/service.jpeg" width="80%">
      ...
      <tr>
      <td><img src="/Pics/Consle/shumei_tanchaung01.jpeg" width="80%"></td>
      <td><img src="/Pics/console/cloud_market/ZIM.jpeg" width="80%"></td>
      </tr>
      </tbody></table>
...
2. 配置服务项
    ...
    - 实时音视频
      ...
      <td>审核方式</td>
      <td>是</td>
      <td>ZEGO 支持服务端API发起审核的方式。相关实现方式请参考数美内容审核的 [使用说明|_blank](#18683)。该服务默认开通，不支持关闭。
      </tr>
      </tbody></table>
    <a id="ZIM"></a>
    - 即时通讯
...
<img src="/Pics/console/cloud_market/select.jpeg" width="80%">

- 实时音视频
<img src="/Pics/console/cloud_market/Moderation1.jpeg" width="80%">
- 即时通讯
<img src="/Pics/console/cloud_market/check_ZIM.jpeg" width="80%">

### 4 查看总体服务信息和数美账号信息

前往“云市场>已开通产品”，点击“数美内容审核”，进入详情页。

<img src="/Pics/console/cloud_market/nextdata.jpeg">

<img src="/Pics/console/cloud_market/nextdata_details.jpeg">
...
<img src="/Pics/console/cloud_market/Moderation2.jpeg" width="80%">
...
<img src="/Pics/console/cloud_market/describe_1.jpeg" width="80%">
...
<img src="/Pics/console/cloud_market/describe_2.jpeg" width="80%">

ZEGO 控制台只支持基本查询和统计，如需更多维度统计和分析，请导出文件自行处理。

<img src="/Pics/console/cloud_market/describe_3.jpeg" width="80%">
