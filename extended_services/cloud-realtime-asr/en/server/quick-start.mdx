...
sequenceDiagram
    ...
    rect rgb(125, 168, 237)
        ...
        Note right of Client: Business server must set SubtitleType to 1, 2, or 3 when starting recognition
...
const data = JSON.stringify({
  ...
  "SubtitleType": 3 // Subtitle delivery type, default is 0. 0: No delivery; 1: Recognition results only; 2: Translation results only; 3: Both recognition and translation results
});
