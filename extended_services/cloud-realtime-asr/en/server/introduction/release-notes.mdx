...
2. **Deprecated the qwen3-asr-flash-realtime speech recognition model** (formerly `"Vendor": "AliyunQwenASR"`). **If you are still using this model, it will be replaced with** [Qwen-Audio-3.0-ASR-Flash-Streaming](https://help.aliyun.com/zh/model-studio/asr-model#qwen-audio-3-0-asr-flash-streaming) later.
