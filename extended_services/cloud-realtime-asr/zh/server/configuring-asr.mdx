...
- 选择合适厂商/识别模型：支持腾讯 ASR（含大模型版本）、阿里百炼 Paraformer、阿里百炼 Fun-ASR、阿里百炼 Qwen-ASR、火山 SeedASR（豆包大模型）、微软等
...
| 参数                   | 类型   | 是否必选 | 描述                                                                                                                                                                                                                                  |
| ---------------------- | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Vendor                 | String | 否       | ASR 供应商，默认为 Tencent：<ul><li>Tencent: 腾讯</li><li>AliyunParaformer: 阿里云 Paraformer</li><li>AliyunFunASR: 阿里云 Fun-ASR</li><li>AliyunQwenASR: 阿里云 Qwen-ASR</li><li>VolcSeedASR: 火山引擎 SeedASR（豆包大模型）</li><li>Microsoft: 微软 ASR</li></ul> |
