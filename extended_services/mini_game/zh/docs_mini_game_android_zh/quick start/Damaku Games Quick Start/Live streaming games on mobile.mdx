...
- 已在项目中集成 ZEGO Express SDK，详情请参考实时音视频的 [集成 SDK](https://doc-zh.zego.im/real-time-video-android-java/quick-start/integrating-sdk)。
...
请参考实时音视频的 [实现视频通话 - 创建引擎](https://doc-zh.zego.im/real-time-video-android-java/quick-start/implementing-video-call)，创建 ZegoExpressEngine。

完成初始化之后，请参考 实时音视频的 [实现视频通话 - 登录房间](https://doc-zh.zego.im/real-time-video-android-java/quick-start/implementing-video-call)，登录 RTC 房间。
...
// 详情请参考文档 [控制台 - 项目信息](/console/project-info)
// appID 需已开通小游戏服务
long appID = 您的 AppID;
...
请参考实时音视频的 [实现视频通话 - 退出房间](https://doc-zh.zego.im/real-time-video-android-java/quick-start/implementing-video-call)，完成退出 RTC 房间。

#### 5.2 销毁 ZegoExpressEngine

请参考实时音视频的 [实现视频通话 - 销毁引擎](https://doc-zh.zego.im/real-time-video-android-java/quick-start/implementing-video-call)，完成销毁。
