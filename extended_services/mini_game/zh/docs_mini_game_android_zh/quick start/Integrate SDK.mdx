...
<td>BLUETOOTH</td>
<td>连接蓝牙设备权限。</td>
<td>连接蓝牙设备时需要使用该权限。<Warning title="Warning"><p>仅 Android 6.0 以下版本需要声明，Android 6.0 及以上版本无需声明。</p></Warning></td>
</tr>
<tr>
...
- [主播在移动端开播弹幕游戏](./DamakuGamesQuickStart/Live%20streaming%20games%20on%20mobile.mdx)。
