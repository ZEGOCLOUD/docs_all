...
- [实时音视频 - 集成 SDK](https://doc-zh.zego.im/real-time-video-ios-oc/quick-start/integrating-sdk)。
- [实时语音 - 集成 SDK](https://doc-zh.zego.im/real-time-voice-ios/quick-start/integrating-sdk)。
...
4. 选择 “TARGETS > General > Frameworks,Libraries,and Embedded Content” 菜单，添加 ZegoMiniGameEngine.xcframework 和 ZegoConnection.xcframework，将 “Embed” 设置为 “Embed & Sign”。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/embed_and_sign1.png" /></Frame>
