...
- 已安装 CocoaPods。安装 CocoaPods 的方法以及常见问题可参考 [CocoaPods 常见问题](https://doc-zh.zego.im/faq/cocoapods-issues)。
...
<Step title="登录 Apple 开发者账号。">
  ...
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/xcode_preferences.png" /></Frame>
...
<Step title="修改 Bundle Identifier 和开发者证书。">
  ...
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/Team_and_BundleID.jpeg" /></Frame>
</Step>
<Step title="修改 “/ZegoMiniGameEngineDemo/KeyCenter.m” 文件，填写 SDK 初始化所需的 “AppID”，并且将 hostUrl 地址修改为跑通服务端源码后获得的地址（如本文 [前提条件](#前提条件-2) 所述）。">
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/appid_host.jpeg" /></Frame>
</Step>
<Step title="将 iOS 设备连接到开发电脑，单击 Xcode 上方的的 “Any iOS Device”，在弹出的选项框选择该 iOS 设备（或者模拟器）。">
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/device_selection.jpeg" /></Frame>
</Step>
<Step title="单击 Xcode 左上角的 “Build” 按钮编译和运行示例源码，即可体验小游戏。">
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/run.jpeg" /></Frame>
</Step>
</Steps>