...
<tbody>
  ...
  <tr>
    ...
    <td>String</td>
    <td>是</td>
    <td>签名，签名的生成请参考 <a href="#3">签名机制</a>。
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Int64</td>
    <td>是</td>
    <td>Unix 时间戳，单位为秒。最多允许 10 分钟的误差。
  </tr>
</tbody>
</table>
...
AppID 和 ServerSecret 通过在 [ZEGO 控制台\|_blank](https://console.zego.im) 创建项目获取，详情请参考 [控制台 - 项目信息\|_blank](https://doc-zh.zego.im/article/12107)。
...
<tbody>
  <tr>
    <td>AppId</td>
    <td>应用 ID。通过在 [ZEGO 控制台\|_blank](https://console.zego.im) 创建项目获取，详情请参考 [控制台 - 项目信息\|_blank](https://doc-zh.zego.im/article/12107)。</td>
  </tr>
  <tr>
    <td>SignatureNonce</td>
  ...
  <tr>
    <td>ServerSecret</td>
    <td>应⽤密钥，通过在 [ZEGO 控制台\|_blank](https://console.zego.im) 创建项目获取，详情请参考 [控制台 - 项目信息\|_blank](https://doc-zh.zego.im/article/12107)。</td>
  </tr>
  <tr>
    <td>Timestamp</td>
...
CallbackSecret 必须严格保密，防止泄漏。如何获取，请参考 [控制台 - 项目信息\|_blank](#12107)。
