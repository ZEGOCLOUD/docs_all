...
AppID 和 ServerSecret 通过在 [ZEGO 控制台](https://console.zego.im) 创建项目获取，详情请参考 [控制台 - 项目信息](https://doc-zh.zego.im/article/12107)。
...
<tbody>
  <tr>
    <td>AppId</td>
    <td>应用 ID。通过在 [ZEGO 控制台](https://console.zego.im) 创建项目获取，详情请参考 [控制台 - 项目信息](https://doc-zh.zego.im/article/12107)。</td>
  </tr>
  <tr>
    <td>SignatureNonce</td>
  ...
  <tr>
    <td>ServerSecret</td>
    <td>应⽤密钥，通过在 [ZEGO 控制台](https://console.zego.im) 创建项目获取，详情请参考 [控制台 - 项目信息](https://doc-zh.zego.im/article/12107)。</td>
  </tr>
  <tr>
    <td>Timestamp</td>
