...
- 已在项目中集成 ZEGO Express SDK，详情请参考实时音视频的 [集成 SDK](https://doc-zh.zego.im/real-time-video-web/quick-start/integrating-sdk)。
...
请参考实时音视频的 [实现视频通话 - 创建引擎](https://doc-zh.zego.im/real-time-video-web/quick-start/implementing-video-call)，创建 ZegoExpressEngine。

完成初始化之后，请参考 实时音视频的 [实现视频通话 - 登录房间](https://doc-zh.zego.im/real-time-video-web/quick-start/implementing-video-call)，登录 RTC 房间。
