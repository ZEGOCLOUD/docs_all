...
在实现主播在浏览器开播弹幕游戏之前，还需要额外集成 ZEGO Express SDK 搭配使用。请参考 [实时音视频 - 集成 SDK](https://doc-zh.zego.im/real-time-video-web/quick-start/integrating-sdk)。如果您的项目已集成相关 SDK，可忽略此步骤。
