...
If you need to enable the host to launch a barrage game in the browser, you need to additionally integrate the ZEGOCLOUD Express SDK for use. Please refer to [Video Call - Integrate the SDK\|_blank](#1031). If your project has integrated the relevant SDK, you can ignore this step.
...
- [Implement live comment-based games on PCs as a host](!ZegoMiniGameEngine-Live_streaming_games_on_PC)
- [Implement live comment-based games on browsers as a host](!ZegoMiniGameEngine-browser_danmaku_game)
