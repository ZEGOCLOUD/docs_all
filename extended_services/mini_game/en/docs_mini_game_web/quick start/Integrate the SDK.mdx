...
If you need to enable the host to launch a barrage game in the browser, you need to additionally integrate the ZEGOCLOUD Express SDK for use. Please refer to [Video Call - Integrate the SDK](https://www.zegocloud.com/docs/real-time-video-web/quick-start/integrating-sdk). If your project has integrated the relevant SDK, you can ignore this step.
