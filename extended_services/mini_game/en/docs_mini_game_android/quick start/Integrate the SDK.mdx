...
2. Open the `app/build.gradle` file and add the following dependency to the `dependencies` section:
  ...
  dependencies { 
      ...
      // Replace x.y.z in the following sample code with the version number of ZEGOCLOUD MiniGameEngine SDK. For more information, see [Release notes](https://doc-zh.zego.im/article/17635).
...
1. Download the latest SDK and decompress the SDK. For more information, see [Download\|_blank](#16440).
