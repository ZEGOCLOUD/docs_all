...
- [Video Call - Integrate the SDK](https://www.zegocloud.com/docs/real-time-video-ios-oc/quick-start/integrating-sdk).
- [Voice Call - Integrate the SDK](https://www.zegocloud.com/docs/real-time-voice-ios/quick-start/integrating-sdk).

### 3. Import ZEGOCLOUD MiniGameEngine SDK

<Steps>
<Step title="Download the latest SDK and decompress the SDK">
For more information, see [Download](https://www.zegocloud.com/docs/faq/mini-game-alternatives) .
</Step>
...
<Step title="Choose TARGETS > General > Frameworks,Libraries,and Embedded Content. ">
  ...
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/embed_and_sign.png" /></Frame>
</Step>
</Steps>
...
<Step title="In Xcode, choose TARGETS > Info > Custom iOS Target Properties.">
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/info.jpeg" /></Frame>
</Step>
<Step title="Click the plus icon (+) to grant the camera and microphone permissions.">
  ...
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/add_privacy.jpeg" /></Frame>

  The following figure shows the result where the camera and microphone permissions are granted.
  
  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/privacy_example.jpeg" /></Frame>
