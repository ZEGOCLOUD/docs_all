...
- A project is created in the [ZEGOCLOUD console](https://console.zegocloud.com/account/login), and the application ID is obtained. This is optional in free-trial mode. For more information, see [How to create  project](https://www.zegocloud.com/docs/console/create-project) in the "Console" documentation.
- The server secret of the created project is obtained. This is optional in free-trial mode. For more information, see [How to view project information](https://www.zegocloud.com/docs/console/project-info) in the "Console" documentation.
...
<Frame width="512" height="auto" caption="">
  <img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/16764_1.jpeg" />
</Frame>
...
2. Configure a game source.
   ...
   3. In the dialog, set the `Mode`parameter to "Capture specific window" and select a game.
    ...
    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/16764_2_3.jpeg" /></Frame>
...
3. Configure a video image.
 ...
 <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/16764_2.jpeg" /></Frame>
   ...
   2. In the `Setting`dialog box, perform the following operations:
      - Click the "Output" tab. On this tab, set the video bitrate to 7,000 Kbit/s.
        <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/16764_3.jpeg" /></Frame>
      ...
      - Click the "Video" tab. On this tab, set the `Base (Canvas) Resolution` parameter and the `Output (Scaled) Resolution` parameter to 720×1080, and set the `Common FPS Values` parameter to 30.
          ...
          <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/16764_4.jpeg" /></Frame>
...
Set the `Stream Key` parameter to `ABC`.
       <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/MiniGames/16764_5.jpeg" /></Frame>
