...
This section describes the Public parameters that are used when you call an operation of the ZEGOCLOUD server API, including Public request parameters and Public response parameters.
