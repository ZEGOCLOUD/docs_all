...
|300001001|The recording task has stopped. The reason may be that you call the [Stop recording] method or the recording conditions trigger the auto-stop recording. To know the conditions that trigger the auto-stop recording, refer to the [`MaxIdleTime`](7427#MaxIdleTime) and [`MaxRecordTime`](7427#MaxRecordTime) parameters. |
