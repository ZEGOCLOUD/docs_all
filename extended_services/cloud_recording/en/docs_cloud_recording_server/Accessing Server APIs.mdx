...
In this context, `PRODUCT` refers to different services provided by ZEGOCLOUD, and in this particular product, it is `cloudrecord`, for instance, `cloudrecord-api.zego.im`. 
