...
To update the layout of the mixed streams during video recording, call the [`UpdateLayout`](/cloud-recording-server/update-the-mixed-stream-layout) method multiple times. For more details, see [Set stream mixing layout](./Common%20Features/Set%20the%20Mixed%20Flow%20Layout.mdx).


### Update the whiteboard

To update the Whiteboard ID during recording, call the [`UpdateWhiteboard`](/cloud-recording-server/whiteboard-update) method multiple times. For more details, see [Whiteboard Recording](./Common%20Features/Whiteboard%20Recording.mdx).
