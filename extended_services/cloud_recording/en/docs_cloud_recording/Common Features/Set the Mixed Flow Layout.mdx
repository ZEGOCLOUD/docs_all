...
To set video layout, set the `MixMode` parameter when calling the [`StartRecord`](/cloud-recording-server/start-recording) method.

During the mixed-stream recording, you can change the layout by calling the [`UpdateLayout`](/cloud-recording-server/update-the-mixed-stream-layout) method.
...
To specify the large region in the horizontal layout, set the `MixMaxResolutionStreamId` parameter when calling the calling the [`StartRecord`](/cloud-recording-server/start-recording) method and [`UpdateLayout`](/cloud-recording-server/update-the-mixed-stream-layout) methods.
...
To specify the large region in the vertical layout, set the `MixMaxResolutionStreamId` parameter when calling the calling the [`StartRecord`](/cloud-recording-server/start-recording) method and [`UpdateLayout`](/cloud-recording-server/update-the-mixed-stream-layout) methods.
...
To specify the large region in the floating layout, set the `MixMaxResolutionStreamId` parameter when calling the calling the [`StartRecord`](/cloud-recording-server/start-recording) method and [`UpdateLayout`](/cloud-recording-server/update-the-mixed-stream-layout) methods.
...
To set the size and position of each user's region on the canvas, set the `MixInputList` parameter when calling the [`StartRecord`](/cloud-recording-server/start-recording) method and [`UpdateLayout`](/cloud-recording-server/update-the-mixed-stream-layout) methods.
