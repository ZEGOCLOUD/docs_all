...
For the cloud recording server-side APIs, the QPS (Queries Per Second) can be found in the [API reference - API Overview](/cloud-recording-server/api-overview).
