...
- ZEGOCLOUD recommends that each of your recording tasks call the [Stop recording](./stop-recording.mdx) method to stop recording to avoid additional costs for continued recording.
</Warning>
