...
- [单流和混流的录制分辨率分别在哪里设置？](https://doc-zh.zego.im/faq/recording-resolution-setting)
- [在单流录制过程中，为什么白板文件设置的 StreamType 不生效？](https://doc-zh.zego.im/faq/single-stream-recording-stream-type-issue)
- [开始录制后，如果房间内新增了流，这个新增的流会被录制吗？](https://doc-zh.zego.im/faq/recording-new-stream)
- [在录制过程中，如果音视频流退出房间再重进，会是什么表现？](https://doc-zh.zego.im/faq/recording-rejoin-behavior)
