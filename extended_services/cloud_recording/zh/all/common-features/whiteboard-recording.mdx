...
- 阅读本文前，请确保您已了解 [单流录制](./single-stream-recording.mdx)、[混流录制](./mixed-stream-recording.mdx) 和 [设置混流布局](./set-the-mixed-flow-layout.mdx)。 
- 混流录制模式下白板的布局请参考 [设置混流布局](./set-the-mixed-flow-layout.mdx) 中各个布局的注意事项。
</Note>
...
- [录制过程中，房间内的白板不需要录制了，要如何操作？](https://doc-zh.zego.im/faq/exclude-whiteboard-recording)
- [为什么启动录制后，录制任务成功，但是录制结果的视频中没有显示白板？](https://doc-zh.zego.im/faq/recording-missing-whiteboard)
- [为什么录制结果中，白板的窗口变小，出现异常？](https://doc-zh.zego.im/faq/recording-whiteboard-size-issue)
- [为什么白板的窗口位置会显示背景图？](https://doc-zh.zego.im/faq/whiteboard-background-display-issue)
- [录制视频里可以同时展示两个白板窗口么？](https://doc-zh.zego.im/faq/multiple-boards-recording)
- [当开启了白板录制，但房间内过了一段时间才新增白板，白板如何录制？](https://doc-zh.zego.im/faq/delayed-whiteboard-recording)
