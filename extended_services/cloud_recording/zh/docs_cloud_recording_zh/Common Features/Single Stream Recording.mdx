...
在调用 [StartRecord](#12322) 方法时，将 `RecordMode` 参数设为 “1” 即可启用单流录制模式。
...
- [单流和混流的录制分辨率分别在哪里设置？\|_blank](https://doc-zh.zego.im/faq/record_solution)
- [在单流录制过程中，为什么白板文件设置的 StreamType 不生效？\|_blank](https://doc-zh.zego.im/faq/stream_type_invalid)
- [开始录制后，如果房间内新增了流，这个新增的流会被录制吗？\|_blank](https://doc-zh.zego.im/faq/new_stream)
- [在录制过程中，如果音视频流退出房间再重进，会是什么表现？\|_blank](https://doc-zh.zego.im/faq/Enter_after_exit)
