...
- 阅读本文前，请确保您已了解 [单流录制](./Single%20Stream%20Recording.mdx)、[混流录制](./Mixed%20Stream%20Recording.mdx) 和 [设置混流布局](./Set%20the%20Mixed%20Flow%20Layout.mdx)。 
- 混流录制模式下白板的布局请参考 [设置混流布局](./Set%20the%20Mixed%20Flow%20Layout.mdx) 中各个布局的注意事项。
</Note>
