...
| 参数 | 类型 | 是否必选 | 描述 |
| --- | --- | --- | --- |
| TaskId | Int | 是 | 录制任务 ID，长度固定为 16 个字节的字符串。 |
...
| └RecordMode | Int | 请参考 <a href="./start.mdx" target="_blank">开始录制</a>。 |
| └StreamType | Int | 请参考 <a href="./start.mdx" target="_blank">开始录制</a>。 |
...
| FileId | String | 请参考 <a href="./start.mdx" target="_blank">开始录制</a> 中的 OutputFileRule 参数。 |
