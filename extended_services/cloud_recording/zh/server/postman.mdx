...
<Warning title="注意">
本文已不再更新，推荐使用 [如何在线调试服务端 API](/cloud-recording-server/call-api-online) 进行调试。
</Warning>
...
- 已经 [开通云端录制服务](https://doc-zh.zego.im/cloud-recording/quick-start/integration) 并获取了调用接口所必须的 AppID、ServerSecret 等信息。
