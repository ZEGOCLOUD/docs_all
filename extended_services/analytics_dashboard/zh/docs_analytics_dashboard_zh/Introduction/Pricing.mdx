...
为了更好地满足开发者的个性化需求，星图于 **2023 年 8 月 1 日** 起，正式商用，并提供 `免费版`、`专业版`、`旗舰版` 三个档位的套餐包。每个套餐包均支持 [通话洞察](./../Guides/Communication%20Insights/Function%20introduction.mdx)、[用户监测](./../Guides/User%20behavior%20monitoring.mdx)、[运营大盘](./../Guides/Operations%20Dashboard/Function%20introduction.mdx) 等功能，所提供的功能服务和计费标准会有所差异，开发者可根据自身业务需求选择订阅套餐包。
...
<Frame width="80%" height="auto" caption="">
  <img src="https://doc-media.zego.im/sdk-doc/Pics/Prism/billing.jpeg" />
</Frame>
