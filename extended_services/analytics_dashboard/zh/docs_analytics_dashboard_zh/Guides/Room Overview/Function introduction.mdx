...
房间详情页最上方为房间基础信息模块，展示包括房间持续时间、当前在房人数、峰值在房人数、累计在房人数、累计推流人数、音/视频卡顿率等基础指标，帮助用户快速了解房间规模、体验。
...
- 推流并发图表呈现了房间生命周期内的推流数变化趋势，便于您判断是否由于推/拉流路数导致用户体验问题，点击悬浮窗“查看此刻推流列表”可快速跳转流列表模块。
