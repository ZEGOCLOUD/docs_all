...
您可以前往 [数据说明](./communication-insights/data-explanation.mdx) 查看各个指标的详细介绍。
...
<Frame width="512" height="auto"><img src="https://doc-media.zego.im/docuo/b319f9874d.png" /></Frame>
...
跟踪推流对应的拉流用户，并分析拉流用户质量，可以点击“查看拉流汇总”，前往推流质量页了解相关数据。有关该页面的介绍，详情请参考 [通话洞察](./communication-insights/function-introduction.mdx#推流质量页)。

<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/Prism/Stream_playing.png" /></Frame>

**查看通话互动质量**

查看通话互动质量，详细了解通话用户间的互动详情，可点击“查看端到端质量”，前往端到端质量页了解相关数据。有关该页面的介绍，详情请参考 [通话洞察](./communication-insights/function-introduction.mdx#端到端详情页)。
