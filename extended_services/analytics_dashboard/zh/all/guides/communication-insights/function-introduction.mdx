...
- 用户基本数据包括：用户 ID、SDK 版本、系统、机型、地区、运营商、网络、推流路径、拉流路径。
    ...
    - 拉流路径：表示拉流从服务器到客户端的路径，如 CDN → 客户端，表示客户端是从 CDN 节点拉流。
        ...
        <Frame width="auto" height="auto" ><img src="https://media-resource.spreading.io/docuo/workspace564/27e54a759d23575969552654cb45bf89/014f1306fa.png" /></Frame>


    若信息发生了变化，可以点击信息旁边的图标展开查看。

    <Frame width="auto" height="auto" ><img src="https://media-resource.spreading.io/docuo/workspace564/27e54a759d23575969552654cb45bf89/88aff3aecf.png" /></Frame>   
