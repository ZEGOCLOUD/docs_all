...
以下请求参数列表仅列出了接口请求参数和部分公共参数，完整公共参数列表请参考 [调用方式 - 公共请求参数](./../access-server-apis.mdx#公共请求参数)。
...
<td>String</td>
<td>否</td>
<td>国家或地区的名称。<ul><li>all：默认值，表示所有国家和地区。</li><li>其他值：仅支持中文地名，具体值请参考 <a href="https://prism.zego.im">星图 - 实时监控 - 业务监控 - 用户体验</a> 筛选 <code>地区</code> 后的下拉列表。<img src="https://doc-media.zego.im/docuo/51a706c402.jpeg" /></li></ul></td>
</tr>
<tr>
<td>Platform</td>
<td>String</td>
