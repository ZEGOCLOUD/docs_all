...
<Warning title="注意">每次调用接口都需要生成新的签名。</Warning>
...
<Frame>
  <img src="https://storage.zego.im/sdk-doc/Pics/Consle/1031.png" />
</Frame>

<Frame>
  <img src="https://storage.zego.im/sdk-doc/Pics/Consle/1028.png" />
</Frame>
...
<tbody>
  ...
  <tr>
    <td>SignatureNonce</td>
    <td>随机字符串，即公共参数里的 SignatureNonce，生成算法可参考 <a href="#签名示例">3.3 签名示例</a>。</td>
  </tr>
  <tr>
    <td>ServerSecret</td>
