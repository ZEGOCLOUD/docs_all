...
The Real-time Monitoring provides you with the real-time data within the last 2 hours, updated once per minute. If you need to view historical data, you can go to [Operations Dashboard](./Operations%20Dashboard/Introduction.mdx).  
</Warning>
