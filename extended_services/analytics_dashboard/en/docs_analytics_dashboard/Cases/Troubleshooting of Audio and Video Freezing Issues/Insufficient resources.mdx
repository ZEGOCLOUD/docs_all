...
Before troubleshooting the cause of lag, please refer to [Call Quality Monitoring](../../Guides/Call%20Quality%20Monitoring/Function%20Introduction.mdx) to familiarize yourself with the features of the Analytics Dashboard - Call Quality Monitoring module.
</Note>
...
2. Enter the Search Page of Call Quality Monitoring, locate the target stream, select the target App, input the playback user ID or stream ID, and call time, and retrieve the stream list information.
