...
[Analytics Dashboard](https://console.zegocloud.im) (AD) is ZEGO's audio and video quality operations platform for developers. It helps developers comprehensively monitor audio and video services, reconstruct call quality and interaction scenarios, and efficiently identify and troubleshoot issues with low barriers, ultimately improving audio and video quality and user experience.
