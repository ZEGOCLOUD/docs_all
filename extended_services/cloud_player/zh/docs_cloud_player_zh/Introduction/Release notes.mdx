...
| -------- | -------- | -------- | -------- |
| 播放器支持连续播放多个媒体资源 | 支持在创建云播放器时选择传入 `StreamUrlList` 设置多个媒体资源进行连续播放 | [创建云端播放器](/cloud-player-server/create-player) | 2025-09-23 |
|播放器支持更新媒体资源列表|支持在更新云播放器时选择传入 `StreamUrlList` 更新媒体资源列表 | [更新云端播放器](/cloud-player-server/update-player) | 2025-09-23 |
|服务端更新| 支持在查询云端播放器时返回当前播放的媒体资源列表和媒体资源下标 | [查询云端播放器](/cloud-player-server/describe-players#players)| 2025-09-23 |
|!mu| 回调新增 `PlayIndex` 参数，表示加载的媒体资源下标 | [回调](/cloud-player-server/callback/callback#detail) | 2025-09-23 |
---
