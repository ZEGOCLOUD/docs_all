...
- Create a project in the [ZEGOCLOUD console](https://console.zegocloud.com/account/login) and apply for a valid AppID. For more details, please refer to [How to view project information](https://www.zegocloud.com/docs/console/project-info).
