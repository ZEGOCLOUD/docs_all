...
<td>String</td>
<td>No</td>
<td><p>Unique identifier ID of the cloud player, returned by <a href="./cloud player create.mdx" target="blank">CreatePlayer</a>.</p><p><b>If PlayerId is filled in, please make sure that the PlayerId already exists, otherwise the query result may be empty.</b></p></td>
</tr>
<tr>
<td>PageSize</td>
<td>Number</td>
