...
<td>Status</td>
<td>Number</td>
<td>Status of the cloud player.<ul><li>1: Creating.</li><li>2: Connecting to media resource.</li><li>3: Waiting to play.</li><li>4: Playing.</li><li>5: Paused.</li><li>6: Failed to connect to media resource.</li><li>7: Playback ended.</li><li>8: Destroyed.</li></ul></td>
</tr>
<tr data-row-level="5-3-9">
<td>DestroyReason</td>
<td>Number</td>
<td>Reason for destroying the cloud player.<ul><li>1: Actively destroyed by calling the <a href="./cloud player destroy.mdx" target="blank">DeletePlayer</a> interface.</li><li>2: The idle time exceeded <code>MaxIdleTime</code>.</li><li>3: Media resource playback has ended.</li><li>4: Failed to push stream.</li><li>5: Failed to enter or was kicked out of the room.</li></ul></td>
</tr>
</tbody></table>
