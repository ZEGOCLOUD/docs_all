...
<div class="multiple-select-codes">
  <div class="code-tabs hide-scrollbar">
    <div class="scroll-box">
      <span class="tab-item">
        <span>Query a Single Upload Task</span>
      </span>
      <span class="tab-item">
        <span>Get Multiple Upload Tasks</span>
      </span>
    </div>
  </div>
...
<Note title="Note">Aside from the above, this field has no correlation with the list information, so please do not use it for any other logic.</Note></td>
</tr>
...
<td>Status</td>
<td>Number</td>
<td>Upload status, with values as follows:
<ul>
  <li>1: Pending</li>
  <li>2: Uploading</li>
...
<Note title="Note">It is recommended to use this as the <code>StreamUrl</code> when [creating a media player](!cloud_player-cloud_player_create).</Note></td>
</tr>
</tbody></table>
