...
<td>String</td>
<td>Yes</td>
<td><p>Unique identifier ID for the cloud player, returned by <a href="./cloud player create.mdx" target="blank">CreatePlayer</a>.</p><p><b>When calling this interface, please make sure that PlayerId already exists, otherwise errors may occur.</b></p></td>
</tr>
</tbody></table>
