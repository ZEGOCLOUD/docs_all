...
|<p style={{width:"10em"}}>Interface Name|Interface Function|<p style={{width:"10em"}}>Call Frequency Limit|
|-|-|-|
...
|[Callback](./server%20APIs%20callback.mdx)|Receive real-time cloud player status change events and upload task-related events through this callback in real time.**Please note that you need to contact ZEGO technical support to configure the callback address.**|-|
