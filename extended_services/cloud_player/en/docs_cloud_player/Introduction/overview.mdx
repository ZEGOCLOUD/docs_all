...
| Transcoding | <p>Support for transcoding the streams pushed to the rooms, with the following audio and video parameters configurable:</p><ul><li>AudioOptions: Set audio transcoding format, sample rate, bitrate, number of channels, volume, etc.</li><li>VideoOptions: Set video transcoding format, resolution, frame rate, bitrate, video padding mode, etc.</li></ul> |
