...
| InternalUploadStreamUrl | String | ZEGO internal URL of the file after successful upload.<Note title="Note">It is recommended to use this as the <code>StreamUrl</code> when [creating a cloud player](./create-player.mdx).</Note> |
