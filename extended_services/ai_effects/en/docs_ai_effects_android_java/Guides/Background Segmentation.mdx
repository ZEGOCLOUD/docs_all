...
3. Import the `SegmentationModel`. For details, see [Import models\|_blank](9920#2).
...
To use the portrait segmentation feature, import the model file `SegmentationModel` first; otherwise, this feature can't take effect. For details, see [Import resources and models\|_blank](!Quick_Starts/Import_Resources).
</Warning>
...
1. Do either one of the following: 
    ...
    - Call the `setPortraitSegmentationBackgroundTexture` method to set the background texture. 
...
1. Do either one of the following: 
    ...
    - Call the `setChromaKeyBackgroundBuffer` method to set the background buffer.
