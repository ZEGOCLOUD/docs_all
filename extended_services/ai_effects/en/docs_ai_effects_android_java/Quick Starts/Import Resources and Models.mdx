...
2. Before calling the [create\|_blank](@create__1) method to create a `ZegoEffects` object, call the [setResources\|_blank](@setResources) method to set the resource or model path list and load the resources and models.
