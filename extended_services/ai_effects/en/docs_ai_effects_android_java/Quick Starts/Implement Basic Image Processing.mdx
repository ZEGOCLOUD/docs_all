...
- Integrate the ZegoEffects SDK into your project. For more information, see [Quick starts - Integration](#9910).
...
1. Import the AI resources and models.
     ...
     To use the SDK's AI features, you must import the necessary AI resources or models by calling the `setResources` method. For details, see [Quick starts - Import resources and models](#9920).
