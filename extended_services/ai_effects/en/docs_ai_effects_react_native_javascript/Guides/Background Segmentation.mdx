...
- You have imported the basic "SegmentationModel" resource files. For details, see [Import resources and models|_blank](!Quick_Starts/Import_Resources).
...
Before using the portrait segmentation feature, please import the corresponding "SegmentationModel" model files, otherwise the feature will not take effect. For details, please refer to [Quick Start - Import Resources and Models|_blank](!Quick_Starts/Import_Resources).
</Warning>

1. Call the [setPortraitSegmentationBackgroundPath|_blank](@setPortraitSegmentationBackgroundPath) interface to set the background path for portrait segmentation.
...
2. Call the [enablePortraitSegmentation|_blank](@enablePortraitSegmentation) interface to enable the portrait segmentation feature.
...
Call the [enablePortraitSegmentationBackgroundBlur|_blank](@enablePortraitSegmentationBackgroundBlur) interface to enable the background blur feature for portrait segmentation. After enabling the blur feature, you can call the [setPortraitSegmentationBackgroundBlurParam|_blank](@setPortraitSegmentationBackgroundBlurParam) interface to set the "intensity" parameter of the [ZegoEffectsBlurParam|_blank](@-ZegoEffectsBlurParam) object to adjust the degree of background blur.
...
Call the [enablePortraitSegmentationBackgroundMosaic|_blank](@enablePortraitSegmentationBackgroundMosaic) interface to enable the background mosaic feature for portrait segmentation. After enabling the mosaic feature, you can call the [setPortraitSegmentationBackgroundMosaicParam|_blank](@setPortraitSegmentationBackgroundMosaicParam) interface to set the "intensity" parameter of the [ZegoEffectsMosaicParam|_blank](@-ZegoEffectsMosaicParam) object to adjust the degree of mosaic.
...
1. Call the [setChromaKeyBackgroundPath|_blank](@setChromaKeyBackgroundPath) interface to set the custom background path for chroma key segmentation.
...
2. Call the [enableChromaKey|_blank](@enableChromaKey) interface to enable the chroma key segmentation feature, then call the [setChromaKeyParam|_blank](@setChromaKeyParam) interface to set parameters and adjust color tolerance, edge smoothness, etc.
...
Call the [enableChromaKeyBackgroundBlur|_blank](@enableChromaKeyBackgroundBlur) interface to enable the background blur feature for chroma key segmentation. After enabling the blur feature, you can call the [setChromaKeyBackgroundBlurParam|_blank](@setChromaKeyBackgroundBlurParam) interface to set the "intensity" parameter of the [ZegoEffectsBlurParam|_blank](@-ZegoEffectsBlurParam) object to adjust the degree of blur.
...
Call the [enableChromaKeyBackgroundMosaic|_blank](@enableChromaKeyBackgroundMosaic) interface to enable the background mosaic feature for chroma key segmentation. After enabling the mosaic feature, you can call the [setChromaKeyBackgroundMosaicParam|_blank](@setChromaKeyBackgroundMosaicParam) interface to set the "intensity" parameter of the [ZegoEffectsMosaicParam|_blank](@-ZegoEffectsMosaicParam) object to adjust the degree of mosaic.
