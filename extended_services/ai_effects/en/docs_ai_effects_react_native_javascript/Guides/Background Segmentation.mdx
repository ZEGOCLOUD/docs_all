...
- You have imported the basic "SegmentationModel" resource files. For details, see [Import resources and models](!Quick_Starts/Import_Resources).
...
Before using the portrait segmentation feature, please import the corresponding "SegmentationModel" model files, otherwise the feature will not take effect. For details, please refer to [Quick Start - Import Resources and Models](!Quick_Starts/Import_Resources).
</Warning>
