...
- Integrate the ZegoEffects SDK into your project. For details, see [Integration\|_blank](!Quick_Starts/Integration).
- Implement the basic image processing functionality. For details, see [Implementation\|_blank](!Quick_Starts/Solution_Implementation).
...
1. To apply the eyeliner, call the [`setEyeliner`\|_blank](@setEyeliner) method with the path of the eyeliner resource passed to the `path` parameter.
2. To set the `intensity`, call the [`setEyelinerParam`\|_blank](@setEyelinerParam) method.
   The value range of the `intensity` property of [`ZegoEffectsEyelinerParam`\|_blank](@-ZegoEffectsEyelinerParam) is [0, 100]. As this value gets larger, the effect gets stronger.
...
To remove the eyeliner, call the [`setEyeliner`\|_blank](@setEyeliner) method with the `path` parameter set to `nil`.
...
1. To apply the eyeshadow, call the [`setEyeshadow`\|_blank](@setEyeshadow) method with the path of the eyeshadow resource passed to the `path` parameter.
2. To set the `intensity`, call the [`setEyeshadowParam`\|_blank](@setEyeshadowParam) method.
   The value range of the `intensity` property of [`ZegoEffectsEyeshadowParam`\|_blank](@-ZegoEffectsEyeshadowParam) is [0, 100]. As this value gets larger, the effect gets stronger.
...
To remove the eyeshadow, call the [`setEyeshadow`\|_blank](@setEyeshadow) method with the `path` parameter set to `nil`.
...
1. To apply the eyelashes, call the [`setEyelashes`\|_blank](@setEyelashes) method with the path of the eyelashes resource passed to the `path` parameter.
2. To set the `intensity`, call the [`setEyelashesParam`\|_blank](@setEyelashesParam) method.
   The value range of the `intensity` property of [`ZegoEffectsEyelashesParam`\|_blank](@-ZegoEffectsEyelashesParam) is [0, 100]. As this value gets larger, the effect gets stronger.
...
To remove the eyelashes, call the [`setEyelashes`\|_blank](@setEyelashes) method with the `path` parameter set to `nil`.
...
1. To apply the blusher, call the [`setBlusher`\|_blank](@setBlusher)  method with the path of the blusher resource passed to the `path` parameter.
2. To set the `intensity`, call the [`setBlusherParam`\|_blank](@setBlusherParam) method.
   The value range of the `intensity` property of [`ZegoEffectsBlusherParam`\|_blank](@-ZegoEffectsBlusherParam) is [0, 100]. As this value gets larger, the effect gets stronger.
...
To remove the blusher, call the [`setBlusher`\|_blank](@setBlusher) method with the `path` parameter set to `nil`.
...
1. To apply the lipstick, call the [`setLipStick`\|_blank](@setLipStick) method with the path of the lipstick resource passed to the `path` parameter.
2. To set the `intensity`, call the [`setLipStickParam`\|_blank](@setLipStickParam) method.
   The value range of the `intensity` property of [`ZegoEffectsLipstickParam`\|_blank](@-ZegoEffectsLipstickParam) is [0, 100]. As this value gets larger, the effect gets stronger.
...
To remove the lipstick, call the [`setLipStick`\|_blank](@setLipStick) method with the `path` parameter set to `nil`.
...
1. To apply the colored eye contacts, call the [`setColoredcontacts`\|_blank](@setColoredcontacts) method with the path of the colored eye contacts resource passed to the `path` parameter.
2. To set the `intensity`, call the [`setColoredcontactsParam`\|_blank](@setColoredcontactsParam) method.
   The value range of the `intensity` property of [`ZegoEffectsColoredcontactsParam`\|_blank](@-ZegoEffectsColoredcontactsParam) is [0, 100]. As this value gets larger, the effect gets stronger.
...
To remove the colored eye contacts, call the [`setColoredcontacts`\|_blank](@setColoredcontacts) method with the `path` parameter set to `nil`.
...
You can't superimpose the makeup looks and [stickers\|_blank](!Common_Features/Stickers). Once you apply a makeup look, the sticker will be overridden.
</Warning>

#### Use the makeup looks

  
1. To apply the makeup looks, call the [`setMakeup`\|_blank](@setMakeup) method with the path of the makeup look resource passed to the `path` parameter.
2. To set the `intensity`, call the [`setMakeupParam`\|_blank](@setMakeupParam) method.
   The value range of the `intensity` property of [`ZegoEffectsMakeupParam`\|_blank](@-ZegoEffectsMakeupParam) is [0, 100]. As this value gets larger, the effect gets stronger.
...
To remove the colored eye contacts, call the [`setMakeup`\|_blank](@setMakeup) method with the `path` parameter set to `nil`.
