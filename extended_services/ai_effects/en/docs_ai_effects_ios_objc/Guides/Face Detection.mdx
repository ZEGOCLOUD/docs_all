...
3. Import the `FaceDetectionModel`. For details, see [Import models\|_blank](9919#2).

## Enable face detection

<Warning title="Warning">

To use the face detection feature, import the model file `FaceDetectionModel` first; otherwise, this feature can't take effect. For details, see [Import resources and models\|_blank](!Quick_Starts/Import_Resources).
</Warning>
