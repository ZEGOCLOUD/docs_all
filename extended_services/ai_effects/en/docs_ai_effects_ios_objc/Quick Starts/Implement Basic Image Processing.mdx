...
- Integrate the ZegoEffects SDK into your project. For more information, see [Quick starts - Integration\|_blank](#9909).
...
- A project has been created in [ZEGOCLOUD Console\|_blank](https://console.zegocloud.com) and applied for a valid AppID and AppSign. For details, please refer to [Console - How to view project information\|_blank](#16144) .
...
![/Pics/AI_Vision/QuickStarts/Implemention_iOS_en.png](http://doc.oa.zego.im/Pics/AI_Vision/QuickStarts/Implemention_iOS_en.png)
...
1. Import the AI resources and models.
     ...
     To use the SDK's AI features, you must import the necessary AI resources or models by calling the `setResources` method. For details, see [Quick starts - Import resources and models\|_blank](#9919).
...
3. Create Effects Object
    ...
    Pass the AppID and AppSign obtained from the [Prerequisites](!Quick_Starts/Solution_Implementation#1) directly to the [create\|_blank](/article/api?doc=Effects_SDK_API~objectivec_ios~class~ZegoEffects#create-appid-app-sign-2) interface. After internal authentication by the SDK, it will create an Effects object and return the corresponding [error code\|_blank](!Error_Codes/Error_Codes).
