...
1. 调用 [zego_register_face_detection_result_callback](@zego_register_face_detection_result_callback) 接口设置人脸检测结果回调。
...
2. 调用 [zego_effects_enable_face_detection](@zego_effects_enable_face_detection) 接口开启人脸检测功能。
