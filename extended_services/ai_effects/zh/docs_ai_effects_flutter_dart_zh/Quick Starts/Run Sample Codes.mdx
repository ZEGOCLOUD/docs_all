...
1. 下载 [iOS ZegoEffects SDK](https://doc-zh.zego.im/article/15898) 或 [Android ZegoEffects SDK](https://doc-zh.zego.im/article/15899) 最新版本，并解压后，将 `Resources` 和 `Models` 文件夹导入到您下载的 [示例源码](https://storage.zego.im/AIEffect/ZegoEffects/Sourcecode/Flutter/example.zip) 中，需要保留原来的“Backgrounds.bundle”文件。
