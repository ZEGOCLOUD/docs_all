...
1. 请在 [下载\|_blank](!ZegoEffects_downloads) 页面，获取最新版本的 SDK zip 包并解压。  
...
![/Pics/AI_Vision/QuickStarts/integration_macOS_2.png](http://doc.oa.zego.im/Pics/AI_Vision/QuickStarts/integration_macOS_2.png)
