...
1. 下载 [iOS ZegoEffects SDK\|_blank](https://doc-zh.zego.im/article/15898) 或 [Android ZegoEffects SDK\|_blank](https://doc-zh.zego.im/article/15899) 最新版本，并解压后，将 `Resources` 和 `Models` 文件夹导入到您下载的 [示例源码\|_blank](https://github.com/ZEGOCLOUD/zego_effects_reactnative_demo) 中。
...
2. 在示例源码的根目录下，添加`KeyCenter.js` 文件，具体内容如下。并填写对应的`appID`，`appSign`及`effectLicense`，获取方式请参考 [前提条件\|_blank](21322#2)。
