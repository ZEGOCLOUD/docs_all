...
1. 调用 [setPortraitSegmentationBackgroundPath](@setPortraitSegmentationBackgroundPath) 接口，设置人像分割使用的背景路径。
...
1. 调用 [setChromaKeyBackgroundPath](@setChromaKeyBackgroundPath) 接口，设置绿幕分割使用自定义背景路径。
