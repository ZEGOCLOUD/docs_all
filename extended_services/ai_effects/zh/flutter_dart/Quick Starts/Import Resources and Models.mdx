...
1. 下载 [iOS ZegoEffects SDK](https://doc-zh.zego.im/article/15898) 或 [Android ZegoEffects SDK](https://doc-zh.zego.im/article/15899) 最新版本。
...
3. 如需使用资源和模型，在调用 [create](/unique-api/ai-effects-sdk/zh/dart_flutter/zego_effects_plugin/ZegoEffectsPlugin/create.html) 方法创建对象之前，先调用 [setResources](/unique-api/ai-effects-sdk/zh/dart_flutter/zego_effects_plugin/ZegoEffectsPlugin/setResources.html) 方法加载资源，模型。
   ```
