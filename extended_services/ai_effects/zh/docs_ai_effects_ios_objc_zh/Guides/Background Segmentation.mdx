...
1. 调用 [setPortraitSegmentationBackgroundPath\|_blank](@setPortraitSegmentationBackgroundPath) 或 [setPortraitSegmentationBackgroundBuffer\|_blank](@setPortraitSegmentationBackgroundBuffer) 接口，设置人像分割使用的背景路径或背景 Buffer（二选一）。
...
1. 调用 [setChromaKeyBackgroundPath\|_blank](@setChromaKeyBackgroundPath) 或 [setChromaKeyBackgroundBuffer\|_blank](@setChromaKeyBackgroundBuffer) 接口，设置绿幕分割使用的背景路径或背景 Buffer（二选一）。
