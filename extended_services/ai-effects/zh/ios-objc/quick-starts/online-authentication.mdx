...
export const flowchart1Map = {
    'default,Android,mac': <img src="https://storage.zego.im/sdk-doc/Pics/ZegoEffects/getAuthorizedMessage_iOS_Android.png" />,
...
export const flowchart2Map = {
    'default,Android,mac': <img src="https://storage.zego.im/sdk-doc/Pics/ZegoEffects/getAuthorizedMessage_iOS_Android_cgi.png" />,
