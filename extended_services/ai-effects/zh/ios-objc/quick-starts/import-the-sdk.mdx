...
- [如何获取 SDK 的堆栈信息？](https://doc-zh.zego.im/faq/ai-effects-stacktrace)
- [如何获取 SDK 的日志信息？](https://doc-zh.zego.im/faq/ai-effects-logs)
- [Xcode Archive 时提示 “Undefined symbols for architecture armv7: "_OBJC_CLASS_$_ZegoEffects"”，该如何处理？](https://doc-zh.zego.im/faq/xcode-undefined-symbols)
