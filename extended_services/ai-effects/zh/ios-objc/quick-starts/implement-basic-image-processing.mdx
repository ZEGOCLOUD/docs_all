...
- 已在项目中集成 SDK，详情请参考 [快速开始 - 集成 SDK](./Import%20the%20SDK.mdx)。
...
<Frame width="auto" height="auto">
  <img src="https://storage.zego.im/sdk-doc/Pics/AI_Vision/QuickStarts/Implemention_iOS_zh.png" />
</Frame>
...
使用 Effects 的 AI 相关功能前，必须调用 [setResources](@setResources) 接口导入 AI 资源或模型，详情请参考 [快速开始 - 导入资源和模型](./import-resources-and-models.mdx)。
...
<Step title="部署高级配置项">
部署高级配置项，如配置设备性能等级，详情请参考 [配置设备性能等级](./Configure%20Device%20Performance%20Levels.mdx)。
...
将 [前提条件](#前提条件) 中申请到的 AppID、AppSign 直接传入 [create](/article/api?doc=effects-sdk_API~objectivec_ios~class~ZegoEffects#create-appid-app-sign-2) 接口，由 SDK 内部鉴权之后，创建 Effects 对象并返回相关 [错误码](./../Error%20Codes.mdx)。
...
<Step title="开启 AI 功能">
调用 [enableWhiten](@enableWhiten)/[enableBigEyes](@enableBigEyes)/[setPortraitSegmentationBackgroundPath](@setPortraitSegmentationBackgroundPath)/[enablePortraitSegmentation](@enablePortraitSegmentation) 接口开启 AI 功能。
