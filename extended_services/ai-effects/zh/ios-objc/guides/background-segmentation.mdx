...
- 已在项目中集成 ZegoEffects SDK，实现基本的图像处理功能，详情请参考 [快速开始 - 实现图像处理](./../quick-starts/implement-basic-image-processing.mdx)。
- 导入 “SegmentationModel” 模型路径，详情请参考 [快速开始 - 导入资源和模型](./../quick-starts/import-resources-and-models.mdx)。
...
<Warning title="注意">
使用人像分割功能前，请先导入对应的 “SegmentationModel” 模型文件，否则功能无法生效。详情请参考 [快速开始 - 导入资源和模型](./../quick-starts/import-resources-and-models.mdx)。
</Warning>
