...
3. Create Effects Object.
    ...
    Pass the AppID and AppSign obtained from the [Prerequisites](!Quick_Starts/Solution_Implementation#1) directly to the [create](@create__1) interface. After internal authentication by the SDK, it will create an Effects object and return the corresponding [error code](/ai-effects-android-java/error-codes).
