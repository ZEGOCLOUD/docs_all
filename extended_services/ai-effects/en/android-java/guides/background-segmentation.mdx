...
3. Import the `SegmentationModel`. For details, see [Import models](9920#2).
...
<Warning title="Warning">
Enabling the background mosaic feature will override any previously set custom background and background blurring feature.
</Warning>
