...
- You have integrated ZegoExpressSDK into your project. For details, see [Quick start](https://www.zegocloud.com/docs/real-time-video-flutter/quick-start/implementing-video-call).
...
- When creating the Effects object, the SDK internally authenticates through AppID and AppSign.
</Warning>
...
<Warning title="Note">
Ensure that the Express SDK has been initialized. For details, see [Implement video call document](https://www.zegocloud.com/docs/real-time-video-flutter/quick-start/implementing-video-call).
</Warning>
