...
- Integrate the ZegoEffects SDK into your project. For more information, see [Quick starts - Integration](#9909).
- Get the unique license file of the SDK. For details, see [Online privilege authentication](!Quick_Starts/Authenticate_users_with_tokens).
- A project has been created in [ZEGOCLOUD Console](https://console.zegocloud.com) and applied for a valid AppID and AppSign. For details, please refer to [Console - How to view project information](#16144) .
...
1. Import the AI resources and models.
     ...
     To use the SDK's AI features, you must import the necessary AI resources or models by calling the `setResources` method. For details, see [Quick starts - Import resources and models](#9919).
...
2. Deploy Advanced Configuration
    ...
    Call the [setAdvancedConfig](@setAdvancedConfig) interface to deploy advanced configuration items, such as configuring device performance levels. For details, please refer to [Configure Device Performance Level](!getDeviceLevel).
