...
3. Do the following to add the framework file to the project target:  
    ...
    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/AI_Vision/QuickStarts/integration_macOS_1.png" /></Frame>
...
3. Enter the **Key** as `Privacy - Camera Usage Description` to add camera permissions.  
    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/AI_Vision/QuickStarts/add_Camera_Privacy_ios.png" /></Frame>


## Related documents

- [How to obtain the SDK stack traces?](https://www.zegocloud.com/docs/faq/ai-effects-stacktrace)
- [How to obtain the SDK logs?](https://www.zegocloud.com/docs/faq/ai-effects-stacktrace)
- [How to handle the error that occurred when archiving your app in Xcode?](https://www.zegocloud.com/docs/faq/xcode-undefined-symbols)
