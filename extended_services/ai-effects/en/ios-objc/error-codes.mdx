...
export const errorCallbackMap = {
    'default': <a href='https://www.zegocloud.com/docs/article/api?doc=effects-sdk_API~objectivec_ios~protocol~ZegoEffectsEventHandler#effects-errcode-desc' target='_blank'>effects:errcode:desc:</a>,
    'macOS': <a href='https://www.zegocloud.com/docs/article/api?doc=effects-sdk_API~objectivec_macos~protocol~ZegoEffectsEventHandler#effects-errcode-desc' target='_blank'>effects:errcode:desc:</a>,
    'Android': <a href='@onError' target='_blank'>onError</a>,
    'Flutter': <a href='https://docs.zegocloud.com/unique-api/ai-effects-sdk/en/dart_flutter/zego_effects_plugin/ZegoEffectsPlugin/registerEventCallback.html' target='_blank'>onEffectsError</a>,
...
Generally, the errors are returned through the callback {getPlatformData2(props,errorCallbackMap)}. Please refer to the following error codes and handle them accordingly.
