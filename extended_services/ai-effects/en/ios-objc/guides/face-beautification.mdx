...
export const setSkinColorParamMap = {
    ...
    'Flutter': <a href='https://www.zegocloud.com/docs/unique-api/ai-effects-sdk/en/dart_flutter/zego_effects_plugin/ZegoEffectsPlugin/setSkinColorParam.html' target='_blank'>setSkinColorParam</a>,
}
