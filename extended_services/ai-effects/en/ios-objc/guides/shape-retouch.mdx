...
// Set the intensity of eyes brightening. The value range is [0, 100], and the default value is 50
ZegoEffectsEyesBrighteningParam param = ZegoEffectsEyesBrighteningParam();
param.intensity = 100;
mEffects.setEyesBrighteningParam(param);
```
:::
...
2. Call the {getPlatformData2(props,setNoseLengtheningParamMap)} method to set the intensity.  
    ...
    The value range of the `intensity` property of the {getPlatformData2(props,ZegoEffectsNoseLengtheningParamMap)} is [-100, 100], and the default value is 50. The value gets larger, the nose gets more lengthened. 
...
param.intensity = 100;
mEffects.setNoseLengtheningParam(param);
```
:::
:::if{props.platform="RN"}
```js
...
// Set the intensity, the value range is [-100, 100], and the default value is 50.
ZegoEffectsNoseLengtheningParam param = ZegoEffectsNoseLengtheningParam();
param.intensity = 100;
