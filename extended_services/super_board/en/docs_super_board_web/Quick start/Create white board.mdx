...
For details about how to obtain the token used for authentication during SDK initialization, refer to [Generate a token](./User%20Access%20Control.mdx#generate-a-token).
