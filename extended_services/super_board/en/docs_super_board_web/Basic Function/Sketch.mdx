...
1. Enable the drawing feature of Super Board.
 ...
 - Call [`setOperationMode`\|_blank](@setOperationMode) method to set the operation mode to `ZegoSuperBoardOperationMode.Draw` to enable the drawing feature of ZEGO Super Board.
