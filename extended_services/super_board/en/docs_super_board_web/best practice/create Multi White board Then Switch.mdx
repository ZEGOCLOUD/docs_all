...
Refer to [Getting started](../Quick%20start/Create%20white%20board.mdx) to integrate and initialize the SDK and log in to the room. The complete sample code is as follows:
