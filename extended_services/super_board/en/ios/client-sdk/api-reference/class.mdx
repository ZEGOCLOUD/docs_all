...
| --- | --- | --- |
| filePath | nonnull NSString * | The absolute path of the files to be uploaded can be PPT, PDF, XLS, JPG, JPEG, PNG, BMP, and TXT files. For details, please refer to [File specifications](https://www.zegocloud.com/docs/super-board-android/product-desc/overview). |
