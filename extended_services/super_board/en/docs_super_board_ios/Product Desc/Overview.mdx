...
| Web | Supports | Supports | Supports | Please refer to [Browser versions supported by the SDK](../Quick%20start/Create%20white%20board.mdx). |
...
| Electron | Supports | Supports | Supports | <ul><li>Electron 7.0.0 ～ 23.0.0 </li><li>Windows 7 or above</li><li>macOS 10.13 or above.</li></ul> |
