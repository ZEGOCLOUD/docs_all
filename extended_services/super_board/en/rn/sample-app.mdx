...
- A project has been created in the ZEGOCLOUD console and applied for a valid AppID and AppSign. For details, please refer to [Admin console - How to view project information](https://www.zegocloud.com/docs/console/project-info).
