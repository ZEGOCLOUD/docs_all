...
- A project has been created in [ZEGOCLOUD Console](https://console.zegocloud.com/account/login) and applied for a valid AppID and AppSign. For details, please refer to [Console - Project Information](https://www.zegocloud.com/docs/console/project-info).
