...
2. The sample code is missing the AppID and AppSign required for SDK initialization. You need to modify the “example/lib/uitils/zego_auth_constants.dart” file. Please fill in the AppID and AppSign obtained from the [Prerequisites](#prerequisites) correctly.
