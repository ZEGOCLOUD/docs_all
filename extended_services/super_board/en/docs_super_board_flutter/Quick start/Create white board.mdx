...
If you need to know how to create a Flutter project, please refer to the official Flutter documentation [Test drive\|_blank](https://docs.flutter.dev/get-started/test-drive#create-app). 
</details>
...
1. Import the libraries of ZEGOCLOUD Super Board SDK for Android  
    Download and unzip the [sample code\|_blank](!ZegoSuperBoard-sample_app) to get the “superboard_view_flutter” folder.    
...
Call the [initWithConfig\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/initWithConfig.html) method to initialize the ZegoSuperBoard SDK.
...
- [onError\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard_event_handler/ZegoSuperBoardEventHandler/onError.html): Error codes thrown by the SDK. For errorCode reference, see [Error codes\|_blank](!ZegoSuperBoard-ErrorCodes/ErrorCodes).
- [onRemoteSuperBoardSubViewAdded\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard_event_handler/ZegoSuperBoardEventHandler/onRemoteSuperBoardSubViewAdded.html): Notification for a new whiteboard added remotely.
- [onRemoteSuperBoardSubViewRemoved\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard_event_handler/ZegoSuperBoardEventHandler/onRemoteSuperBoardSubViewRemoved.html): Notification for a whiteboard destroyed remotely.
- [onRemoteSuperBoardSubViewSwitched\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard_event_handler/ZegoSuperBoardEventHandler/onRemoteSuperBoardSubViewSwitched.html): Notification for switching whiteboard files remotely.
...
You can call the [loginRoom|_blank](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/loginRoom.html) interface of [ZegoExpressEngine\|_blank](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngine-class.html) to log in to the room. If the room does not exist, the room will be created and logged in when this interface is called.
...
- The constructor of [ZegoUser\|_blank](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoUser/ZegoUser.html) will set the userName to be the same as the parameter userID you passed.
...
To obtain the current number of whiteboards in a room, call the [querySuperBoardSubViewList\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/querySuperBoardSubViewList.html) method.
...
If you need to destroy a specific whiteboard, call the [destroySuperBoardSubView\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/destroySuperBoardSubView.html) interface and pass in the uniqueID of that whiteboard to destroy it.
...
- [Draw\|_blank](!ZegoSuperBoard-BasicFunction/Sketch)
- [Turn pages\|_blank](!ZegoSuperBoard-BasicFunction/flip)
- [Zoom in or out\|_blank](!ZegoSuperBoard-BasicFunction/Scale)
- [Switch a whiteboard\|_blank](!ZegoSuperBoard-BasicFunction/Switch)
- [Get whiteboard list\|_blank](!ZegoSuperBoard-BasicFunction/Whiteboardlist)
