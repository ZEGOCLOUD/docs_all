    ...
    <div class="sdk-download-item-wrapper">
      ...
      <div class="download-selector">
        <div class="download-select-wrapper" style="padding-right: 0;">
          <a class="download-target-btn" href="https://storage.zego.im/SuperBoardSDK%2FFlutter%2FDemoSourceCode%2Fsuperboard_view_flutter.zip" target="_blank">Download</a>
