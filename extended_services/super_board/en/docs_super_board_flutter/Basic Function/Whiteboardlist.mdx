...
1. When entering the room for the first time, you can call the [querySuperBoardSubViewList\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/querySuperBoardSubViewList.html) method to actively retrieve the list of whiteboards already created in the room.
...
2. When already in the room, you can call the [getSuperBoardSubViewModelList\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/getSuperBoardSubViewModelList.html) to retrieve the list of all current whiteboards.
