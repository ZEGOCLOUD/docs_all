...
whiteboard is created by referring to [Create a super board\|_blank](!ZegoSuperBoard-QuickStart/CreateWboard).
...
Call [setOperationMode\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/setOperationMode.html) method to set the operation mode to ZegoSuperBoardOperationMode.Draw，to enable the drawing feature of ZegoSuperBoard.
...
Set the [setToolType\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/setToolType.html), [setBrushColor\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/setBrushColor.html) and [setBrushSize\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/setBrushSize.html) methods to modify the type, color and size of the drawing tool.
