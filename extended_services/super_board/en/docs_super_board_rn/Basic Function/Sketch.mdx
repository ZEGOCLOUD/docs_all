...
Call [setOperationMode\|_blank](@setOperationMode) method to set the operation mode to ZegoSuperBoardOperationMode.Draw，to enable the drawing feature of ZegoSuperBoard.
...
Set the [setToolType\|_blank](@setToolType) property of the [ZegoSuperBoardManager\|_blank](@-ZegoSuperBoardManager) class to modify the tool type of ZEGOCLOUD Super Board. Currently, 10 tools are supported.
