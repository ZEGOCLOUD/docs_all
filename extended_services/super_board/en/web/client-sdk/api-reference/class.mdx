...
| Name | Type | Description |
| --- | --- | --- |
| file | File | The file object to be uploaded supports ppt, pdf, xls, jpg, jpeg, png, bmp, txt and other types of files. For details, please refer to [File specifications](https://www.zegocloud.com/docs/super-board-android/product-desc/overview). |
