...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/WhiteboardView/switch.gif" /></Frame>

## 前提条件

已 [创建超级白板\|_blank](!ZegoSuperBoard-QuickStart/CreateWboard)。

## 实现流程

### 监听远端白板切换

调用 [onRemoteSuperBoardSubViewSwitched\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard_event_handler/ZegoSuperBoardEventHandler/onRemoteSuperBoardSubViewSwitched.html) 接口，监听远端白板切换。
...
调用 [switchSuperBoardSubView\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/switchSuperBoardSubView.html) 可以切换白板；调用 [switchSuperBoardSubViewWithSheetIndex\|_blank](https://pub.dev/documentation/zego_superboard/latest/zego_superboard/ZegoSuperBoardManager/switchSuperBoardSubViewWithSheetIndex.html) 可以切换 Excel 文件。
