...
<Card title="示例源码" href="https://storage.zego.im/SuperBoardSDK%2FFlutter%2FDemoSourceCode%2Fsuperboard_view_flutter.zip" target="_blank">
本地下载
</Card>
...
- 文件共享功能不是默认开启的，使用前请在 [ZEGO 控制台](https://console.zego.im) 自助开通（开通步骤请参考控制台文档 [服务配置 - 文件共享](#14338)），或联系 ZEGO 技术支持开通。
...
<Frame width="256" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/demo_run.jpeg" /></Frame>
