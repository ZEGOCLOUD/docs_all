    ...
    <div class="sdk-download-item-wrapper">
      ...
      <div class="download-selector">
        <div class="download-select-wrapper" style="padding-right: 0;">
          <a class="download-target-btn" href="https://storage.zego.im/SuperBoardSDK%2FFlutter%2FDemoSourceCode%2Fsuperboard_view_flutter.zip" target="_blank">本地下载</a>
          <ul class="download-dropdown-list">
            <li data-href="https://storage.zego.im/SuperBoardSDK%2FFlutter%2FDemoSourceCode%2Fsuperboard_view_flutter.zip"
...
2. 下载的示例源码中缺少 SDK 初始化所需的 AppID 和 AppSign，需要修改 “example/lib/uitils/zego_auth_constants.dart” 文件。请使用本文 [前提条件](#18393#2) 已获取的 AppID 和 AppSign 正确填写。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/appID.png" /></Frame>
...
3. 登录 Apple ID。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/login_AppleID.jpeg" /></Frame>
    输入 AppID 和密码。
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/login.jpeg" /></Frame>
4. 修改开发者证书和 Bundle Identifier。
   ...
   <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/Signing_and_Capabilities.jpeg" /></Frame>
...
5. 运行源码
    ...
    - Visual Studio Code
        ...
        2. 在顶部菜单栏中点击“Run > Start Debugging“。
            <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/vscode_run.jpeg" /></Frame>
    ...
    - Xcode
        ...
        2. 使用 Xcode 打开示例源码目录中的“superboard_demo/ios/Runner.xcworkspace”，单击顶部“运行”图标，即可运行项目。              
            <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/xcode_run.jpeg" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/flutter/demo_run.jpeg" /></Frame>
