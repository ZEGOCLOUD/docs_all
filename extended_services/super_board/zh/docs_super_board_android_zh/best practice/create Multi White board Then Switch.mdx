...
| 方法        | 描述           |
| ----------- | -------------- |
| [createEngine\|_blank](/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#create-engine)  | 创建 ZegoExpressEngine 单例对象并初始化 SDK  |
|[getInstance\|_blank](@getInstance)| 获取 ZegoSuperBoardManager 实例对象  |
| [init\|_blank](@init)| 初始化 ZegoSuperBoard SDK  |
| [loginRoom\|_blank](/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#login-room) | 登录房间  |
