...
![/Pics/WhiteboardView/sync.gif](http://doc.oa.zego.im/Pics/WhiteboardView/sync.gif)
...
<details class="zg-primary">
    <summary>此步骤以如何创建新项目为例，如果是集成到已有项目，可忽略此步骤。</summary>

1. 打开 Android Studio，选择菜单 “File > New > New Project”。

   ![](/Pics/Android/WhiteBoard/new_project.png)

2. 选择项目类型 “Empty Activity”。

   ![](/Pics/Android/WhiteBoard/new_project_1.png)

3. 选择项目存储路径。

   ![](/Pics/Android/WhiteBoard/new_project_5.png)
...
1. 请参考 [下载 SDK 包\|_blank](!DownloadSDK/DownloadSDK)，下载最新版本的 SDK，下载完成后进行解压。
...
- [onError\|_blank](@onError)：SDK 抛出的错误码。errorCode 可参考 [常见错误码\|_blank](#11344)。
...
<details class="zg-primary">
    <summary>此步骤介绍 Token 过期时如何处理；如果您未使用 Token 鉴权，可忽略此步。</summary>  
