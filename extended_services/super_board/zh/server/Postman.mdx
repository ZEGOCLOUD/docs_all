...
开发者可参考 [跑通示例源码](https://doc-zh.zego.im/super-board-ios/quick-start/run-demo) 运行 Demo 登录房间，也可参考 [快速开始](https://doc-zh.zego.im/super-board-ios/quick-start/create-white-board) 开发自己的应用登录房间。
