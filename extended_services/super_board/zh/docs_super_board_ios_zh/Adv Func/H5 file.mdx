...
- 在 ZegoDocsView SDK 中使用 H5 文件的完整示例源码请参考 [跑通示例源码\|_blank](../Quick%20Start/Run%20Demo.mdx)。
...
## 使用步骤
H5 文件制作成功后，想要实现多端互通，请参考[快速开始 - 创建文件白板\|_blank](../Quick%20Start/create%20white%20board.mdx)，在项目中集成 ZegoSuperView SDK，实现 H5 文件上传和多端同步显示。

## 文件制作和使用规范

H5 文件制作及使用规范请参考 [H5 文件规范\|_blank](../Product%20Desc/Use%20restrictions/fileRule.mdx#h5-文件)。
...
## H5 桥接层错误码
H5 桥接层错误码请参考 [常见错误码](../Error%20Code.mdx)。
