...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/WhiteboardView/superboard_h5.gif" /></Frame>
...
- ZEGO 提供了制作完成的 H5 文件供开发者参考，包含集成 ZEGO 桥接层以及接口使用方法，详情请参考 [H5 文件示例源码\|_blank](https://storage.zego.im/docs/web/demo/zego_h5_demo.zip)。

- 在 ZegoDocsView SDK 中使用 H5 文件的完整示例源码请参考 [示例源码\|_blank](!Sample_Codes/Sample_Codes)。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/docsview/H5_Sequence.png" /></Frame>
...
## 使用步骤
H5 文件制作成功后，想要实现多端互通，请参考[快速开始 - 创建文件白板\|_blank](!QuickStart/CreateWboard)，在项目中集成 ZegoSuperView SDK，实现 H5 文件上传和多端同步显示。

## 文件制作和使用规范

H5 文件制作及使用规范请参考 [H5 文件规范\|_blank](!ProductDesc/File_Specification#7)。

## H5 桥接层 API


<details open class="zg-primary">
    <summary>以下介绍 H5 桥接层 API。</summary>
...
## H5 桥接层错误码
H5 桥接层错误码请参考 [常见错误码\|_blank](!ErrorCodes/ErrorCodes)。
