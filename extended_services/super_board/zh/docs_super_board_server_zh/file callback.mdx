...
| 参数 | 说明  |
|---- | ------ | 
| callbacksecret  | 服务端校验密钥。在 [ZEGO 控制台\|_blank](https://console.zego.im/) 注册项目时生成，可在 “控制台 > 项目配置 > 后台相关密钥” 中查看。 | 
| timestamp| Unix 时间戳。|
| nonce | 随机数。|
