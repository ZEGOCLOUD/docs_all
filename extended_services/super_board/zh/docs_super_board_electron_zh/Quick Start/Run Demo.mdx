    ...
    <div class="sdk-download-item-wrapper">
      ...
      <div class="download-selector">
        <div class="download-select-wrapper" style="padding-right: 0;">
          <a class="download-target-btn" href="https://github.com/zegoim/zego-superboard-electron-sample" target="_blank">GitHub</a>
          <ul class="download-dropdown-list">
            <li data-href="https://github.com/zegoim/zego-superboard-electron-sample"
...
2. 下载的示例源码中缺少 SDK 初始化所需的 AppID 和 AppSign，需要修改 “superboard/key_center.js” 文件。请使用本文 [前提条件](#18265#2) 已获取的 AppID 和 AppSign 正确填写。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/electron/Info_required.jpeg" /></Frame>
...
5. 运行成功后将会自动弹出登录窗口，请在此窗口输入自定义的 room ID、userName、userID，登录应用，体验超级白板功能。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/superboard/electron/login.jpeg" /></Frame>

6. 如需停止体验，请在 Terminal 中执行 `Control+C` 命令停止运行。
