...
开发者可参考本文中的实现以及 ZEGO 提供的 [示例源码](../quick-start/run-demo.mdx)，根据自己的业务场景组合代码以满足业务需求。
...
请参考 [快速开始](../quick-start/create-white-board.mdx) 完成 SDK 的集成与初始化，并登录房间。
...
创建文件白板使用的文件需要先上传，详见 [共享文件管理](../basic-func/file-manage.mdx)。
</Note>
...
拥有权限的客户端可以在白板上进行绘制，详情请参考 [白板绘制](../basic-func/sketch.mdx)。
...
切换至动态 PPT 后，可通过跳步/翻页接口或点击工具进行 PPT 演示，详情请参考 [白板翻页](../basic-func/scale-and-flip.mdx)。
