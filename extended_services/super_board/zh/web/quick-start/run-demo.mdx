...
<Card title="示例源码" href="https://artifact-demo.zego.im/extended_services/super_board/zh/docs_super_board_web_zh/quick-start/superboard_demo_web.zip" target="_blank">
**本地下载**
</Card>
...
- 已生成 Token，详情请参考 [使用 Token 鉴权](./user-access-control.mdx)。也可以参考 [控制台 - 开发辅助](https://doc-zh.zego.im/console/development-assistance/temporary-token)，在 ZEGO 控制台获取临时 Token（有效期为 24 小时）。
