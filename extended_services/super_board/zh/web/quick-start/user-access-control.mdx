...
- 已在项目中集成 ZEGO Express SDK（2.14.0 及以上版本），实现基本的实时音视频功能，请参考 [快速开始 - 集成](https://doc-zh.zego.im/real-time-video-web/quick-start/integrating-sdk) 和 [快速开始 - 实现流程](https://doc-zh.zego.im/real-time-video-web/quick-start/implementing-video-call)。
