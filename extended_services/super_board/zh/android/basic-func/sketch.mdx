...
<Frame width="auto" height="auto" >
  <img src="https://doc-media.zego.im/docuo/1ced8ebc21.gif" alt="superboard_scatch.gif"/>
</Frame>
## 前提条件

已参考 [快速开始](../quick-start/create-white-board.mdx) 创建了白板。
...
- 将 [setOperationMode](@setOperationMode) 设置为 ZegoSuperBoardOperationMode.Draw，即可开启 ZegoSuperBoard 的绘制功能并同时关闭滚动功能。
- 将 [setOperationMode](@setOperationMode) 设置为 ZegoSuperBoardOperationMode.Scroll，会关闭绘制功能并同时打开滚动功能。
