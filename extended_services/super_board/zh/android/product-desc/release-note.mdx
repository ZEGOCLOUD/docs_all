...
| 优化项         | 优化描述                                     | 相关接口 |
| -------------- | -------------------------------------------- | -------- |
| 更新音视频 SDK | 音视频 SDK 更新为 Express Video SDK 3.24.0。 | -        |
...
| 优化项         | 优化描述                                     | 相关接口 |
| -------------- | -------------------------------------------- | -------- |
| 优化文件 SDK   | 文件 SDK 支持 16 KB 的页面大小。             | -        |
| 更新音视频 SDK | 音视频 SDK 更新为 Express Video SDK 3.22.0。 | -        |
...
| 优化项  | 优化描述 | 相关接口 |
| -----  | ---- | ----- |
| 废弃测试环境 | 统一环境概念，对外不再区分测试环境/正式环境，详见 [测试环境废弃说明](https://doc-zh.zego.im/real-time-voice-android/introduction/abandon-test-environment)。|-|
