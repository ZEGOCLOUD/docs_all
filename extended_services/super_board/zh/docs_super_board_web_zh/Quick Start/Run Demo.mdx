...
<Card title="示例源码" href="https://storage.zego.im/SuperBoardSDK/Web/DemoSourceCode/superboard_demo_web.zip" target="_blank">
**本地下载**
...
- 已生成 Token，详情请参考 [使用 Token 鉴权](./User%20Access%20Control.mdx)。也可以参考 [控制台 - 开发辅助](https://doc-zh.zego.im/article/16309)，在 ZEGO 控制台获取临时 Token（有效期为 24 小时）。


<Warning title="Warning">

使用超级白板前，请参考 [控制台 - 服务配置 - 文件共享\|_blank](https://doc-zh.zego.im/article/14338) 在 [ZEGO 控制台\|_blank](https://console.zego.im) 自助开通文件共享功能（或联系 ZEGO 技术支持开通相关功能权限），否则超级白板服务无法正常使用。 
</Warning>
