    ...
    <div class="sdk-fun">Linux - Java</div>
      ...
      <div class="download-select-wrapper" style="padding-right: 0;">
          ...
          <ul class="download-dropdown-list">
            <li data-href="https://storage.zego.im/downloads/ServerRecorder/ZegoServerRecordingDemo-Java.zip" class="dropdown-option">
              本地下载
            </li>
          </ul>
        </div>
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Linux/ServerRecording/Java/4.jpeg" /></Frame>
...
![](/Pics/Linux/ServerRecording/use_step1.jpg)

2. 执行 `cd out/artifacts/playrecorder_demo_jar` 命令，切换到 “playrecorder_demo_jar” 目录。

![/Pics/Linux/ServerRecording/Java/2.jpeg](//doc.oa.zego.im/Pics/Linux/ServerRecording/Java/2.jpeg)
...
- “app_id”，指您在 [前提条件](19015#1_1) 获取到的 AppID。
- “room_id”，指您需要进行数据流录制的房间 ID。
- “user_id”，指您登录房间所对应的用户 ID。
- “token”，指登录录制流所属房间的鉴权 Token。
- 如果您不设置其它附加参数，默认录制时长为 20s，录制单流，生成一个 .mp4 音视频文件。 

![/Pics/Linux/ServerRecording/Java/3.jpeg](//doc.oa.zego.im/Pics/Linux/ServerRecording/Java/3.jpeg)
