...
- config：进行单流录制的各项配置，详情请参考 [ZegoRecordSingleStreamConfig](https://doc-zh.zego.im/API/ServerRecord-java/com/zego/zegoliveroom/entity/ZegoRecordSingleStreamConfig.html)。
