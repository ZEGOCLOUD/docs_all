...
ZEGO 本地服务端录制 SDK 由深圳市即构科技有限公司提供，您可以在本页面获取适用于 Linux 客户端的 SDK，合规事宜请参考 [ZEGO 安全合规白皮书](https://doc-zh.zego.im#16142)。
...
相关 API 请参考 [SetPlayQualityMonitorCycle](https://doc-zh.zego.im)
