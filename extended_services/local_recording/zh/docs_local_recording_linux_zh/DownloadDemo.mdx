    ...
    <div class="sdk-fun">Linux - C++</div>
      ...
      <div class="download-select-wrapper" style="padding-right: 0;">
          ...
          <ul class="download-dropdown-list">
            <li data-href="https://storage.zego.im/downloads/ZegoServerRecordingDemo.zip" class="dropdown-option">
              本地下载
            </li>
          </ul>
        </div>
...
![](/Pics/Linux/ServerRecording/demoMenu.png)
...
![](/Pics/Linux/ServerRecording/use_step2.jpg)

3. 执行 `export LD_LIBRARY_PATH=./libs/:$LD_LIBRARY_PATH`命令，将 “libs” 文件夹添加到库文件搜索路径。

![](/Pics/Linux/ServerRecording/use_step3.jpg)
...
![](/Pics/Linux/ServerRecording/use_step4.jpg)
