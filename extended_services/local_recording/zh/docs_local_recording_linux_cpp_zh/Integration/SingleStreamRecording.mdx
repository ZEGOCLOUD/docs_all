...
在登录房间之前调用 [SetToken](https://doc-zh.zego.im/API/ServerRecord/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#a68bdea0d66d62c8bf4d671284707b3ae) 接口将 Token 传入 SDK。
...
- 参数：  
  ...
  muxerStreamType：录制流类型，请参考 [MuxerStreamType](https://doc-zh.zego.im/API/ServerRecord/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#aa3bdd4c85ace109d95354ff574454b96)，默认录制音视频。
