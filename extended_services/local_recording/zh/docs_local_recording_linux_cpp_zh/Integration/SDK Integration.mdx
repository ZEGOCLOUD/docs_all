...
## 2 下载 SDK
本地服务端录制 SDK 下载地址：[ZegoLiveRoom-ServerRecording-Linux](https://storage.zego.im/downloads/ZegoLiveRoom-ServerRecording-Linux.zip)

SDK 下载并解压完成后如下图：

<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/Linux/ServerRecording/download.png" />
</Frame>
...
* [快速开始-录制单流](./SingleStreamRecording.mdx)
* [快速开始-录制混流](./MixStreamRecording.mdx)
