...
2. Modify your app-level `build.gradle` file:
  ...
  dependencies {
      ...
      implementation 'im.zego:zego_uikit_prebuilt_live_audio_room_android:+'    // Add this line to your module-level build.gradle file's dependencies, usually named [app].
  }
  ```
