...
如需更精细地开发您的语聊房应用，您可以查看 [实时语音文档](https://doc-zh.zego.im/real-time-voice-android/introduction/entry)。
:::

:::if{props.platform="iOS"}
如需更精细地开发您的语聊房应用，您可以查看 [实时语音文档](https://doc-zh.zego.im/real-time-voice-ios/introduction/entry)。
:::
...
<CardGroup cols={2}>
  ...
  <Card title="使用实时语言 SDK 完全定制"  href="https://doc-zh.zego.im/real-time-voice-android/introduction/entry" target="_blank">
...
<CardGroup cols={2}>
  ...
  <Card title="使用实时语言 SDK 完全定制"  href="https://doc-zh.zego.im/real-time-voice-ios/introduction/entry"  target="_blank">
    要开发完全自定义的语聊房应用，您可以使用实时语音 SDK来实现。
  </Card>
</CardGroup>
:::
