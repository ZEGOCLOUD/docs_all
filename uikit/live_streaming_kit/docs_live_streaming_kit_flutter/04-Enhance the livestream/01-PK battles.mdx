...
If you want to customize the layout for PK, you just need to inherit from [ZegoLiveStreamingPKMixerLayout](https://pub.dev/documentation/zego_uikit_prebuilt_live_streaming/latest/zego_uikit_prebuilt_live_streaming/ZegoLiveStreamingPKMixerLayout-class.html) and override two methods: `getResolution` and `getRectList`.
