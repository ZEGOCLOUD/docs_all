...
| audioVideoViewConfig                  | Configuration of audio and video views.                                                                                                                                                                                                       | [ZegoLiveStreamingAudioVideoViewConfig](#zegolivestreamingaudiovideoviewconfig) |
| bottomMenuBarConfig                   | Configuration parameters for the bottom menu bar of the live streaming page, such as the buttons in the bottom bar, the button quantity limit, whether to hide automatically, whether to hide when clicking other areas, and the color style. | [ZegoLiveStreamingBottomMenuBarConfig](#zegolivestreamingbottommenubarconfig) |
...
| translationText                       | Supports switching the language environment of UIKit and modifying specific texts. The default value is ZegoLiveStreamingTranslationText(language:.ENGLISH).                                                                                  | ZegoLiveStreamingTranslationText                                      |
