...
dependencies {
    ...
    implementation 'im.zego:zego_uikit_signaling_plugin_android:+'  // Add this line to your module-level build.gradle file's dependencies, usually named [app].
}
```
...
<CardGroup cols={2}>
  <Card title="How to upgrade UIKits with a plugin to V2.0.0" href="https://www.zegocloud.com/docs/faq/upgrade-uikit-plugin-to-v2" target="_blank" />
</CardGroup>
