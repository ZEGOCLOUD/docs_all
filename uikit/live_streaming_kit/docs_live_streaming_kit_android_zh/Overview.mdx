...
如果需要搭建一个玩法复杂、自定义程度更精细的直播应用，建议您接入我们的 [超低延迟直播 SDK](https://doc-zh.zego.im/live-streaming-android/introduction/overview) 来实现。
:::
:::if{props.platform="iOS"}
如果需要搭建一个玩法复杂、自定义程度更精细的直播应用，建议您接入我们的 [超低延迟直播 SDK](https://doc-zh.zego.im/live-streaming-ios/introduction/overview) 来实现。
:::
