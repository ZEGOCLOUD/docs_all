...
- First, you'll need to generate a [Kit Token](../04-Authentication%20and%20Kit%20Token.mdx).
    ...
    (**Note**: You can `skip this step` if you wanna speed up your integration testing. Remember to generate the Kit Token by referring to [this](https://www.zegocloud.com/docs/uikit/callkit-web/authentication-and-kit-token) when you plan to make your app go live officially.)
