...
<td>number</td>
<td>是</td>
<td>项目唯一标识 AppID，请从 [ZEGO 控制台](https://console.zego.im) 获取，详情请参考 [控制台 - 项目信息](/console/project-info)。</td>
</tr>
<tr>
<td>serverSecret</td>
<td>string</td>
<td>是</td>
<td>用于后台服务请求接口的鉴权校验，请从 [ZEGO 控制台](https://console.zego.im)&nbsp; 获取，详情请参考 [控制台 - 项目信息](/console/project-info)。</td>
</tr>
<tr>
<td>roomID</td>
<td>string</td>
...
将 [服务器生成的 token](/live-streaming-kit-web/authentication-and-kit-token) 转换为 UIKit 需要用的 kit Token。
...
<td>string</td>
<td>是</td>
<td>开发者在自己的服务端生成，生成方法请参考 [使用 Kit Token 鉴权](/live-streaming-kit-web/authentication-and-kit-token)。</td>
</tr>
<tr>
<td>roomID</td>
<td>string</td>
...
请参考如下文档完成所需插件的集成步骤：
- 白板：[使用白板](https://doc-zh.zego.im/callkit-web/custom-prebuilt-features/use-the-whiteboard)。
- 房间消息：[房间消息](https://doc-zh.zego.im/callkit-web/custom-prebuilt-features/in-room-messages)。
</Note>
