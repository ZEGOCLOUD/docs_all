...
<td>number</td>
<td>是</td>
<td>项目唯一标识 AppID，请从 [ZEGO 控制台](https://console.zego.im) 获取，详情请参考 [控制台 - 项目信息](https://doc-zh.zego.im/article/12107)。</td>
</tr>
<tr>
<td>serverSecret</td>
<td>string</td>
<td>是</td>
<td>用于后台服务请求接口的鉴权校验，请从 [ZEGO 控制台](https://console.zego.im)&nbsp; 获取，详情请参考 [控制台 - 项目信息](https://doc-zh.zego.im/article/12107)。</td>
</tr>
<tr>
<td>roomID</td>
<td>string</td>
...
请参考如下文档完成所需插件的集成步骤：
- 白板：[使用白板](https://doc-zh.zego.im/article/20282)。
- 房间消息：[房间消息](https://doc-zh.zego.im/article/20283)。
</Note>
