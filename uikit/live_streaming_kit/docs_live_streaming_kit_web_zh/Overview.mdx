...
如果需要搭建一个玩法复杂、自定义程度更精细的直播应用，建议您接入我们的 [超低延迟直播 SDK](https://doc-zh.zego.im/live-streaming-web/introduction/overview) 来实现。
...
<CardGroup cols={2}>
  ...
  <Card title="更精细地开发您的直播应用"  href="https://doc-zh.zego.im/live-streaming-web/introduction/overview" target="_blank">
    点击了解详情
  </Card>
</CardGroup>
