...
|||
|--|--|
|<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/Prebuilt_Web/groupCall_p.jpg" /></Frame>|<Frame width="180" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/Prebuilt_Web/groupCall_m.png" /></Frame>|
...
<CardGroup cols={2}>
  ...
  <Card title="I want to try a live demo:">
    ...
    <Button primary-color="NavyBlue" target="_blank" href="https://www.zegocloud.com/docs/real-time-video-web/introduction/overview">Fully customized with SDKs</Button>
  </Card>
</CardGroup>
...
<Card title="Using WebView" href="https://www.zegocloud.com/404">
...
The Video Conference Kit supports the following platforms:

- [Android](https://www.zegocloud.com/docs/uikit/video-conference-kit-android/overview)
- [iOS](https://www.zegocloud.com/docs/uikit/video-conference-kit-ios/overview)
- [Flutter](https://www.zegocloud.com/docs/uikit/video-conference-kit-flutter/overview)
- [React Native](https://www.zegocloud.com/docs/uikit/video-conference-kit-rn/overview)
- [Web](https://www.zegocloud.com/docs/uikit/video-conference-kit-web/overview)