...
<CardGroup cols={2}>
  ...
  <Card title="I want to try a live demo:">
    ...
    <Button primary-color="NavyBlue" target="_blank" href="https://www.zegocloud.com/docs/video-call/overview?platform=web&language=javascript">Fully customized with SDKs</Button>
  </Card>
</CardGroup>
