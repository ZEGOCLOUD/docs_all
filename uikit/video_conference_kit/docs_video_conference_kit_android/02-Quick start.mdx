...
1. **Add ZegoUIKitPrebuiltVideoConference as dependencies**
    ...
    dependencies {
        ...
        implementation 'im.zego:zego_uikit_prebuilt_video_conference_android:+'    // Add this line in your module-level build.gradle file's dependencies, usually named [app].
    }
    ```
