...
<Steps>
    ...
    详细步骤请参考 [使用 Token 鉴权](./Authentication%20and%20Kit%20Token.mdx) 。如需快速调试，建议使用控制台生成的临时 Token，生成临时 Token 的具体操作请参考 [控制台 - 项目管理](/console/project-info)。
    </Step>
    ...
    <Step title="调用 UIKit 组件。">
        <Tabs>
            ...
            <Steps>
                ...
                <Frame width="256" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/21853a1650.jpeg" alt="20250214-110156.jpeg"/></Frame>
                ``` js index.vue {15, 36}
                <template>
                    <view>
...
|                                                                                                                                                                                                          |                                                                                                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/12765df983.jpeg" alt="miniprogram_your_page.jpeg"/></Frame> | <Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/efee65a3e8.jpeg" alt="miniprogram_single_call_page.jpeg"/></Frame> |
