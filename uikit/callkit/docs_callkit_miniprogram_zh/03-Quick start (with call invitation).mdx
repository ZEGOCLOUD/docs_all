...
## 前提条件
- 已在 [ZEGO 控制台](https://console.zego.im/account/login) 创建项目，并申请有效的 AppID 和 AppSign，详情请参考 [控制台 - 项目信息](/console/project-info)。
...
<Steps>
    ...
    详细步骤请参考 [Token](https://doc-zh.zego.im/real-time-video-miniprogram/communication/using-token-authentication) 生成文档。如需快速调试，建议使用控制台生成的临时 Token，生成临时 Token 的具体操作请参考 [控制台 - 项目管理](/console/project-info)。
    </Step> 
        ...
        <Tabs>
            ...
            <Steps>
                ...
                <Frame width="256" height="auto" caption="">
                    <img src="https://doc-media.zego.im/docuo/21853a1650.jpeg" alt="20250214-110156.jpeg"/>
                </Frame>
                ``` js index.vue
                <template>
                    <view>
               ...
               .button-container {
                ...
                <Frame width="auto" height="auto" caption="新建终端">
                  <img src="https://doc-media.zego.im/docuo/36da689ece.jpeg" alt="20250214-102417.jpeg"/>
                </Frame>
                <Frame width="auto" height="auto" caption="构建npm">
                  <img src="https://doc-media.zego.im/docuo/142dce6305.jpeg" alt="20250214-103101.jpeg"/>
                </Frame>
                </Step>
            </Steps>
            </Tab>
...
|--|--|--|
|<Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/c5e53f324b.png" alt="home.png"/></Frame>|<Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/e7e43e36c2.png" alt="StartCallPage.png"/></Frame>|<Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/8eb62111b7.png" alt="CallerWaitingPage.png"/></Frame>|

**被叫方**

|被叫收到呼叫邀请页面|接受邀请后双方通话页面|
|--|--|
|<Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/42894b6f9b.png" alt="CalleeReceiveInvite.png"/></Frame>|<Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/ac8b9222af.png" alt="talkingpage.png"/></Frame>|
