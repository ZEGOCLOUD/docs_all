...
| :------------------------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| <Frame width="130" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/1online.gif" /></Frame> | <Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/2background.gif" /></Frame> | <Frame width="128" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/3offline.gif" /></Frame> |
...
dependencies {
    ...
    implementation 'im.zego:zego_uikit_prebuilt_call_android:+'    // Add this line to your module-level build.gradle file's dependencies, usually named [app].
}
```
</Step>
...
<CardGroup cols={2}>
  ...
  <Card target="_blank" title="How to upgrade UIKits with a plugin to V2.0.0"  href="https://www.zegocloud.com/docs/faq/upgrade-uikit-plugin-to-v2" />
</CardGroup>
