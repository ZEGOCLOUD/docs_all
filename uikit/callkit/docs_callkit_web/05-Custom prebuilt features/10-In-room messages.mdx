...
1. You can use this [server-side API](https://www.zegocloud.com/docs/zim-server/messaging/send-room-messages) to send command messages with MessageType=2.
...
1. send gift: You can use this [server-side API](https://www.zegocloud.com/docs/zim-server/messaging/send-room-messages) to send command messages with MessageType=2.  And encode the command message to represent different gifts.
