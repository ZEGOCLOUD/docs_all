...
| 属性        | 类型   | 是否必选 | 描述                                                                                                                                                                                                                                      |
| :---------- | :----- | :------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| resourcesID | string | 否       | 一个可映射多个厂商进阶推送配置的英文字符串，长度不超过 32 个字，由开发者自定义。使用此字段，可将多个厂商的推送配置抽象为一种您自定的推送策略。具体介绍请参考 [即时通讯 - resourceID 说明](https://doc-zh.zego.im/zim-web/offline-push-notifications/resourcesid-introduction)。 |
| title       | string | 否       | 推送标题。                                                                                                                                                                                                                                |
