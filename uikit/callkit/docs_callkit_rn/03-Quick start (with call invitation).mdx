...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <Frame width="300" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/1online.gif" /></Frame> | <Frame width="256" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/2background.gif" /></Frame> | <Frame width="300" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/3offline.gif" /></Frame> | <Frame width="155" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/iOScallkit.gif" /></Frame> |
...
<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/android_resource_id.png" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/ios_resource_id.png" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/capabili.jpeg" /></Frame>


And double-click on `Push Notifications` to add this feature.

<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/push.jpeg" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/capability_window.jpeg" /></Frame>

#### 5. Check and Make sure the following features are enabled

<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/push2.png" /></Frame>

#### 6. Import the PushKit and CallKit libraries.

<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/ios-callkit-framework.png" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/index2_ios.png" /></Frame>
