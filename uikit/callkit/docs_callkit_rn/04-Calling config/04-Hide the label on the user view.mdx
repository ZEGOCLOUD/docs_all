...
| Config                                                                                                                                                                                                                                                                                                                          | Effects                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. `showMicrophoneStateOnView`: Whether to display the microphone state on the view. Displayed by default. <br/> 2. `showCameraStateOnView`: Whether to display the camera state on the view. Displayed by default. <br/> 3. `showUserNameOnView`: Indicates whether to display the username on the view. Displayed by default. | <Frame width="256" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/ZegoUIKit/Flutter/_normal_switch_30_label.png" /></Frame> |
