...
完成上述申请后，请参考 [resourcesID 说明 - 配置](https://doc-zh.zego.im/zim-uniapp-x/offline-push-notifications/resourcesid-introduction)，在 ZEGO 控制台上使用如下信息配置 resourcesID：
...
<Step title="后续操作">
完成上述配置后，请参考 [实现离线推送](./Offline%20call.mdx) 集成 ZPNs SDK 等其他步骤。
</Step>
</Steps>