...
创建 Channel 后，请参考 [resourcesID 说明 - 配置](https://doc-zh.zego.im/zim-uniapp-x/offline-push-notifications/resourcesid-introduction)，在 ZEGO 控制台上使用如下信息配置 resourcesID：
