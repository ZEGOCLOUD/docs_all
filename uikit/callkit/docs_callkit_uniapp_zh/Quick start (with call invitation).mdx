...
const appID = 1234567; // 您在 zego 控制台获取的 appID
const appSign = 'appSign'; // 您在 zego 控制台获取的 appSign
...
```
发起呼叫邀请API请参考 [sendInvitation](./API%20Reference/Api.mdx#sendInvitation)
