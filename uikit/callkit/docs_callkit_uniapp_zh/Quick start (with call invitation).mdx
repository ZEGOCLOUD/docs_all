...
<Frame width="100%">
    <img src="https://doc-media.zego.im/docuo/97cc39689b.png" alt=""/>
</Frame>
...
<Frame width="100%">
    <img src="https://doc-media.zego.im/docuo/fc005e6051.png" alt="free_buy_for_cloud_build.png"/>
</Frame>

<Frame width="100%">
    <img src="https://doc-media.zego.im/docuo/c30b1f1c5a.png" alt="free_buy_for_cloud_build.png"/>
</Frame>

单击项目目录的 “manifest.json” 文件后，单击 “App 原生插件配置 > 云端插件 [选择云端插件]”。

<Frame width="50%">
    <img src="https://doc-media.zego.im/docuo/6ef174060a.png" alt="choose_native_plugins.png" />
</Frame>
...
在 [即时通讯 - 下载](https://doc-zh.zego.im/zim-uniapp-x/client-sdks/sdk-downloads) 页面，获取最新版本的 ZPNs 原生插件 SDK，并解压得到的 “zego-ZPNsUniPlugin.zip” 文件。
...
<Frame width="100%">
    <img src="https://doc-media.zego.im/docuo/18428d374c.png" alt="choose_native_plugins.png" />
</Frame>
</Step>

<Step title="导入 离线通知 SDK（JS 封装层）">
在 [即时通讯 - 下载](https://doc-zh.zego.im/zim-uniapp-x/client-sdks/sdk-downloads) 页面获取最新版本的 ZPNs JS 插件 SDK ，并解压得到的 “zego-ZPNsUniPlugin-JS.zip” 文件。
...
<Frame width="100%">
    <img src="https://doc-media.zego.im/docuo/8fbac5726a.png" alt="download_and_import.png"/>
</Frame>
...
<Frame height="120px">
    <img src="https://doc-media.zego.im/docuo/3c07b30ce4.png" alt="screenshot-20240909-101238.png"/>
</Frame>
</Step>
...
<Frame width="50%">
    <img src="https://doc-media.zego.im/docuo/47d08e1b29.png" alt="run_with_custom.png"/>
</Frame>

<Frame width="80%">
    <img src="https://doc-media.zego.im/docuo/02f56f8dad.png" alt="config_custom.png"/>
</Frame>
