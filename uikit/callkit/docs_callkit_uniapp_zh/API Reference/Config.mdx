...
| 属性               | 类型               | 必需 | 描述                                             |
| :----------------- | :----------------- | :--- | :----------------------------------------------- |
| invitationID       | String             | 是   | 呼叫邀请 ID。                                    |
| invitees           | String[]           | 否   | 需要取消邀请的用户ID列表，默认取消全部呼叫用户。 |
| notificationConfig | NotificationConfig | 否   | 离线通知配置。                                   |
...
| 属性                                         | 类型            | 必需 | 描述                                                                                       |
| :------------------------------------------- | :-------------------------------------- | :--- | :----------------------------------------------------------------------------------------- |
| incomingCallRingtone                         | String                                                                                                    | 否   | 接收呼叫邀请时的铃声。                                                                     |
| outgoingCallRingtone                         | String                                                                                                    | 否   | 发送呼叫邀请时的铃声。                                                                     |
| showDeclineButton                            | Boolean                                                                                                   | 否   | 在收到呼叫邀请界面显示拒绝按钮，默认为 true。                                              |
| callConfig                                   | [ZegoUIKitPrebuiltCallConfig](#zegouikitprebuiltcallconfig)                                               | 否   | 通话配置项。                                                                               |
| endCallWhenInitiatorLeave                    | Boolean                                                                                                   | 否   | 当呼叫发起者离开时，是否自动结束通话，默认为 false。                                       |
| enableNotifyWhenAppRunningInBackgroundOrQuit | Boolean                                                                                                   | 否   | 当应用程序在后台运行或退出时是否启用消息推送，默认为 false。                               |
| offlinePushConfig                            | [OfflinePushConfig](#offlinepushconfig)                                                                   | 否   | Android 各家厂商离线推送配置。                                                             |
| canInvitingInCalling                         | Boolean                                                                                                   | 否   | 是否允许在通话中发送邀请，默认为 false。                                                   |
| onlyInitiatorCanInvite                       | Boolean                                                                                                   | 否   | 是否只有呼叫发起者有权限在通话中邀请其他人加入通话。默认为 false。                         |
| onIncomingCallDeclineButtonPressed           | Function                                                                                                  | 否   | 当拒绝按钮被按下时（被叫用户拒绝呼叫邀请），将触发此回调。                                 |
| onIncomingCallAcceptButtonPressed            | Function                                                                                                  | 否   | 当接受按钮被按下时（被叫用户接受呼叫邀请），将触发此回调。                                 |
| onIncomingCallReceived                       | [onIncomingCallReceivedCallback](./Callback.mdx#onIncomingCallReceivedCallback)                           | 否   | 当接收到呼叫邀请时，将触发此回调。                                                         |
| onIncomingCallCanceled                       | [onIncomingCallCanceledCallback](./Callback.mdx#onIncomingCallCanceledCallback)                           | 否   | 当主叫用户取消呼叫邀请时，将触发此回调                                                     |
| onIncomingCallTimeout                        | [onIncomingCallTimeoutCallback](./Callback.mdx#onIncomingCallTimeoutCallback)                             | 否   | 被叫用户在超时时间内未响应呼叫邀请时，将通过此回调接收到通知。                             |
| onOutgoingCallCancelButtonPressed            | Function                                                                                                  | 否   | 当取消按钮被按下时（主叫用户取消呼叫邀请），将触发此回调。                                 |
| onOutgoingCallAccepted                       | [onOutgoingCallAcceptedCallback](./Callback.mdx#onOutgoingCallAcceptedCallback)                           | 否   | 当被叫用户接受呼叫邀请时，主叫用户将通过此回调接收到通知。                                 |
| onOutgoingCallRejectedCauseBusy              | [onOutgoingCallRejectedCauseBusyCallback](./Callback.mdx#onOutgoingCallRejectedCauseBusyCallback)         | 否   | 当被叫用户拒绝呼叫邀请时（被呼叫者忙碌），主叫用户将通过此回调接收到通知。                 |
| onOutgoingCallDeclined                       | [onOutgoingCallDeclinedCallback](./Callback.mdx#onOutgoingCallDeclinedCallback)                           | 否   | 当被叫用户主动拒绝呼叫邀请时，主叫用户将通过此回调接收到通知。                             |
| onOutgoingCallTimeout                        | [onOutgoingCallTimeoutCallback](./Callback.mdx#onOutgoingCallTimeoutCallback)                             | 否   | 当呼叫邀请在超时时间内未收到响应时，主叫用户将通过此回调接收到通知。                       |
| onCallingInvitationListSheetDisplay          | [onCallingInvitationListSheetDisplayCallback](./Callback.mdx#onCallingInvitationListSheetDisplayCallback) | 否   | 当用户在通话中邀请点击邀请列表按钮时，将触发此回调。可以通过此回调设置需要邀请的用户列表。 |
