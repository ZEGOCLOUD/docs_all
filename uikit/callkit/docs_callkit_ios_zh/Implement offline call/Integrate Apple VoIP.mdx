...
1. 参考 [创建 VoIP 服务证书](https://developer.apple.com/cn/help/account/create-certificates/create-voip-services-certificates/)， 创建您的 VoIP 服务证书，并在您的Mac 设备上导出一个.p12 文件。如需了解具体操作，请参考 [即时通讯 - Apple 推送集成指南](https://doc-zh.zego.im/zim-ios/offline-push-notifications/integrate-apns)。

2. 在 [ZEGO 控制台](https://console.zego.im) 上添加 VoIP 服务证书.p12文件，配置离线推送证书，详情请参考 [控制台 - 离线推送配置](https://doc-zh.zego.im/console/service-configuration/im/offline-push-config)。
