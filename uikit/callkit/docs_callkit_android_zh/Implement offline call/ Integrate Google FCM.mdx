...
1. 在 [Firebase控制台](https://console.firebase.google.com/) 创建一个项目。如需了解具体操作，请参考 [即时通讯 - Google 推送集成指南](https://doc-zh.zego.im/zim-android/offline-push-notifications/integrate-fcm)。

<Video src="https://www.youtube.com/embed/HhP7rLirCA4"/>

2. 在 [ZEGO 控制台](https://console.zego.im/) 添加 FCM 证书，详情请参考 [控制台 - 离线推送配置](https://doc-zh.zego.im/console/service-configuration/im/offline-push-config)。
3. 在 [ZEGO 控制台](https://console.zego.im/) 创建一个 resourceID，详情请参考 [即时通讯 - resourceID 说明](https://doc-zh.zego.im/zim-android/offline-push-notifications/resourcesid-introduction)。
...
如果您的项目已经集成了 Firebase Cloud Message，您将需要额外的步骤来完成集成，请参考 [如何解决同时集成 Firebase Cloud Message 时的冲突](https://doc-zh.zego.im/faq/firebase-integration-conflict-resolution) 。
