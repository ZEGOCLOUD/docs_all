...
如需更精细地开发您的通话应用，您可尝试 [实时音视频](https://doc-zh.zego.im/real-time-video-ios-oc/introduction/entry) 以实现完全定制。
:::
...
如需更精细地开发您的通话应用，您可尝试 [实时音视频](https://doc-zh.zego.im/real-time-video-uniapp/introduction/entry) 以实现完全定制。
:::
...
<CardGroup cols={2}>
<Card title="快速开始（基本通话）" href="./Quick start.mdx">
快速实现基本通话功能。
</Card>
<Card title="快速开始（包含呼叫邀请）"  href="./Quick start (with call invitation).mdx">
快速实现带有呼叫邀请的通话功能。
</Card>
<Card title="自定义通话"  href="./Calling config/Overview.mdx">
对通话功能及界面做更深入自定义配置。
</Card>
:::if{props.platform=undefined}
