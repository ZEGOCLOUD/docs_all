...
<Frame width="128" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/effects.jpeg" />
</Frame>
...
On top of the initialization code added in Quick Start, you need to set `ZegoUIKitBeautyPlugin` to the `plugins` parameter. Then, add the `beautyEffectButton` to the bottom menu bar. Additionally, please refer to [Online authentication](https://www.zegocloud.com/docs/ai-effects-android-java/quick-starts/online-authentication) to obtain the license and set it to the `beauty` parameter of `ZegoUIKitPrebuiltCallConfig`.
...
Click to download the [beauty resources](https://artifact-sdk.zego.im/sdk-doc/Pics/zegocloud/uikit/BeautyResources_v2.zip), and extract the Resources and Models folders to your project.
...
<Tabs>
  ...
  <Tab title="Android">
    ...
    <Steps>
      <Step title="Create an assets folder">
        Create an `assets` folder under the `main` directory of your Android project (no need to create one if the assets folder already exists), like this: **xxx/android/app/src/main/assets**.
      </Step>

      <Step title="Copy the folders to the assets directory.">
        After importing, your project directory structure should look like this:
      ```bash
  ...
  <Tab title="iOS">
    <Steps>
      <Step title="Create an Resources folder">
        Create an `Resources` folder under the `Runner` directory of your iOS project (no need to create one if the Resources folder already exists), like this: **xxx/iOS/Runner/Resources**.
      </Step>
      ...
      <Step title="Adding resources to iOS">
          ...
          <Frame width="400" height="auto" caption="">
            <img src="https://doc-media.zego.im/docuo/add_folder.png" />
          </Frame>


          <Frame width="400" height="auto" caption="">
            <img src="https://doc-media.zego.im/docuo/add_folder_ret.png" />
          </Frame>
      </Step>
    </Steps>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/effects_beauty_01.png" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/effects_beauty_02.png" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/effects_filters.png" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/effects_pro_stickers.png" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/effects_background.png" />
</Frame>
