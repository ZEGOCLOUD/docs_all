...
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| <Frame width="400" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/conference_start_screen_share.png" /></Frame> | <Frame width="400" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/conference_watch_screen_share.png" /></Frame> | <Frame width="400" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/conference_watch_web_screenshare.png" /></Frame> | <Frame width="400" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/fullScreenShare.png" /></Frame> |
...
To start the screen sharing, add the `ZegoCallMenuBarButtonName.toggleScreenSharingButton` config to the `bottomMenuBarConfig` to let the screen sharing button show.
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/share_screen_create_extension_ios1.png" />
</Frame>

2. In the following window, select the **Broadcast Upload Extension**, and click **Next**.

<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/share_screen_create_extension_ios.png" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/createScreenTarget.png" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/screen_share_target_set.jpg" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/screen_floder.png" />
</Frame>
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/flutter_ios_floder.png" />
</Frame>

* Click the **+** button as shown in the following figure.

<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/cliick_add_button.png" />
</Frame>

* Select and add the `ZegoExpressEngine.xcframework`.

<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/add_download_express.png" />
</Frame>

* Set Embed to `Do Not Embed`.

<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/add_express.png" />
</Frame>
