...
<Tabs>
  <Tab title="Android">
        ...
        <Steps>
          <Step title="add the following">
            ...
            <Frame width="800" height="auto" caption="">
              <img src="https://doc-media.zego.im/docuo/68c974520a.jpeg" alt="android-config-appbuildgradle.jpeg"/>
            </Frame>
          </Step>
      ...
      <Accordion title="Modify gradle-wrapper.properties" defaultOpen="false">
        ...
        <Frame width="400"  height="auto" caption="">
          <img src="https://doc-media.zego.im/docuo/kotlin180.jpg" />
        </Frame>
      </Accordion>
      ...
      <Accordion title="Modify permissions" defaultOpen="false">
        ...
        <Frame width="400"  height="auto" caption="">
          <img src="https://doc-media.zego.im/docuo/permission_android.png" />
        </Frame>
      </Accordion>
