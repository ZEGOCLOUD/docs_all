...
## 2.How to solve the issue that after receiving an offline call invitation and clicking to answer, the app fails to jump to the call page

[Delaying Auto-entry into Offline Calls After App Launch](./../Quick%20start%20(with%20call%20invitation).mdx#delaying-auto-entry-into-offline-calls-after-app-launchoptional)
