...
| :------------------------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| <Frame width="200" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/1online.gif" /></Frame> | <Frame width="150" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/2background.gif" /></Frame> | <Frame width="150" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/3offline.gif" /></Frame> | <Frame width="145" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/iOScallkit.gif" /></Frame> |
...
> ​If you don't know how to create a project and obtain an app ID, please refer to [this guide](https://www.zegocloud.com/docs/console/create-project).
...
<Frame width="400" height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/mermaid-diagram-2023-10-19-170946.png" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Android">
    ...
    <Accordion title="1. Firebase Console and ZEGO Console Configuration" defaultOpen="false">
      <Steps>
        ...
        <Step title="In the ZegoCloud console: Add FCM certificate, create a resource ID">
          ...
          <Frame width="400"   height="auto" caption="">
            <img src="https://doc-media.zego.im/docuo/android_resource_id.png" />
          </Frame>
        </Step>
    ...
    <Accordion title="2. Modify the compileSdkVersion and minSdkVersion" defaultOpen="false">
      <Steps>
        <Step title="Modify the `compileSdkVersion` to 33 in the `your_project/android/app/build.gradle` file">
          <Frame width="400"   height="auto" caption="">
            <img src="https://doc-media.zego.im/docuo/compile_sdk_version.png" />
          </Frame>
        </Step>
    ...
    <Accordion title="5. Add app permissions" defaultOpen="false">
      ...
      <Frame width="400"   height="auto" caption="">
        <img src="https://doc-media.zego.im/docuo/android_permission.png" />
      </Frame>
...
<UIKIT_ANDROID_PREVENT_CODE_OBFUSCATION />
    ...
    <Accordion title="8. Guide your users to set app permissions" defaultOpen="false">
      ...
      * Display pop-up window: Switch to **Enable**
      ...
      |                                                                                                                                                                                               |                                                                                                                                                                                               |                                                                                                                                                                                               |
      | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
      | <Frame width="300" height="auto" ><img src="https://doc-media.zego.im/docuo/miui12_settings1.jpg" /></Frame> | <Frame width="300" height="auto" ><img src="https://doc-media.zego.im/docuo/miui12_settings2.jpg" /></Frame> | <Frame width="300" height="auto" ><img src="https://doc-media.zego.im/docuo/miui12_settings3.jpg" /></Frame> |
    ...
    <Accordion title="1. Apple Developer Center and ZEGOCLOUD Console Configuration" defaultOpen="false">
      <Steps>
        ...
        <Step title="Add the voip service certificate .p12 file. Then, create a resource ID">
          ...
          <Frame width="400"   height="auto" caption="">
            <img src="https://doc-media.zego.im/docuo/ios_resource_id.png" />
          </Frame>
        </Step>
      </Steps>
    </Accordion>
...
<UIKIT_IOS_PERMISSION_CONFIG_EN />
    ...
    <Accordion title="3. Disable the Bitcode" defaultOpen="false">
      ...
      <Steps>
        ...
        <Step title="Select your target project, and follow the notes on the following two images to disable the Bitcode respectively">
          <Frame width="400"   height="auto" caption="">
            <img src="https://doc-media.zego.im/docuo/bitcode_1.png" />
          </Frame>
          <Frame width="400"   height="auto" caption="">
            <img src="https://doc-media.zego.im/docuo/bitcode_2.png" />
          </Frame>
        </Step>
      </Steps>
    </Accordion>
    ...
    <Accordion title="4. Disable Build Libraries for Distribution" defaultOpen="false">
      ...
      <Frame width="400"   height="auto" caption="">
        <img src="https://doc-media.zego.im/docuo/call_disable_build_libraries_for_distribution.png" />
      </Frame>
    </Accordion>
    ...
    <Accordion title="5. Add Push Notifications configuration" defaultOpen="false">
      ...
      <Frame width="400"   height="auto" caption="">
        <img src="https://doc-media.zego.im/docuo/capabili.jpeg" />
      </Frame>
      ...
      <Frame width="400"   height="auto" caption="">
        <img src="https://doc-media.zego.im/docuo/push.jpeg" />
      </Frame>
    </Accordion>
    ...
    <Accordion title="6. Add the Background Modes capability" defaultOpen="false">
      ...
      <Frame width="400"   height="auto" caption="">
        <img src="https://doc-media.zego.im/docuo/capability_window.jpeg" />
      </Frame>
    </Accordion>

    <Accordion title="7. Check and Make sure the following features are enabled" defaultOpen="false">
      <Frame width="400"   height="auto" caption="">
        <img src="https://doc-media.zego.im/docuo/push2.png" />
      </Frame>
    </Accordion>

    <Accordion title="8. Import the PushKit and CallKit libraries" defaultOpen="false">
      <Frame width="400"   height="auto" caption="">
        <img src="https://doc-media.zego.im/docuo/ios-callkit-framework.png" />
      </Frame>
    </Accordion>
  </Tab>
...
<Frame width="400"   height="auto" caption="">
  <img src="https://doc-media.zego.im/docuo/run_flutter_project.jpg" />
</Frame>
