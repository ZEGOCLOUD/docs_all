...
<Frame width="200" height="auto" caption="">
    <img src="https://doc-media.zego.im/docuo/b79795a54c.gif" alt="Android_call_demo.gif"/>
...
dependencies {
    ...
    implementation 'im.zego:zego_uikit_prebuilt_call_android:+'    // add this line in your module-level build.gradle file's dependencies, usually named [app].
}
```
</Step>
