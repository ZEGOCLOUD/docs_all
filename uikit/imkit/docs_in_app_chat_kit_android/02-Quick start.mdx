...
<Steps>
<Step title="Add im.zego:zego_inapp_chat_uikit_android as dependencies">
...
dependencies {
    ...
    implementation 'im.zego:zego_inapp_chat_uikit_android:+'    // add this line in your module-level build.gradle file's dependencies, usually named [app].
}
```
</Step>
