...
<Frame width="200" height="auto" caption="">
    <img src="https://doc-media.zego.im/docuo/4e648e6706.gif" />
...
dependencies {
    ...
    implementation 'im.zego:zego_uikit_prebuilt_call_android:+'    // 在您的模块级 build.gradle 文件的 dependencies 中添加这行代码，通常命名为 [app]。
}
```
</Step>
...
<CardGroup cols={1}>
  <Card title="音视频通话 UIKit - 自定义 UI" href="https://doc-zh.zego.im/callkit-android/calling-config/overview" target="_blank">
