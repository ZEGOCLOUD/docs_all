...
这份文档将介绍如何配合使用 IMKit 和 [音视频通话 UIKit](https://doc-zh.zego.im/callkit-ios/overview)。
...
请参考[音视频通话 UIKit 快速开始(包含呼叫邀请)](https://doc-zh.zego.im/callkit-ios/quick-start-(with-call-invitation))来集成 音视频通话 UIKit 。
</Step>
...
<CardGroup cols={2}>
  ...
  <Card title="音视频通话 UIKit - 快速开始" href="https://doc-zh.zego.im/callkit-ios/quick-start-(with-call-invitation)" target="_blank">
    本文档中的步骤帮助您快速发起通话。
  </Card>

  <Card title="音视频通话 UIKit - 自定义 UI" href="https://doc-zh.zego.im/callkit-ios/calling-config/overview" target="_blank">
