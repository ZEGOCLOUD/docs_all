...
| 参数               | 类型   | 是否必选 | 描述             |
|------------------|------|------|-------------------------|
| TaskId      | String | 否    | 数字人视频流任务 ID，如果仅填入此字段，表示拉取所有的驱动任务列表。 通过 [创建数字人视频流任务](./Create%20Digital%20Human%20Stream%20Task.mdx) 接口的响应参数获取。    |
...
| &nbsp;&nbsp;└Status      | Number       | 数字人驱动任务状态：<ul><li>1：排队中。</li><li>2：播报中。</li><li>3：播报失败。</li><li>4：播报结束。</li></ul> |
