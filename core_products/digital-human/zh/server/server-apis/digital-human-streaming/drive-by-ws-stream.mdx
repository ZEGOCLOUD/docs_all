...
如需了解完整 WebSocket 驱动数字人流程，请参考 [WebSocket 驱动数字人](./../../quick-start/digital-human-ws-drive.mdx)。
...
| └WssAddress      | String    | 数字人视频流任务对应的 WebSocket 连接地址。通过此地址与数字人 API 平台服务服务端建立连接之后，可以向其传输 PCM 音频数据驱动数字人说话。 |
