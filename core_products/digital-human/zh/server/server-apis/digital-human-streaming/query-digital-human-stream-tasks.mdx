...
无接口请求参数，公共参数列表请参考 [调用方式 - 公共请求参数](./../Accessing%20Server%20APIs.mdx#公共请求参数)。
...
| &nbsp;&nbsp;└RoomId      | String       | 数字人视频流任务 的房间ID。[创建数字人视频流任务](./Create%Digital%20Human%20Stream%20Task.mdx) 传入的房间 ID。 |
| &nbsp;&nbsp;└TaskId      | String       | 数字人视频流任务 的流ID。[创建数字人视频流任务](./Create%Digital%20Human%20Stream%20Task.mdx) 传入的流 ID。 |
