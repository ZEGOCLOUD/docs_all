...
| Data | Object | 返回数据。 |
| └Status      | Number       | 任务状态：<ul><li>1：视频流任务初始化中。</li><li>2：视频流任务初始化失败。</li><li>3：推流中。</li><li>4：正在停止推流。</li></ul> |
| └RoomId | String | 数字人视频流任务 的房间ID。[创建数字人视频流任务](./create-digital-human-stream-task.mdx) 传入的房间 ID。 |
| └StreamId | String | 数字人视频流任务 的流ID。[创建数字人视频流任务](./create-digital-human-stream-task.mdx) 传入的流 ID。 |
