...
通过本接口，您可以获取一个 WebSocket 链接地址。通过向这个地址传输 PCM 音频数据以实时驱动数字人说话。

如需了解使用 WebSocket 驱动数字人的完整流程，请参考 [WebSocket 驱动数字人](/aigc-digital-human-server/quick-start/digital-human-ws-drive)。
