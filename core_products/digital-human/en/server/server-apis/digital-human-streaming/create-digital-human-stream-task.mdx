...
| Width  | Number | No    | The width of the digital human/resource, in pixels.               |
| Height | Number | No    | The height of the digital human/resource, in pixels.               |
...
| Parameter      | Type   | Required | Description             |
|---------------|--------|----------|-------------------------|
| Width   | Number | No    | The width of the video stream, in pixels, with a maximum of 1920. The product of `Width` and `Height` must not exceed 1920 × 1080. |
| Height  | Number | No    | The height of the video stream, in pixels, with a maximum of 1920. The product of `Width` and `Height` must not exceed 1920 × 1080. |
