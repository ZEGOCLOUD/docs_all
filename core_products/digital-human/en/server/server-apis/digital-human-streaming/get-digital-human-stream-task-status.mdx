...
| └Status      | Number | Task status: <ul><li>1: Initializing the video stream task.</li><li>2: Failed to initialize the video stream task.</li><li>3: Publishing the stream.</li><li>4: Stopping the stream-publishing.</li><li>5: Stream-publishing stopped.</li></ul> |
