...
For the complete process of driving the Digital Human via WebSocket, please refer to [WebSocket Drive Digital Human](/aigc-digital-human-server/quick-start/digital-human-ws-drive).
