...
| Status      | Number       | Status of the Digital Human video stream drive task associated with DriveId:<ul><li>1: Queued.</li><li>2: Driving.</li><li>3: Drive failed.</li><li>4: Drive ended.</li></ul> |
</Tab>
</Tabs>
