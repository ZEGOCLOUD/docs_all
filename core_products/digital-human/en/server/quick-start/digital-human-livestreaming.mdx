...
- 已获取数字人 ID 和音色 ID，详情请参考 [查询数字人列表](./../server-apis/digital-human-management/get-digital-human-list.mdx) 和 [查询音色列表](./../server-apis/digital-human-management/get-timbre-list.mdx)。
...
调用 [查询数字人列表](./../server-apis/digital-human-management/get-digital-human-list.mdx) 获取可用的数字人。

### 3 获取可用的音色列表

调用 [查询音色列表](./../server-apis/digital-human-management/get-timbre-list.mdx) 获取音色。
...
通过 [文本](./../server-apis/digital-human-streaming/drive-by-text.mdx)、[音频](./../server-apis/digital-human-streaming/drive-by-audio.mdx)、[RTC 音频流](./../server-apis/digital-human-streaming/drive-by-rtc-stream.mdx) 或 [Web Socket 接口](./digital-human-ws-drive.mdx)，驱动数字人说话。
