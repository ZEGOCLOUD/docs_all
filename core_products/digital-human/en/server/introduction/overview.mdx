...
<Note title="Note">  
The Digital Human PaaS has been fully upgraded and rebranded as the Digital Human API, offering developers a cost-effective and high-quality digital human service:  
...
<tbody>
  ...
  <tr>
    ...
    <td>Upload a single image to the Image-to-Digital Human API to quickly generate a digital human.<Note title="Note">Feature is in beta test. Please contact ZEGOCLOUD sales.</Note></td>
  </tr>
  <tr>
