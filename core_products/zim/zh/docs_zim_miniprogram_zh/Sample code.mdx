...
<Card title="示例源码" href="https://storage.zego.im/zim/example/miniprogram/ZIMExampleJavaScript.zip" target="_blank">点击获得完整代码。</Card>
...
- 设备已连接到网络。
- 微信小程序基础库版本及微信版本，请参考 [平台兼容](./Introduction/Overview.mdx#平台兼容)。
...
4. 点击微信开发者工具的工具栏，选择 “构建 npm”，等待编译完成即可运行。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Web/wx_npmbuild.png" /></Frame>

### 使用 uni-app 框架示例源码运行到微信小程序平台

1. 打开微信开发者工具，选择 “设置 > 安全设置”，打开服务端口。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Web/safe_setting.png" /></Frame>

2. 打开 HBuilderX，选择 “文件 > 导入 > 从本地目录导入”，导入示例源码文件。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Web/import_uni_project.png" /></Frame>
...
4. 点击 HBuilderX 工具栏，选择 “运行 > 运行到小程序模拟器 > 运行设置”，填入“微信开发者工具路径”，并保存。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Web/run_config.png" /></Frame>

5. 点击 HBuilderX 工具栏，选择 “运行 > 运行到小程序模拟器 > 运行时是否压缩代码”。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Web/pack_code.png" /></Frame>

6. 点击 HBuilderX 工具栏，选择 “运行 > 运行到小程序模拟器 > 微信开发者工具”，等待编译完成即可。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Web/run_uniapp.png" /></Frame>
