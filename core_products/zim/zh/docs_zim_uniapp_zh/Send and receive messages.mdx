...
uni-app SDK 是一个基于原生 iOS/Android 平台 ZIM SDK 的 uni-app Wrapper。开发者如需使用 uni-app 开发 Web 或小程序平台的应用，请下载对应的 SDK 集成使用：[下载 Web SDK](https://doc-zh.zego.im/zim-web/client-sdks/sdk-downloads) 和 [下载小程序 SDK](https://doc-zh.zego.im/zim-miniprogram/client-sdks/sdk-downloads)。
</Note>
...
1. 请参考 [下载](./Client SDKs/SDK downloads.mdx) 页面，获取最新版本的 SDK 到本地，并将得到的 “zego-ZIMUniPlugin.zip” 文件解压缩。
...
#### 方式二：通过 uni-app 插件市场获取  [ZIM SDK 原生插件](https://ext.dcloud.net.cn/plugin?id=8601)
...
- <b>方式一：</b>请参考 [下载](./Client SDKs/SDK downloads.mdx) 页面，获取最新版本的 JS 封装层到本地，并将得到的 “zego-ZIMUniplugin-JS.zip” 文件解压缩。
...
} from './js_sdk/zego-ZIMUniplugin-JS/lib';
```
