...
请在 [ZEGO 控制台](https://console.zego.im/) 自助配置 ZIM 离线推送（详情请参考 [项目管理 - 即时通讯 - 离线推送配置](https://doc-zh.zego.im/console/service-configuration/im/offline-push-config)），提供 **服务账号密钥 JSON 文件**。若无法配置，请联系 ZEGO 技术支持处理。
