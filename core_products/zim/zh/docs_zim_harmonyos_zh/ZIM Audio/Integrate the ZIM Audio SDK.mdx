...
- 开发环境：
    ...
    - 获取配套 [API Version 12 Release\|_blank](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/development-intro-api-V5?catalogVersion=V5) 的 HarmonyOS 5.0.0 Release 操作系统或以上版本的鸿蒙设备真机或模拟器。
...
<Step title="导入 SDK">
    ...
    "@zego/ZIMAudio": "file:./libs/ZIMAudio.har"
    ```
    </Step>
    </Steps>
