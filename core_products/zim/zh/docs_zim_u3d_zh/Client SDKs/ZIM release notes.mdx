...
[升级到 2.10.0 版本的编译问题，升级前必看 >>](./ZIM%20upgrade%20guide.mdx#2100-升级指南)
</Warning>
...
| 废弃项  | 废弃描述 | 相关接口 |
| -----  | ---- | ----- |
| 废弃系统消息类型 | [ZIMMessageType](@-ZIMMessageType) 废弃了系统消息（值为 30），开发者请使用功能更完善的自定义消息（值为 200）替代。 | [ZIMMessageTypeCustom](/article/api?doc=zim_API~cs_unity3d~enum~ZIMMessageType#custom) |
