...
开发者可以通过 [ZIMMediaUploadingProgress](@ZIMMediaUploadingProgress) 回调，接收富媒体消息的上传发送进度的相关通知。
...
开发者可以通过 [ZIMMediaDownloadingProgress](@ZIMMediaDownloadingProgress) 回调，接收富媒体消息的下载进度的相关通知。
