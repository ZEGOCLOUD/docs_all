...
<td>图片消息。支持主流图片格式，包括 JPG、PNG、BMP、TIFF、GIF、WebP。3.2.0 及以上版本大小不超过 20 MB；3.2.0 以下版本大小不超过 10 MB。</td>
</tr>
<tr data-row-level="7">
<td>ZIMFileMessage(12)</td>
<td>文件消息。消息内容为文件，格式不限。3.2.0 及以上版本大小不超过 1 GB；3.2.0 以下版本大小不超过 100 MB。</td>
</tr>
<tr data-row-level="8">
<td>ZIMAudioMessage(13)</td>
<td>语音消息。支持 MP3、M4A 格式的语音文件，时长不超过 300 秒。3.2.0 及以上版本大小不超过 1 GB；3.2.0 以下版本大小不超过 6 MB。</td>
</tr>
<tr data-row-level="9">
<td>ZIMVideoMessage(14)</td>
<td>视频消息。支持 MP4、MOV 格式的视频文件。3.2.0 及以上版本大小不超过 1 GB；3.2.0 以下版本大小不超过 100 MB。<Note title="说明">若要在消息发送成功后获取视频首帧的宽高信息，视频必须使用 H.264 或 H.265 编码格式。</Note></td>
</tr>
