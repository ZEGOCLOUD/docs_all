...
import { tokenWillExpireMap, connectionStateChangedMap } from "/snippets/zim/const-link.mdx"
...
<Frame width="auto" height="auto">
  <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Authenticate_users_with_tokens.png" alt="Token Authentication Flow" />
</Frame>
