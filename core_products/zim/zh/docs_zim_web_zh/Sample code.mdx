...
<Card title="示例源码" href="https://storage.zego.im/zim/example/web/ZIMExampleJavaScript.zip" target="_blank">点击获得完整代码。</Card>
...
- 设备已连接到网络。
- 浏览器版本及兼容性，请参考 [平台兼容](./Introduction/Overview.mdx#平台兼容)。
