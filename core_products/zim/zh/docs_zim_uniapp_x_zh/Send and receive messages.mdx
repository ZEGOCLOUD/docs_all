...
- 使用 uni-app 开发 Web 或小程序平台的应用，请下载对应的 SDK 并集成使用：通过引入 npm 包的方式下载：[Web SDK](https://doc-zh.zego.im/article/12815) 和 [小程序 SDK](https://doc-zh.zego.im/article/12816)，或通过 CDN 地址在浏览器打开后下载到本地（格式为`包名@版本`，比如：https://unpkg.com/zego-zim-web@2.25.0/index.js）。
</Note>
...
- 通过引入 npm 包的方式下载对应的 SDK：[Web SDK](https://doc-zh.zego.im/article/12815) 和 [小程序 SDK](https://doc-zh.zego.im/article/12816)，或通过 CDN 地址在浏览器打开后下载到本地（格式为`包名@版本`，比如：https://unpkg.com/zego-zim-web@2.25.0/index.js）。
