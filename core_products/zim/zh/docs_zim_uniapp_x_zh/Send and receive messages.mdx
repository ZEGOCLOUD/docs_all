...
<Tab title="从插件市场获取">
从 uni-app x 插件市场获取  [ZIM uni-app x SDK ](待补充)。

<Frame width="512" height="auto" caption=""><Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/UniApp/uni_5.png" /></Frame></Frame></Tab>
</Tabs>
