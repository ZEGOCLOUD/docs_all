...
#### 方式二：通过 uni-app x 插件市场获取  [ZIM uni-app x SDK ](https://ext.dcloud.net.cn/plugin?id=8601)
...
uni-app x 官方自定义调试基座使用说明，请参考 [什么是自定义调试基座及使用说明 ](https://ask.dcloud.net.cn/article/35115)。 
</Note>
