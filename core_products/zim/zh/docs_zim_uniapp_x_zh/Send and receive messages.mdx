...
- ZIM SDK 原生插件（uni-app ）是一个基于原生 iOS/Android 平台 ZIM SDK 的 uni-app Wrapper。开发者如需使用 uni-app 开发 Web 或小程序平台的应用，请下载对应的 SDK 并集成使用：[下载 Web SDK](https://doc-zh.zego.im/article/12815) 和 [下载小程序 SDK](https://doc-zh.zego.im/article/12816)。
</Note>
...
因为 uni-app 项目使用 UTS 插件时，不支持 Web 和 小程序平台，所以需要通过手动下载对应平台的 SDK 来集成。

- 请下载对应的 SDK：[Web SDK](https://doc-zh.zego.im/article/12815) 和 [小程序 SDK](https://doc-zh.zego.im/article/12816)。
