...
- 使用 uni-app 开发 Web 或小程序平台的应用，请下载对应的 SDK 并集成使用：[Web SDK](https://doc-zh.zego.im/article/12815)、[小程序 SDK](https://doc-zh.zego.im/article/12816)。
</Note>
...
- 下载对应的 SDK：[Web SDK](https://doc-zh.zego.im/article/12815)、[小程序 SDK](https://doc-zh.zego.im/article/12816)。
