...
<Tab title="从插件市场获取">
从 uni-app x 插件市场获取  [ZPNs uni-app x SDK ](https://ext.dcloud.net.cn/plugin?name=zego-zim-zpns-uts)。
...
#### 厂商推送设置
    ...
    部分厂商的特殊配置文件，需要在自定义基座进行云端打包时被打包到 apk 里，所以需要在自己项目跟目录下创建 “nativeResources/android” 目录。如下图所示：
