...
<ParamField
  name="getInstance"
  prototype="static getInstance(): void"
  desc="获取 SDK 单例对象。"
  prefixes={["static"]}
  parent_name="ZIMAudio"
  parent_type="class">
...
<ParamField
  name="init"
  prototype="init(license: string): void"
...
<ParamField
  name="setANSParam"
  prototype="setANSParam(param: [ZIMAudioANSParam](./interface#zimaudioansparam)): void"
...
<ParamField
  name="startRecord"
  prototype="startRecord(config: [ZIMAudioRecordConfig](./interface#zimaudiorecordconfig)): void"
  desc="开始录制音频文件"
  parent_name="ZIMAudio"
  parent_type="class">
**参数**
...
<ParamField
  ...
  prototype="setAudioRouteType(routeType: [ZIMAudioRouteType](./enum#zimaudioroutetype)): void"
  desc="设置音频路由类型"
  parent_name="ZIMAudio"
  parent_type="class">
**参数**
...
<ParamField
  name="startPlay"
  prototype="startPlay(config: [ZIMAudioPlayConfig](./interface#zimaudioplayconfig)): void"
  desc="开始播放音频文件"
  parent_name="ZIMAudio"
  parent_type="class">
**参数**
