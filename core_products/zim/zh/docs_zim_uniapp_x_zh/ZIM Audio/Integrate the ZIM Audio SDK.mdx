...
1. 请参考 [下载](./../Client SDKs/SDK downloads.mdx) 页面，获取最新版本的 SDK 到本地，并将得到的 “zego-zim-audio-uts.zip” 文件解压缩。
...
<Frame width="auto" height="auto" >
  <img src="https://doc-media.zego.im/docuo/9dfc9b4754.png" alt="Integrate the ZIM Audio SDK.png"/>
</Frame>
</Tab>
</Tabs>
