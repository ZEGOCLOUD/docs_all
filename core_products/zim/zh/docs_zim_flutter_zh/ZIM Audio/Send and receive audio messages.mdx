...
如需了解发送进度，请参考 [onMessageSendProgress API](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onMessageSendProgress.html)。
...
如需了解下载进度，请参考 [onMessageDownloadProgress API](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onMessageDownloadProgress.html)。
