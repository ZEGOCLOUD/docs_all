...
ZIM Flutter SDK 2.21.1 版本对以往部分命名定义进行了订正和甄误，从旧版本升级到 2.21.1 版本时，请您阅读以下指南。
</Warning>
...
1. [ZIMCustomMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMCustomMessage-class.html): [searchedContent](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMCustomMessage/searchedContent.html) 从可选项提升为了必选项。若开发者无需对自定义消息进行关键字搜索，则设置为空字符串即可。
