...
| 消息编辑 | 支持编辑自定义消息的检索字段（[ZIMCustomMessage > searchedContent](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMMessageSendConfig/searchedContent.html)），详情请参考 [编辑消息](./../Guides/Messaging/Edit%20messages.mdx)。 | [editMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/editMessage.html) |
