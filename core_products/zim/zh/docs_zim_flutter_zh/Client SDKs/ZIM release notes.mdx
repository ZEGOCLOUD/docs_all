...
1. 修复在同一实例生命周期内，[onConversationSyncStateChanged](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onConversationSyncStateChanged.html) 事件通知在 “登录登出再登录” 后失效的问题。
