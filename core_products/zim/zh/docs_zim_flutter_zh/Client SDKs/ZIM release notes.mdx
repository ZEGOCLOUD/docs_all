...
| 新增社群会话管理 | 会话列表新增社群类型会话，支持以社群模式展示会话。详细请参考 [频道会话管理 - 将频道会话同步到会话列表](../Guides/community/channel-conversation-management.mdx#将频道会话同步到会话列表) | <ul><li> [queryConversationList](@queryConversationList2)</li><li> [onConversationChanged](@onConversationChanged)</li></ul> |
...
|功能项-25% | 功能描述-40% | 相关接口-25%|
|-----|-----|-----|
|自动定位未读消息|在会话有未读消息的时候，进入会话自动定位到第一条未读消息。| [ZIMConversation](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMConversation-class.html)  |
|优先返回本地历史消息|联网查询历史消息支持优先返回本地消息，再异步返回服务端消息。| [queryHistoryMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryHistoryMessage.html) |

**改进优化**

|优化项-25% | 优化描述-40% | 相关接口-25%|
|-----|-----|-----|
|优化用户自定义状态功能|用户自定义状态支持设置到无限期，并获取对应状态的超时时间。详细请参考[用户自定义状态](../Guides/Users/Online%20Status%20Subscription.mdx#设置自定义状态)。 | [updateUserCustomStatus](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/updateUserCustomStatus.html) |
...
|功能项-25% | 功能描述-40% | 相关接口-25%|
|-----|-----|-----|
|消息表态支持重复表态和统计表态次数| 支持单个用户对同一条消息进行多次相同类型的表态。查询消息表态时，可以获取此消息每种表情的累计表态次数，或者统计每个用户针对该消息每种表情的表态次数。详细请参考[消息表态](../Guides/Messaging/Respond%20to%20messages%20with%20emoticons.mdx#2-新增消息表态--重复表态计数)。|[addMessageReaction](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/addMessageReaction.html)|

**改进优化**
|优化项-25% | 优化描述-40% | 相关接口-25%|
|-----|-----|-----|
|优化删除会话接口| 删除会话时，发起删除的客户端会触发会话变更的相关回调。详细请参考[删除会话](../Guides/Conversation/Delete%20conversations.mdx#删除单个会话)。|<ul><li>[deleteConversation](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/deleteConversation.html)</li><li>[onConversationChanged](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onConversationChanged.html)</li><li>[deleteAllConversations](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/deleteAllConversations.html)</li><li>[onConversationsAllDeleted](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onConversationsAllDeleted.html)</li></ul>|
|优化消息置顶功能| 消息置顶超过最大消息数时，支持设置是否覆盖当前置顶列表。|[pinMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/pinMessage.html)|
|优化多端登录场景下用户离线推送的角标处理策略 | 用户在多端登录的场景下，其他端阅读了新消息，iOS 端的离线通知角标会进行清除。详细请参考[使用 ZIM SDK 实现离线推送](./../Offline%20push%20notifications/use-zim-to-zpns.mdx#场景-4ios-通知徽标数量)。 | [updateUserBadge](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/updateUserBadge.html) |
...
|功能项-25% | 功能描述-40% | 相关接口-25%|
|-----|-----|-----|
| 本地会话支持按照会话名称过滤查询 | 本地会话搜索接口支持将会话名称作为 keywords 条件进行过滤查询。详细请参考[搜索本地消息 - 基于会话名称搜索会话](./../Guides/Messaging/Search%20for%20local%20messages.mdx#基于会话名称搜索会话)。| [searchLocalConversations](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/searchLocalConversations.html)|
| 新增查询用户共同群组列表功能 | 用户可以通过此接口查询自己和指定 userID 的用户之间共同群组列表，来展示相关信息。详细请参考[群组管理 - 查询与指定用户的已加入的共同群组列表](./../Guides/Group/Manage%20groups.mdx#查询与指定用户的已加入的共同群组列表)。|[queryGroupList](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryGroupList.html)|

**改进优化**

|优化项-25% | 优化描述-40% | 相关接口-25%|
|-----|-----|-----|
| 增加会话标记数量 | 单个会话的会话标记数量最大支持到 60 个。详情请参考[标记会话 - 设置或取消标记](../Guides/Conversation/Mark%20conversations.mdx#2-设置或取消标记)。|[setConversationMark](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/setConversationMark.html)|
| 优化组合消息的子项发送逻辑 | 发送包含多个子项的组合消息时，部分子项发送失败不会影响其他正常发送的子项。详细请参考[收发消息 - 组合消息](../Guides/Messaging/Send%20and%20receive%20messages.mdx#允许子项部分失败)。|[ZIMMessageSendConfig](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMMessageSendConfig-class.html)|
| 优化组合消息对媒体类型的限制 | 组合消息支持一次性发送 10 条媒体消息，不限制媒体类型。|[ZIMMultipleMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMMultipleMessage-class.html)|
...
|优化项-25% | 优化描述-40% | 相关接口-25%|
|-----|-----|-----|
|置顶会话排序优化| 置顶会话新增置顶时间字段，支持按置顶时间对置顶会话进行排序。详细请参考 [置顶会话](../Guides/Conversation/Pin%20a%20conversation.mdx#置顶顺序说明)。 | [ZIMConversation > pinnedTime](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMConversation/pinnedTime.html) |
...
|功能项-25% | 功能描述-40% | 相关接口-25%|
|-----|-----|-----|
|查询合并消息支持携带 messageID| 查询合并消息时，支持携带 messageID。 | [queryCombineMessageDetail](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryCombineMessageDetail.html)
...
|功能项-25% | 功能描述-40% | 相关接口-25%|
|-----|-----|-----|
| 支持设置用户在客户端发送的消息不计入未读消息数 | 当用户发送一些特殊场景的客户端消息时，可以设置此消息不计入未读消息数。例如，主播发起 PK 连麦的申请消息，接收方接收后不会增加对应的未读消息数。详细请参考 [收发消息 - 发送不计入未读消息数的消息](./../Guides/Messaging/Send%20and%20receive%20messages.mdx#发送不计入未读消息数的消息)。 | <ul><li>[sendMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/sendMessage.html)</li><li>[disableUnreadMessageCount](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMMessageSendConfig/disableUnreadMessageCount.html)</li></ul> |
| 新增群主退群后的群组 Tips 消息 | 群主退群后，群成员会额外收到一条 Tips 消息 `xxx 成为新群主`。详细请参考 [接收群组 Tips 消息](./../Guides/Messaging/Receive%20tip%20messages.mdx)。 | [onGroupMessageReceived](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onGroupMessageReceived.html) |
| 取消媒体消息发送 | 用户在发送媒体消息（视频、音频等）时，调用此接口可以取消发送媒体消息。详细请参考 [取消媒体消息发送](./../Guides/Messaging/Cancel%20sending%20message.mdx)。 | [cancelSendingMessage]() |
| 获取回执已读时间 | 通过单聊或者群聊发送消息时，可以通过已读回执获取对端用户已读时间的时间戳。详细请参考 [获取回执已读时间](./../Guides/Messaging/Read%20receipts.mdx#获取回执已读时间)。 | [sendMessageReceiptsRead](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/sendMessageReceiptsRead.html) |
| 获取房间用户扩展字段 | 用户在加入房间后，可获取此用户进房前的用户扩展信息。详细请参考 [获取房间用户扩展字段信息](./../Guides/Room/Room%20info.mdx#获取房间用户扩展字段信息)。 | [queryRoomMembers](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryRoomMembers.html)、[queryRoomMemberList](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryRoomMemberList.html)、[onRoomMemberJoined](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onRoomMemberJoined.html)、[onRoomMemberLeft](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onRoomMemberLeft.html) |
...
ZIM Flutter SDK 2.21.1 版本对以往部分命名定义进行了订正和甄误，并修改了部分接口的用法。详细请参考 [ZIM 升级指南](./ZIM%20upgrade%20guide.mdx#2211-升级指南)。
</Warning>
...
| 群组定向消息 | ZIM 支持用户在调用 [ZIM 服务端接口](/zim-server/messaging/send-group-messages#targetoption) 发送群组消息时，指定对某些群用户是否可见。详情请参考 [群组定向消息](./../Guides/Messaging/group-targeted-message.mdx)。 | [onGroupMessageReceived](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onGroupMessageReceived.html) |
| 会话列表同步状态回调 | 当用户登录 ZIM 服务时或断线重连后，可通过 [onConversationSyncStateChanged](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onConversationSyncStateChanged.html) 回调，得知其从 ZIM 服务端同步最新会话列表的状态。详情请参考 [获取会话列表 - 监听会话列表同步状态变更](./../Guides/Conversation/Get%20the%20conversation%20list.mdx#监听会话列表同步状态变更)。 | [onConversationSyncStateChanged](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onConversationSyncStateChanged.html) |
| 消息编辑 | 支持编辑自定义消息的检索字段（[ZIMCustomMessage > searchedContent](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMCustomMessage/searchedContent.html)），详情请参考 [编辑消息](./../Guides/Messaging/Edit%20messages.mdx)。 | [editMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/editMessage.html) |
...
| <div style={{width:"130px"}}>功能项</div>  | 功能描述 | 相关接口 |
| ------------------------------  | ---- | ----- |
| 消息编辑 | 支持编辑单聊消息和群聊消息的内容和其他属性，详情请参考 [编辑消息](./../Guides/Messaging/Edit%20messages.mdx)。<Note>此接口默认仅适用于过去 24 小时内的消息。</Note> | [editMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/editMessage.html) |
| 消息重发 | 当用户发送消息时遭遇断网，如果网络在 30 秒内恢复，ZIM SDK 会自动重发该消息。如果网络在 30 秒后恢复，用户可以手动重发该消息，详情请参考 [收发消息 - 消息重发](./../Guides/Messaging/Send%20and%20receive%20messages.mdx#重发消息)。 | [ZIMMessageSendConfig > isRetrySend](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMMessageSendConfig/isRetrySend.html) |
...
| <div style={{width:"130px"}}>功能项</div>  | 功能描述 | 相关接口 |
| ------------------------------  | ---- | ----- |
| 组合消息  | 新增组合消息类型，支持在一条消息中包含多种内容项，包括文本、图片、音频、视频、文件以及自定义消息。可实现如文本+图片、文本+视频、文本+音频等多种组合方式，灵活满足不同场景需求。详情请参考 [收发消息 - 组合消息](./../Guides/Messaging/Send%20and%20receive%20messages.mdx#组合消息)。 | [ZIMMultipleMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMMultipleMessage-class.html) |
...
| <div style={{width:"130px"}}>功能项</div>  | 功能描述 | 相关接口 |
| -----  | ---- | ----- |
| 群备注  | 支持用户对某个群组设置仅自己可见的群备注。详情请参考 [群资料管理 - 修改群备注](./../Guides/Group/Group%20info.mdx)。| <ul><li>[updateGroupAlias](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/updateGroupAlias.html)</li><li>[onGroupAliasUpdated](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMEventHandler/onGroupAliasUpdated.html)</li></ul> |
| 用户在线状态 | 不仅支持用户通过订阅以持续关注其他用户的在线状态变化，还支持一次性查询其他用户的当下的在线状态，也支持用户查询自己的订阅列表。此外，在多端登录场景下，用户可以监听自己的在线平台变化。详情请参考 [用户状态订阅](./../Guides/Users/Online%20Status%20Subscription.mdx)。| <ul><li>[subscribeUsersStatus](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/subscribeUsersStatus.html)</li><li>[onUserStatusUpdated]()</li><li>[unsubscribeUsersStatus](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/unsubscribeUsersStatus.html)</li><li>[queryUsersStatus](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryUsersStatus.html)</li><li>[querySubscribedUserStatusList](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/querySubscribedUserStatusList.html)</li></ul> |
...
| 切换房间  | 新增 `switchRoom` 接口以切换房间，适用于秒开等需要平滑切换房间的业务场景。详情请参考 [房间管理 - 切换房间](./../Guides/Room/Manage%20rooms.mdx) | [switchRoom](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMUserInfo/switchRoom.html) |
...
| 会话标记 | 支持用户对会话设置标记，适用于需要关注某会话或无法处理某条会话的场景。可使用本功能实现会话分组，即对多个会话设置相同的标记。客户端实现流程请参考 [标记会话](./../Guides/Conversation/Mark%20conversations.mdx)，服务端实现流程请参考 [设置会话标记](/zim-server/conversation/set-conversation-marks)。  | <ul><li>[setConversationMark](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/setConversationMark.html)</li><li>[设置会话标记](/zim-server/conversation/set-conversation-marks)</li></ul> |
|  会话列表查询 | 支持将标记、会话类型和是否包含未读消息作为过滤项获取会话列表。详情请参考 [标记会话](./../Guides/Conversation/Mark%20conversations.mdx)。 | [queryConversationTotalUnreadMessageCount](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryConversationTotalUnreadMessageCount.html) |
| 回复消息 | 支持用户在会话内针对某条消息进行回复，当前支持回复文本、图片、文件、音频、视频、合并和自定义消息。此外，还支持用户查询回复树，获取回复的完整消息列表。详情请参考 [回复消息](./../Guides/Messaging/Reply%20to%20a%20message.mdx)。 | <ul><li>[replyMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/replyMessage.html)</li><li>[queryMessageRepliedList](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryMessageRepliedList.html)</li></ul> |
| 获取特定历史消息列表 | 支持查询指定的历史消息列表，适用于需要了解某条消息的上下文的场景。详情请参考 [获取历史消息](./../Guides/Messaging/Get%20message%20history.mdx)。 | [queryMessages](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryMessages.html) |
...
[升级到 2.13.0 版本的编译问题，升级前必看 >>](./ZIM%20upgrade%20guide.mdx#2130-升级指南)
</Warning>
...
| <div style={{width:"130px"}}>功能项</div>  | 功能描述 | 相关接口 |
|-------|-------|-------|
| 多端登录 | 支持配置双平台或多平台登录策略，用户可在多平台、多设备上同时登录同一账户，实现会话、消息、群组等数据多端互通。如需了解多端登录对其他功能的影响，请参考 [多端登录](./../Guides/Users/Multi-device%20login.mdx)。<br />**注意**：仅支持专业版或旗舰版套餐用户使用此功能，且需联系 ZEGO 技术支持进行配置登录策略。 | [login](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/login.html) |
...
[升级到 2.9.0 版本的编译问题，升级前必看 >>](./ZIM%20upgrade%20guide.mdx##290-升级指南)
</Warning>
...
[升级到 2.3.0 版本的编译问题，升级前必看 >>](./ZIM%20upgrade%20guide.mdx##230-升级指南)
</Warning>
