...
| 通知携带图片 | 支持在离线推送通知中携带一张图片，详情请参考 [通知携带图片附件](./../Offline%20push%20notifications/Best%20Practices/Notify%20with%20photo%20attachment.mdx)。 | <ul><li>[ZIMPushConfig > resourceID](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMPushConfig/resourcesID.html)</li><li>[全员推送](/zim-server/messaging/push-message-to-all-users)</li></ul> |
| 更新图标角标 | 支持用户离线情况下，更新 App 图标角标，提醒用户消息未读数，详情请参考 [更新图标角标](./../Offline%20push%20notifications/Best%20Practices/Modify%20a%20notification%20badge.mdx)。 | <ul><li>[setServerBadge](https://pub.dev/documentation/zego_zpns/latest/zego_zpns/ZPNs/setServerBadge.html)</li><li>[ZIMPushConfig > enableBadge](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMPushConfig/enableBadge.html)</li><li>[ZIMPushConfig > badgeIncrement](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMPushConfig/badgeIncrement.html)</li></ul> |
...
| <div style={{width:"130px"}}>功能项</div>  | 功能描述 | 相关接口 |
|-------|-------|-------|
| 优化 iOS VoIP 开发体验 | 为方便 Flutter 开发者实现 VoIP 功能，ZEGO 将 iOS CallKit 、PushKit 库的部分功能封装到独立插件 zego_callkit，详情请参考 [CallKit 使用指南](../Offline%20push%20notifications/Best%20Practices/CallKit%20user%20guide.mdx)。 | - |
...
| <div style={{width:"130px"}}>功能项</div>  | 功能描述 | 相关接口 |
|-------|-------|-------|
| Web 开发 | 支持使用 Flutter 框架开发 Web 应用，实现离线推送，详情请参考 [离线推送 - Web 推送集成指南](./../Offline%20push%20notifications/Integrate%20FCM%20(for%20web).mdx)。 | - |
...
| 向 Android 设备推送私信 | 支持通过安卓设备厂商的私信通道推送消息，实现无上限推送。如何创建私信通道，请查看 [小米](./../Offline%20push%20notifications/Integrate%20Xiaomi.mdx)、[华为](./../Offline%20push%20notifications/Integrate%20Huawei.mdx)、[OPPO](./../Offline%20push%20notifications/Integrate%20OPPO.mdx)、[vivo](./../Offline%20push%20notifications/Integrate%20vivo.mdx) 推送集成指南的相关内容。 | [ZIMPushConfig > resourcesID](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMPushConfig/resourcesID.html) |
...
| <div style={{width:"130px"}}>功能项</div> | 功能描述 | 相关接口 |
| -- | -- | -- |
| 数据类成员变量类型变更 | [ZPNsMessage](https://pub.dev/documentation/zego_zpns/latest/zego_zpns/ZPNsMessage-class.html) 中的 extras 的类型由 Map 字段的 value 类型由 Map\<String, Object> 修改为 Map\<String, Object?> 类型，以兼容 Json 转 map 时，value 可能为 null 的情况。详情请参考 [ZPNs 升级指南 - 2.5.0 升级指南 ](https://doc-zh.zego.im/zim-flutter/client-sdks/zpns-upgrade-guide)。 | [ZPNsMessage > extras](https://pub.dev/documentation/zego_zpns/latest/zego_zpns/ZPNsMessage/extras.html) |
