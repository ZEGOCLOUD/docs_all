...
3. 注册离线推送。
    ...
    注册离线推送后，可以通过 [ZPNsEventHandler](https://pub.dev/documentation/zego_zpns/latest/zego_zpns/ZPNsEventHandler-class.html) 类中的 [onRegistered](https://pub.dev/documentation/zego_zpns/latest/zego_zpns/ZPNsEventHandler/onRegistered.html) 回调，获取到离线推送的 `pushID`，向指定设备推送离线消息。
