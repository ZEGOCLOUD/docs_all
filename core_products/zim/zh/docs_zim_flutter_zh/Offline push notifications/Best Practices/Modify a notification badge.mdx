...
export const setServerBadge={
    ...
    "RN,uni-app": <a href="@setServerBadge" target="_blank">setServerBadge</a>
}
export const registerPush={
    ...
    "RN,uni-app": <a href="@registerPush" target="_blank">registerPush</a>
}
export const setPushConfig={
    ...
    "RN,uni-app": <a href="@setPushConfig" target="_blank">setPushConfig</a>
}
export const setLocalBadge={
    ...
    "RN,uni-app": <a href="@setLocalBadge" target="_blank">setLocalBadge</a>
}
