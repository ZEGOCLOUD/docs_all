...
<Tab title="从插件市场获取">
从 uni-app 插件市场获取  [zego-callkit-uts](https://ext.dcloud.net.cn/plugin?name=zego-callkit-uts)。
...
拉起通话界面后，如需接受邀请，实现真正的通话，请集成 Express SDK，详情请参考 [实时音视频](https://doc-zh.zego.im/real-time-video-flutter/introduction/entry)。
