...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | const [ZIMLogConfig](./struct#zimlogconfig) & | 日志配置对象。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | const [ZIMCacheConfig](./struct#zimcacheconfig) & | 缓存配置对象。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| userInfo | const [ZIMUserInfo](./struct#zimuserinfo) & | 用于标识用户的信息。包含用户的唯一 ID和用户名。注意 userID 在同一个 appID 下需唯一，否则会出现互踢的情况。   <br/>注意：不支持通过此接口设置 ZIMUserInfo.userAvatarUrl。  |
...
| conversationInfos | const std::vector\<[ZIMConversationBaseInfo](./struct#zimconversationbaseinfo)\> & | 需要被修改会话标记的会话简要信息列表。最大可传入 100 个会话。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> | 要插入的消息。 |
| conversationID | const std::string & | 会话 ID。 |
| conversationType | [ZIMConversationType](./enum#zimconversationtype) | 会话类型。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| messageList | const std::vector\<std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\>\> &messageList, | 要设置已读的消息列表，所含消息不能超过 10 条。 |
| conversationID | const std::string & | 会话 ID。 |
| conversationType | [ZIMConversationType](./enum#zimconversationtype) | 会话类型。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| messageList | const std::vector\<std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\>\> &messageList, | 要查询的消息列表。 |
| conversationID | const std::string & | 会话 ID。 |
| conversationType | [ZIMConversationType](./enum#zimconversationtype) | 会话类型。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> | 要查询的消息。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> | 要发送的消息，使用时，请根据消息类型修改 message 的类型。 例如，发送文本消息时，请使用 ZIMTextMessage。仅支持：ZIMTextMessage(1)、ZIMImageMessage(11)、ZIMFileMessage(12)、ZIMAudioMessage(13)、ZIMVideoMessage(14)、ZIMCombineMessage(100)、ZIMCustomMessage(200)。 |
| toOriginalMessage | std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> | 引用的源消息。仅支持：ZIMTextMessage(1)、ZIMImageMessage(11)、ZIMFileMessage(12)、ZIMAudioMessage(13)、ZIMVideoMessage(14)、ZIMCombineMessage(100)、ZIMCustomMessage(200)。 |
| config | [ZIMMessageSendConfig](./struct#zimmessagesendconfig) | 发送消息的相关配置。 |
| notification | [ZIMMessageSendNotification](#zimmessagesendnotification) | 发送消息时的相关通知。 |
| callback | [ZIMMessageSentCallback](./interface#zimmessagesentcallback) | 消息的发送结果的回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> | 需要被撤回的消息。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| messageList | std::vector\<[ZIMMessage](./struct#zimmessage) *\> | 被删除的消息列表。 |
...
| message | std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> | 需要被表态的消息。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> | 需要被删除表态的消息。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | const std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> & | 需要被拉取表态用户详情的消息。 |
...
| message | const std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> & | 需要更新的消息体。 |
...
| toRoomInfo | const [ZIMRoomInfo](./struct#zimroominfo) & | 需要切换至的房间的基本信息。其中的 roomName 字段，仅在切换至的房间不存在，且 isCreateWhenRoomNotExisted 字段为 true 的情况下生效。 |
...
| userList | const std::vector\<[ZIMUserInfo](./struct#zimuserinfo)\> | 黑名单列表变更的用户信息集合 |
...
| --- | --- | --- |
| zim | [ZIM](#zim) * | ZIM 实例对象。 |
| conversationChangeInfoList | std::vector\<[ZIMConversationChangeInfo](./struct#zimconversationchangeinfo)\> | 会话变更的信息。 |
...
| --- | --- | --- |
| zim | [ZIM](#zim) * | ZIM 实例对象。 |
| messageList | const std::vector\<std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\>\> & | 收到的消息的列表。 |
...
| --- | --- | --- |
| zim | [ZIM](#zim) * | ZIM 实例对象。 |
| message | const std::shared_ptr\<[ZIMMessage](./struct#zimmessage)\> & | 收到的消息。 |
