...
| 参数         | 类型              | 是否必选 | 描述                                                                 |
|--------------|-------------------|----------|----------------------------------------------------------------------|
| FromUserId   | String            | 是        | 用户的 UserID。<ul><li>查询单聊会话消息时，此处填入任一参与用户的 userID。</li><li>查询群聊会话消息时，此处可填入任意已注册用户的 userID。</li></ul> |
| ConvId       | String            | 是        | 会话 ID。<ul><li>查询单聊会话消息时，此处填入另一参与用户的 userID。</li><li>查询群聊会话消息时，此处填入目标群组的 groupID。</li></ul> |
