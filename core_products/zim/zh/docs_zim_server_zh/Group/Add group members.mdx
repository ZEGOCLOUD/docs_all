...
<ul><li>
Code 为 0：
<ul><li>ErrorList 为空，全部指定用户邀请成功。</li><li>ErrorList 不为空，表示部分指定用户邀请失败，请参考 SubCode 处理。</li></ul>
</li>
<li>
Code 不为 0：
<ul><li>ErrorList 为空，表示参数错误、接口频率限制、系统错误。</li><li>ErrorList 不为空，表示全部指定用户邀请失败。</li></ul>
</li>
</ul></td>
</tr>
<tr data-row-level="5-1">
