...
如果您需要通过客户端回调获取导致消息未通过 ZIM 内容审核的原因，请联系 ZEGO 技术支持开通相关配置。相关客户端回调请参考 [收发消息 - 监听消息状态](https://doc-zh.zego.im/zim-android/guides/messaging/send-and-receive-messages#%E7%9B%91%E5%90%AC%E6%B6%88%E6%81%AF%E7%8A%B6%E6%80%81)。
