...
export const peerMessageReceivedMap= {
  ...
  'iOS': <a href='/zim-ios/client-sdks/api-reference/protocol#zimpeermessagereceivedinfofromuserid' target='_blank'>peerMessageReceived</a>,
  'mac': <a href='/zim-macos/client-sdks/api-reference/protocol#zimpeermessagereceivedinfofromuserid' target='_blank'>peerMessageReceived</a>,
  'window': <a href='@onPeerMessageReceived' target='_blank'>onPeerMessageReceived</a>,
...
export const messageSentStatusChangedMap= {
  ...
  'web': <a href='@messageSentStatusChanged' target='_blank'>messageSentStatusChanged</a>,
}
...
sequenceDiagram
    ...
    Note over SDK: onMessageQueried<br/>onPeerMessageReceived<br/>onMessageSentStatusChanged<br/>onMessageRevoked<br/>onMessageSent<br/>onMessageDeleted<br/>...
