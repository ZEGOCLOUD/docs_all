...
<Frame width="auto" height="auto">
  <img src="https://doc-media.zego.im/docuo/3731b8d2e9.png" alt="7_置顶会话_中文.png"/>
</Frame>
...
- 置顶会话中记录了会话被置顶的时间，可通过置顶时间对置顶会话进行排序

    会话被置顶时会记录此时的时间戳 {getPlatformData(props,pinnedTimeMap)}，未置顶和取消置顶的会话中 {getPlatformData(props,pinnedTimeMap)} 为 0。
