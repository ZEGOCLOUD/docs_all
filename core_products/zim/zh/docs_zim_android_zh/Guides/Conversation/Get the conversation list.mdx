...
export const onConversationSyncStateChangedMap = {
  ...
  'U3d': <a href='@onConversationSyncStateChanged' target='_blank'>onConversationSyncStateChanged</a>,
  ...
  'Web': <a href='@onConversationSyncStateChanged' target='_blank'>onConversationSyncStateChanged</a>,
  'iOS': <a href='https://docs.zegocloud.com/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-conversation-sync_state-changed' target='_blank'>onConversationSyncStateChanged</a>,
  'mac': <a href='https://docs.zegocloud.com/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-conversation-sync-state-changed' target='_blank'>onConversationSyncStateChanged</a>,
}
...
:::if{props.platform="undefined|iOS|macOS|Web|Flutter|window"}
在用户登录之前，请调用 {getPlatformData(props,setEventHandlerMap)} 接口，监听 {getPlatformData(props,onConversationSyncStateChangedMap)} 回调，将会在如下情形时收到会话列表拉取状态变更通知：
:::
...
<tr>
:::if{props.platform="window"}
<td><code>ZIM_CONVERSATION_SYNC_STATE_STARTED</code></td>
:::
:::if{props.platform="undefined"}
<td><code>STARTED</code></td>
:::
:::if{props.platform="ios"}
<td><code>ZIMConversationSyncStateStarted</code></td>
:::
...
<td>0</td>
<td>会话列表同步开始。</td>
<td>业务层可以通过本事件在 UI 上开始展示“拉取中”。建议在会话列表同步期间不要查询会话列表，等待会话拉取完成后再进行查询。</td>
</tr>
<tr>
:::if{props.platform="window"}
<td><code>ZIM_CONVERSATION_SYNC_STATE_FINISHED</code></td>
:::
:::if{props.platform="undefined"}
<td><code>FINISHED</code></td>
:::
:::if{props.platform="ios"}
<td><code>ZIMConversationSyncStateFinished</code></td>
:::
:::if{props.platform="macOS"}
<td><code>ZIMConversationSyncStateFinished</code></td>
:::
<td>1</td>
<td>会话列表同步完成。</td>
<td>业务层可以通过本事件在 UI 上取消展示“拉取中”。此时可以开始拉取会话列表。</td>
</tr>
<tr>
:::if{props.platform="window"}
<td><code>ZIM_CONVERSATION_SYNC_STATE_FAILED</code></td>
:::
:::if{props.platform="undefined"}
<td><code>FAILED</code></td>
:::
:::if{props.platform="ios"}
<td><code>ZIMConversationSyncStateFailed</code></td>
:::
:::if{props.platform="macOS"}
<td><code>ZIMConversationSyncStateFailed</code></td>
:::
<td>1</td>
<td>会话列表同步失败。</td>
<td>业务层可以通过本事件在 UI 上取消展示“拉取中”。</td>
</tr>
</tbody>
</table>
