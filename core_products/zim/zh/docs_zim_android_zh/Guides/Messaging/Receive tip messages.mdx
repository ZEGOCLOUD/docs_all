        ...
        for (ZIMMessage message : messageList) {
            ...
            if (message.getType() == ZIMMessageType.TIPS) {
                ...
                if (tipsMessage.event == ZIMTipsMessageEvent.GROUP_INFO_CHANGED) {
                    ...
                    if (memberInfo.type == ZIMTipsMessageChangeInfoType.GROUP_OWNER_TRANSFERRED) {
                        ZIMGroupMemberSimpleInfo newOwnerInfo = memberInfo.groupNewOwner;
                    }
                    // ... 业务逻辑
                }
                // ... 其他逻辑
    ...
    for (ZIMMessage message in messageList){
      ...
      if(message.type == ZIMMessageType.tips){
        ...
        if(tipsMessage.event == ZIMTipsMessageEvent.groupInfoChanged){
          ...
          if (memberInfo.type == ZIMTipsMessageChangeInfoType.groupOwnerTransferred) {
              ZIMGroupMemberSimpleInfo newOwnerInfo = memberInfo.groupNewOwner;
          }
          // ... 业务逻辑
        }
