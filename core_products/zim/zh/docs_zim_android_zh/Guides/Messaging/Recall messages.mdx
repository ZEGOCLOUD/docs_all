...
ZIM SDK 支持在单聊、群聊或社群频道会话中撤回自己发送的消息。群聊会话时，管理员可以撤回普通成员的消息，群主可以撤回所有人的消息；社群频道会话时，社群管理员或所有者同样可撤回普通成员的消息。

<Frame width="auto" height="auto" >
  <img src="https://doc-media.zego.im/docuo/14e7c6ccda.png" alt="2_撤回消息_中文.png"/>
</Frame>
