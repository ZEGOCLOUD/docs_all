...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/receipt_2.png" /></Frame>
...
// 对方设置了消息的已读回执
zim.onMessageReceiptChanged(function (zim, { infos }) {
    console.log('messageReceiptChanged', infos);
});
// 对方设置了会话的已读回执
zim.onConversationMessageReceiptChanged(function (zim, { infos }) {
    console.log('conversationMessageReceiptChanged', infos);
});
```
:::
