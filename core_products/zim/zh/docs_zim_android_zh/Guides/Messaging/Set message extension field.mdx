...
const conversationType = 0; // 会话类型，取值为 单聊:0, 房间:1, 群组:2, 社群频道:3
...
// 发送社群频道信息
// ZIMConversationType type = ZIMConversationType.CommunityChannel;
...
// 发送社群频道信息
// auto conversationType = zim::ZIMConversationType::ZIM_CONVERSATION_TYPE_COMMUNITY_CHANNEL;
...
// 发送社群频道信息
// ZIMConversationType channelType = ZIMConversationType.CommunityChannel;
...
```cpp title="示例代码"
// 收到单聊消息后，更新消息的本地拓展字段
virtual void onMessageReceived(zim::ZIM *zim, const ZIMMessageReceivedEventResult &result) override {
