...
zim.onRroomAttributesUpdated(function ({ roomID, infos }) {
    console.log('roomAttributesUpdated', roomID, infos);
});
```
</CodeGroup>
...
zim.onRoomAttributesUpdated(function ({ roomID, infos }) {
    console.log('roomAttributesUpdated', roomID, infos);
});
```
</CodeGroup>
...
zim.onRroomAttributesBatchUpdated(function ({ roomID, infos }) {
    console.log('roomAttributesBatchUpdated', roomID, infos);
});
```
</CodeGroup>
