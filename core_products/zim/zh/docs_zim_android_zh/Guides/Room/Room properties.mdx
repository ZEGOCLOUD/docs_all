...
zim.on('roomAttributesUpdated', (zim: ZIM, data: ZIMEventOfRoomAttributesUpdatedResult) => {
...
zim.on('roomAttributesBatchUpdated', (zim: ZIM, data: ZIMEventOfRoomAttributesUpdatedResult) => {
