...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Common/GroupMembers.png" /></Frame>
...
- **SDK 版本 ≥ 2.19.0**：
    ...
    - 若 A 和 B 非好友，则可以通过以下任意方式获取用户 B 的最新信息：
        - 先调用服务端接口 [查询用户 B 的用户信息](/zh/zim-server/user/query-user-information) ，再调用该接口。
...
// 注册监听“群成员信息变更”的回调
zim.onGroupMemberInfoUpdated(function (zim, { groupID, userList, operatedInfo }) {
    console.log('groupMemberInfoUpdated', groupID, userList, operatedInfo);
});
```
</CodeGroup>
