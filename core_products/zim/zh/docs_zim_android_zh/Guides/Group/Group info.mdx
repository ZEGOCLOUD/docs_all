...
// 注册监听“群名更新”的回调
zim.on('groupNameUpdated', (zim: ZIM, data: ZIMGroupNameUpdatedEventResult) => {
...
// 注册监听“群头像 URL 更新”的回调
zim.on('groupAvatarUrlUpdated', (zim: ZIM, data: ZIMGroupAvatarUrlUpdatedEventResult) => {
...
// 注册监听“群公告更新”的回调
zim.on('groupNoticeUpdated', (zim: ZIM, data: ZIMGroupNoticeUpdatedEventResult) => {
...
```typescript
// 监听群备注修改通知
zim.on('groupAliasUpdated', (zim: ZIM, data: ZIMGroupAliasUpdatedEventResult) => {
