...
export const ZIMGroupAttributesQueriedCallbackMap = {
  ...
  'Web': <a href='@-ZIMGroupAttributesQueriedResult' target='_blank'>ZIMGroupAttributesQueriedResult</a>,
...
- 用户使用“群属性管理”功能之前，请先加入某个群组，否则无法使用相关功能，详情请参考 [加入群组](./Manage%20groups.mdx#加入群组)。
- 群内成员（包含群主）都可以使用“群属性管理”功能。
</Warning>

<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Common/GroupAttributes.png" /></Frame>
