...
channelInfo.channelName = "公告频道";
channelInfo.channelAvatarUrl = "https://example.com/channel_avatar.png";
channelInfo.communityID = communityID;    // 所属社群 ID

ZIMCommunityChannelCreateConfig config = new ZIMCommunityChannelCreateConfig();
config.channelNotice = "这是频道公告";
...
调用 {getPlatformData(props,updateCommunityChannelNameMap)} 接口更新频道名称。
...
调用 {getPlatformData(props,updateCommunityChannelAvatarUrlMap)} 接口更新频道头像 URL。
...
调用 {getPlatformData(props,updateCommunityChannelNoticeMap)} 接口更新频道公告内容。
