...
channelInfo.channelID = "channel_001";    // 频道 ID，可自定义
...
channelInfo.communityID = communityID;    // 所属社群 ID
...
config.channelAttributes = channelAttributes;
...
config.duration = 3600;  // 禁言 1 小时；-1 为永久禁言
config.mode = ZIMCommunityChannelMuteMode.ALL;  // 禁言所有人
