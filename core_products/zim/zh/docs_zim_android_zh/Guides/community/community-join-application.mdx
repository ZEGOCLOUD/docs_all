...
export const updateCommunityJoinModeMap = {
  ...
  'Flutter': <a href="@updateCommunityJoinMode" target="_blank">updateCommunityJoinMode</a>,
}
export const sendCommunityJoinApplicationMap = {
  ...
  'Flutter': <a href="@sendCommunityJoinApplication" target="_blank">sendCommunityJoinApplication</a>,
}
export const queryCommunitySelfApplicationListMap = {
  ...
  'Flutter': <a href="@queryCommunitySelfApplicationList" target="_blank">queryCommunitySelfApplicationList</a>,
}
export const cancelCommunityJoinApplicationMap = {
  ...
  'Flutter': <a href="@cancelCommunityJoinApplication" target="_blank">cancelCommunityJoinApplication</a>,
}
export const queryCommunityApplicationListMap = {
  ...
  'Flutter': <a href="@queryCommunityApplicationList" target="_blank">queryCommunityApplicationList</a>,
}
export const acceptCommunityJoinApplicationMap = {
  ...
  'Flutter': <a href="@acceptCommunityJoinApplication" target="_blank">acceptCommunityJoinApplication</a>,
}
export const rejectCommunityJoinApplicationMap = {
  ...
  'Flutter': <a href="@rejectCommunityJoinApplication" target="_blank">rejectCommunityJoinApplication</a>,
}
export const onCommunitySelfApplicationListChangedMap = {
  ...
  'Flutter': <a href="@onCommunitySelfApplicationListChanged" target="_blank">onCommunitySelfApplicationListChanged</a>,
}
export const onCommunityApplicationListChangedMap = {
  ...
  'Flutter': <a href="@onCommunityApplicationListChanged" target="_blank">onCommunityApplicationListChanged</a>,
}
...
- 邀请入群当前通过 `inviteUsersIntoCommunity` 直接实现，不产生申请记录；邀请链接等由业务侧自行实现。
...
以游客身份进入社群的用户也可提交入群申请：审批通过前保持游客身份，审批通过（或 ANY 模式直接入群）后 SDK 自动将游客态转为正式成员态，无需先退出游客模式，详见[游客模式](./community-visitor-mode.mdx)。
