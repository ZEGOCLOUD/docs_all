...
export const extendedDataUpdatedCallback={
    ...
    "Web,RN,UTS": <a href="@-ZIMUserExtendedDataUpdatedResult" target="_blank">ZIMUserExtendedDataUpdatedResult</a>,
...
export const ZIMUserNameUpdatedCallback={
    ...
    "Web,RN,UTS": <a href="@-ZIMUserNameUpdatedResult" target="_blank">ZIMUserNameUpdatedResult</a>,
...
export const ZIMUserAvatarUrlUpdatedCallback={
    ...
    "Web,RN,UTS": <a href="@-ZIMUserAvatarUrlUpdatedResult" target="_blank">ZIMUserAvatarUrlUpdatedResult</a>,
...
export const ZIMUsersInfoQueriedCallback={
    ...
    "Web,RN,UTS": <a href="@-ZIMUsersInfoQueriedResult" target="_blank">ZIMUsersInfoQueriedResult</a>,
...
zim.queryUsersInfo(userIDs, { isQueryFromServer: false } as ZIMUsersInfoQueryConfig)
