...
```typescript
// 好友列表变更回调
zim.on('friendListChanged', (zim: ZIM, data: ZIMEventOfFriendListChangedResult) => {
    // 待办事项
});

// 好友信息更新回调
zim.on('friendInfoUpdated', (zim: ZIM, data: ZIMEventOfFriendInfoUpdatedResult) => {
    // 待办事项
});

// 好友申请列表变更回调
zim.on('friendApplicationListChanged', (zim: ZIM, data: ZIMEventOfFriendApplicationListChangedResult) => {
    // 待办事项
});

// 好友申请更新回调
zim.on('friendApplicationUpdated', (zim: ZIM, data: ZIMEventOfFriendApplicationUpdatedResult) => {
    // 待办事项
});
```
:::
