...
```typescript
// 好友列表变更回调
zim.on('friendListChanged', (zim: ZIM, data: ZIMFriendListChangedEventResult) => {
    // 待办事项
});

// 好友信息更新回调
zim.on('friendInfoUpdated', (zim: ZIM, data: ZIMFriendInfoUpdatedEventResult) => {
    // 待办事项
});

// 好友申请列表变更回调
zim.on('friendApplicationListChanged', (zim: ZIM, data: ZIMFriendApplicationListChangedEventResult) => {
    // 待办事项
});

// 好友申请更新回调
zim.on('friendApplicationUpdated', (zim: ZIM, data: ZIMFriendApplicationUpdatedEventResult) => {
    // 待办事项
});
```
:::
