...
export const ZIMEventHandlerMap = {
  ...
  "RN,uniapp,harmonyos": <a href="@on">on</a>,
...
export const DisconnectedMap = {
  ...
  "RN,uniapp,harmonyos":`Disconnected`,
...
export const ConnectingMap = {
  ...
  "RN,uniapp,harmonyos":`Connecting`,
  "Flutter":`connecting`,  
}
export const ReconnectingMap = {
  ...
  "RN,uniapp,harmonyos":`Reconnecting`,
...
:::
:::if{props.platform="uniapp|harmonyos"}
...
```
:::
:::if{props.platform="RN|harmonyos"}
```javascript
// 创建订阅配置
const config = {
    subscriptionDuration: 60, // 订阅时长为60分钟
