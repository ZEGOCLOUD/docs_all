...
export const onCallInvitationReceivedMap = {
  ...
  'iOS': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-call-invitation-received' target='_blank'>callInvitationReceived</a>,
...
3. 发送方调用 {getPlatformData(props,sendMessageMap)}，传入 “sentConfig”，向接收方发送单聊消息。
