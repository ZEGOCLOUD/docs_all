...
- 已完成如下步骤：
    ...
    :::if{props.platform="UTS"}
        ...
        <Tabs>
        <Tab title="uni-app x">
        将下载好的 “google-services.json” 文件，复制到自己项目根目录下的 “nativeResources/android” 目录。
        </Tab>
        <Tab title="uni-app">
        将下载好的 “google-services.json” 文件，复制到自己项目根目录下的 “nativeplugins/zego-ZPNsUniPlugin/android/assets” 目录。
        </Tab>
        </Tabs>
...
1. 配置 google-services.json。
  ...
  将下载好的 “google-services.json” 文件，复制到自己项目的 “app” 目录下，如下图：

  <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/ZIM/offline_push_huawei_json.png" /></Frame>

2. 在项目级 “build.gradle”（文件路径：项目/build.gradle）文件中，配置 Google 的 maven 仓库，拉取 Google 的依赖。
...
3. 在应用级 “build.gradle”（文件路径：项目/应用模块/build.gradle）文件中，增加 Firebase 相关依赖。
...
1. 前往 [Firebase 控制台](https://console.firebase.google.com)，选择您的项目。
  ...
  <Frame width="auto" height="auto" >
    <img src="https://doc-media.zego.im/docuo/f30d181f90.jpeg" />
  </Frame>

2. 点击项目设置 > 服务账号。

  <Frame width="auto" height="auto" >
    <img src="https://doc-media.zego.im/docuo/58a445d151.jpeg" />
  </Frame>

3. 点击生成新的私钥，然后点击生成密钥。

  <Frame width="auto" height="auto" >
    <img src="https://doc-media.zego.im/docuo/c0e57dbfc5.jpeg" />
  </Frame>
...
1. 登录 [ZEGO 控制台](https://console.zego.im/)，选择项目管理 进入自己的项目，点击服务配置 > 即时通讯。
  ...
  <Frame width="auto" height="auto" >
    <img src="https://doc-media.zego.im/docuo/a923d7b2f2.png"  />
  </Frame>

2. 在离线推送配置中，点击添加证书，上传 FCM 证书，然后点击确定。

  <Frame width="auto" height="auto" >
    <img src="https://doc-media.zego.im/docuo/97becb7459.png" />
  </Frame>

  <Frame width="auto" height="auto" >
    <img src="https://doc-media.zego.im/docuo/8e7b07846a.png" alt="20250820-164225.png"/>
  </Frame>
