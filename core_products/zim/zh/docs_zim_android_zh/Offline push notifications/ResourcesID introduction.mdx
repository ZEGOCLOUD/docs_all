...
<td>[自定义通知铃声](./Customize%20notification%20sound.mdx)</td>
</tr>
<tr>
...
<tr>
<tr>
<td rowspan="2">鸿蒙 next</td>
<td>test_message</td>
<td>正式、测试消息。0：正式，1：测试。默认0</td>
</tr>
<tr>
<td>push_type</td>
<td>推送类型</td>
<td>0：通知消息，6：静默（后台）消息，10：VOIP消息。参考华为请求参数说明 [Modifying content in newly delivered notifications](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-scenariozed-api-request-param)</td>
</tr>
<tr>
<td>category</td>
<td>推送类别</td>
<td>参考华为请求参数说明 [Modifying content in newly delivered notifications](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-scenariozed-api-request-param)</td>
</tr>
<tr>
<td>click_type</td>
<td>点击跳转类型。</td>
<td> 非必填，0：打开应用首页，1：打开应用自定义页面,默认0。参考华为请求参数说明 [Modifying content in newly delivered notifications](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-scenariozed-api-request-param)</td>
</tr>
<tr>
<tr>
<td>uri</td>
<td>应用内置页面ability对应的uri。</td>
<td> 当ActionType为1时必填，其他时候非必填。参考华为请求参数说明 [Modifying content in newly delivered notifications](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-scenariozed-api-request-param)</td>
</tr>
<tr>
...
<td>[实现静默推送](./Implement%20silent%20push%20notifications.mdx)</td>
</tr>
<tr>
<td rowspan="3">华为</td>
<td>target_user_type</td>
<td>推送类型，分为正式推送与测试推送。</td>
<td>[华为推送集成指南 - 基于消息分类实现无限制推送](./Integrate%20Huawei.mdx#基于消息分类实现无限制推送)</td>
</tr>
<tr>
<td>channel Id</td>
<td>离线推送推送通道。</td>
...
<td>category</td>
<td>推送类别</td>
<td>[OPPO 推送集成指南 - 消息分类新规申请消息分类](./Integrate%20OPPO.mdx#根据-oppo-消息分类新规申请消息分类)</td>
<td>notify_level</td>
<td>通知栏消息提醒等级</td>
<td>[OPPO 推送集成指南 - 消息分类新规申请消息分类](./Integrate%20OPPO.mdx#根据-oppo-消息分类新规申请消息分类)</td>
</tr>
...
- 在 ZEGO 中的应用：[使用私信通道发送不限量推送](./Integrate%20Xiaomi.mdx)
</td>
</tr>
<tr>
...
<td>
- 参考文档：Android 官网文档 [创建和管理通知渠道](https://developer.android.com/develop/ui/views/notifications/channels?hl=zh-cn)
- 在 ZEGO 中的应用：[小米推送集成指南 - 使用私信通道无限制推送](./Integrate%20Xiaomi.mdx#基于系统消息配置不限量推送)
</td>
</tr>
<tr>
...
<td>category</td>
<td>推送类别</td>
<td rowspan="2">[vivo 推送集成指南 - 基于系统消息配置不限量推送](./Integrate%20vivo.mdx#基于系统消息配置不限量推送)</td>
</tr>
<tr>
<td>push_mode</td>
<td>推送环境</td>
