...
2. 声明依赖
    ...
    进入 “app” 目录，打开 “build.gradle” 文件，在 “dependencies” 中添加 `implementation 'im.zego:zim_audio:x.y.z'`，请从 [发布日志 - ZIMAudio](https://doc-zh.zego.im/zim-android/client-sdks/zim-audio-release-notes) 查询 SDK 最新版本，并将 `x.y.z` 修改为具体的版本号。
