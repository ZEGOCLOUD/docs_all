...
ZEGO 提供 ZIM + RTC 服务联动的场景解决方案，公开 [语聊房](https://doc-zh.zego.im/live-audio-room-ios-objective-c/overview)、[秀场直播](https://doc-zh.zego.im/live-audio-room-ios-objective-c/overview) 等业务场景搭建的示例源码，帮助开发者能在极短的时间内搭建完美的业务场景。
...
| [房间](./Basic%20concepts.mdx#房间)模块 | 支持创建房间、销毁房间，适用于直播、语聊房等临时性活动。 |
| [群组](./Basic%20concepts.mdx#群组)模块 | 支持创建群组、解散群组，持久化存储群组关系链。 |
...
| [uni-app (x)](https://doc-zh.zego.im/zim-uniapp-x/introduction/overview) | <ul><li>HBuilderX 4.36 或以上版本。</li><li>iOS 12.0 或以上版本。</li><li>Android 5.0 或以上版本。</li></ul>  |
...
| 平台 | 增量 |
| -- | -- |
| Android | <ul><li>arm：4.61 MiB</li><li>arm64：5.35 MiB</li><li>x64：5.76 MiB</li><li>x86：5.82 MiB</li></ul> |
| iOS | <ul><li>arm64：4.98 MiB</li><li>arm64-catalyst：5.06 MiB</li><li>arm64-simulator：5.06 MiB</li><li>x64-catalyst: 5.38 MiB</li><li>x64-simulator: 5.56 MiB</li></ul> |
| macOS | <ul><li>arm64：6.21 MiB</li><li>x64：6.91 MiB</li></ul> |
| Windows | <ul><li>x64：6.49 MiB</li><li>x86：5.32 MiB</li></ul> |

如需了解更多，请参考 [什么是 SDK 的安装包大小增量？](https://doc-zh.zego.im/faq/sdk-package-size)