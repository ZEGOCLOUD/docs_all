...
<Card title="示例源码" href="https://storage.zego.im/zim/example/android/ZIMExampleJava.zip" target="_blank">点击获得完整代码。</Card>
...
3. 在解压后的示例源码文件夹中，选择 “ZIMExampleJava” 文件夹，并单击 “Open” 打开。
    ...
    <Frame width="80%" height="auto">
      <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Android/demo.png" />
    </Frame>

4. 请参考 [下载 SDK](./Client%20SDKs/SDK%20downloads.mdx)，下载最新版本的 SDK 包，解压后将文件拷贝到示例源码的 “app/jniLibs/release/” 目录下。
