...
请注意，2.7.0 版本开始，ZPNs 将各个厂商包的实现逻辑打包到了不同的厂商库中。若您从低版本升级，需要根据您的厂商接入情况，依赖对应的 ZPNs 厂商包并更新厂商推送库，详情请查阅最新的接入文档（[小米](./../Offline%20push%20notifications/Integrate%20Xiaomi.mdx)/[华为](./../Offline%20push%20notifications/Integrate%20Huawei.mdx)/[OPPO](./../Offline%20push%20notifications/Integrate%20OPPO.mdx)/[vivo](./../Offline%20push%20notifications/Integrate%20vivo.mdx)/[Google](./../Offline%20push%20notifications/Integrate%20FCM.mdx)）。
