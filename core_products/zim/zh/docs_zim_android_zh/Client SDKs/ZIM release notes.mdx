...
|-----|-----|-----|
|消息置顶| 用户可以将特定消息固定在单聊或者群聊消息列表的顶部，且不会因新消息影响置顶的状态。 |  |
...
|离线推送功能支持附带 OPPO 私信模版 | OPPO 推送在消息分类中新增了私信通道，ZIM 对此进行了适配。详细请参考 [OPPO 推送集成指南](./../Offline%20push%20notifications/Integrate%20OPPO.mdx)。 | [ZIMPushConfig](@-ZIMPushConfig) |
