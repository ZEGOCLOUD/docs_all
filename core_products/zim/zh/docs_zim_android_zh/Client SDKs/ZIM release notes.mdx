...
1. 修复在同一实例生命周期内，[onConversationSyncStateChanged](@onConversationSyncStateChanged) 事件通知在 “登录登出再登录” 后失效的问题。
...
<h5><div style={{width:"130px"}}>改进优化</div></h5>
...
<h5><div style={{width:"130px"}}>新增功能</div></h5>
