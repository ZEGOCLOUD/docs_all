...
|-----|-----|-----|
|新增社群功能|	社群（Community）是基于ZEGO IM新支持的即时通讯能力，可以协助开发者搭建类Discord的实时互动社区。满足游戏玩家、兴趣小组、粉丝运营、教育培训等各个类型用户进行大范围实时互动聊天的场景。||

**改进优化**

|优化项-25% | 优化描述-40% | 相关接口-25%|
|-----|-----|-----|
|SDK接口优化	|ZIM3.0.0版本针对之前版本的废弃接口进行优化和删除，具体影响请参考升级指南||
