...
<Step title="申请通知权限">
调用 [applyNotificationPermission](https://docs.zegocloud.com/article/api?doc=zim_API~javascript_react-native~class~ZPNs#apply-notification-permission) 接口向用户申请同意 App 的通知权限。
