...
1. 参考 [Apple 推送集成指南](./Integrate%20APNs.mdx)，为 2 个应用分别获取 2 份离线推送证书。
2. 参考 [控制台 - 离线推送配置](https://doc-zh.zego.im/console/service-configuration/im/offline-push-config)，在 ZEGO 控制台上配置上述获取的 2 份推送证书。
