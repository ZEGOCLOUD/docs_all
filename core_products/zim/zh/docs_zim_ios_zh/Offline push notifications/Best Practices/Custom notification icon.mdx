...
在 [ZEGO 控制台](https://console.zego.im) 配置 `mutable_content : 是` 选项的 resourceID，配置流程请参考 [自定义点击跳转配置](/console/service-configuration/im/custom-notification-click-redirection)。
