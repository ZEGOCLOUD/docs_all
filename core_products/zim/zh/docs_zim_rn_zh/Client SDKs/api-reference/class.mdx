...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZIMCacheConfig](./interface#zimcacheconfig) | 缓存配置对象。 |
...
- **相关回调**：[ZIMCallingInvitationSentResult]。
</Note>

<Warning title="">
- **支持版本**：2.9.0 及以上。
- **注意事项**：不在呼叫内的用户调用会失败。ZIM SDK在接受后无相关业务逻辑，开发者可以自定义加入呼叫后的开发逻辑。呼叫默认最多只能包含 9 名用户。
</Warning>
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZIMGroupSearchConfig](./interface#zimgroupsearchconfig) | 搜索群组的配置。 |
...
| config | [ZIMGroupMemberSearchConfig](./interface#zimgroupmembersearchconfig) | 搜索群成员的配置。 |
...
| --- | --- | --- |
| count | number | 分页查询数量。 |
| config | [ZIMGroupListQueryConfig](./interface#zimgrouplistqueryconfig) | 查询参数配置。 |
...
| --- | --- | --- |
| count | number | 分页数量。 |
| config | [ZIMGroupListQueryConfig](./interface#zimgrouplistqueryconfig) | 查询配置参数。 |
...
| config | [ZIMMessagePinConfig](./interface#zimmessagepinconfig) | 消息置顶配置对象。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZIMFileCacheQueryConfig](./interface#zimfilecachequeryconfig) | 查询缓存的配置。 |
...
- **相关回调**：[ZIMFileCacheQueriedResult]。
</Note>
...
| config | [ZIMMessageExportConfig](./interface#zimmessageexportconfig) | 导出消息的配置。 |
| progress | [ZIMMessageExportingProgress](#zimmessageexportingprogress) | 导出消息进度的返回。 |
...
| config | [ZIMMessageImportConfig](./interface#zimmessageimportconfig) | 导入消息的配置。 |
| progress | [ZIMMessageImportingProgress](#zimmessageimportingprogress) | 导出消息进度的返回。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | [ZIMMessage](./interface#zimmessage) | 要下载的媒体文件消息。 |
| fileType | [ZIMMediaFileType](./enum#zimmediafiletype) | 媒体文件类型。 |
| config | [ZIMMediaDownloadConfig](./interface#zimmediadownloadconfig) | 下载配置对象。 |
| progress | [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress) | 下载媒体文件的进度回调。 |
...
- **相关回调**：[ZIMMediaDownloadedResult]、[ZIMMediaDownloadingProgress]。
</Note>
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | [ZIMMediaMessage](./interface#zimmediamessage) | 要下载的媒体消息。 |
| fileType | [ZIMMediaFileType](./enum#zimmediafiletype) | 媒体文件类型。 |
| progress | [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress) | 下载媒体文件的进度回调。 |
...
| config | [ZIMMessageReactionAddConfig](./interface#zimmessagereactionaddconfig) | 添加表态的配置。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZIMAudioANSParam](./interface#zimaudioansparam) | ANS 参数 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZIMAudioRecordConfig](./interface#zimaudiorecordconfig) | 音频录制配置。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZIMAudioPlayConfig](./interface#zimaudioplayconfig) | 音频播放配置。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| errorInfo | [ZIMAudioError](./interface#zimaudioerror) | 错误信息。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| totalDuration | number | 音频时长（以毫秒为单位）。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| currentDuration | number | 当前记录持续时间（以毫秒为单位）。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| totalDuration | number | 总播放时间（以毫秒为单位）。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| currentDuration | number | 当前播放时间，以毫秒为单位。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| message | [ZIMMediaMessage](./interface#zimmediamessage) | 当前文件下载的消息对象。 |
| currentFileSize | number | 当前进度，即当前文件下载的实时大小。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| exportedMessageCount | number | 当前进度，即当前导出的消息数。 |
| totalMessageCount | number | 总进度，即导出消息的总数目。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| importedMessageCount | number | 当前进度，即当前导入的消息数。 |
| totalMessageCount | number | 总进度，即导入消息的总数目。 |
