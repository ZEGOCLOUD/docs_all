...
4. Click the **Run** button in "Android Studio" to run the sample app. 
    ...
    <img src="https://doc-media.zego.im/sdk-doc/Pics/ZIM/flutter/run_example_demo_0.png" />
    </Frame>
...
3. Modify the Bundle Identifier and the certificate. 
    ...
    1. In Xcode, select the **Runner** in the left pane.
        ...
        <Frame width="512" height="auto" caption="">
        <img src="https://doc-media.zego.im/sdk-doc/Pics/Flutter/ZegoExpressEngine/flutter-xcode-select-project.png" />
        </Frame>
