...
- Request method: GET
- Request URL: `https://auth-api.zego.im?Action=CgiDescribeZIMAudioLicense`
...
The following table describes only some common request parameters. For the complete list of common request parameters, see [Accessing Server APIs](../Accessing%20Server%20APIs.mdx#common-parameters).
