...
|---------------|---------|----------|-----------------------------------------------------------------------------|
| Message       | String  | Yes      | The content of the multi-item message, a JSON byte string generated according to the `Message Structure` for the multi-item message type, with a default size of 5 KB. If you need to increase this limit, please contact ZEGOCLOUD technical support, with a maximum of 32 KB. |
| ExtendedData | String | No | Extended field, up to 1 KB in length. |
| OfflinePush   | Object  | No       | Offline push, see <a href="#offlinepush-introduction-inapplicable-for-room-messages"> OfflinePush introduction</a> for more information. <Warning title="Warning">This parameter is meaningless when importing messages.</Warning> |
...
| Parameters | Type | Required or not | Description |
| :-- | :-- | :-- | :-- | 
| Message | String | Yes | <p>Image message content, a JSON byte string generated according to `Message structure` , defaults to 2 KB. Please contact ZEGO technical support for configurations up to 32 KB if needed.</p> |
| ExtendedData | String | No | Extended field, up to 1 KB in length. |
| OfflinePush | Object | No | Offline Push, see <a href="#offlinepush-introduction-inapplicable-for-room-messages"> OfflinePush introduction</a> for more information. <Warning title="Warning">This parameter is meaningless when importing messages.</Warning> |
| HasReceipt | Number | No | Message includes a receipt: <ul><li>0: No.</li><li>1: Yes.</li></ul> <Warning title="Warning">This parameter is meaningless when importing messages.</Warning> |
...
| Width | Number | Yes | Image width in pixels（px). |
| Height | Number | Yes | Image heightin pixels（px). |
