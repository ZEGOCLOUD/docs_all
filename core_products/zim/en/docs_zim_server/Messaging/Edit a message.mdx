...
Upon successful editing of a message, the callbacks on [message not sent yet](./../Callbacks/Message%20not%20sent%20yet.mdx) and [message sent](./../Callbacks/Message%20sent.mdx) will be triggered.
