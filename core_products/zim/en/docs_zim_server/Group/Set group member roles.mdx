...
<td>String</td>
<td> Yes </td>
<td>The ID of the operator. It is recommended to fill in the user ID of the group owner.<Warning title="warning">This parameter cannot be the same as ToUserId.</Warning></td>
</tr>
<tr>
<td>GroupId</td>
<td>String</td>
