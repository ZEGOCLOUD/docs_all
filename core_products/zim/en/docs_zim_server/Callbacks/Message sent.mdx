...
| source | Int | Message source: <ul><li>0: Message sent through the SDK API (default, `source` is 0 will not return this parameter). </li><li>1: Message sent through the server API. </li></ul> |
