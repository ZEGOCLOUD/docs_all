...
| reason | String | When result is 3, you can fill in the reason for refusing to send the message here.<Note title="Note">If you need to use this field, please contact ZEGOCLOUD technical support to configure the related switch.</Note> |
