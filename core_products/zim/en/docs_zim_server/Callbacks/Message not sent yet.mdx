...
- For versions prior to 2.21.0: If you need this callback to return the rejection reason from the ZIM content moderation service, please contact ZEGOCLOUD Technical Support to enable the feature.
- For versions 2.21.0 and above: The rejection reason from the ZIM content moderation service is returned by default.
</Warning>
