...
# Message callback of a one-to-one conversation bot 

- - -

## Description

This callback is triggered when the recipient of a one-to-one message is a bot account. The business backend can use this callback to obtain detailed information about the one-to-one message.
