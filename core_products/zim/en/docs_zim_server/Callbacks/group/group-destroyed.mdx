# Callback on group destroyed

---

## Overview

With this callback, you can receive the callback on the group destroyed by the user in real time, and view the information of the group destroyed by the user.
...
- Request URL: The corresponding callback endpoint set in the [ZEGOCLOUD Admin Console](https://console.zegocloud.com)
...
| operator_account | String | The user ID of the group destroyer. |
| owner_account | String | The user ID of the group owner. |
| user_ids | Arrays | The user IDs of all group members when the group is destroyed. |
