...
|-----|-----|-----|
|Optimized delete conversation API| When deleting a conversation, the client that initiated the deletion will trigger related conversation change callbacks. For details, see [Delete conversations](../Guides/Conversation/Delete%20conversations.mdx#delete-a-single-conversation).|<ul><li>[deleteConversation](@deleteConversation)</li><li>[onConversationChanged](@onConversationChanged)</li><li>[deleteAllConversations](@deleteAllConversations)</li><li>[onConversationsAllDeleted](@onConversationsAllDeleted)</li></ul>|
