...
| [sendMediaMessage](@sendMediaMessage)|  A new rich media message sending method [sendMediaMessage](@sendMediaMessage) (overloaded with the same name) was added, which supports getting the information before media uploading and can send rich media information such as files, pictures, audio, and video.  | 2.4.0 |
