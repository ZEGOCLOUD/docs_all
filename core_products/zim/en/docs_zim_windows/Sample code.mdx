...
<Card title="Sample Code" href="https://artifact-demo.zego.im/zim/example/windows/ZIMDemo.zip" target="_blank">Click here to get the complete sample code.</Card>
...
![/Pics/Windows/ZIM/DebuggerAndRun.png](https://doc-media.zego.im/sdk-doc/Pics/Windows/ZIM/DebuggerAndRun.png)
...
1. **Compliance failed because the Platform Toolset or Windows SDK version used in the project properties is different from the version in the sample source code, such as Visual Studio 2015/2017.**
    ...
    ![/Pics/Windows/ZIM/Property_Win_and_MSVC_SDK.png](https://doc-media.zego.im/sdk-doc/Pics/Windows/ZIM/Property_Win_and_MSVC_SDK.png)
