...
| [ZIMTipsMessagePinStatusChangeInfo](#zimtipsmessagepinstatuschangeinfo) | [ZIMUserFullInfo](#zimuserfullinfo) |
...
<ParamField
  name="isPreferQueryFromServer"
  prototype="public BOOL isPreferQueryFromServer"
  parent_name="ZIMMessageQueryConfig"
  parent_type="class">
Whether to prioritize querying historical messages from the server. Since the SDK can determine whether local data is complete and return historical messages more quickly, it is recommended to enable this flag only when required by business scenarios.
</ParamField>
