...
| [ZIMGroupListQueryConfig](#zimgrouplistqueryconfig) | [ZIMGroupMemberInfo](#zimgroupmemberinfo) |
...
| [ZIMMessageMentionedInfo](#zimmessagementionedinfo) | [ZIMMessagePinConfig](#zimmessagepinconfig) |
| [ZIMMessagePinStatusChangeInfo](#zimmessagepinstatuschangeinfo) | [ZIMMessageQueryConfig](#zimmessagequeryconfig) |
| [ZIMMessageReaction](#zimmessagereaction) | [ZIMMessageReactionAddConfig](#zimmessagereactionaddconfig) |
| [ZIMMessageReactionChangeInfo](#zimmessagereactionchangeinfo) | [ZIMMessageReactionsChangedEventResult](#zimmessagereactionschangedeventresult) |
| [ZIMMessageReactionSimpleInfo](#zimmessagereactionsimpleinfo) | [ZIMMessageReactionUserChangeInfo](#zimmessagereactionuserchangeinfo) |
| [ZIMMessageReactionUserFullInfo](#zimmessagereactionuserfullinfo) | [ZIMMessageReactionUserInfo](#zimmessagereactionuserinfo) |
...
| [ZIMRoomMemberQueryConfig](#zimroommemberqueryconfig) | [ZIMRoomOperatedInfo](#zimroomoperatedinfo) |
| [ZIMSelfUserInfo](#zimselfuserinfo) | [ZIMSelfUserRule](#zimselfuserrule) |
| [ZIMSendingMessageCancelConfig](#zimsendingmessagecancelconfig) | [ZIMSubscribedUserStatusQueryConfig](#zimsubscribeduserstatusqueryconfig) |
...
| [ZIMTipsMessagePinStatusChangeInfo](#zimtipsmessagepinstatuschangeinfo) | [ZIMUserCustomStatusUpdateConfig](#zimusercustomstatusupdateconfig) |
...
<ParamField
  ...
  parent_name="ZIMConversationFilterOption"
  parent_type="class">
Set whether the session has been pinned to the top as the filter item of the query condition.

<Note title="">
- **Use cases**: When you only need to query the pinned sessions or only need to query the unpinned sessions, you can modify this parameter. By default, it does not filter whether the sessions are pinned or not.
...
<ParamField
  name="ZIMUserBadgeUpdatedCallback"
  prototype="void(^[ZIMUserBadgeUpdatedCallback](#zimuserbadgeupdatedcallback))();"
  desc="Update the user badge callback."
  parent_name="ZIMDefines"
  parent_type="class">
Supported version: 2.28.0 and above.

Detailed description: Callback after developer update user badge.
</ParamField>
<ParamField
...
<ParamField
  ...
  prototype="void(^[ZIMGroupListQueriedCallback](#zimgrouplistqueriedcallback))((NSArray<[ZIMGroupInfo](#zimgroupinfo)> *) groupList, (unsigned long long) nextFlag, ([ZIMError](#zimerror)) errorInfo);"
...
| nextFlag | unsigned long long | pagination anchor. |
...
| errorInfo | [ZIMError](#zimerror) | Insert the error code for the local message. 0 means inserting the message successfully, non-0 means inserting the message failed. If there is a failure to insert the message, the developer should check the https://doc-zh.zego.im/zim-android/sdk-error-codes/zim to query the solution. |
...
| errorInfo | [ZIMError](#zimerror) * | The error code of the message reaction addition. 0 represents the operation success, non-0 represents the operation failure, please refer to the Error codes doc (https://www.zegocloud.com/docs/zim-ios/sdk-error-codes/zim) for solutions. |
...
<ParamField
  name="ZIMMessageReactionsAllDeletedCallback"
  prototype="void(^[ZIMMessageReactionsAllDeletedCallback](#zimmessagereactionsalldeletedcallback))(([ZIMError](#zimerror) *) errorInfo);"
  desc="The delete of return for message reactions."
  parent_name="ZIMDefines"
  parent_type="class">
**Parameters**
...
Related API: [deleteMessageAllReactions]
</Note>
</ParamField>
<ParamField
  name="ZIMMessageReactionUserListQueriedCallback"
  prototype="void(^[ZIMMessageReactionUserListQueriedCallback](#zimmessagereactionuserlistqueriedcallback))(([ZIMMessage](#zimmessage) *) message, (NSArray<[ZIMMessageReactionUserFullInfo](#zimmessagereactionuserfullinfo)> *) userInfoList, (NSString *) reactionType, (long long) nextFlag, (int) totalCount, ([ZIMError](#zimerror) *) error);"
...
| userInfoList | NSArray\<[ZIMMessageReactionUserFullInfo](#zimmessagereactionuserfullinfo)\> * | Query the detailed list of users' reactions. |
...
| error | [ZIMError](#zimerror) * | Error information. |
...
| conversationID | NSString * | ConversationID. |
| conversationType | [ZIMConversationType](./enum#zimconversationtype) | Conversation Type. |
| errorInfo | [ZIMError](#zimerror) | Set the error code of the receipt conversation read. 0 indicates that the setting is successful, and non-zero indicates that the setting fails. If the setting fails, the developer should check the [official website error code document](https://doc-zh.zego.im/zim-ios/sdk-error-codes/zim) for solutions. |
...
| errorInfo | [ZIMError](#zimerror) | Set the error code of the receipt message read. 0 indicates that the setting is successful, and non-zero indicates that the setting fails. If the setting fails, the developer should check the [official website error code document](https://doc-zh.zego.im/zim-ios/sdk-error-codes/zim) for solutions. |
...
| errorInfo | [ZIMError](#zimerror) | Query the error code of the message receipt. 0 means the query is successful, and non-zero means the query failed. If the query fails, the developer should check the [official website error code document](https://doc-zh.zego.im/zim-ios/sdk-error-codes/zim) for solutions. |
...
| errorInfo | [ZIMError](#zimerror) | Set the error code returned by querying the group member list. 0 means the query is successful, and non-zero means the query failed. If the query fails, the developer should check the [official website error code document](https://doc-zh.zego.im/zim-ios/sdk-error-codes/zim) for solutions. |
...
| --- | --- | --- |
| message | [ZIMMessage](#zimmessage) | Message object. |
| errorInfo | [ZIMError](#zimerror) | Retraction notice. 0 representative withdraw successfully, non 0 withdraw unsuccessful. When the withdrawal fails, the developer responds to the [official website](https://doc-zh.zego.im/zim-ios/sdk-error-codes/zim) Review the solution. |
...
| errorInfo | [ZIMError](#zimerror) * | Error code for querying room user attributes. 0 means the query of room user attributes is successful, non-0 means the query of room user attributes fails. If there is a failure to query the room user attributes, the developer should check the https://doc-zh.zego.im/zim-android/sdk-error-codes/zim query solution. |
...
<ParamField
  ...
  parent_name="ZIMLoginConfig"
  parent_type="class">
User-defined custom status duration, in seconds. The default expiration time is 1 day. If -1 is passed, it becomes permanently valid. During login, if this field is an empty string (which is the default), the current user's custom status will not be modified, and this field is also considered invalid.
</ParamField>
...
<ParamField
  name="sumCount"
  prototype="public unsigned int sumCount"
  parent_name="ZIMMessageReaction"
  parent_type="class">
...
<ParamField
  name="increaseCount"
  prototype="public unsigned int increaseCount"
...
<ParamField
  ...
  prototype="public NSArray<[ZIMMessageReactionUserChangeInfo](#zimmessagereactionuserchangeinfo)> * userChangeInfoList"
  parent_name="ZIMMessageReactionChangeInfo"
  parent_type="class">
user change list.
</ParamField>
...
<ParamField
  name="reactions"
  prototype="public NSArray<[ZIMMessageReactionSimpleInfo](#zimmessagereactionsimpleinfo)> * reactions"
  parent_name="ZIMMessageReactionUserFullInfo"
  parent_type="class">
...
<ParamField
  name="changeInfoList"
  prototype="public [ZIMMessageReactionChangeInfo](#zimmessagereactionchangeinfo)[] changeInfoList"
  parent_name="ZIMMessageReactionsChangedEventResult"
  parent_type="class">
change info list.
</ParamField>
...
<ParamField
  ...
  prototype="public NSArray<int> * failedIndexList"
  parent_name="ZIMMultipleMessage"
  parent_type="class">
...
<ParamField
  name="threadID"
  prototype="public NSString * threadID"
  parent_name="ZIMPushConfig"
  parent_type="class">
...
Update user custom status configuration.
...
<ParamField
  ...
  parent_type="class">
User-defined custom status duration, in seconds. The default expiration time is 1 day. If -1 is passed, it becomes permanently valid.
</ParamField>
...
<ParamField
  ...
  parent_name="ZIMUserStatus"
  parent_type="class">
User-defined custom state expiration timestamp. A value of -1 indicates it never expires.
</ParamField>
