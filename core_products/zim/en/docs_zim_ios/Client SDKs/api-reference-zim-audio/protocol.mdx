...
| Name | Type | Description |
| --- | --- | --- |
| eventHandler | id\<[ZIMAudioEventHandler](#zimaudioeventhandler)\> | Event notification callback. If the eventHandler is set to [null], all the callbacks set previously will be cleared. Developers should monitor the corresponding callbacks according to their own business scenarios. The main callback functions of the SDK are here. |
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioRecordConfig](./class#zimaudiorecordconfig) | Record config |
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioPlayConfig](./class#zimaudioplayconfig) | Play config |
