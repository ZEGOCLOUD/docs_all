...
<ParamField
  name="setAdvancedConfigWithKey"
  prototype="+ (void)setAdvancedConfig:(NSString *) key :(NSString *) value;"
...
| --- | --- | --- |
| key | NSString * | Key of the advanced configuration |
| value | NSString * | Value of the advanced configuration |
...
<ParamField
  ...
  prototype="- (void)init:(NSString *) license;"
...
| Name | Type | Description |
| --- | --- | --- |
| license | NSString * | License information. If the developer has not obtained it through the server-side API, an empty string can be passed in, but subsequent use of features requiring a license will be restricted. |
...
<ParamField
  ...
  prototype="- (void)setEventHandler:(id<[ZIMAudioEventHandler](#zimaudioeventhandler)>) eventHandler;"
...
| Name | Type | Description |
| --- | --- | --- |
| eventHandler | id\<[ZIMAudioEventHandler](#zimaudioeventhandler)\> | Event notification callback. Pass [null] to clear the previously set callback. Developers should listen to the corresponding callbacks based on their business scenarios. The main SDK callback functions are all here. |
...
| Name | Type | Description |
| --- | --- | --- |
| enable | BOOL | Whether to enable noise suppression; true to enable, false to disable |
...
| Name | Type | Description |
| --- | --- | --- |
| enable | BOOL | Whether to enable automatic gain control; true to enable, false to disable |
...
<ParamField
  name="setANSParam"
  prototype="- (void)setANSParam:([ZIMAudioANSParam](./class#zimaudioansparam)) param;"
...
| Name | Type | Description |
| --- | --- | --- |
| param | [ZIMAudioANSParam](./class#zimaudioansparam) | ANS parameters, including ANS mode |
...
<ParamField
  name="startRecordWithConfig"
  prototype="- (void)startRecord:([ZIMAudioRecordConfig](./class#zimaudiorecordconfig)) config;"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioRecordConfig](./class#zimaudiorecordconfig) | Recording configuration |
...
<ParamField
  name="startPlayWithConfig"
  prototype="- (void)startPlay:([ZIMAudioPlayConfig](./class#zimaudioplayconfig)) config;"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioPlayConfig](./class#zimaudioplayconfig) | Playback parameters |
...
<ParamField
  name="onError"
  prototype="- (void)onError:([ZIMAudioError](./class#zimaudioerror)) errorInfo;"
  desc="SDK error notification"
  parent_file="Declared in \`ZIMAudioEventHandler.h\`"
...
| Name | Type | Description |
| --- | --- | --- |
| errorInfo | [ZIMAudioError](./class#zimaudioerror) |  |
