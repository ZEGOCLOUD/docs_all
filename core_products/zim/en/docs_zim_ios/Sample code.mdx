...
<Card title="Sample Code" href="https://artifact-demo.zego.im/zim/example/ios/ZIMExampleLegacy.zip" target="_blank">Click here to get the complete sample code.</Card>
