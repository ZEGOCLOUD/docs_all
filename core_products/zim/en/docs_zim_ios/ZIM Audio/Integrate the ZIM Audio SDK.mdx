...
To solve this problem, you need to call [setAdvancedConfigWithKey](https://www.zegocloud.com/docs/article/api?doc=zim_API~objective-c_ios~class~ZIMAudio#set-advanced-config-with-key-key-value) of ZIM Audio SDK to align the audio_session_mix_with_others、audio_session_do_nothing configuration items with the Express SDK.
