...
<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/in_app_chat/17694_2.png" /></Frame>
...
<Accordion title="How to resolve abnormal issues such as volume fluctuation and long microphone usage time when using Express SDK and ZIM Audio SDK together?" defaultOpen="false">
&nbsp;&nbsp;&nbsp;&nbsp;Due to the configuration inconsistency between  Express SDK and ZIM Audio SDK, the `audio session` on iOS is repeatedly modified, resulting in abnormal phenomena.
To solve this problem, you need to call [setAdvancedConfigWithKey](https://doc-zh.zego.im/article/api?doc=zim_API~objective-c_ios~class~ZIMAudio#set-advanced-config-with-key-key-value) of ZIM Audio SDK to align the audio_session_mix_with_others、audio_session_do_nothing configuration items with the Express SDK.
