...
1. Refer to [Integrate APNs](./Integrate%20APNs.mdx) to get 2 offline push certificates for each of the 2 projects.
2. Refer to [How to configure Offline Push Certificates](https://www.zegocloud.com/docs/console/service-configuration/offline-push-config) to configure the 2 push certificates obtained above on the ZEGOCLOUD console.


<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/in_app_chat/17537.jpeg" /></Frame>
...
This step needs to be completed before calling the [registerAPNs](@registerAPNs) interface to register with APNs.
</Warning>
