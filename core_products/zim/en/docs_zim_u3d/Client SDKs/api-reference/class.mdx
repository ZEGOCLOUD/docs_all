...
| [ZIMAudioMessageLiteInfo](#zimaudiomessageliteinfo) | [ZIMCacheConfig](#zimcacheconfig) |
| [ZIMCallAcceptConfig](#zimcallacceptconfig) | [ZIMCallCancelConfig](#zimcallcancelconfig) |
| [ZIMCallEndConfig](#zimcallendconfig) | [ZIMCallInfo](#zimcallinfo) |
...
| [ZIMCallInvitationQueryConfig](#zimcallinvitationqueryconfig) | [ZIMCallInvitationReceivedInfo](#zimcallinvitationreceivedinfo) |
| [ZIMCallInvitationRejectedInfo](#zimcallinvitationrejectedinfo) | [ZIMCallInvitationSentInfo](#zimcallinvitationsentinfo) |
| [ZIMCallInviteConfig](#zimcallinviteconfig) | [ZIMCallJoinConfig](#zimcalljoinconfig) |
| [ZIMCallQuitConfig](#zimcallquitconfig) | [ZIMCallRejectConfig](#zimcallrejectconfig) |
| [ZIMCallUserInfo](#zimcalluserinfo) | [ZIMCombineMessage](#zimcombinemessage) |
...
| [ZIMLogConfig](#zimlogconfig) | [ZIMMediaDownloadConfig](#zimmediadownloadconfig) |
| [ZIMMediaMessage](#zimmediamessage) | [ZIMMediaMessageLiteInfo](#zimmediamessageliteinfo) |
| [ZIMMediaMessageSendNotification](#zimmediamessagesendnotification) | [ZIMMessage](#zimmessage) |
...
| [ZIMMessageQueryConfig](#zimmessagequeryconfig) | [ZIMMessageReactionUserQueryConfig](#zimmessagereactionuserqueryconfig) |
...
| [ZIMUserInfo](#zimuserinfo) | [ZIMUsersInfoQueryConfig](#zimusersinfoqueryconfig) |
...
<ParamField
  name="SetLogConfig"
  prototype="public static  void SetLogConfig([ZIMLogConfig](#zimlogconfig) config)"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMLogConfig](#zimlogconfig) | Log configuration object. |
...
<ParamField
  name="SetCacheConfig"
  prototype="public static  void SetCacheConfig([ZIMCacheConfig](#zimcacheconfig) config)"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMCacheConfig](#zimcacheconfig) | Cache configuration object. |
...
<ParamField
  name="Login"
  prototype="public abstract  void Login([ZIMUserInfo](#zimuserinfo) userInfo,string token,[ZIMLoggedInCallback](./interface#zimloggedincallback) callback)"
...
| Name | Type | Description |
| --- | --- | --- |
| userInfo | [ZIMUserInfo](#zimuserinfo) | Unique ID used to identify the user. Note that the userID must be unique under the same appID, otherwise mutual kicks out will occur.  <br/>Note: Do not set ZIMUserInfo.userAvatarUrl through this interface. |
...
<ParamField
  name="Login"
  prototype="public abstract  void Login([ZIMUserInfo](#zimuserinfo) userInfo,[ZIMLoggedInCallback](./interface#zimloggedincallback) callback)"
  desc="Login, you must log in before using all functions."
  parent_file="Declared in \`ZIM.cs\`"
  parent_name="ZIM"
  parent_type="class">
...
<ParamField
  ...
  prototype="public abstract  void QueryConversationList([ZIMConversationQueryConfig](#zimconversationqueryconfig) config,[ZIMConversationListQueriedCallback](./interface#zimconversationlistqueriedcallback) callback)"
...
<ParamField
  ...
  prototype="public  void QueryConversationPinnedList([ZIMConversationQueryConfig](#zimconversationqueryconfig) config,[ZIMConversationPinnedListQueriedCallback](./interface#zimconversationpinnedlistqueriedcallback) callback)"
...
<ParamField
  ...
  prototype="public abstract  void DeleteConversation(string conversationID,[ZIMConversationType](./enum#zimconversationtype) conversationType,[ZIMConversationDeleteConfig](#zimconversationdeleteconfig) config,[ZIMConversationDeletedCallback](./interface#zimconversationdeletedcallback) callback)"
...
<ParamField
  ...
  prototype="public abstract  void InsertMessageToLocalDB([ZIMMessage](#zimmessage) message,string conversationID,[ZIMConversationType](./enum#zimconversationtype) conversationType,string senderUserID,[ZIMMessageInsertedCallback](./interface#zimmessageinsertedcallback) callback)"
...
<ParamField
  ...
  prototype="public abstract  void SendMessageReceiptsRead(List<[ZIMMessage](#zimmessage)> messageList,string conversationID,[ZIMConversationType](./enum#zimconversationtype) conversationType,[ZIMMessageReceiptsReadSentCallback](./interface#zimmessagereceiptsreadsentcallback) callback)"
...
| Name | Type | Description |
| --- | --- | --- |
| messageList | List\<[ZIMMessage](#zimmessage)\> | The list of messages to be read with no more than 10 messages. |
| conversationID | string | Conversation ID. |
| conversationType | [ZIMConversationType](./enum#zimconversationtype) | Conversation type. |
...
<ParamField
  ...
  prototype="public abstract  void QueryMessageReceiptsInfo(List<[ZIMMessage](#zimmessage)> messageList,string conversationID,[ZIMConversationType](./enum#zimconversationtype) conversationType,[ZIMMessageReceiptsInfoQueriedCallback](./interface#zimmessagereceiptsinfoqueriedcallback) callback)"
...
| Name | Type | Description |
| --- | --- | --- |
| messageList | List\<[ZIMMessage](#zimmessage)\> | list of messages to query. |
| conversationID | string | Conversation ID. |
| conversationType | [ZIMConversationType](./enum#zimconversationtype) | Conversation type. |
...
<ParamField
  ...
  prototype="public abstract  void QueryGroupMessageReceiptReadMemberList([ZIMMessage](#zimmessage) message,string groupID,[ZIMGroupMessageReceiptMemberQueryConfig](#zimgroupmessagereceiptmemberqueryconfig) config,[ZIMGroupMessageReceiptMemberListQueriedCallback](./interface#zimgroupmessagereceiptmemberlistqueriedcallback) callback)"
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMessage](#zimmessage) | list of messages to query. |
...
<ParamField
  ...
  prototype="public abstract  void QueryGroupMessageReceiptUnreadMemberList([ZIMMessage](#zimmessage) message,string groupID,[ZIMGroupMessageReceiptMemberQueryConfig](#zimgroupmessagereceiptmemberqueryconfig) config,[ZIMGroupMessageReceiptMemberListQueriedCallback](./interface#zimgroupmessagereceiptmemberlistqueriedcallback) callback)"
  desc="Query the list of read members of the group."
  parent_file="Declared in \`ZIM.cs\`"
  parent_name="ZIM"
  parent_type="class">
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMessage](#zimmessage) | Message to query |
| groupID | string | Group ID. |
| config | [ZIMGroupMessageReceiptMemberQueryConfig](#zimgroupmessagereceiptmemberqueryconfig) | query configuration |
| callback | [ZIMGroupMessageReceiptMemberListQueriedCallback](./interface#zimgroupmessagereceiptmemberlistqueriedcallback) | Query the result callback of the specific read member list. |
...
<ParamField
  name="ReplyMessage"
  prototype="public  void ReplyMessage([ZIMMessage](#zimmessage) message,[ZIMMessage](#zimmessage) toOriginalMessage,[ZIMMessageSendConfig](#zimmessagesendconfig) config,[ZIMMessageSendNotification](#zimmessagesendnotification) notification,[ZIMMessageSentCallback](./interface#zimmessagesentcallback) callback)"
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMessage](#zimmessage) | The message to be sent. Only supports: ZIMTextMessage(1), ZIMImageMessage(11), ZIMFileMessage(12), ZIMAudioMessage(13), ZIMVideoMessage(14), ZIMCombineMessage(100), ZIMCustomMessage(200)." |
| toOriginalMessage | [ZIMMessage](#zimmessage) | The source message to be quoted. Only supports: ZIMTextMessage(1), ZIMImageMessage(11), ZIMFileMessage(12), ZIMAudioMessage(13), ZIMVideoMessage(14), ZIMCombineMessage(100), ZIMCustomMessage(200)." |
| config | [ZIMMessageSendConfig](#zimmessagesendconfig) | Related configuration for sending messages. |
| notification | [ZIMMessageSendNotification](#zimmessagesendnotification) | Related notifications when messages are sent. |
| callback | [ZIMMessageSentCallback](./interface#zimmessagesentcallback) | Callback of the sending result of the message. |
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMessage](#zimmessage) | The media file message to download. |
...
<ParamField
  name="RevokeMessage"
  prototype="public abstract  void RevokeMessage([ZIMMessage](#zimmessage) message,[ZIMMessageRevokeConfig](#zimmessagerevokeconfig) config,[ZIMMessageRevokedCallback](./interface#zimmessagerevokedcallback) callback)"
  desc="revoke message."
  parent_file="Declared in \`ZIM.cs\`"
  parent_name="ZIM"
  parent_type="class">
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMessage](#zimmessage) | The message needs to be revoke. |
...
<ParamField
  name="DeleteMessages"
  prototype="public abstract  void DeleteMessages(List<[ZIMMessage](#zimmessage)> messageList,string conversationID,[ZIMConversationType](./enum#zimconversationtype) conversationType,[ZIMMessageDeleteConfig](#zimmessagedeleteconfig) config,[ZIMMessageDeletedCallback](./interface#zimmessagedeletedcallback) callback)"
  desc="delete message."
  parent_file="Declared in \`ZIM.cs\`"
  parent_name="ZIM"
  parent_type="class">
...
| Name | Type | Description |
| --- | --- | --- |
| messageList | List\<[ZIMMessage](#zimmessage)\> | List of deleted messages. |
...
<ParamField
  ...
  prototype="public abstract  void AddMessageReaction(string reactionType,[ZIMMessage](#zimmessage) message,[ZIMMessageReactionAddedCallback](./interface#zimmessagereactionaddedcallback) callback)"
...
| message | [ZIMMessage](#zimmessage) | The message needs reaction. |
...
<ParamField
  ...
  prototype="public abstract  void DeleteMessageReaction(string reactionType,[ZIMMessage](#zimmessage) message,[ZIMMessageReactionDeletedCallback](./interface#zimmessagereactiondeletedcallback) callback)"
...
| message | [ZIMMessage](#zimmessage) | The message needs reaction delete. |
...
<ParamField
  ...
  prototype="publicabstract  void QueryMessageReactionUserList([ZIMMessage](#zimmessage) message,[ZIMMessageReactionUserQueryConfig](#zimmessagereactionuserqueryconfig) config,[ZIMMessageReactionUserListQueriedCallback](./interface#zimmessagereactionuserlistqueriedcallback) callback)"
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMessage](#zimmessage) | The message needs querying reaction user list. |
| config | [ZIMMessageReactionUserQueryConfig](#zimmessagereactionuserqueryconfig) | reaction user query config. |
...
<ParamField
  ...
  prototype="public abstract  void UpdateMessageLocalExtendedData(string localExtendedData,[ZIMMessage](#zimmessage) message,[ZIMMessageLocalExtendedDataUpdatedCallback](./interface#zimmessagelocalextendeddataupdatedcallback) callback)"
...
| message | [ZIMMessage](#zimmessage) | Message body to be updated |
...
<ParamField
  name="CreateRoom"
  prototype="public abstract  void CreateRoom([ZIMRoomInfo](#zimroominfo) roomInfo,[ZIMRoomCreatedCallback](./interface#zimroomcreatedcallback) callback)"
...
<ParamField
  name="CreateRoom"
  prototype="public abstract  void CreateRoom([ZIMRoomInfo](#zimroominfo) roomInfo,[ZIMRoomAdvancedConfig](#zimroomadvancedconfig) config,[ZIMRoomCreatedCallback](./interface#zimroomcreatedcallback) callback)"
...
<ParamField
  name="EnterRoom"
  prototype="public abstract  void EnterRoom([ZIMRoomInfo](#zimroominfo) roomInfo,[ZIMRoomAdvancedConfig](#zimroomadvancedconfig) config,[ZIMRoomEnteredCallback](./interface#zimroomenteredcallback) callback)"
...
<ParamField
  ...
  prototype="public abstract  void QueryRoomMemberList(string roomID,[ZIMRoomMemberQueryConfig](#zimroommemberqueryconfig) config,[ZIMRoomMemberQueriedCallback](./interface#zimroommemberqueriedcallback) callback)"
...
| config | [ZIMRoomMemberQueryConfig](#zimroommemberqueryconfig) | Configuration of query room member operation. |
...
<ParamField
  name="messageList"
  prototype="public [ZIMMessage](#zimmessage)[] messageList"
  parent_name="ZIMCombineMessage"
  parent_type="class">
...
<ParamField
  name="messageList"
  prototype="public std::vector<std::shared_ptr<[ZIMMessage](#zimmessage)>> messageList"
  parent_name="ZIMConversationSearchInfo"
  parent_type="class">
...
<ParamField
  name="OnError"
  prototype="public delegate  void OnError([ZIM](#zim) zim,[ZIMError](#zimerror) errorInfo)"
...
<ParamField
  ...
  prototype="public delegate  void OnUserInfoUpdated([ZIM](#zim) zim,[ZIMUserFullInfo](#zimuserfullinfo) info)"
...
<ParamField
  ...
  prototype="public delegate  void OnConversationChanged([ZIM](#zim) zim,List<[ZIMConversationChangeInfo](#zimconversationchangeinfo)> conversationChangeInfoList)"
...
| --- | --- | --- |
| zim | [ZIM](#zim) | ZIM instance. |
| conversationChangeInfoList | List\<[ZIMConversationChangeInfo](#zimconversationchangeinfo)\> | Changed information about the conversation. |
...
<ParamField
  ...
  prototype="public delegate  void OnBroadcastMessageReceived([ZIM](#zim) zim,[ZIMMessage](#zimmessage) message,ZIMEventOfBroadcastMessageReceivedResult data)"
...
| --- | --- | --- |
| zim | [ZIM](#zim) | ZIM instance. |
| message | [ZIMMessage](#zimmessage) |  Received message. |
...
<ParamField
  ...
  prototype="public delegate  void OnMessageReactionsChanged([ZIM](#zim) zim,List<[ZIMMessageReaction](./struct#zimmessagereaction)> reactions)"
...
| --- | --- | --- |
| zim | [ZIM](#zim) | ZIM instance. |
| reactions | List\<[ZIMMessageReaction](./struct#zimmessagereaction)\> | The list of changed reactions. |
...
<ParamField
  ...
  prototype="public delegate  void OnReceivePeerMessage([ZIM](#zim) zim,List\<[ZIMMessage](#zimmessage)> messageList,uint message_list_length,string fromUserID)"
...
| --- | --- | --- |
| zim | [ZIM](#zim) | ZIM instance. |
| messageList | List\<[ZIMMessage](#zimmessage)\> | List of received messages. |
| message_list_length | uint | The length of the message list. |
...
<ParamField
  ...
  prototype="public delegate  void OnReceiveRoomMessage([ZIM](#zim) zim,List<[ZIMMessage](#zimmessage)> messageList,uint message_list_length,string fromRoomID)"
...
<ParamField
  ...
  prototype="public delegate  void OnMessageRepliedInfoChanged([ZIM](#zim) zim,List\<[ZIMMessage](#zimmessage)> messageList)"
...
<ParamField
  ...
  prototype="public delegate  void OnReceiveGroupMessage([ZIM](#zim) zim,List\<[ZIMMessage](#zimmessage)> messageList,uint message_list_length,string fromGroupID)"
...
<ParamField
  ...
  prototype="public delegate  void OnRoomMemberJoined([ZIM](#zim) zim,List<[ZIMUserInfo](#zimuserinfo)> memberList,string roomID)"
...
| --- | --- | --- |
| zim | [ZIM](#zim) | ZIM instance. |
| memberList | List\<[ZIMUserInfo](#zimuserinfo)\> | List of members who joined the room. |
...
<ParamField
  ...
  prototype="public delegate  void OnRoomMemberLeft([ZIM](#zim) zim,List<[ZIMUserInfo](#zimuserinfo)> memberList,string roomID)"
...
| --- | --- | --- |
| zim | [ZIM](#zim) | ZIM instance. |
| memberList | List\<[ZIMUserInfo](#zimuserinfo)\> | List of members who left the room. |
| roomID | string | The ID of the room where this event occurred. |
