...
The ZIM SDK supports recalling messages you have sent in one-on-one or group chat sessions. In group chats, administrators can recall messages sent by regular members, and the group owner can recall messages sent by any member.

<Frame width="auto" height="auto">
  <img src="https://media-resource.spreading.io/docuo/workspace740/af061ebc6eaf0f12ae9e7f72235bd04e/111c83ad6a.png" alt="Recall messages.png"/>
</Frame>
