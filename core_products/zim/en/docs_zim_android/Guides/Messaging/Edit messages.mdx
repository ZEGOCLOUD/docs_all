...
- Editing a message triggers the server-side [pre-message sending callback](https://www.zegocloud.com/docs/zim-server/callbacks/message-not-sent-yet) and [post-message sending callback](https://www.zegocloud.com/docs/zim-server/callbacks/message-sent).
