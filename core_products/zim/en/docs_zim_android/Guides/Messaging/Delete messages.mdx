...
By default, a deletion operation only takes effect for the current user. To make the specified messages invisible to all members in the conversation, refer to [Delete for Everyone](#delete-for-everyone).
:::
