...
// For one-to-one conversations, toConversationID is the userID of the other party; for group conversations, toConversationID is the groupID; for room conversations, toConversationID is the roomID
...
// For one-to-one conversations, conversationID is the userID of the other party; for group conversations, conversationID is the groupID; for room conversations, conversationID is the roomID
const conversationID = 'xxxx';
