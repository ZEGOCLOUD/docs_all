...
After setting the mute, the client will receive the {getPlatformData(props,conversationChangedMap)} notification event on the operation end and multi-end online devices.
