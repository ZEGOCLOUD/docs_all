...
<Frame width="auto" height="auto">
  <img src="https://media-resource.spreading.io/docuo/workspace740/af061ebc6eaf0f12ae9e7f72235bd04e/7df615ee9b.png" alt="Session marker.png"/>
</Frame>
...
- The maximum number of marks allowed for a single conversation is specified differently across ZIM SDK versions:
    - **SDK Version ≥ 2.27.0**： Up to 60 marks.
    - **SDK Version ≥ 2.19.0 and < 2.27.0**: Up to 30 marks.  
