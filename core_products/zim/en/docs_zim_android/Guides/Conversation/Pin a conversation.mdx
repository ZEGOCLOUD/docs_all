...
export const pinnedTimeMap = {
  'Android': <a href='@-ZIMConversation' target='_blank'>pinnedTime</a>,
  'Flutter': <a href='https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMConversation/pinnedTime.html' target='_blank'>pinnedTime</a>,
}
...
<Frame width="auto" height="auto">
  <img src="https://media-resource.spreading.io/docuo/workspace740/af061ebc6eaf0f12ae9e7f72235bd04e/06745bec33.png" alt="Pinned conversation.png"/>
</Frame>
...
- Pinned conversations record the time when the conversation is pinned, and the pinned conversations can be sorted by the pinned time.

    When a conversation is pinned, the time stamp at that time is recorded {getPlatformData(props,pinnedTimeMap)}, and {getPlatformData(props,pinnedTimeMap)} is 0 for unpinned and unpinned conversations.
