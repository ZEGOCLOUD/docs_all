...
export const onRoomAttributesUpdatedMap = {
  ...
  'iOS': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objectivec_ios~protocol~ZIMEventHandler#zim-room-attributes-updated-room-id' target='_blank'>roomAttributesUpdated</a>,
  'mac': <a href='https://doc-zh.zego.im/article/api?doc=zim_API~objectivec_macos~protocol~ZIMEventHandler#zim-room-attributes-updated-room-id' target='_blank'>roomAttributesUpdated</a>,
}
