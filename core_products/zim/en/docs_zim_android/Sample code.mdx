...
* Android Studio 2.1 or later.
    <Note title="Note">
    - When you compile the sample code for the first time, if you do not have the corresponding dependent library or build tool, Android Studio will automatically download the required dependency files. This may take a while for you to wait. 
...
<Card title="Sample Code" href="https://artifact-demo.zego.im/zim/example/android/ZIMExampleJava.zip" target="_blank">Click here to get the complete sample code.</Card>
...
2. Open the `ZIMExampleJava` folder in the unzipped sample code package. 
    ...
    <Frame width="512" height="auto" caption="">
    <img src="https://doc-media.zego.im/sdk-doc/Pics/ZIM/Android/ZIMExampleJava.jpeg" />
    </Frame>
