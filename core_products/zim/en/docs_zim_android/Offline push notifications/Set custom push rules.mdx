...
export const onUserRuleUpdatedMap = {
  ...
  'Web': <a href='@userRuleUpdated' target='_blank'>userRuleUpdated</a>,
  'iOS': <a href='https://www.zegocloud.com/docs/article/api?doc=zim_API~objective-c_ios~protocol~ZIMEventHandler#zim-user-rule-updated' target='_blank'>userRuleUpdated</a>,
  'mac': <a href='https://www.zegocloud.com/docs/article/api?doc=zim_API~objective-c_macos~protocol~ZIMEventHandler#zim-user-rule-updated' target='_blank'>userRuleUpdated</a>,
