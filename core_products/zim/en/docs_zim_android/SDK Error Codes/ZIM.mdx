...
| 6000230 | The message was intercepted by the developer's server through the [Callback on message not sent yet](./../../docs_zim_server/Callbacks/Message%20not%20sent%20yet.mdx). No processing required.|
