...
|-----|-----|-----|
| Delete messages for all members | Supports deleting messages for everyone in group chats. After deletion, the message is seamlessly deleted for all group members. For details, refer to [Delete messages - Delete messages for everyone](./../Guides/Messaging/Delete%20messages.mdx#delete-messages-for-everyone) | [deleteMessages](@deleteMessages) |
