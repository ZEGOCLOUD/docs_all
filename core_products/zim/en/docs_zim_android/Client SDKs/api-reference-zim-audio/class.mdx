...
| Name | Type | Description |
| --- | --- | --- |
| eventHandler | [ZIMAudioEventHandler](#zimaudioeventhandler) | Event notification callback. If the eventHandler is set to [null], all the callbacks set previously will be cleared. Developers should monitor the corresponding callbacks according to their own business scenarios. The main callback functions of the SDK are here. |
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioRecordConfig](./struct#zimaudiorecordconfig) | Record config |
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioPlayConfig](./struct#zimaudioplayconfig) | Play config |
