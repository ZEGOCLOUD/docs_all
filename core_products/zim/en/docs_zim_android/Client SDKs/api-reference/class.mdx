...
<ParamField
  name="updateUserCustomStatus"
  prototype="ZIMUserCustomStatusUpdatedResult updateUserCustomStatus(String customStatus, [ZIMUserCustomStatusUpdateConfig](./struct#zimusercustomstatusupdateconfig) config, [ZIMUserCustomStatusUpdatedCallback](./interface#zimusercustomstatusupdatedcallback) callback)"
  desc="It is used to update the user-defined status."
  parent_file="Declared in \`ZIM.java\`"
  parent_name="ZIM"
  parent_type="class"
...
| --- | --- | --- |
| customStatus | String | Description: User-defined status. The default maximum value is 64 bytes. The default expiration time is 1 day. At login, if the field is an empty string (which is the default), the current user's custom state is not modified. |
| config | [ZIMUserCustomStatusUpdateConfig](./struct#zimusercustomstatusupdateconfig) | The config of the custom status update. |
| callback | [ZIMUserCustomStatusUpdatedCallback](./interface#zimusercustomstatusupdatedcallback) | The callback of the custom status update. |
...
| Name | Type | Description |
| --- | --- | --- |
| badge | int | Detailed description: The number of badges that need to be set. |
| callback | [ZIMUserBadgeUpdatedCallback](./interface#zimuserbadgeupdatedcallback) | The result of the update badges. |
...
- **Restrictions**: Available after login, unavailable after logout. UserIDs support a maximum of 100 users. Cannot reuse a groupID that has been previously used to create a group, regardless of whether the original group has been disbanded.
</Warning>
</ParamField>
<ParamField
...
- **Caution**: Available after login, unavailable after logout. UserIDs can have a maximum of 100 users and a group can have a maximum of 500 users. Cannot reuse a groupID that has been previously used to create a group, regardless of whether the original group has been disbanded.
- **Related callbacks**: The result of creating the group is obtained through the [ZIMGroupCreatedCallback] callback.
...
| Name | Type | Description |
| --- | --- | --- |
| count | int | Number of paged queries. |
| config | [ZIMGroupListQueryConfig](./struct#zimgrouplistqueryconfig) | Query parameter configuration. |
...
| config | [ZIMGroupListQueryConfig](./struct#zimgrouplistqueryconfig) | Query configuration parameters. |
| callback | [ZIMGroupListQueriedCallback](./interface#zimgrouplistqueriedcallback) | Callback for querying the result of the group list. |
...
| config | [ZIMMessagePinConfig](./struct#zimmessagepinconfig) | Message pin configuration object. |
...
| config | [ZIMMessageReactionAddConfig](./struct#zimmessagereactionaddconfig) | Add the configuration for reaction. |
...
| callback | [ZIMMessageReactionsAllDeletedCallback](./interface#zimmessagereactionsalldeletedcallback) | Returns the result of revoking the message. |
...
| --- | --- | --- |
| zim | [ZIM](#zim) | ZIM instance. |
| result | [ZIMMessageReactionsChangedEventResult](./struct#zimmessagereactionschangedeventresult) | The result of the reaction change. |
