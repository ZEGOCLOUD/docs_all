...
| [ZIMGroupListQueryConfig](#zimgrouplistqueryconfig) | [ZIMGroupMemberCountQueriedResult](#zimgroupmembercountqueriedresult) |
...
| [ZIMLogoutConfig](#zimlogoutconfig) | [ZIMMediaMessage](#zimmediamessage) |
...
<Warning title="Deprecated">Deprecated since version 2.14.0. To obtain the URL of a group member's avatar, please refer to userAvatarUrl.</Warning>
</ParamField>
<ParamField
...
Logout-related parameters.

<Note title="">
- **Use cases**: Used to set different parameters during logout.
</Note>
...
<ParamField
  ...
  parent_type="class">
Whether to clear DB data when logout.
...
<ParamField
  ...
  parent_type="class">
The flag of the paging query. For the first query, set this field to an empty string. If the "nextFlag" field of the [ZIMMessageReactionUserListQueriedResult] callback is not an empty string, it needs to be set here to continue the query on the next page.
...
<Warning title="Deprecated">Deprecated in version 2.14.0. To obtain the URL of a user's avatar, please refer to userAvatarUrl from the baseInfo.</Warning>
</ParamField>
<ParamField
  name="extendedData"
  prototype="extendedData: string "
...
<ParamField
  ...
  parent_name="ZPNsConfig"
  parent_type="class">
storageBucket of firebase config.
</ParamField>
<ParamField
  ...
  parent_name="ZPNsConfig"
  parent_type="class">
messagingSenderId of firebase config.
</ParamField>
<ParamField
  name="appId"
...
<ParamField
  ...
  parent_name="ZPNsConfig"
  parent_type="class">
measurementId of firebase config.
</ParamField>
<ParamField
  name="vapidKey"
...
<ParamField
  ...
  parent_type="class">
The notification title of the message.
</ParamField>
<ParamField
  name="content"
  prototype="content: string "
  parent_name="ZPNsMessage"
  parent_type="class">
The notification content of the message.
</ParamField>
<ParamField
  name="extras"
  ...
  parent_name="ZPNsMessage"
  parent_type="class">
The notification extra data of the message.
</ParamField>
