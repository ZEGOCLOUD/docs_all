...
Related reference: For details, please refer to Authentication (https://www.zegocloud.com/docs/zim-web/guides/users/authentication).
</Note>
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMLogoutConfig](./interface#zimlogoutconfig) | Log out of the configuration object. |
