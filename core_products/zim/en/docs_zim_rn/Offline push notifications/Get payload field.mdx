...
- Before using the ZPNs SDK, please configure the ZIM offline push certificate in the [ZEGO Admin Console](https://console.zego.im) (for details, please refer to [Project Management- IM- Offline Push Configuration](https://www.zegocloud.com/docs/uikit/video-conference-kit-rn/customize-prebuilt-features/customize-the-menu-bar)), If it cannot be configured, please contact ZEGOCLOUD technical support.
</Warning>
