...
<Card title="Sample Code" href="https://artifact-demo.zego.im/zim/example/react-native/ZIMReactNativeExample.zip" target="_blank">Click here to get the complete sample code.</Card>
