...
| [ZIMAudioEventHandler](#zimaudioeventhandler) | [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress) |
| [ZIMMessageExportingProgress](#zimmessageexportingprogress) | [ZIMMessageImportingProgress](#zimmessageimportingprogress) |
...
<ParamField
  name="getVersion"
  prototype="  getVersion(): Promise&lt;string&gt;"
...
<ParamField
  ...
  prototype="  setGeofencingConfig(areaList: number[], type: [ZIMGeofencingType](./enum#zimgeofencingtype)): Promise&lt;boolean&gt;"
...
<ParamField
  name="setCacheConfig"
  prototype="  setCacheConfig(config: [ZIMCacheConfig](./interface#zimcacheconfig)): void"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMCacheConfig](./interface#zimcacheconfig) | Cache configuration object. |
...
<ParamField
  name="updateUserCustomStatus"
  prototype="  updateUserCustomStatus(customStatus: string, callback: ZIMUserCustomStatusUpdatedCallback): [ZIMUserCustomStatusUpdatedResult](./interface#zimusercustomstatusupdatedresult)"
  desc="It is used to update the user-defined status."
  parent_name="ZIM"
  parent_type="class"
  anchor_suffix="1">
...
Related reference: For details, please refer to Authentication (https://www.zegocloud.com/docs/zim-rn/guides/users/authentication).
</Note>
...
<ParamField
  ...
  prototype="  updateUserBadge(badge: number): Promise&lt;void&gt;"
...
| Name | Type | Description |
| --- | --- | --- |
| badge | number | Detailed description: The number of badges that need to be set. |
...
| Name | Type | Description |
| --- | --- | --- |
| count | number | Number of paged queries. |
| config | [ZIMGroupListQueryConfig](./interface#zimgrouplistqueryconfig) | Query parameter configuration. |
...
| config | [ZIMGroupListQueryConfig](./interface#zimgrouplistqueryconfig) | Query configuration parameters. |
...
<ParamField
  name="pinMessage"
  prototype="  pinMessage(message: [ZIMMessage](./interface#zimmessage), isPinned: boolean, config?: [ZIMMessagePinConfig](./interface#zimmessagepinconfig), callback: ZIMMessagePinnedCallback): Promise&lt;[ZIMMessagePinnedResult](./interface#zimmessagepinnedresult)&gt;"
...
| config | [ZIMMessagePinConfig](./interface#zimmessagepinconfig) | Message pin configuration object. |
...
<ParamField
  ...
  prototype="  clearLocalFileCache(config: [ZIMFileCacheClearConfig](./interface#zimfilecacheclearconfig)): Promise&lt;void&gt;"
...
<ParamField
  ...
  prototype="  queryLocalFileCache(config: [ZIMFileCacheQueryConfig](./interface#zimfilecachequeryconfig)): Promise&lt;[ZIMFileCacheQueriedResult](./interface#zimfilecachequeriedresult)&gt;"
...
<ParamField
  ...
  prototype="  exportLocalMessages(folderPath: string, config: [ZIMMessageExportConfig](./interface#zimmessageexportconfig), progress: [ZIMMessageExportingProgress](#zimmessageexportingprogress)): Promise&lt;void&gt;"
...
| config | [ZIMMessageExportConfig](./interface#zimmessageexportconfig) | Export the configuration of the message. |
| progress | [ZIMMessageExportingProgress](#zimmessageexportingprogress) | Return of export message progress. |
...
<ParamField
  ...
  prototype="  importLocalMessages(folderPath: string, config: [ZIMMessageImportConfig](./interface#zimmessageimportconfig), progress: [ZIMMessageImportingProgress](#zimmessageimportingprogress)): Promise&lt;void&gt;"
...
| config | [ZIMMessageImportConfig](./interface#zimmessageimportconfig) | Import the configuration of the message. |
| progress | [ZIMMessageImportingProgress](#zimmessageimportingprogress) | Return of import message progress. |
...
<ParamField
  ...
  prototype="  downloadMediaFile(message: [ZIMMessage](./interface#zimmessage), fileType: [ZIMMediaFileType](./enum#zimmediafiletype), config: [ZIMMediaDownloadConfig](./interface#zimmediadownloadconfig), progress: [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress)): Promise&lt;[ZIMMediaDownloadedResult](./interface#zimmediadownloadedresult)&gt;"
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMessage](./interface#zimmessage) | The media file message to download. |
| fileType | [ZIMMediaFileType](./enum#zimmediafiletype) | Media file type. |
| config | [ZIMMediaDownloadConfig](./interface#zimmediadownloadconfig) | Download the configuration object. |
| progress | [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress) | Progress callback for downloading media files. |
...
<ParamField
  name="downloadMediaFile"
  prototype="  downloadMediaFile(message: [ZIMMediaMessage](./interface#zimmediamessage), fileType: [ZIMMediaFileType](./enum#zimmediafiletype), progress: [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress)): Promise&lt;[ZIMMediaDownloadedResult](./interface#zimmediadownloadedresult)&gt;"
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMediaMessage](./interface#zimmediamessage) | The media message to download. |
| fileType | [ZIMMediaFileType](./enum#zimmediafiletype) | Media file type. |
| progress | [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress) | Progress callback for downloading media files. |
...
| config | [ZIMMessageReactionAddConfig](./interface#zimmessagereactionaddconfig) | Add the configuration for reaction. |
...
<ParamField
  ...
  prototype="  deleteMessageAllReactions(message: [ZIMMessage](./interface#zimmessage)): Promise&lt;void&gt;"
...
<ParamField
  ...
  prototype="  setAdvancedConfig(key: string, value: string): Promise&lt;void&gt;"
...
<ParamField
  name="sharedInstance"
  prototype="  sharedInstance(): [ZIMAudio](#zimaudio)"
...
<ParamField
  name="init"
  prototype="  init(license?: string): Promise&lt;void&gt;"
...
<ParamField
  name="initWithLicense"
  prototype="  initWithLicense(license?: string): Promise&lt;void&gt;"
  desc="Initialize ZIM Audio SDK"
  parent_name="ZIMAudio"
  parent_type="class">
**Parameters**
...
<ParamField
  name="enableANS"
  prototype="  enableANS(enable: boolean): Promise&lt;void&gt;"
...
<ParamField
  name="enableAGC"
  prototype="  enableAGC(enable: boolean): Promise&lt;void&gt;"
...
<ParamField
  name="setANSParam"
  prototype="  setANSParam(param: [ZIMAudioANSParam](./interface#zimaudioansparam)): Promise&lt;void&gt;"
...
| Name | Type | Description |
| --- | --- | --- |
| param | [ZIMAudioANSParam](./interface#zimaudioansparam) | ANS parameter |
...
<ParamField
  name="startRecord"
  prototype="  startRecord(config: [ZIMAudioRecordConfig](./interface#zimaudiorecordconfig)): Promise&lt;void&gt;"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioRecordConfig](./interface#zimaudiorecordconfig) | Audio recording configuration.  |
...
<ParamField
  name="completeRecord"
  prototype="  completeRecord(): Promise&lt;void&gt;"
...
<ParamField
  name="cancelRecord"
  prototype="  cancelRecord(): Promise&lt;void&gt;"
...
<ParamField
  name="isRecording"
  prototype="  isRecording(): Promise&lt;boolean&gt;"
...
<ParamField
  ...
  prototype="  setAudioRouteType(routeType: [ZIMAudioRouteType](./enum#zimaudioroutetype)): Promise&lt;void&gt;"
...
<ParamField
  name="startPlay"
  prototype="  startPlay(config: [ZIMAudioPlayConfig](./interface#zimaudioplayconfig)): Promise&lt;void&gt;"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioPlayConfig](./interface#zimaudioplayconfig) | Audio playing configuration. |
...
<ParamField
  name="stopPlay"
  prototype="  stopPlay(): Promise&lt;void&gt;"
...
<ParamField
  name="isPlaying"
  prototype="  isPlaying(): Promise&lt;boolean&gt;"
...
| Name | Type | Description |
| --- | --- | --- |
| errorInfo | [ZIMAudioError](./interface#zimaudioerror) | Error information. |
...
<ParamField
  ...
  prototype="  [ZIMMediaDownloadingProgress](#zimmediadownloadingprogress)(message: [ZIMMediaMessage](./interface#zimmediamessage), currentFileSize: number, totalFileSize: number): void"
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZIMMediaMessage](./interface#zimmediamessage) | The message object for the current file download. |
...
<ParamField
  ...
  prototype="  [ZIMMessageExportingProgress](#zimmessageexportingprogress)(exportedMessageCount: number, totalMessageCount: number): void"
...
<ParamField
  ...
  prototype="  [ZIMMessageImportingProgress](#zimmessageimportingprogress)(importedMessageCount: number, totalMessageCount: number): void"
...
| Name | Type | Description |
| --- | --- | --- |
| handler | (message: [ZPNsMessage](./interface#zpnsmessage)) =\> void | Function to receive offline silent push notifications. |
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZPNsLocalMessage](./interface#zpnslocalmessage) | Message object for creating local notifications. |
...
Detailed description: For Android 8.0 or later, you can invoke this API to create a notification channel. For details, please refer to [Google Official document](https://developer.android.google.com/develop/ui/views/notifications/channels?hl=en)  .
</ParamField>
<ParamField
  name="enableDebug"
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZPNsRegisterConfig](./interface#zpnsregisterconfig) | Offline push configuration object. |
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZPNsConfig](./interface#zpnsconfig) | ZPNs configuration data class. |
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZPNsMessage](./interface#zpnsmessage) | the ZPNs message data class. |
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZPNsMessage](./interface#zpnsmessage) | ZPNs message object. |
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZPNsRegisterMessage](./interface#zpnsregistermessage) | Offline push message object. |
...
| Name | Type | Description |
| --- | --- | --- |
| message | [ZPNsMessage](./interface#zpnsmessage) | ZPNs message class. |
