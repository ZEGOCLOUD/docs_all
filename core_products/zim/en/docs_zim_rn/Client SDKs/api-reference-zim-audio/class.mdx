...
<ParamField
  ...
  desc="Registers Audio event notification callback"
  parent_name="ZIMAudio"
  parent_type="class">
**Parameters**
...
| --- | --- | --- |
| type | K | Event type. |
| listener | [ZIMAudioEventHandler](#zimaudioeventhandler)[K] | Custom callback method after an event occurs. |
...
<ParamField
  ...
  desc="Unregisters Audio event notification callback"
  parent_name="ZIMAudio"
  parent_type="class">
**Parameters**
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioRecordConfig](./interface#zimaudiorecordconfig) | Recording configuration |
...
| Name | Type | Description |
| --- | --- | --- |
| config | [ZIMAudioPlayConfig](./interface#zimaudioplayconfig) | Playback parameters |
...
| Name | Type | Description |
| --- | --- | --- |
| totalDuration | number | Total playback duration in milliseconds |
...
| Name | Type | Description |
| --- | --- | --- |
| currentDuration | number | Current playback duration in milliseconds |
