...
| AI Voice Changer | "Conan's Voice Changer Tie" in real-time calls, perfectly reproducing the target role's timbre and rhythm while retaining the user's speech rate, emotion, and tone, switching timbres at will, with ultra-low latency. | <ul><li>Social voice chat</li><li>Live streaming</li><li>Game voice</li></ul> |
...
| Video Screen Rotation | When users use mobile devices for live streaming or video calls, they can adopt different video capture directions, and can adapt and adjust according to the camera direction and angle of the peer user. | Multi-type device video call, live streaming scenarios that require the best video playback angle. |
