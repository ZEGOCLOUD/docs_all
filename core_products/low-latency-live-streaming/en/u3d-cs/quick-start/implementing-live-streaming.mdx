...
<Note title="Note">
If you need to understand Express-related microphone/audio/speaker interfaces, please refer to [FAQ - How to implement switching camera/video screen/microphone/audio/speaker?](https://www.zegocloud.com/docs/faq/device-switching).
</Note>
...
- Live streaming is not enabled by default. Please enable it by yourself in the ZEGOCLOUD Console or contact ZEGOCLOUD Technical Support. For details, please refer to [Enable Service](#enable-service).
...
- [Does the SDK support automatic reconnection?](https://www.zegocloud.com/docs/faq/express-reconnect)
- [In live streaming scenarios, how to listen for remote viewer role users logging in/logout of rooms?](https://www.zegocloud.com/docs/faq/audience-room-events)
- [How to adjust the camera focal length (zoom function)?](https://www.zegocloud.com/docs/faq/camera-focus-adjustment)

- [Why can't I open the camera?](https://www.zegocloud.com/docs/faq/camera-access-failure)

- [How to ensure smooth audio and video in poor network environments (flow control function)?](https://www.zegocloud.com/docs/faq/flow-control-in-weak-network)
