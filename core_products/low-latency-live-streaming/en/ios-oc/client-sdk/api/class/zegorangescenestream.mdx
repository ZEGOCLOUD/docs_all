...
| --- | --- | --- |
| handler | nullable id\<[ZegoRangeSceneStreamEventHandler](../../api-reference/class#zegorangescenestreameventhandler)\> | The object used to receive range scene stream callbacks. |
