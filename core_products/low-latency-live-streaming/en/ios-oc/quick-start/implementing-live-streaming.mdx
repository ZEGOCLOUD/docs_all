...
<Note title="Note">
If you need to know about Express's microphone/audio/speaker related interfaces, please refer to [FAQ - How to Implement Switching Camera/Video Screen/Microphone/Audio/Speaker?](/faq/device-switching).
</Note>
...
- [Does SDK Support Reconnection After Disconnection?](/faq/express-reconnect)
