...
The SDK also supports Token-based authentication. If you want to upgrade the authentication mode, see [Guide for upgrading the authentication mode from using the AppSign to Token](https://docs.zegocloud.com/faq/token_upgrade).
</Warning>
