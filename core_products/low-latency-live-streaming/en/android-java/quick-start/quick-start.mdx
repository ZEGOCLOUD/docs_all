...
<Accordion title="Method 2: Manually add the SDK to the project" defaultOpen="false">
...
Here is a downloadable [sample code](https://github.com/ZEGOCLOUD/zegocloud_sdk_demo_android/tree/master/live_streaming/quick_start) that can be used as a reference when developing your app.
...
For a detailed demo source code, check it [here](https://github.com/ZEGOCLOUD/zegocloud_sdk_demo_android/tree/master/live_streaming/quick_start).
