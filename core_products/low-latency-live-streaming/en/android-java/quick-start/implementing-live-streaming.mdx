...
Developers can obtain temporary Tokens (valid for 24 hours) in [ZEGOCLOUD Console](https://console.zegocloud.com/dashboard). For details, please contact ZEGOCLOUD Technical Support.
...
<Note title="Note">
If you need to understand Express's microphone/audio/speaker related interfaces, please refer to [FAQ - How to implement switching camera/video screen/microphone/audio/speaker?](https://www.zegocloud.com/docs/faq/device-switching).
</Note>
...
- Ultra-low latency live streaming is not enabled by default. Please enable it yourself in ZEGO Console or contact ZEGOCLOUD Technical Support. For details, please refer to [Enable Service](#enable-service).
...
- [How to handle issues related to rooms and users?](https://www.zegocloud.com/docs/faq/express-room-maintenance)
...
- [In live streaming scenarios, how to listen for events of remote viewer role users logging in/logging out of rooms?](https://www.zegocloud.com/docs/faq/audience-room-events)
- [How to adjust the camera focal length (zoom function)?](https://www.zegocloud.com/docs/faq/audience-room-events)
...
- [Why is audio and video capture invalid after Android 9 app is locked or switched to background](https://www.zegocloud.com/docs/faq/android-background-capture-issue)
