...
<ParamField
  ...
  prototype="public [ZegoStreamAlignmentMode](../../api-reference/enum#zegostreamalignmentmode) streamAlignmentMode"
  parent_name="ZegoAutoMixerTask"
  parent_type="class">
...
<ParamField
  ...
  prototype="public [ZegoStreamAlignmentVolumeControlMode](../../api-reference/enum#zegostreamalignmentvolumecontrolmode) streamAlignmentVolumeControlMode"
  parent_name="ZegoAutoMixerTask"
  parent_type="class">
...
<ParamField
  ...
  prototype="public [ZegoAutoMixerTask](../../api-reference/class#zegoautomixertask)"
