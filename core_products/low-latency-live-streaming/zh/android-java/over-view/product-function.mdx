...
<tr>
<td>[RTMP 推流到 ZEGO 服务器](!OBS_Push)</td>
<td>在直播场景下，主播可以通过 RTMP 推流工具将音视频流推送到 ZEGO 服务器，实现低延迟的效果。</td>
<td>直播场景。</td>
</tr>
<tr>
<td>[混流](!Other_Functions/Mixer)</td>
...
<tr>
<td>[通话质量监测](!Publisher_Player_Advanced/MonitorStreamQuality)</td>
...
<tr>
<td>[直播连麦](!hybrid_hierarchical_delivery_system-Integration/Solution_Implementation)</td>
...
<tr>
<td>[同时推多路流](!hybrid_hierarchical_delivery_system-Push_Multiple_Streams)</td>
...
<tr>
<td>[音视频流加密](!hybrid_hierarchical_delivery_system-Audio_and_Video_Stream_Encryption)</td>
<td>推流时对流进行加密，拉流时必须有与加密密钥一致的解密密钥。</td>
<td>需要加密流信息以保护通信安全的场景。</td>
</tr>
<tr>
<td>[游戏语音](!AudioAdvanced/Range_Voice)</td>
...
<tr>
<td>[实时消息与信令](!AdvancedModule/IM)</td>
...
<tr>
<td>[音频频谱与音量变化](!hybrid_hierarchical_delivery_system-Audio_Spectrum_and_Volume_Change)</td>
<td>音频频谱：即数字音频信号在各频点的能量值。音量变化：即某条流音量的大小。</td>
<td>- 判断麦上的用户谁在说话、麦克风、扬声器等是否可用。
- 音频频谱动画展示。</td>
</tr>
<tr>
<td>[耳返与声道设置](!hybrid_hierarchical_delivery_system-Inear_and_Channel_Settings)</td>
...
<tr>
<td>[自定义视频采集](!VideoAdvanced/CustomVideoCapture)</td>
...
<tr>
<td>[自定义视频渲染](!VideoAdvanced/CustomVideoRender)</td>
...
<tr>
<td>[媒体播放器](!Other_Functions/MediaPlayer)</td>
...
<tr>
<td>[音效文件播放器](!hybrid_hierarchical_delivery_system-AudioAdvanced/Audio_Player)</td>
<td>提供音效播放器，并进行音效统一管理，实现对增强真实感或者烘托场景氛围的简短效果音的播放/控制等功能。</td>
<td>- 秀场直播。
- 游戏娱乐。</td>
</tr>
<tr>
<td>[音视频录制](!Other_Functions/Local_Media_Recording)</td>
