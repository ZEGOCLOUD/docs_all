...
- 已在项目中集成 ZEGO Express SDK，并实现了基本的音视频推拉流功能，详情请参考 [快速开始 - 集成](/live-streaming-android/quick-start/integrating-sdk) 和 [快速开始 - 实现流程](/live-streaming-android/quick-start/implementing-live-streaming)。
...
当开发者收到 [onLocalDeviceExceptionOccurred](@onLocalDeviceExceptionOccurred) 设备回调不为 0 时，相关的错误码请参考 [常见错误码](/real-time-video-android-java/client-sdk/error-code#1006xxx-设备错误)。
