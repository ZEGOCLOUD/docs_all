...
- 已在项目中集成 ZEGO Express SDK，详情请参考 [快速开始 - 集成](/live-streaming-ios/quick-start/integrating-sdk)。
...
临时 Token 仅供调试，正式上线时，请从开发者的业务服务器生成 token，详情可参考 [使用 Token 鉴权](/live-streaming-ios/communication/use-token-authentication)。如果 Token 错误，请参考 [错误码](/live-streaming-ios/client-sdk/error-code) 文档中的 1002067 和 1003072 排查问题。
...
- 如果用户在音视频直播的过程中，遇到相关错误，可查询 [错误码](/live-streaming-ios/client-sdk/error-code)。
