...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 伴奏资源信息，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#获取伴奏资源](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#获取伴奏资源) |
</ParamField>
<ParamField
