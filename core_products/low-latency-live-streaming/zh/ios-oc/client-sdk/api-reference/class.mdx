...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 点歌服务返回的 JSON 字符串，包含歌曲资源信息，详细请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 伴奏资源信息，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-2](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-2) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 伴奏长分片高潮片段资源信息，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-3](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-3) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 歌曲、伴奏或高潮片段资源信息，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-4](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-4) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 点歌服务返回的 JSON 字符串，包含歌曲资源信息，详细请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-4](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#resources-4) |
</ParamField>
<ParamField
