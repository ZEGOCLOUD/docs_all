...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/A_LiveStreamingSDK/LiveStreaming_overview.jpg" /></Frame>
...
<tr>
    <td>SDK 包体积</td>
    <td>
    <p>Express SDK 全功能安装包集成到 App 后，App 的增量大小如下：</p>
    <ul><li>iOS（arm64）：7.11 MB</li><li>Android（arm64）：7.93 MB</li><li>Android（armv7）：7.44 MB</li><li>macOS（x86_64）：10.48 MB</li><li>Windows（x86）：10.41 MB</li><li>Windows（x86_64）：12.55 MB</li><li>Linux (x64)：11.23 MB</li></ul>
