...
- 服务器：对应 RTMP 推流地址，即 `rtmp://hosts/AppName/`
    ...
    **请注意，RTMP 推流地址 URL，与 [CDN 推流鉴权](/real-time-video-uniapp/live-streaming/cdn-stream-publishing-authentication) 中的推流地址 URL 不同，不可混用，使用时请您注意区分。**
...
调用 [startPlayingStream](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html) 接口，传入 RTMP 推流的 “streamID” （即 3.2.1 章节中设置的“串流密码”）进行拉流播放。
...
调用 [stopPlayingStream](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html) 接口，传入 RTMP 推流的 “streamID”（即 3.2.1 章节中设置的“串流密码”）停止拉取远端推送的音视频流。
