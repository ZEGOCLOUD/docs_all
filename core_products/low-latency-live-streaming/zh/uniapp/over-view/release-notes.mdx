...
新增 [ZegoViewMode](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/enums/_zegoexpressdefines_.zegoviewmode.html) 参数，用于设置媒体播放器的视图模式，详情请参考 [媒体播放器](!Other_Functions/MediaPlayer) 文档。
