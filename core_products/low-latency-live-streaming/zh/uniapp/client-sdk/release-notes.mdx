...
1. 修复初始化引擎后无法通过调用 getVideoConfig 接口获取默认的场景化配置值的问题
    ...
    相关 API 请参考： [getVideoConfig](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#getvideoconfig) 
