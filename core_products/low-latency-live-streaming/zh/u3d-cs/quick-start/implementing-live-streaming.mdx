...
- 已在项目中集成 ZEGO Express SDK，详情请参考 [快速开始 - 集成](/live-streaming-u3d/quick-start/integrating-sdk)。
...
- 超低延迟直播不是默认开启的，请在 ZEGO 控制台自助开通或联系 ZEGO 技术支持，详情请参考 [开通服务](https://doc-zh.zego.im/live-streaming-u3d/quick-start/implementing-live-streaming)。
- 如果用户在直播的过程中，遇到相关错误，可查询 [错误码](/live-streaming-u3d/client-sdk/error-code)。
...
## 相关文档
- [常见错误码](/real-time-video-u3d-cs/client-sdk/error-code)
