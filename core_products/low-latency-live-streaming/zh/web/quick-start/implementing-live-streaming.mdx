...
您可以监听 [roomStateChanged](@roomStateChanged) 回调实时监控自己与房间的连接状态。只有当房间状态是连接成功时，才能进行推流、拉流等操作。如果登录房间失败，可参考 [错误码](/live-streaming-web/client-sdk/error-code) 进行操作。
...
超低延迟直播不是默认开启的，请在 ZEGO 控制台自助开通或联系 ZEGO 技术支持，详情请参考 [开通服务](https://doc-zh.zego.im/live-streaming-web/quick-start/implementing-live-streaming)。
...
## 相关文档
- [错误码文档](/live-streaming-web/client-sdk/error-code)
