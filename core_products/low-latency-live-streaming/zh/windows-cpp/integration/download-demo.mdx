...
* 已安装 [Qt](http://download.qt.io/official_releases/qt) 5.9 或以上版本，详细信息请参考 [Getting Started with Qt\|_balnk](https://doc.qt.io/qt-5/gettingstarted.html)。
...
1. 下载 SDK 包，解压后将文件拷贝到示例源码如下目录。
    ...
    * Windows 系统：[下载 SDK 包](#2972)，并解压到 “/libs/ZegoExpress/win” 目录。
    * macOS 系统：[下载 SDK 包](#5566)，并解压到 “/libs/ZegoExpress/mac” 目录。
