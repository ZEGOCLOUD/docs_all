...
可参考 [快速开始 - 实现流程](!Integration/Solution_Implementation#3_1) 的 “3.1 创建引擎” 和 “3.2 登录房间” 完成房间登录。
...
通过 [ZegoMixerAudioConfig](@-ZegoMixerAudioConfig) 设置混流音频相关配置，主要包括音频码率、声道数、编码ID。 
