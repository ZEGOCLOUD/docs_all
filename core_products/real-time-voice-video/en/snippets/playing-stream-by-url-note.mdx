...
- The authentication parameter in the playing stream URL is mainly used for anti-leeching. For specific rules, please reference [CDN Stream Playing Authentication](./cdn-stream-playing-recording-screenshot-authentication.mdx) . If there is no authentication parameter, you can ignore the "authParam" field.
