...
<Note title="">
- **Use cases**: Recommended configuration in different business scenarios [https://docs.zegocloud.com/article/12122.](https://docs.zegocloud.com/article/12122.)
...
<Warning title="">
- **Available since**: 2.10.0
- **Restrictions**: Please refer to [https://docs.zegocloud.com/article/7611](https://docs.zegocloud.com/article/7611) or contact ZEGO technical support.
</Warning>
</ParamField>
<ParamField
...
<Note title="">
- **When to call**: After the callback [onStart] is received.
- **References**: Please refer to the documentation [https://docs.zegocloud.com/article/4054](https://docs.zegocloud.com/article/4054) for details.
