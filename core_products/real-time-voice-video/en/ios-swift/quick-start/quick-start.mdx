...
- Sign up and create a project in [Admin Console](https://console.zegocloud.com).
...
Then, call the [`createEngineWithProfile`(/article/api?doc=Express_Video_SDK_API~ObjectiveC_ios~class~zego-express-engine#create-engine-with-profile-event-handler) method to initialize the Video Call SDK.  And config the following: 
