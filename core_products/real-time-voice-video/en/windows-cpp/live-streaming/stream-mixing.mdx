...
可参考 [快速开始 - 实现流程](/real-time-video-windows-cpp/quick-start/implementing-video-call) 的 “创建引擎” 和 “登录房间” 完成房间登录。
...
请参考 [快速开始 - 实现流程](/real-time-video-windows-cpp/quick-start/implementing-video-call) 的 “创建引擎” 和 “登录房间” 完成房间登录。
