...
在消除稳态噪声（详情请参考 [音频 3A 处理](/real-time-video-windows-cpp/audio/audio-3a-processing)）的基础上，有效消除非稳态噪声且实现人声高保真，主要噪声包括鼠标、键盘、敲击、空调、厨房碗碟、嘈杂餐厅、环境风声、咳嗽、吹气等非人声的噪声，以及小房间的人声混响。
...
2. 初始化和登录房间的具体流程，请参考实现视频通话文档中的 “[创建引擎](/real-time-video-windows-cpp/quick-start/implementing-video-call)” 及 “[登录房间](/real-time-video-windows-cpp/quick-start/implementing-video-call)”。
