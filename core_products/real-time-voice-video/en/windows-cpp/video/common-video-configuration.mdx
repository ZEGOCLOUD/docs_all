...
<Note title="Note">
If the playing stream end needs to play 60-frame streams, you need to contact technical support. For details, please refer to [Does ZEGO Express SDK support pulling 60-frame streams?](https://www.zegocloud.com/docs/faq/60fps-stream-pulling)
</Note>
...
- [How to choose video resolution, frame rate, and bitrate?](https://www.zegocloud.com/docs/faq/video-parameters-selection)
