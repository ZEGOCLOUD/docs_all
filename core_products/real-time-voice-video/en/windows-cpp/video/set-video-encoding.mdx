...
[How to solve video image abnormalities (such as black screen, green screen, mosaic, etc.) when interoperating between Web platform and Native platform?](https://www.zegocloud.com/docs/faq/cross-platform-video-issues)
