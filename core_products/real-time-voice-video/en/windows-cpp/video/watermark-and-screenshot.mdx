...
[ZegoWatermark](@-ZegoWatermark) 对象中的 [imageURL](@imageURL) 参数当前只支持 “本地文件传输协议”，即 `file:///+绝对路径的形式`。
...
2. **[ZegoWatermark](@-ZegoWatermark) 中的 “layout” 如何指定？**
    ...
    水印的布局不能超过当前设置的推流的视频编码分辨率，对推流编码分辨率的设置请参考 [setVideoConfig ](@setVideoConfig) 接口。
