...
| Method | Description |
|-------|--------|
| [enablePublishDirectToCDN](https://zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-express-engine#enable-publish-direct-to-cdn) | Enable direct publishing to CDN |
| [startPublishingStream](https://zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-express-engine#start-publishing-stream) | Start publishing stream |
| [stopPublishingStream](https://zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-express-engine#stop-publishing-stream) | Stop publishing stream |
