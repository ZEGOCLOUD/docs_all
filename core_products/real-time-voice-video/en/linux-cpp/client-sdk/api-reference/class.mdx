...
| Name | Type | Description |
| --- | --- | --- |
| audioSpectrum | const ZegoAudioSpectrum& | Locally captured audio spectrum value list. Spectrum value range is [0-2^31]. |
...
| Name | Type | Description |
| --- | --- | --- |
| audioSpectrums | const std::unordered_map\<std::string, ZegoAudioSpectrum\>& | Remote audio spectrum hash map, key is the streamID, value is the audio spectrum list of the corresponding streamID. Spectrum value range is [0-2^31] |
...
| --- | --- | --- |
| mediaPlayer | [IZegoMediaPlayer](#izegomediaplayer)* | Callback player object. |
| spectrumList | const ZegoAudioSpectrum& | Locally captured frequency spectrum value list. Spectrum value range is [0-2^31]. |
