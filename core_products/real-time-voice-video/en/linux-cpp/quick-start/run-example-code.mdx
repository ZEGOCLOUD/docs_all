...
- If cross-compilation is needed, please refer to [How to cross-compile Linux alsa-lib dependency library?](/faq/alsa-lib-cross-compile_1) and [How to cross-compile Linux v4l-utils dependency library?](/faq/linux-v4l-utils-cross-compile) documents. At the same time, the target machine needs to have libasound and libv4l2 dependency libraries installed.
</Note>
