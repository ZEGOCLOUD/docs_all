...
Call the [createAudioEffectPlayer](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-express-engine#create-audio-effect-player) method of [IZegoExpressEngine](@-IZegoExpressEngine) to create an audio effect player instance.
...
1. Call the [pause](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#pause) method to pause the audio effect specified by audioEffectID. Call the [pauseAll](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#pause-all) method to pause all playing audio effects.
2. After the audio effect is paused, call the [resume](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#resume) method to resume the audio effect specified by audioEffectID. Call the [resumeAll](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#resume-all) method to resume all paused audio effects.
3. Call the [stop](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#stop) method to stop the audio effect specified by audioEffectID. Call the [stopAll](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#stop-all) method to stop all audio effects.
...
1. Call the [setVolume](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#set-volume) method to set the volume of the audio effect specified by audioEffectID. The value range is [0-200], and the default value is 100.
2. Call the [setVolumeAll](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#set-volume-all) method to set the volume of all audio effects at the same time. The value range is [0-200], and the default value is 100.
...
1. Call the [getTotalDuration](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#get-total-duration) method to get the total duration of a single audio effect.
2. Call the [getCurrentProgress](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#get-current-progress) method to get the current playback progress of the audio effect.
3. Call the [seekTo](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-audio-effect-player#seek-to) method to set the playback progress as needed.
...
After using the audio effect player, you need to call the [destroyAudioEffectPlayer](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_linux~class~zego-express-i-zego-express-engine#destroy-audio-effect-player) method in time to destroy it and release the resources occupied by the player.
