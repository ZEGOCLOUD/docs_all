...
| Name | Type | Description |
| --- | --- | --- |
| audioSpectrum | number[] | Locally captured audio spectrum value list. Spectrum value range is [0-2^31]. |
...
| Name | Type | Description |
| --- | --- | --- |
| audioSpectrums | object | Remote audio spectrum hash map, key is the streamID, value is the audio spectrum list of the corresponding streamID. Spectrum value range is [0-2^31] |
...
| Name | Type | Description |
| --- | --- | --- |
| spectrumList | Array\<number\> | Locally captured frequency spectrum value list. Spectrum value range is [0-2^31]. |
