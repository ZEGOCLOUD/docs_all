...
- You have created a project in the [ZEGO Console](https://console.zego.im) and obtained a valid AppID and AppSign. For details, see [Console - Project Information](/console/project-info).
