...
The "streamID" published by remote users can be obtained from the [roomStreamUpdate](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~javascript_web~interface~ZegoRTCEvent&jumpType=route#room-stream-update) callback.
