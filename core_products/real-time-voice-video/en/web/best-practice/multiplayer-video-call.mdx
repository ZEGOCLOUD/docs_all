...
sequenceDiagram
    ...
    UserB->>ZEGO Express SDK: 3.UserB creates engine <br/> [new ZegoExpressEngine]
    UserB->>ZEGO Express SDK: 4.UserB logs in to room <br/> [loginRoom]
    UserB->>ZEGO Express SDK: 5.UserB publishes stream <br/> [startPublishingStream]
    ZEGO Express SDK->>UserA: 6.UserA receives roomStreamUpdate callback <br/> (get UserB's streamID)
    UserA->>ZEGO Express SDK: 7.UserA passes UserB's streamID to play stream <br/> [startPlayStream]
```
{/*
