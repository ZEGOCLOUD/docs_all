...
- You have implemented basic real-time audio and video functionality. For details, please refer to [Implement a basic video call](https://www.zegocloud.com/docs/real-time-video-web/quick-start/implementing-video-call).
