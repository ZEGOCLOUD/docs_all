...
When running the Java source code to generate Token, if "java.security.InvalidKeyException:illegal Key Size" exception appears, please refer to [Related FAQ](/faq/java-token-key-size-error) to solve.
</Warning>
