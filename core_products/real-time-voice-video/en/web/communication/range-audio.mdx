...
- For browser compatibility of range audio, please refer to [Which browsers does ZEGO Express Web SDK support](https://www.zegocloud.com/docs/faq/web-sdk-browser-support_1).
