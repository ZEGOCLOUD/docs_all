...
<Note title="">
- **Use cases**: the developer can use this callback to judge the status of the current user in the room. Developers will receive this notification when calling room related functions (refer to "related interfaces"). You may also receive this notification when the network condition of the user equipment changes (SDK will automatically log in to the room again when the line is disconnected. For details, please refer to https://doc-zh.zego.im/faq/overview )。
