...
<ParamField
  ...
  parent_name="ZegoCopyrightedMusicGetKrcLyricByTokenResponse"
  parent_type="class">
Lyrics in lrc format, dedicated to progressive lyrics scene, please refer to https://www.zegocloud.com/docs/online-ktv-electron/client-api/apis-to-obtain-songs-and-lyrics for details.
</ParamField>
...
<ParamField
  ...
  parent_name="ZegoCopyrightedMusicGetStandardPitchResponse"
  parent_type="class">
Standard pitch line data. For details, please refer to Android: /online-ktv-android/zego-content-center/scoring-component, iOS: /online-ktv-ios/zego-content-center/scoring-component
</ParamField>
...
<ParamField
  ...
  parent_name="ZegoCopyrightedMusicRequestResourceResponse"
  parent_type="class">
The JSON returned by the song order service contains song resource information, please refer to https://www.zegocloud.com/docs/online-ktv-electron/client-api/apis-to-obtain-songs-and-lyrics#1_1 for details.
</ParamField>
...
<ParamField
  ...
  parent_name="ZegoExpressPlayerConfig"
  parent_type="class">
Whether to keep the screen on during playback, with a default value of false. Setting it to true prevents the screen from automatically turning off when playing videos on mobile devices.
</ParamField>
...
<Note title="">
- **Use cases**: the developer can use this callback to judge the status of the current user in the room. Developers will receive this notification when calling room related functions (refer to "related interfaces"). You may also receive this notification when the network condition of the user equipment changes (SDK will automatically log in to the room again when the line is disconnected. For details, please refer to https://www.zegocloud.com/docs/faq/overview )。
