...
You have created a project in the [ZEGOCLOUD Console](https://console.zego.im/), applied for a valid `AppID`, and obtained the `Server URL` for accessing the server. 
...
<Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/e06d33eeae.jpeg" /></Frame>
