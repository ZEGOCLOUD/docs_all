...
[How to solve the screen abnormality problem (such as black screen, green screen, flower screen, etc.) when interworking between Web platform and Native platform?](/faq/cross-platform-video-issues)
