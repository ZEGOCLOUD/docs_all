...
- Interface Prototypes
    ...
    - Local captured sound level callback interface [onCapturedSoundLevelUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onCapturedSoundLevelUpdate.html):
    ...
    - Remote audio sound level callback interface [onRemoteSoundLevelUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRemoteSoundLevelUpdate.html):
    ...
    - Local captured audio spectrum callback interface [onCapturedAudioSpectrumUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onCapturedAudioSpectrumUpdate.html):
         ...
         *
         * Callback notification period is 100 ms.
         * @param audioSpectrum Array of local captured audio spectrum values, spectrum values range from [0-2^31]
         */
    ...
    - Remote played stream audio spectrum callback interface [onRemoteAudioSpectrumUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRemoteAudioSpectrumUpdate.html):
         ...
         *
         * Callback notification period is 100 ms.
         * @param audioSpectrums Key-value pairs of remote audio spectrums, key is stream ID, value is the corresponding stream's audio spectrum value array, spectrum values range from [0-2^31]
         */
...
- Usage Examples
    ...
    You can first use the [onRoomStreamUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRoomStreamUpdate.html) callback method to get the list of existing streams in the current room and save it, then use the saved stream list to index the `Map` to obtain the sound level/audio spectrum data for each stream.
...
- Call [startSoundLevelMonitor](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/startSoundLevelMonitor.html) to start sound level monitoring:
    ...
    When calling the [startSoundLevelMonitor](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/startSoundLevelMonitor.html) interface, you can set the `millisecond` parameter to adjust the sound level callback interval.
    ```dart
    ...
    After calling the above interface, [onCapturedSoundLevelUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onCapturedSoundLevelUpdate.html) will trigger immediately, with a callback value of 0 when not publishing and not previewing; [onRemoteSoundLevelUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRemoteSoundLevelUpdate.html) will only callback after starting to play streams with [startPlayingStream ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/startPlayingStream.html).

- Call [startAudioSpectrumMonitor ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/startAudioSpectrumMonitor.html) to start audio spectrum monitoring:
    ...
    After calling the above interface, [onCapturedAudioSpectrumUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onCapturedAudioSpectrumUpdate.html) will trigger immediately, with a callback value of 0 when not publishing and not previewing; [onRemoteAudioSpectrumUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRemoteAudioSpectrumUpdate.html) will only callback after starting to play streams with [startPlayingStream ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/startPlayingStream.html).
...
- Call [stopSoundLevelMonitor ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/stopSoundLevelMonitor.html) to stop sound level monitoring:
    ...
    After calling the above interface, [onCapturedSoundLevelUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onCapturedSoundLevelUpdate.html) and [onRemoteSoundLevelUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRemoteSoundLevelUpdate.html) will no longer callback.

- Call [stopAudioSpectrumMonitor ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/stopAudioSpectrumMonitor.html) to stop audio spectrum monitoring:
    ...
    After calling the above interface, [onCapturedAudioSpectrumUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onCapturedAudioSpectrumUpdate.html) and [onRemoteAudioSpectrumUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRemoteAudioSpectrumUpdate.html) will no longer callback.
...
- Interface Prototypes
    ...
    - Sound level update callback interface for each single stream in manual mixing [onMixerSoundLevelUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMixerSoundLevelUpdate.html):
    ...
    - Sound level update callback interface for each single stream in automatic mixing [onAutoMixerSoundLevelUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onAutoMixerSoundLevelUpdate.html):
...
- Automatic Mixing Scenario
  ...
  When calling the [startAutoMixerTask](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/startAutoMixerTask.html) interface to initiate an automatic mixing task, set the `enableSoundLevel` parameter to `true` to start sound level monitoring:
...
- Manual Mixing Scenario
  ...
  When calling the [startMixerTask](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/startMixerTask.html) client interface to update a mixing task, set the `enableSoundLevel` parameter to `false` to stop sound level monitoring:
...
- Automatic Mixing Scenario
  ...
  When calling the [startAutoMixerTask](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/startAutoMixerTask.html) client interface to update an automatic mixing task, set the `enableSoundLevel` parameter to `false` to stop sound level monitoring:
...
- [How to handle no sound issues?](/faq/no-audio-issue)
- [How to handle low volume issues?](/faq/low-audio-volume-issue)
