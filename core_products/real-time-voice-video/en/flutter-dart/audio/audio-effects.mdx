...
Call the [setVoiceChangerPreset ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setVoiceChangerPreset.html) method to use the SDK's preset voice changer effects.

The preset voice changer effects of [ZegoVoiceChangerPreset](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoVoiceChangerPreset.html) are as follows. Developers can choose according to their needs:
...
Call [setReverbPreset](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setReverbPreset.html) to set reverb through preset enumeration.

The preset reverb effects of [ZegoReverbPreset](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoReverbPreset.html) are as follows. Developers can choose according to their needs:
...
If the SDK's preset reverb types cannot meet your needs, developers can call the [ZegoReverbAdvancedParam ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoReverbAdvancedParam-class.html) method and set relevant parameters in combination to achieve the reverb effect developers need (for detailed parameter description, please refer to the API documentation).
...
When custom reverb parameters are set, the preset reverb effect set when enabling reverb will become invalid. If you want to use the SDK preset parameters again, you can use the [setReverbPreset ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setReverbPreset.html) preset enumeration method to set.
...
This example constructs [ZegoAudioConfig ](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAudioConfig/ZegoAudioConfig.html) through preset enumeration and sets it to dual channel.
