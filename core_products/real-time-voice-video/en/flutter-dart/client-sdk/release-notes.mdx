...
4. Added an error code related to resource file permissions for the media player
    ...
    For related API, please refer to [onMediaPlayerStateUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMediaPlayerStateUpdate.html)
