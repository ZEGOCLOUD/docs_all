...
1. onPublisherQualityUpdate callback provides traffic control status information
    ...
    For related API, please refer to [onPublisherQualityUpdate](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherQualityUpdate.html)
    
    
2. setDummyCaptureImagePath supports passing network image addresses
    
    For related API, please refer to [setDummyCaptureImagePath](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setDummyCaptureImagePath.html)
...
For related API, please refer to [switchPlayingStream](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/switchPlayingStream.html)
...
4. PK mixed streaming scenario supports blurring picture edges
    ...
    For related API, please refer to [startMixerTask](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/startMixerTask.html)
...
1. Screen sharing feature supports outline effect on Windows and macOS devices
    ...
    For related API, please refer to [enableHightLight](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoScreenCaptureSource/enableHightLight.html)
...
3. Support setting the stream title when publishing a stream
    ...
    If you want to display the live title in scenarios such as the live list, the SDK supports developers to configure the title through the streamTitle parameter in [ZegoPublisherConfig](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoPublisherConfig-class.html) before calling the [startPublishingStream](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/startPublishingStream.html) interface to start publishing the stream.
    
    For related API, please refer to [startPublishingStream](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/startPublishingStream.html), [ZegoPublisherConfig > streamTitle](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoPublisherConfig/streamTitle.html)
...
4. Added an error code related to resource file permissions for the media player
    ...
    For related API, please refer to [onMediaPlayerStateUpdate](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngine/onMediaPlayerStateUpdate.html)
...
1. More Features Added for Web Platform
    ...
    | Feature | API |
    | --- | --- |
    | Get and Set Audio Parameters | <ul><li>[getAudioConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/getAudioConfig.html)</li><li>[setAudioConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setAudioConfig.html)</li></ul> |
    | Geo-fencing | [setGeoFence](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setGeoFence.html) |
    | Cloud Proxy | [setCloudProxyConfig\|_blank](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setCloudProxyConfig.html) |
    | Set Mirror Mode | [setVideoMirrorMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoMirrorMode.html)<Note title="Note">    Setting stream mirroring is not supported.    </Note> |
    | Set Publishing End Capture Volume | [setCaptureVolume](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setCaptureVolume.html) |
    | Forward to CDN | <ul><li>[addPublishCdnUrl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/addPublishCdnUrl.html)</li><li>[removePublishCdnUrl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/removePublishCdnUrl.html)</li></ul> |
    | Dynamic Traffic Control Strategy Switching | <ul><li>[enableTrafficControl](https://doc-zh.zego.im/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enableTrafficControl.html)</li><li>[setMinVideoBitrateForTrafficControl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setMinVideoBitrateForTrafficControl.html)</li><li>[setTrafficControlFocusOn](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setTrafficControlFocusOn.html)</li></ul> |
    | Set Playback Volume | <ul><li>[setPlayVolume](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/setPlayVolume.html)</li><li>[setAllPlayStreamVolume](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/setAllPlayStreamVolume.html)</li></ul><Note title="Note">        Values above 100 are not supported and will be treated as 100.    </Note> |
    | Whether to receive all audio data for playback | [muteAllPlayAudioStreams](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/muteAllPlayAudioStreams.html) |
    | Whether to receive all video data for playback | [muteAllPlayVideoStreams](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/muteAllPlayVideoStreams.html) |
    | Update playback view | [updatePlayingCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/updatePlayingCanvas.html) |
    | Whether to enable hardware decoding | [enableHardwareEncoder\|_blank](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enableHardwareEncoder.html) |
    | Real-time sequential data | <ul><li>[createRealTimeSequentialDataManager](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineIM/createRealTimeSequentialDataManager.html)</li><li>[destroyRealTimeSequentialDataManager](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineIM/destroyRealTimeSequentialDataManager.html)</li><li>[startBroadcasting](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRealTimeSequentialDataManager/startBroadcasting.html)</li><li>[stopBroadcasting](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRealTimeSequentialDataManager/stopBroadcasting.html)</li><li>[sendRealTimeSequentialData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRealTimeSequentialDataManager/sendRealTimeSequentialData.html)</li><li>[startSubscribing](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRealTimeSequentialDataManager/startSubscribing.html)</li><li>[stopSubscribing](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRealTimeSequentialDataManager/stopSubscribing.html)</li><li>[onReceiveRealTimeSequentialData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onReceiveRealTimeSequentialData.html)</li></ul> |
    | Enable and disable sound level monitoring | <ul><li>[startSoundLevelMonitor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/startSoundLevelMonitor.html)</li><li>[stopSoundLevelMonitor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/stopSoundLevelMonitor.html)</li></ul> |
    | Basic beauty effects | <ul><li>[startEffectsEnv](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/startEffectsEnv.html)</li><li>[stopEffectsEnv](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/stopEffectsEnv.html)</li><li>[enableEffectsBeauty](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableEffectsBeauty.html)</li><li>[setEffectsBeautyParam](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setEffectsBeautyParam.html)</li></ul> |
    | Media player | [loadCopyrightedMusicResourceWithPosition](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/loadCopyrightedMusicResourceWithPosition.html) |
    | Low-light Enhancement | [setLowlightEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancement.html) |
    | Auto Mixing | <ul><li>[startAutoMixerTask](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/startAutoMixerTask.html)</li><li>[stopAutoMixerTask](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/stopAutoMixerTask.html)</li></ul> |
    | Play Stream Screenshot | [takePlayStreamSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/takePlayStreamSnapshot.html) |
    | Local Device Exception Event Callback | [onLocalDeviceExceptionOccurred](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onLocalDeviceExceptionOccurred.html) |
    | Local Video and Audio Device State Change Event Callback | <ul><li>[onVideoDeviceStateChanged](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onVideoDeviceStateChanged.html)</li><li>[onAudioDeviceStateChanged](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onAudioDeviceStateChanged.html)</li></ul> |
    | Get Raw Audio Data | <ul><li>[startAudioDataObserver](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/startAudioDataObserver.html)</li><li>[stopAudioDataObserver](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/stopAudioDataObserver.html)</li><li>[onMixedAudioData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMixedAudioData.html)</li><li>[onPlayerAudioData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerAudioData.html)</li></ul> |
    | Mixer Sound Level Callback | [onMixerSoundLevelUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMixerSoundLevelUpdate.html)<Note title="Note">Web platform only supports getting mixer sound level through SEI. Please contact ZEGOCLOUD technical support to enable configuration and handle race conditions when calling the interface.</Note> |
    | Auto Mixer Sound Level Callback | [onAutoMixerSoundLevelUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onAutoMixerSoundLevelUpdate.html)<Note title="Note">Please contact ZEGOCLOUD technical support to enable configuration.</Note> |
...
1. Fixed issue where calling [getVideoConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/getVideoConfig.html) after engine initialization failed to get default scene configuration
2. Fixed issue where calling [setVideoConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoConfig.html) before publishing stream did not take effect
3. Fixed issue where setting maxMemberCount parameter when logging into room did not take effect
4. Fixed issue where calling [setStreamExtraInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setStreamExtraInfo.html), [mutePublishStreamVideo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/mutePublishStreamVideo.html), [mutePublishStreamAudio](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/mutePublishStreamAudio.html), [enableCamera](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/enableCamera.html) before publishing stream did not take effect
5. Fixed issue where remainTimeInSecond field in [onRoomTokenWillExpire](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRoomTokenWillExpire.html) had incorrect unit (changed from milliseconds to seconds)
6. Fixed issue where [setRoomMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setRoomMode.html) could still be called to modify multi-room mode after engine initialization
...
Developers can specify the use of AI algorithm through [setLowlightEnhancementParams](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancementParams.html). When device performance is insufficient to support AI algorithm, SDK will automatically use traditional algorithm. Generally, mid to high-end devices can stably run Low Light Enhancement AI algorithm. 

For related API, please refer to [setLowlightEnhancementParams](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancementParams.html)
...
4. Added support for automatic static image push when camera stops capturing
    ...
    For related API, please refer to [ZegoExpLowlightEnhancementType](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpLowlightEnhancementType.html)
...
For related API, please refer to [ZegoAECMode > AI](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_defines/ZegoAECMode.html#AI)

2. Support for Setting Video Noise Reduction Feature
    
    The new video denoising interface `setVideoDenoiseParams` is applicable in scenarios such as addressing poor camera capture performance, significant visual noise in footage, or situations requiring dedicated video denoising processing. Developers can choose different video noise reduction modes [ZegoVideoDenoiseMode](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_defines/ZegoVideoDenoiseMode.html) and video noise reduction strengths [ZegoVideoDenoiseStrength](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_defines/ZegoVideoDenoiseStrength.html) based on their business scenarios. 
    
    For related API, please refer to [setVideoDenoiseParams](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_api_publisher/ZegoExpressEnginePublisher/setVideoDenoiseParams.html)
    
    
3. Support for Joining the Output Stream After Stream Mixing to the Target Room
    
    The stream mixing feature supports joining the output stream after stream mixing to a specified room, i.e., it supports setting the target room information for the output stream [targetRoom](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_defines/ZegoMixerOutput/targetRoom.html). Each output stream only supports joining one room, and once added, dynamic room updates are not supported during the stream mixing process. 
    
    For related API, please refer to [targetRoom](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_defines/ZegoMixerOutput/targetRoom.html)
...
4. Web Support for Setting Log Level Before Initializing the Engine
    ...
    For related API, please refer to [setLogConfig](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_api/ZegoExpressEngine/setLogConfig.html)
    
5. New callback for room state change notification on the web end
    
    When the connection state of the room changes, the [onRoomStateChanged](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRoomStateChanged.html) callback is triggered, and developers can use this callback to determine the current user status in the room.
    
    For related API, please refer to [onRoomStateChanged](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRoomStateChanged.html)
...
2. Support for Adapting to OpenGL 3.0 Version During Video Custom Capture and Pre-processing
    ...
    For related API, please refer to [setLowlightEnhancement](/unique-api/express-video-sdk/en/dart_flutter/file-___Users_zego_ci_workspace_workspace_rtc_utils_publish_express_api_documents_projects_flutter_lib_src_zego_express_api_publisher/ZegoExpressEnginePublisher/setLowlightEnhancement.html)
...
2. When the media player plays transparent effects, support Alpha data layout on the top right of RGB data
    ...
    When the media player plays transparent effects, a new [ZegoAlphaLayoutType > RightTop](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAlphaLayoutType.html) enumeration is added to support Alpha data splicing on the top right of RGB data. When setting this enumeration, only a scaling factor of 0.5x is supported.
    
    For related API, please refer to [loadResourceWithConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/loadResourceWithConfig.html), [ZegoStreamResourceMode > Custom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoStreamResourceMode.html#Custom), [ZegoAlphaLayoutType > RightTop](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAlphaLayoutType.html)
...
3. Support customizing the stream resource type for audience members before and after going on stage
    ...
    For related API, please refer to  [startPlayingStream](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/startPlayingStream.html), [ZegoPlayerConfig > customResourceConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoPlayerConfig/customResourceConfig.html)
...
2. When logging into a room, the userName field is changed to an optional field
    ...
    When logging into a room using the [loginRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/loginRoom.html) interface, `userName` was originally a required field. This optimization makes it an optional field.
    
    For related API, please refer to  [loginRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/loginRoom.html)
    
3. Optimize the stereo sound effect and improve the sound quality of music pitch shifting
    
    For related API, please refer to [setVoiceChangerParam](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setVoiceChangerParam.html)
...
1. Support for simultaneous video capture from front and rear cameras on iOS platform
    ...
    For related API, please refer to [setVideoSource](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoSource.html), [useFrontCamera](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/useFrontCamera.html), [ZegoVideoSourceType > SecondaryCamera](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoVideoSourceType.html#SecondaryCamera), [ZegoVideoSourceType > Camera](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoVideoSourceType.html#Camera)
...
2. Automatic selection of the clearest camera for video capture on iOS platform for phones with 3 rear cameras
    ...
    For related API, please refer to [setCameraZoomFactor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/setCameraZoomFactor.html)
...
3. Notification of screen capture permission request result on Android platform
    ...
    For related API, please refer to [onMobileScreenCaptureStart](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMobileScreenCaptureStart.html)
...
5. Low-latency mode added to AI noise reduction
    ...
    For related API, please refer to [setANSMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setANSMode.html)
...
6. Control whether a stream is subject to review during streaming
    ...
    For related API, please refer to [startPublishingStream](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/startPublishingStream.html), [ZegoPublisherConfig > streamCensorFlag](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoPublisherConfig/streamCensorFlag.html)
...
7. Media Player now supports playback speeds as low as 0.3x
    ...
    For related API, please refer to [setPlaySpeed](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlaySpeed.html)
...
2. Support for enabling voice changer effects on media player output
    ...
    For related API, please refer to [ZegoMediaPlayer > enableVoiceChanger](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableVoiceChanger.html)
...
3. Added two new sound effects.
    ...
    [ZegoVoiceChangerPreset](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoVoiceChangerPreset.html) added enumeration values for two voice-changing effects, Autobot and OutOfPower, to enrich the voice-changing effects.
    
    For related API, please refer to [setVoiceChangerPreset](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setVoiceChangerPreset.html)
    
4. ZegoMediaPlayer supports video mirroring.
    
    For related API, please refer to [enableViewMirror](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableViewMirror.html)
    
5. Supports initiating mixed-streaming tasks normally when image resource verification fails.
    
    [ZegoMixerTask](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerTask-class.html) added new parameter `mixImageCheckMode`, used to control whether backgroundImageURL, inputList.imageInfo.url, or watermark.imageURL image resources fail to verify whether the mixing task can be initiated normally.
    ...
    For related API, please refer to [startMixerTask](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/startMixerTask.html)
...
6. Supports determining in advance whether the device can run the AI voice changing function.
    ...
    For related API, please refer to [isAIVoiceChangerSupported](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineAIVoiceChanger/isAIVoiceChangerSupported.html)
...
1. Added video stabilization feature (Only supports iOS).
    ...
    For related API, please refer to [setCameraStabilizationMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setCameraStabilizationMode.html)
...
3. Support setting a timeout for CDN repushing to monitor the existence of a stream.
    ...
    For related API, please refer to [addPublishCdnUrl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/addPublishCdnUrl.html)
    
4. Support for callback local recording quality data.
    
    [ZegoDataRecordProgress](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoDataRecordProgress-class.html) adds the [quality] attribute, which can be used to callback the quality data of the recorded file, such as frame rate and bit rate, during the local recording process.
    
    For related API, please refer to [onCapturedDataRecordProgressUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onCapturedDataRecordProgressUpdate.html)
...
5. Supports low-light enhancement and color enhancement when using external capturing.
    ...
    After enabling the external capture function, you can use the [setLowlightEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancement.html) and [enableColorEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableColorEnhancement.html) interfaces to separately enable low-light enhancement and color enhancement to adjust the captured images according to your business needs.
    
    For related API, please refer to [setLowlightEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancement.html), [enableColorEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableColorEnhancement.html)
...
1. Optimizing the callback notification logic of the media streamer.
    ...
    For related API, please refer to [onMediaDataPublisherFileClose](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMediaDataPublisherFileClose.html)
...
2. Support for getting a list of streams in the room from the client.
    ...
    For related API, please refer to [getRoomStreamList](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/getRoomStreamList.html)
...
4. The media player supports obtaining the real-time frame rate of the file.
    ...
    For related API, please refer to [getPlaybackStatistics](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/getPlaybackStatistics.html)
...
5. Media player supports caching network resources locally.
    ...
    For related API, please refer to [enableLocalCache](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableLocalCache.html), [onMediaPlayerLocalCache](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMediaPlayerLocalCache.html)
...
1. Support high-definition and low-code video in the cloud transcoding service
    ...
    For related API, please refer to [ZegoMixerOutputVideoConfig > enableLowBitrateHD](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerOutputVideoConfig/enableLowBitrateHD.html)
...
2. Color enhancement is supported when publishing video-streams
    ...
    For related API, please refer to [enableColorEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableColorEnhancement.html)
...
4. Real-time room messaging supports sending transparent messages
    ...
    For related API, please refer to [sendTransparentMessage](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineIM/sendTransparentMessage.html)
...
6. Automatic mixing supports setting water level
    ...
    For related API, please refer to [ZegoAutoMixerTask > minPlayStreamBufferLength](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAutoMixerTask/minPlayStreamBufferLength.html)
...
8. Custom audio offset value is supported for mixing
    ...
    For related API, please refer to [ZegoMixerInput > advancedConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerInput/advancedConfig.html)
...
9. The media player supports callbacks for video resolution change events
    ...
    For related API, please refer to [onMediaPlayerVideoSizeChanged](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMediaPlayerVideoSizeChanged.html)
...
10. The audio player supports separate settings for streaming volume and local volume
    ...
    For related API, please refer to [ZegoAudioEffectPlayer > setPublishVolume](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAudioEffectPlayer/setPublishVolume.html), [ZegoAudioEffectPlayer > setPlayVolume](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAudioEffectPlayer/setPlayVolume.html), [ZegoAudioEffectPlayer > setPublishVolumeAll](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAudioEffectPlayer/setPublishVolumeAll.html), [ZegoAudioEffectPlayer > setPlayVolumeAll](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAudioEffectPlayer/setPlayVolumeAll.html)
...
2. The current official website SDK does not include this function. If necessary, please contact ZEGOCLOUD technical support for special packaging.
    ...
    For related API, please refer to [createAIVoiceChanger](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineAIVoiceChanger/createAIVoiceChanger.html), [destroyAIVoiceChanger](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineAIVoiceChanger/destroyAIVoiceChanger.html)
...
2. The video filling method of the virtual background is centered and proportionally scaled. When the video is too large, the excess part will be cropped.
    ...
    For related API, please refer to [enableVideoObjectSegmentation](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enableVideoObjectSegmentation.html)
...
3. Media player supports accompaniment sound quality enhancement
    ...
    For related API, please refer to [enableLiveAudioEffect](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableLiveAudioEffect.html)
...
4. Supports obtaining and uploading audio Dump files
    ...
    For related API, please refer to [startDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineUtilities/startDumpData.html), [stopDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineUtilities/stopDumpData.html), [uploadDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineUtilities/uploadDumpData.html), [removeDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineUtilities/removeDumpData.html), [onRequestDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRequestDumpData.html), [onStartDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onStartDumpData.html), [onStopDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onStopDumpData.html), [onUploadDumpData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onUploadDumpData.html)
...
5. Custom video capture supports transparent channel transmission
    ...
    For related API, please refer to [enableAlphaChannelVideoEncoder](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enableAlphaChannelVideoEncoder.html)
...
1. Optimized low-light enhancement function, smoother in automatic mode
    ...
    For related API, please refer to [setLowlightEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancement.html)
...
2. Optimize the upper limit of expected publish and play stream bit rates for network speed testing
    ...
    For related API, please refer to [startNetworkSpeedTest](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineUtilities/startNetworkSpeedTest.html)
...
3. Optimize the [muteAll] interface logic for receiving audio and video data from remote users when playing streams
    ...
    For related API, please refer to [muteAllPlayAudioStreams](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/muteAllPlayAudioStreams.html), [muteAllPlayVideoStreams](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/muteAllPlayVideoStreams.html), [mutePlayStreamAudio](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/mutePlayStreamAudio.html), [mutePlayStreamVideo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/mutePlayStreamVideo.html)
...
4. The media player supports only playing video or audio without consuming additional decoding performance
    ...
    For related API, please refer to [setPlayMediaStreamType](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlayMediaStreamType.html)
...
2. ScreenCapture supports setting publishing-stream area.
    ...
    For related API, please refer to [updatePublishRegion](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoScreenCaptureSource/updatePublishRegion.html)
    
3. Added SEI callback with timestamp.
    
    For related API, please refer to [onPlayerRecvMediaSideInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerRecvMediaSideInfo.html)
...
2. Transcoding will cause additional delays. It is not recommended if you use this function in your Live Streaming scenarios which playing stream by RTC. 
    ...
    For related API, please refer to [ZegoPlayerConfig > codecTemplateId](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoPlayerConfig/codecTemplateID.html)
    
5. Supports throwing [setDummyCaptureImagePath] exception callback.
    
    For related API, please refer to [onPublisherDummyCaptureImagePathError](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherDummyCaptureImagePathError.html)
    
6. Direct-publish CDN supports updating the CDN address during publishing.
    
    For related API, please refer to [enablePublishDirectToCdn](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherDummyCaptureImagePathError.html)
...
7. Supports  AI-balanced noise reduction mode.
    ...
    For related API, please refer to [ZegoANSMode > ZegoANSModeAIBalanced](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoANSMode.html)
    
**Enhancements**

1. Optimize [setLogConfig] interface.
    
    The life cycle of [setLogConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setLogConfig.html) is expanded to the App life cycle, and its priority is higher than the configuration in [setEngineConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setEngineConfig.html).
    
    For related API, please refer to [setLogConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setLogConfig.html), [setEngineConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setEngineConfig.html)
...
2. Fixed the issue where no error message is thrown when the watermark path exceeds the maximum length set by [setPublishWatermark](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setPublishWatermark.html).
...
5. Fixed the problem that when calling the [sendAudioSideInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/sendAudioSideInfo.html) interface to send audio secondary messages, it takes about 10 seconds for the player to receive the message.
...
2. Support returning low frame rate alarms for encoding and hardware decoding.
    ...
    For related API, please refer to [onPlayerLowFpsWarning](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerLowFpsWarning.html), [onPublisherLowFpsWarning](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherLowFpsWarning.html)
...
3. Mediaplayer supports setting Http Headers of network resources.
    ...
    For related API, please refer to [setHttpHeader](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setHttpHeader.html)
...
4. The range voice supports configuring the attenuation range of the 3D sound effect distance and the sound range of a single stream
    ...
    - Support to set the attenuation range [min, max] of the 3D audio effect distance through the [setAudioReceiveRange](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRangeAudio/setAudioReceiveRange.html) interface. When the distance is less than min, the volume will not attenuate as the distance increases; when the distance is greater than max, the other party's voice will not be heard.
    - Support setting the vocal range [min, max] of a single stream through the [setStreamVocalRange](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRangeAudio/setStreamVocalRange.html) interface.
    
5. Support callback related event activities by publish channel
    
    The [onPublisherSendAudioFirstFrame](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherSendAudioFirstFrame.html) callback function adds a channel parameter, which supports multi-channel listening and streaming to send the first frame information.
    
    For related API, please refer to [onPublisherSendAudioFirstFrame](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherSendAudioFirstFrame.html)
...
1. Before using this function, you need to call the [setVideoConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoConfig.html) interface to specify the video codecID as ZegoVideoCodecIDH264DualStream.
...
3. In the publish-play stream retry state caused by network disconnection, support callback for local network quality.
    For related API, please refer to [onNetworkQuality](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkQuality.html)
    
4. Support generating log upload tasks after calling the [destroyEngine](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/destroyEngine.html) interface.
    
    For related API, please refer to [submitLog](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/submitLog.html)
...
1. Fix the problem of calling the [setRoomExtraInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/setRoomExtraInfo.html)  interface to directly report an error
...
2. The screen capture function supports the capture of system audio.
    ...
    For related API, please refer to [startCapture](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoScreenCaptureSource/startCapture.html)
...
3. Added Enhanced KTV reverb effect.
    ...
    For related API, please refer to [setReverbPreset](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setReverbPreset.html)
...
4. Game voice function supports media player and audio player to use 3D sound effects.
    ...
    For related API, please refer to [ZegoMediaPlayer > updatePosition](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/updatePosition.html), [ZegoAudioEffectPlayer > updatePosition](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAudioEffectPlayer/updatePosition.html)
...
5. The media player supports obtaining media stream video information.
    ...
    For related API, please refer to [getMediaInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/getMediaInfo.html)
...
6. Media player double speed function supports up to 4x.
    ...
    For related API, please refer to [ZegoMediaPlayer > setPlaySpeed](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlaySpeed.html)
...
7. The media player supports functions such as downloading, retrieving data decryption, and playing at the same time.
    ...
    For related API, please refer to [ZegoMediaPlayer > enableBlockData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableBlockData.html)
    
**Enhancements**

1. Adjust the `applicationVolume` and `microphoneVolume` in [ZegoScreenCaptureConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoScreenCaptureConfig-class.html) to become optional fields, expand SDK multi-port compatibility.
...
4. Support for fast switching rooms in multi-room mode.
    ...
    In the multi-room mode, the [switchRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/switchRoom.html) interface is supported to quickly and conveniently realize the function of switching rooms.
    
    For related API, please refer to [switchRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/switchRoom.html)
...
1. Added geofencing function
    ...
    For related APIs, please refer to [setGeoFence](​/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setGeoFence.html)
...
2. Support dynamic switching flow control strategy
    ...
    For related APIs, please refer to [enableTrafficControl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enableTrafficControl.html), [setMinVideoBitrateForTrafficControl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setMinVideoBitrateForTrafficControl.html), [setMinVideoFpsForTrafficControl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setMinVideoFpsForTrafficControl.html), [setMinVideoResolutionForTrafficControl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setMinVideoResolutionForTrafficControl.html)
...
1. Support the vocal enhancement effect in the external playback scene
    ...
    For related APIs, please refer to [enableSpeechEnhance](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableSpeechEnhance.html)
...
3. In-game Voice Chat supports custom setting of sound mode and listening mode
    ...
    For related APIs, please refer to [setRangeAudioCustomMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRangeAudio/setRangeAudioCustomMode.html)
...
4. Optimize the performance of inter-process communication for Screen Sharing on the Express SDK iOS side
    ...
    For related APIs, please refer to [setAppGroupID](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoScreenCaptureSource/setAppGroupID.html)
...
3. Fix the problem that the icon in the data obtained by Windows screen capture [getScreenCaptureSources](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineScreenCapture/getScreenCaptureSources.html) is invalid, and some windows cannot get thumbnails
...
1. Flutter Web supports Screen Sharing
    ...
    For related APIs, please refer to [createScreenCaptureSource](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineScreenCapture/createScreenCaptureSource.html), [setAudioSource](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setAudioSource.html), [setVideoSource](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoSource.html)
    
2. Flutter Web supports the Beautify function
    
    
    For related APIs, please refer to [enableEffectsBeauty](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableEffectsBeauty.html), [setEffectsBeautyParam](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setEffectsBeautyParam.html)
    
    
3. Flutter Web supports multi-room function
    
    For related APIs, please refer to [setRoomMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setRoomMode.html)
    
**Bug Fixes**

1. Fixed [onRemoteSoundLevelUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRemoteSoundLevelUpdate.html) callback will cause abnormal problem
2. Fixed the problem that [setSEIConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setSEIConfig.html) interface setting `SEIType` on iOS platform has no effect
...
2. SDK supports setting cloud proxy
    ...
    For related APIs, please refer to [setCloudProxyConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setCloudProxyConfig.html)
...
This update contains incompatible changes, please refer to [3.0.0 and above version upgrade guide](!upgrade_guide4) for details.
...
4. Support to obtain the codec capability support status of the specified Encoding & Decoding of the current device
    ...
    - Through the [isVideoEncoderSupported](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/isVideoEncoderSupported.html) interface, the hardware or software encoding support of the current encoder can be obtained.
    - Through the [isVideoDecoderSupported](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/isVideoDecoderSupported.html) interface, the hardware or software decoding support of the current decoder can be obtained. Both of the above two interfaces contain three enumerated values: support hardware or software, support hardware, and support software.
    ...
    For related APIs, please refer to [isVideoEncoderSupported](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/isVideoEncoderSupported.html), [isVideoDecoderSupported](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/isVideoDecoderSupported.html)
...
6. Added callback based on the first frame of the Video after the Camera is turned on
    ...
    For related APIs, please refer to [onPlayerRenderCameraVideoFirstFrame](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerRenderCameraVideoFirstFrame.html)
...
7. Added CDN and CDN Plus play streams configuration items to the play streams interface of the Web platform
    ...
    For related APIs, please refer to [startPlayingStream](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/startPlayingStream.html)
...
5. Fixed the problem that the SDK did not trigger [onPlayerRenderVideoFirstFrame](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerRenderVideoFirstFrame.html) when there is no View
...
10. Fix the problem that the [onNetworkQuality](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkQuality.html) interface does not call back on the Android platform
    
    
**Deleted**

1. Abandoned the three old versions of [ZegoScenario] Scenarios Abandoned the three scenarios of `General`, `Communication`, and `Live` in the [ZegoScenario](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoScenario.html) scenario enumeration.
    
2. Deleted `setDebugVerbose`, `setPlayStreamVideoLayer`, `enableAudioDataCallback` and other interfaces, please refer to [3.0.0 and above version upgrade guide](!upgrade_guide4) for details.
...
This version contains breaking changes, please refer to [v2.23.0 Upgrade Guide](!upgrade_guide3) for details
...
1. Support the development of macOS programs using the Flutter framework
    ...
    The Flutter framework adds support for macOS. macOS currently only supports [TextureRenderer](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressTextureRenderUtils/createTextureRenderer.html), it is recommended to obtain the view of [ZegoCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/createCanvasView.html) through [createCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoCanvas-class.html).
    
    For related APIs, please refer to [setPlayerCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlayerCanvas.html)
    
2. Windows supports Media Player settings display and Snapshot functions
    
    Windows supports Media Player to set the display screen through the [setPlayerCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlayerCanvas.html) interface, and take screenshots through the [takePublishStreamSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/takePublishStreamSnapshot.html), [takePlayStreamSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/takePlayStreamSnapshot.html), [Snapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/takeSnapshot.html) interfaces] .
    
    For related APIs, please refer to [setPlayerCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlayerCanvas.html), [takePublishStreamSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/takePublishStreamSnapshot.html), [takePlayStreamSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/takePlayStreamSnapshot.html), [takeSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/takeSnapshot.html).
...
3. 3 new modes are added to the mobile Video capture and rotation function
    ...
    The [TextureRenderer](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressTextureRenderUtils/createTextureRenderer.html) rendering mode of iOS is currently not supported.
    
    For related APIs, please refer to [setAppOrientationMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setAppOrientationMode.html)
...
5. Flutter framework adds interfaces to support developing web programs
    ...
    For related APIs, please refer to [enableCamera](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/enableCamera.html), [mutePlayStreamAudio](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/mutePlayStreamAudio.html), [mutePlayStreamVideo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/mutePlayStreamVideo.html), [sendBroadcastMessage](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineIM/sendBroadcastMessage.html), [sendBarrageMessage](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineIM/sendBarrageMessage.html), etc.].
...
Therefore, when upgrading from an older version to v2.23.0, developers need to migrate to the new [createCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/createCanvasView.html) and [destroyCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/destroyCanvasView.html) interfaces for Video rendering. The new `ZegoExpressCanvasViewUtils` API module can support both external texture and PlatformView rendering methods. For details, please refer to [v2.23.0 Upgrade Guide](!upgrade_guide3)

For related APIs, please refer to [createCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/createCanvasView.html), [destroyCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/destroyCanvasView.html)

**Bug Fixes**

1. Fixed an issue where calling [loginRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/loginRoom.html) during network switching (Wi-Fi or cellular) may not have a callback in multi-room mode.
...
1. Added support for SOCKS5 client proxy
    ...
    In an intranet or firewall scenario, you can interact with the public network through a proxy server, and set the proxy server address through [setEngineConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setEngineConfig.html) to ensure that the ZEGO audio and Video cloud service is normal. Currently, only the SOCKS5 protocol is supported.
    
    For related APIs, please refer to [setEngineConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setEngineConfig.html)
...
4. H.264 and H.265 hardware codec support using Windows AMD/NVIDIA/Intel series graphics cards
    ...
    Support Windows AMD/NVIDIA discrete graphics and Intel HD graphics, you can modify the default graphics priority through [setEngineConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setEngineConfig.html).
    
    For related APIs, please refer to [setEngineConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setEngineConfig.html), [enableHardwareEncoder](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enableHardwareEncoder.html), [enableHardwareDecoder](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enableHardwareDecoder.html)
    
5. iOS and Android platforms support dynamic modification of AudioDeviceMode
    
    Added [setAudioDeviceMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/setAudioDeviceMode.html) interface to dynamically modify the Audio mode of the device. This configuration determines the Volume mode, pre-processing mode and Mic occupation logic of the device. You can choose according to specific scenarios. 
    
    For related APIs, please refer to [setAudioDeviceMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setAudioDeviceMode.html)
    
6. Support to call back PCM data of vocal-aligned Media Player
    
    Note:
    - The [enableAux](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableAux.html) interface needs to be used at the same time when using the Media Player to play the accompaniment.
    - After the [enableAlignedAudioAuxData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/enableAlignedAudioAuxData.html) interface is enabled, the Media Player data will not be pushed out. If you need to tune the accompaniment and align the vocals in the recording and singing scene, you can first mix the accompaniment into the main channel through the [enableAux](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableAux.html) interface, and then enable it through the [enableAlignedAudioAuxData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/enableAlignedAudioAuxData.html) interface]. switch, and finally obtain the PCM data of the media Media Player through the [onAlignedAudioAuxData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onAlignedAudioAuxData.html), [enableAux](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableAux.html) callback. At this time, the data collected by the Media Player and the Mic are aligned, and the data frames correspond one-to-one.
    
    For related APIs, please refer to [enableAlignedAudioAuxData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/enableAlignedAudioAuxData.html), [onAlignedAudioAuxData](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onAlignedAudioAuxData.html), [enableAux](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableAux.html)
    
7. Support the development of Windows programs using the Flutter framework
    
    Note: Windows currently does not support the Media Player setting display screen [setPlayerCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlayerCanvas.html), and the Snapshot function is still being improved. The involved interfaces include [takePublishStreamSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/takePublishStreamSnapshot.html), [takePlayStreamSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/takePlayStreamSnapshot.html), [takeSnapshot](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/takeSnapshot.html).
    
    The Flutter framework adds support for Windows. Windows currently only supports TextureRenderer, it is recommended to use [createCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/createCanvasView.html) to get the view of [ZegoCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoCanvas-class.html).
    
    
    For related APIs, please refer to [setPlayerCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setPlayerCanvas.html)
    
8. Add [createCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/createCanvasView.html) to get the view of the rendering window and [ZegoCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoCanvas-class.html)
    
    The - SDK integrates the [createTextureRenderer](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressTextureRenderUtils/createTextureRenderer.html) and [createPlatformView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressPlatformViewUtils/createPlatformView.html) interfaces, and will use the [ZegoEngineProfile.enablePlatformView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoEngineProfile/enablePlatformView.html) interface to determine which method is preferred for creation. At the same time, when the platform only supports one of the creation methods, it will automatically use the supported method to create. Currently, Windows only supports TextureRenderer, and Web only supports PlatformView.
    - When using TextureRenderer, it is no longer necessary to actively call [updateTextureRendererSize](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressTextureRenderUtils/updateTextureRendererSize.html) to update the window size.
    - When destruction is required, use [destroyCanvasView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressCanvasViewImpl/destroyCanvasView.html) to do so.
...
2. Optimize the network quality callback, the network quality feedback is more sensitive
    ...
    For related APIs, please refer to [onPlayerQualityUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerQualityUpdate.html), [onPublisherQualityUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherQualityUpdate.html), [onNetworkQuality](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkQuality.html)
...
2. Range voice supports custom distance update frequency.
    ...
    If you want to better match the actual business demand, you can call the [setPositionUpdateFrequency](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRangeAudio/setPositionUpdateFrequency.html) interface to modify the frequency by yourself.
    
    For related API, please refer to [setPositionUpdateFrequency](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRangeAudio/setPositionUpdateFrequency.html)
    
3. Support setting the low-light enhancement.
    
    Note: The [setLowlightEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancement.html) interface should be called after calling the [createEngineWithProfile](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngineWithProfile.html) interface to create an engine.
    
    When the surrounding environment of the stream-publishing user is dark, or the frame rate set by the camera is high, resulting in a dark live broadcast screen, and the subject cannot be displayed or recognized normally, you can call the [setLowlightEnhancement](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setLowlightEnhancement.html) interface to set the low-light enhancement to increase the brightness of the video screen. The low-light enhancement function includes three modes: 1: Disable the low-light enhancement (default), 2: Enable the low-light enhancement, 3: Automatically switch on/off the low-light enhancement.
...
5. Add the CDN Plus playing configuration to the startPlayingStream interface.
    ...
    For related API, please refer to [startPlayingStream](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/startPlayingStream.html)
    
**Enhancements**

1. Optimize the related error codes of Token exceptions when mandatory login authentication is enabled.
    
    Added 1002074, 1002075, 1002076, 1002077, 1002078, 1002079, 1002080 and other error codes. After enabling mandatory login authentication, if the Token is incorrect, these error codes will be returned. For details, please refer to [Error codes](!ExpressVideoSDK-Error_Code/Error_Code).
...
1. Media player supports setting the channel.
    ...
    After calling the [createEngine](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngine.html)  interface to initialize the engine and the [createMediaPlayer](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMediaPlayer/createMediaPlayer.html) interface to create a media player, you can call the [setActiveAudioChannel](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setActiveAudioChannel.html) interface to set the left channel, right channel or all channels. When initialized, the media player defaults to all channels.
    
    For related API, please refer to [setActiveAudioChannel](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/setActiveAudioChannel.html)
...
2. Media player supports clearing the last frame when the playback ends.
    ...
    Call the [createEngine](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngine.html) interface to initialize the engine, call the [createMediaPlayer](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMediaPlayer/createMediaPlayer.html) interface to create a media player, and call [clearView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/clearView.html) to clear the last remaining frame.
    
    For related API, please refer to [clearView](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/clearView.html)
    
3. Support the camera to automatically change the frame rate.
    
    Note: When the frame rate set by [setVideoConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoConfig.html) is less than the minimum expected frame rate of [enableCameraAdaptiveFPS](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/enableCameraAdaptiveFPS.html), the frame rate value set by [setVideoConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoConfig.html) will be used. Due to the different hardware and algorithm strategies of different mobile phone manufacturers, the effect of this interface is different on different models or on the front and back cameras of the same model.
    
    When the frame rate set by the user on the streaming end is high, and the ambient light is low and the subject cannot be displayed or recognized normally, you can call the [enableCameraAdaptiveFPS](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/enableCameraAdaptiveFPS.html) interface to automatically reduce the frame rate within a certain range to increase exposure time, so as to improve the brightness of the video picture. This function is often used in live broadcast scenes with high exposure requirements. The [enableCameraAdaptiveFPS](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/enableCameraAdaptiveFPS.html) interface needs to be called after calling the [createEngine](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngine.html) interface to initialize the engine and before starting the camera.
    
    For related API, please refer to [enableCameraAdaptiveFPS](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/enableCameraAdaptiveFPS.html)
...
4. Added 1017009 error code.
    ...
    When the copyrighted music is initialized, the authentication fails because the AppSign or Token is not set, and this error code will appear. At this time, if you use AppSign for authentication, please fill in AppSign when initializing the SDK; if you use Token authentication, before calling the [initCopyrightedMusic](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoCopyrightedMusic/initCopyrightedMusic.html) interface, please call the [loginRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/loginRoom.html) interface and pass in Token for authentication.
    
    For related API, please refer to [initCopyrightedMusic](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoCopyrightedMusic/initCopyrightedMusic.html), [loginRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/loginRoom.html)
...
2. Support SEI data synchronization with Audio frame in audio and Video scenarios
    ...
    For related APIs, please refer to [onPlayerRecvAudioSideInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerRecvAudioSideInfo.html), [sendAudioSideInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/sendAudioSideInfo.html)
...
For related APIs, please refer to [setANSMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setANSMode.html)
...
2. Support setting the playback speed of AudioEffect
    ...
    For related APIs, please refer to [SetPlaySpeed](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoAudioEffectPlayer/setPlaySpeed.html)
...
3. Supports push-pull streaming using QUIC protocol during CDN live streaming
    ...
    For related APIs, please refer to [enablePublishDirectToCDN](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/enablePublishDirectToCDN.html)
...
4. Address and protocol-related information that supports monitoring of push-pull streams
    ...
    For related APIs, please refer to [onPublisherStreamEvent](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherStreamEvent.html), [onPlayerStreamEvent](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerStreamEvent.html)
...
5. Support setting the Stream Mixing Watermark and Stream Mixing input Volume through URL
    ...
    For related APIs, please refer to [startMixerTask](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMixer/startMixerTask.html)
...
6. Added room state change notification [onRoomStateChanged]
    ...
    For related APIs, please refer to [onRoomStateChanged](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onRoomStateChanged.html)
...
1. Support setting the minimum FPS and Video resolution
    ...
    For related APIs, please refer to [setMinVideoFpsForTrafficControl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setMinVideoFpsForTrafficControl.html), [setMinVideoResolutionForTrafficControl](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setMinVideoResolutionForTrafficControl.html)
...
2. Support steady state voice setting detection period parameter
    ...
    For related APIs, please refer to [startAudioVADStableStateMonitor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/startAudioVADStableStateMonitor.html)
...
3. Added Stealth Squad Mode for Area Voice
    ...
    For related APIs, please refer to [setRangeAudioMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRangeAudio/setRangeAudioMode.html)
...
4. Added debugging assistant function
    ...
    For related APIs, please refer to [enableDebugAssistant](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setRangeAudioMode.html)
...
1. Optimized the authentication method
    ...
    For related APIs, please refer to [createEngineWithProfile](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngineWithProfile.html), [loginRoom](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineRoom/loginRoom.html)
...
1. In-game Voice Chat support setting whether to receive Audio data from the specified user
    ...
    For related APIs, please refer to [muteUser](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoRangeAudio/muteUser.html)
...
2. Added MOS sound quality score in the play streams quality callback [onPlayerQualityUpdate]
    ...
    For related APIs, please refer to [onPlayerQualityUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerQualityUpdate.html)
...
2. Optimized the basic Beautify function
    ...
    For related APIs, please refer to [startEffectsEnv](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/startEffectsEnv.html), [stopEffectsEnv](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/stopEffectsEnv.html), [enableEffectsBeauty](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableEffectsBeauty.html), [setEffectsBeautyParam](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setEffectsBeautyParam.html)
...
4. Optimize NTP time error
    ...
    For related APIs, please refer to [getNetworkTimeInfo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineUtilities/getNetworkTimeInfo.html)
...
1. Abandoned the old version of the basic Beautify related interface
    ...
    For related APIs, please refer to [enableBeautify](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDeprecatedApi/enableBeautify.html), [enableEffectsBeauty](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableEffectsBeauty.html), [setBeautifyOption](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDeprecatedApi/setBeautifyOption.html), [setEffectsBeautyParam](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/setEffectsBeautyParam.html)
...
1. The Media Player supports the acquisition of sound waves and spectrum when playing music
    ...
    For related APIs, please refer to [enableSoundLevelMonitor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableSoundLevelMonitor.html), [onMediaPlayerSoundLevelUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMediaPlayerSoundLevelUpdate.html), [enableFrequencySpectrumMonitor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/enableFrequencySpectrumMonitor.html), [onMediaPlayerFrequencySpectrumUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onMediaPlayerFrequencySpectrumUpdate.html)
...
2. Support omnidirectional Virtual Stereo
    ...
    For related APIs, please refer to [enableVirtualStereo](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePreprocess/enableVirtualStereo.html)
...
3. Add local device exception callback [onLocalDeviceExceptionOccurred]
    ...
    For related APIs, please refer to [onLocalDeviceExceptionOccurred](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onLocalDeviceExceptionOccurred.html)
...
1. Stream Mixing output supports advanced encoding parameter configuration
    ...
    For related APIs, please refer to [ZegoMixerOutputVideoConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerOutputVideoConfig-class.html)
...
1. Discard [onDeviceError] callback
    ...
    For related APIs, please refer to [onDeviceError](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onDeviceError.html), [onLocalDeviceExceptionOccurred](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onLocalDeviceExceptionOccurred.html)
...
1. Added real-time ordered data function
    ...
    For related APIs, please refer to [createRealTimeSequentialDataManager](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineIM/createRealTimeSequentialDataManager.html)
...
2. Added H.265 codec exception notification
    ...
    For related APIs, please refer to [onPlayerLowFpsWarning](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerLowFpsWarning.html), [onPublisherStateUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPublisherStateUpdate.html), [onPlayerStateUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onPlayerStateUpdate.html)
...
3. The Media Player supports specifying the start playback progress when loading media resources
    ...
    For related APIs, please refer to [loadResourceWithPosition](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMediaPlayer/loadResourceWithPosition.html)
...
4. Support setting Camera focus and exposure mode
    ...
    For related APIs, please refer to [isCameraFocusSupported](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/isCameraFocusSupported.html), [setCameraFocusPointInPreview](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/setCameraFocusPointInPreview.html), [setCameraFocusMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/setCameraFocusMode.html), [setCameraExposureMode](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/setCameraExposureMode.html), [setCameraExposurePointInPreview](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/setCameraExposurePointInPreview.html)
...
5. Added the function of enabling or disabling play streams alignment
    ...
    For related APIs, please refer to [setPlayStreamsAlignmentProperty](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/setPlayStreamsAlignmentProperty.html)
...
6. Added steady state voice detection function
    ...
    For related APIs, please refer to [startAudioVADStableStateMonitor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/startAudioVADStableStateMonitor.html), [stopAudioVADStableStateMonitor](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineDevice/stopAudioVADStableStateMonitor.html), [onAudioVADStateUpdate](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onAudioVADStateUpdate.html)
...
1. Change nullable parameters to optional parameters
    ...
    For related APIs, please refer to [ZegoEngineConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoEngineConfig/ZegoEngineConfig.html), [ZegoEngineProfile](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoEngineProfile/ZegoEngineProfile.html), [ZegoPublisherConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoPublisherConfig/ZegoPublisherConfig.html), [ZegoCanvas](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoCanvas/ZegoCanvas.html), [ZegoVideoConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoVideoConfig/ZegoVideoConfig.html), [ZegoPlayerConfig](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoPlayerConfig/ZegoPlayerConfig.html), [ZegoMixerInput](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerInput/ZegoMixerInput.html)
...
2. Optimized [ZegoMixerOutput]
    ...
    For related APIs, please refer to [ZegoMixerOutput](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerOutput/ZegoMixerOutput.html)
...
1. Go to the test environment
    ...
    For related API, please refer to [createEngineWithProfile](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngineWithProfile.html)
...
For related API, please refer to [createEngine](/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngine.html)
