...
In Express SDK, define the stream mixing task configuration object through [ZegoMixerTask](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerTask-class.html), which includes information such as input stream layout, output stream, and ZEGO super whiteboard configuration.
...
Call the [ZegoMixerTask > whiteboard](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerTask/whiteboard.html) interface to mix ZEGO super whiteboard content into the stream mixing: you need to fill in parameters such as [whiteboardID](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoMixerWhiteboard/whiteboardID.html) (whiteboard ID), which is the ID and other information returned when integrating ZegoSuperBoard SDK and creating the whiteboard in the [Prerequisites](/real-time-video-flutter/other/push-the-whiteboard) of this article.
