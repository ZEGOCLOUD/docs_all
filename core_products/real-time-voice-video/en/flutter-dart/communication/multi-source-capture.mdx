...
1. Call the [setVideoSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoSource.html) interface to set the video capture source.
...
2. Call the [setAudioSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setAudioSource.html) interface to set the audio capture source.
...
- If you need to use custom audio capture as the audio capture source, you need to set the audio capture source type to `ZegoAudioSourceType.Custom`, and call interfaces such as [sendCustomAudioCaptureAACData](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/sendCustomAudioCaptureAACData.html) or [sendCustomAudioCapturePCMData](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/sendCustomAudioCapturePCMData.html) to send audio data to the SDK. For details, please refer to [Custom Audio Capture and Rendering](/real-time-video-flutter/audio/custom-audio-capture-and-rendering).
- If you need to use a media player as the audio capture source, you need to set the audio capture source type to `ZegoAudioSourceType.MediaPlayer`, call the [createMediaPlayer](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMediaPlayer/createMediaPlayer.html) interface to create a media player, then use the newly created media player to load resources and play. For details, please refer to [Media Player](/real-time-video-flutter/other/media-player).
...
1. Call the [setVideoSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoSource.html) interface to switch the video capture source.
...
2. Call the [setAudioSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setAudioSource.html) interface to switch the audio capture source.
...
| Method | Description |
|-------|--------|
| [setVideoSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoSource.html) | Set video capture source |
| [setAudioSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setAudioSource.html) | Set audio capture source |
| [sendCustomAudioCaptureAACData](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/sendCustomAudioCaptureAACData.html) | Send custom captured AAC data to SDK |
| [sendCustomAudioCapturePCMData](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineCustomAudioIO/sendCustomAudioCapturePCMData.html) | Send custom captured PCM data to SDK |
| [createMediaPlayer](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineMediaPlayer/createMediaPlayer.html) | Create media player instance |
