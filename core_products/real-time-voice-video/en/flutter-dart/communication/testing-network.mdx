...
- A project has been created in the [ZEGOCLOUD Console](https://console.zegocloud.com), and a valid AppID and AppSign have been obtained. For details, please refer to [Console - Project Information](/console/project-info).
...
- Under normal speed test circumstances, the [onNetworkSpeedTestQualityUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkSpeedTestQualityUpdate.html) callback is triggered when network speed quality updates.

- When an error occurs during the speed test, the [onNetworkSpeedTestError](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkSpeedTestError.html) callback is triggered.
...
The speed test results will be returned in [onNetworkSpeedTestQualityUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkSpeedTestQualityUpdate.html) through [ZegoNetworkSpeedTestQuality](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoNetworkSpeedTestQuality-class.html) (Network Speed Test Quality). By analyzing the parameter values, you can determine whether the current network quality is good.

The parameters in [ZegoNetworkSpeedTestQuality](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoNetworkSpeedTestQuality-class.html) are as follows:
...
Call the [stopNetworkSpeedTest](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngineUtilities/stopNetworkSpeedTest.html) interface to stop the network speed test.

After stopping the speed test, you will no longer receive [onNetworkSpeedTestQualityUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkSpeedTestQualityUpdate.html) or [onNetworkSpeedTestError](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/onNetworkSpeedTestError.html) callbacks.
