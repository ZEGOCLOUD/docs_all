...
Before creating the engine, you can set log properties by calling the [setLogConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEngine/setLogConfig.html) interface.
...
Among them, [ZegoLogConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoLogConfig-class.html) contains log-related settings (save path and maximum file size), defined as follows:
