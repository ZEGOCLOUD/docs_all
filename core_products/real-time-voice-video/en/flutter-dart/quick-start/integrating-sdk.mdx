...
<td>When modifying audio device configuration, this permission is required.
...
2. **iOS platform compilation error: "CDN: trunk URL couldn't be downloaded" or "CDN: trunk Repo update failed", how to handle?**
    ...
    This error is usually caused by poor domestic network. It is recommended to enable a proxy. Please refer to [CocoaPods FAQ](/faq/cocoapods-issues).
