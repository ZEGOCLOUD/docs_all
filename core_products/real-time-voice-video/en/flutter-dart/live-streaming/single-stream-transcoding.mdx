...
Configure the codecTemplateID property of [ZegoPlayerConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoPlayerConfig-class.html) with the transcoding template ID obtained in [Step 1: Add Transcoding Template](/real-time-video-flutter/live-streaming/single-stream-transcoding), and start playing the stream.
