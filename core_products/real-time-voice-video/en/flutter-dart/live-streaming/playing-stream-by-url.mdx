...
- 已将音视频流推送到 CDN，并知晓相应的 URL，详情请参考 [使用 CDN 直播](/real-time-video-flutter/live-streaming/using-cdn-for-live-streaming)。
...
拉流时，如果出现错误，请参考 [常见错误码 - 1004xxx 拉流相关的错误码](/real-time-video-flutter/client-sdk/error-code)。
