...
可参考 [快速开始 - 实现流程](/real-time-video-flutter/quick-start/implementing-video-call) 的 “创建引擎” 和 “登录房间”。
...
Web 平台暂不支持设置混流声浪回调。在视频场景中，不建议打开声浪开关，否则拉流端拉 HLS 协议的流可能会出现兼容性问题。
...
请参考 [快速开始 - 实现流程](/real-time-video-flutter/quick-start/implementing-video-call) 中的的 “创建引擎” 和 “登录房间” 完成初始化和房间登录。
