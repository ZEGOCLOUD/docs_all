...
Before calling [startPublishingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/startPublishingStream.html), call the [setVideoConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setVideoConfig.html) interface, set the parameter `codecID` in the [ZegoVideoConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoVideoConfig-class.html) class to `ZegoVideoCodecIDSVC` to enable layered video encoding, and call the [startPublishingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/startPublishingStream.html) interface to start publishing.
...
Through the [setPublishDualStreamConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setPublishDualStreamConfig.html) interface, separately set the resolution, frame rate, and bitrate of the large stream and small stream, and call the [startPublishingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/startPublishingStream.html) interface to start publishing.

<Warning title="Warning">
- Must specify parameters for both large stream and small stream for the [setPublishDualStreamConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setPublishDualStreamConfig.html) interface to take effect.
- The "ratio" of the resolution set for the large stream and small stream must be consistent, otherwise calling the [setPublishDualStreamConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePublisher/setPublishDualStreamConfig.html) interface will result in an error.
</Warning>
...
After the publishing end enables video dual-stream encoding, users at the playing end can call the [setPlayStreamVideoType](https://www.zegocloud.com/unique-api/express-video-sdk/en/dart_flutter/zego_express_engine/ZegoExpressEnginePlayer/setPlayStreamVideoType.html) interface before or after playing, passing specific playing parameters to pull a specific video layer. Currently supported video layers are as follows:
