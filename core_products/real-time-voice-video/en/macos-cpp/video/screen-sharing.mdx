...
- If you need to implement screen sharing functionality yourself, please refer to [How to implement screen sharing through custom capture?](/faq/custom-capture-screen-share).
</Warning>
