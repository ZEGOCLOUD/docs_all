...
| Name | Type | Description |
| --- | --- | --- |
| audioSpectrums | HashMap\<String, float[]\> | Remote audio spectrum hash map, key is the streamID, value is the audio spectrum list of the corresponding streamID. Spectrum value range is [0-2^31] |
