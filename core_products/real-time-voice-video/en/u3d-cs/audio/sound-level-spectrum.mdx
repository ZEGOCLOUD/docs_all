 ...
 * @param audioSpectrums Key-value pairs of remote audio spectrum, key is stream ID, value is the array of audio spectrum values of the corresponding stream, spectrum value range is [0-2^31]
 */
...
- [How to handle no audio issue?](https://www.zegocloud.com/docs/faq/no-audio-issue)
