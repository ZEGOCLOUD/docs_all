...
sequenceDiagram
    ...
    App->>SDK: Listen to range scene event callbacks <br/> [setEventHandler]
...
- [How to handle video pixelation or green screen issues?](https://www.zegocloud.com/docs/faq/video-artifacts)
- [How to handle audio and video out of sync issues?](https://www.zegocloud.com/docs/faq/av-sync-issue)
