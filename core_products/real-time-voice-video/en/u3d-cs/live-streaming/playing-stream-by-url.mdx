...
When playing stream, if an error occurs, please refer to [Common Error Codes - 1004xxx Play Stream Related Error Codes](/real-time-video-u3d-cs/client-sdk/error-code#1004xxx-playing-stream-related-error-codes).
