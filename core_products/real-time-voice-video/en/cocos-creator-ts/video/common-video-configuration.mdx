...
Call the [setVideoConfig](@setVideoConfig-ZegoExpressEngine) interface to modify video configurations. Users can customize parameters or use preset values for settings.
...
- [How to handle video blur issues?](https://doc-zh.zego.im/faq/video_blur)
