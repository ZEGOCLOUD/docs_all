...
Call the [startPlayingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#startplayingstream) interface to start playing stream. If an error occurs during stream playing, please refer to [Common Error Codes - 1004xxx Stream Playing Related Error Codes](/real-time-video-rn/client-sdk/error-code#1004xxx-stream-playing-related-error-codes).
...
To stop playing stream, call the [stopPlayingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#stopplayingstream) interface.
...
You can listen to the result of playing stream from CDN through [playerStateUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#playerstateupdate).

<Warning title="Warning">


If you are not using ZEGO SDK for publishing, but using third-party publishing tools to publish directly, and using ZEGO SDK for playing, in this scenario, the publishing end has not joined the room using ZEGO SDK, and the playing end will not receive the [roomStreamUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#roomstreamupdate) callback by default. You can use the [Add Room Stream](/real-time-video-server/api-reference/room/add-stream) and [Delete Room Stream](/real-time-video-server/api-reference/room/delete-stream) functions to allow the playing end to receive the [roomStreamUpdate ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#roomstreamupdate) callback.
