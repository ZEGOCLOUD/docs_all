...
Developers can register [publisherRelayCDNStateUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#publisherrelaycdnstateupdate) to get add/remove relay CDN address status callbacks. After ZEGO RTC server relays the audio and video stream to CDN, if the CDN relay status changes, such as relay stopping or relay retrying, this callback will be received.
...
Relay CDN information [ZegoStreamRelayCDNInfo](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegostreamrelaycdninfo.html) contains the URL of CDN publishing stream, relay status, reason for relay status change, and time when the status occurred. All parameters in [ZegoStreamRelayCDNInfo](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegostreamrelaycdninfo.html) are as follows:
...
Call the [removePublishCdnUrl](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#removepublishcdnurl) interface to delete the URL dynamically relayed to CDN. **When calling the [removePublishCdnUrl](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#removepublishcdnurl) interface to stop relay, please ensure that the current stream streamID exists.**
...
Before publishing stream, call the [enablePublishDirectToCDN](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#enablepublishdirecttocdn) interface to directly publish audio and video streams to CDN.

<Warning title="Warning">


- After calling the [enablePublishDirectToCDN](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#enablepublishdirecttocdn) interface, calling [addPublishCdnUrl](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#addpublishcdnurl) and [removePublishCdnUrl](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#removepublishcdnurl) to dynamically relay to CDN will no longer take effect, because these two interfaces relay or stop relaying audio and video streams from ZEGOCLOUD to CDN. If audio and video streams are directly published to CDN, they cannot be dynamically relayed to CDN through ZEGOCLOUD.
- If error code 1000038 occurs when calling the [enablePublishDirectToCDN](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#enablepublishdirecttocdn) interface, possible problems are: domain name configuration error, media network exception or media network link is empty, please contact ZEGOCLOUD Technical Support.
...
To stop direct publishing to CDN, call the [stopPublishingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#stoppublishingstream) interface to stop publishing stream.

After stopping publishing stream, if the next publishing stream does not need direct publishing to CDN, you can call the [enablePublishDirectToCDN](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#enablepublishdirecttocdn) interface and pass the value "false" to turn off the direct publishing to CDN function. Calling this interface during publishing stream will not affect this publishing stream.
