...
After starting preview or starting stream publishing, call the [enableHeadphoneMonitor ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#enableheadphonemonitor) interface to enable headphone monitor (i.e., enable capture monitoring), connect headphones, and after the user speaks, they can hear their own voice.
