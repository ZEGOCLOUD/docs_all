...
1. Call the [setVideoSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_impl_zegoexpressengineimpl_.zegoexpressengineimpl.html#setvideosource) interface to set the video capture source.
...
2. Call the [setAudioSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_impl_zegoexpressengineimpl_.zegoexpressengineimpl.html#setaudiosource) interface to set the audio capture source.
...
1. Call the [setVideoSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_impl_zegoexpressengineimpl_.zegoexpressengineimpl.html#setvideosource) interface to switch the video capture source.
...
2. Call the [setAudioSource](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_impl_zegoexpressengineimpl_.zegoexpressengineimpl.html#setaudiosource) interface to switch the audio capture source.
