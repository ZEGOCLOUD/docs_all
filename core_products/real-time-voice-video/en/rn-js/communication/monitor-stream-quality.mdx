...
You can receive publishing stream quality callbacks by registering [publisherQualityUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#publisherqualityupdate). After successfully publishing, you will receive this callback every three seconds. You can understand the health status of the published audio and video stream in real time based on the quality([ZegoPublishStreamQuality](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegopublishstreamquality.html)) parameter.

- In most cases, you only need to pay attention to the "level" parameter of "quality" to judge the comprehensive quality of the publishing stream based on the "level" enumeration value. For details, please refer to [ZegoStreamQualityLevel](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/enums/_zegoexpressdefines_.zegostreamqualitylevel.html).
- If you want to pay attention to more detailed publishing stream quality parameters, you can refer to [ZegoPublishStreamQuality](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegopublishstreamquality.html).
...
You can receive playing stream quality callbacks by registering [playerQualityUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#playerqualityupdate). After successfully playing, you will receive this callback every three seconds. Developers can understand the health status of the played audio and video stream in real time based on the quality([ZegoPlayStreamQuality](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegoplaystreamquality.html)) parameter.

- In most cases, you only need to pay attention to the "level" parameter of "quality" to judge the comprehensive quality of the playing stream based on the "level" enumeration value. For details, please refer to [ZegoStreamQualityLevel](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/enums/_zegoexpressdefines_.zegostreamqualitylevel.html).
- If you want to pay attention to more detailed playing stream quality parameters, you can refer to [ZegoPlayStreamQuality](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegoplaystreamquality.html).
...
After successfully publishing, you can receive notifications of publishing stream status changes through [publisherStateUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#publisherstateupdate).
...
After successfully playing, developers can receive notifications of playing stream status changes through [playerStateUpdate](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#playerstateupdate).
...
You can receive audio first frame callbacks by registering [publisherCapturedAudioFirstFrame](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#publishercapturedaudiofirstframe). After successfully calling the publishing interface, you will receive this callback when the SDK captures the first frame of audio data.
...
Developers can listen to the playing end audio receive first frame callback by registering [playerRecvAudioFirstFrame](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#playerrecvaudiofirstframe). After successfully calling the playing interface, you will receive this callback when the SDK plays the first frame of audio data.
...
You can listen to the playing end receive video first frame callback by registering [playerRecvVideoFirstFrame](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#playerrecvvideofirstframe). After successfully calling the playing interface, you will receive this callback when the SDK plays the first frame of video data.
...
You can listen to the playing end render video first frame callback by registering [playerRenderVideoFirstFrame](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#playerrendervideofirstframe). After successfully calling the playing interface, you will receive this callback when the SDK plays and renders the first frame of video data.
...
You can listen to the capture video size change callback by registering [publisherVideoSizeChanged](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#publishervideosizechanged). After successfully publishing, if the video capture resolution changes during publishing, you will receive this callback.
...
You can receive playing resolution change notifications by registering [playerVideoSizeChanged](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#playervideosizechanged). After successfully playing, if the video resolution changes during playing, you will receive this callback. Users can adjust the display based on the final resolution of the stream.
