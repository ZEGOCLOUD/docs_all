...
1. **Send Broadcast Message**
   ...
   Call the [sendBroadcastMessage ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#sendbroadcastmessage) interface to send broadcast messages to other users in the same room. The length cannot exceed 1024 bytes.

   Get the message sending result through the return of the [ZegoIMSendBroadcastMessageResult ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegoimsendbroadcastmessageresult.html) asynchronous result.
...
2. **Receive Broadcast Message**
   ...
   By calling ZegoExpressEngine's [on ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#on) method, set up to listen to the [IMRecvBroadcastMessage ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#imrecvbroadcastmessage) event callback. After the sender successfully sends the broadcast message, other users in the same room receive relevant information through this callback, including message content, message ID, sending time, and sender information.
...
1. **Send Barrage Message**
   ...
   Call the [sendBarrageMessage ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#sendbarragemessage) interface to send barrage messages to other users in the same room. The length cannot exceed 1024 bytes.

   Get the message sending result through the return of the [ZegoIMSendBarrageMessageResult ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegoimsendbarragemessageresult.html) asynchronous result.
...
2. **Receive Barrage Message**
   ...
   By calling ZegoExpressEngine's [on ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#on) method, set up to listen to the [IMRecvBarrageMessage ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#imrecvbarragemessage) event callback. After the sender successfully sends the barrage message, other users in the same room receive relevant information through this callback, including message content, message ID, sending time, and sender information.
...
1. **Send Custom Signaling**
   ...
   Call the [sendCustomCommand ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#sendcustomcommand) interface to send custom signaling to users specified by "toUserList" in the same room. The length cannot exceed 1024 bytes.

   Get the message sending result through the return of the [ZegoIMSendCustomCommandResult ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpressdefines_.zegoimsendcustomcommandresult.html) asynchronous result.
...
2. **Receive Custom Signaling**
    ...
    By calling ZegoExpressEngine's [on ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#on) method, set up to listen to the [IMRecvCustomCommand ](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#imrecvcustomcommand) event callback. After the sender successfully sends the custom signaling, specified users in the same room receive relevant information through this callback, including message content and message sender information.
