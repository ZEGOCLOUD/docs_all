...
Call the [setVideoConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#setvideoconfig) interface to modify video configuration. Users can either customize parameters or use preset values for configuration.

<Warning title="Warning">


You need to set the relevant video configuration before publishing stream ([startPublishingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#startpublishingstream)) or preview ([startPreview](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#startpreview)). After publishing stream, only encoding resolution and bitrate modifications are supported.
...
Call [setVideoConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#setvideoconfig) to modify publishing stream video configuration. Through this interface, you can set video frame rate, bitrate, video capture resolution, and video encoding output resolution. If not set, the default video configuration is as follows:
...
You can also use the preset combination values provided by ZEGO Express SDK. The preset combination values of [ZegoVideoConfigPreset](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/enums/_zegoexpressdefines_.zegovideoconfigpreset.html) are as follows:
...
When calling the [setVideoConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#setvideoconfig) interface to use preset values, the example code is as follows:
...
By modifying the "viewMode" parameter of the view object [ZegoView](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressdefines_.zegoview.html#viewmode), you can modify the view mode of the video. Currently, three video rendering fill modes are supported:
