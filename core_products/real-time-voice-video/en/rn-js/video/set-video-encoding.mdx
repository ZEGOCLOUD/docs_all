...
Before publishing stream ([startPublishingStream](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#startpublishingstream)), call [setVideoConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#setvideoconfig) to set the parameter "codecID" in the [ZegoVideoConfig](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressdefines_.zegovideoconfig.html) class to enable/disable layered video encoding.
...
After the publishing side enables layered video encoding, the playing side can call the [setPlayStreamVideoType](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#setplaystreamvideotype) interface before or after playing stream. The playing side will play the appropriate video layer according to network conditions by default, for example, only playing the base layer in weak network conditions. Developers can also pass in specific playing parameters to play a specific video layer. Currently supported video layers are as follows:
...
If developers need to enable hardware encoding, they can call the [enableHardwareEncoder](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#enablehardwareencoder) interface.
...
If developers need to enable hardware decoding, they can call the [enableHardwareDecoder](https://www.zegocloud.com/unique-api/express-video-sdk/en/javascript_react-native/classes/_zegoexpressengine_.zegoexpressengine.html#enablehardwaredecoder) interface.
