...
1. Install CocoaPods. If you encounter problems during installation, please refer to [CocoaPods Common Questions - Installing CocoaPods](/faq/cocoapods-issues).
...
5. Run the `pod install` command to install the SDK.
    ...
    - If "CDN: trunk URL couldn't be downloaded" problem occurs, please refer to [CocoaPods Common Questions - Unable to connect to trunk CDN problem](/faq/cocoapods-issues).
    - If "Unable to find a specification for 'ZegoExpressEngine'" problem occurs, please refer to [CocoaPods Common Questions - Unable to find project problem](/faq/cocoapods-issues).
    - If "CocoaPods could not find compatible versions for pod "ZegoExpressEngine-macOS"" problem occurs, please refer to [CocoaPods Common Questions - Unable to find project problem](/faq/cocoapods-issues).
    </Note>
