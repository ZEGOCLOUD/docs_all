...
相关接口使用可参考 [实时音视频 - 登录多房间](/real-time-video-ios-oc/room/multi-room-login) 或 [实时语音 - 登录多房间](/real-time-voice-ios/room/multi-room-login)文档。
...
相关接口使用可参考 [设置视频编码方式](/real-time-video-ios-oc/video/set-video-encoding) 文档。
