...
Set whether the local preview video and the published video have mirror mode enabled. For specific mirroring mode, please refer to [https://www.zegocloud.com/docs/real-time-video-ios-oc/introduction/overview](https://www.zegocloud.com/docs/real-time-video-ios-oc/introduction/overview)
...
| enhanceLevel | float | enhance_level [0.0,1.5], advise 0.9 |
| channel | [ZegoPublishChannel](./enum#zegopublishchannel) | Publish stream channel. |
...
- **Caution**: 
  ...
  2. The face detection function is only effective on devices that support face detection, and some devices may not support this capability. If the device does not support face detection, the SDK will not be able to obtain the detection results and will not trigger the related callbacks. 
