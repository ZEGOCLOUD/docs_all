...
1. Added support for delivery of XCFramework products, adapted to Xcode 12.3
    ...
    Please choose to download XCFramework from the [Download SDK](https://www.zegocloud.com/docs/real-time-video-ios-oc/client-sdk/download-sdk) on the developer center.
