...
2. Starting from this version, the CocoaPods project name of Express Video Call SDK is changed from `ZegoExpressEngine/Video` to `ZegoExpressEngine`, see [Integrate the SDK](/real_time_video_ios_oc/quick-start/integrating-sdk) documentation for more details.
