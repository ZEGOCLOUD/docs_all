...
When you are in the startup / trying phases, fund-seeking phase, or testing & POC phase and considering the budget issue, the [Call Kit](https://www.zegocloud.com/docs/uikit/callkit-android/overview) is your best choice to build an app in a short time.## Language and Framework Support
