...
Before starting preview and starting publishing stream, call the [enableCustomVideoProcessing](https://zegocloud.com/article/api?doc=Express_Video_SDK_API~ObjectiveC_ios~class~zego-express-engine#enable-custom-video-processing-config) interface to enable the custom video preprocessing feature.
...
1. Use "ViewController" as the custom video preprocessing callback object and conform to the [ZegoCustomVideoProcessHandler ](https://zegocloud.com/article/api?doc=Express_Video_SDK_API~ObjectiveC_ios~protocol~zego-custom-video-process-handler) protocol.
...
2. Call the [setCustomVideoProcessHandler ](https://zegocloud.com/article/api?doc=Express_Video_SDK_API~ObjectiveC_ios~class~zego-express-engine#set-custom-video-process-handler) interface to set the custom video capture callback.
