...
iOS and macOS platforms: Only support CVPixelBuffer type data, that is, the [bufferType](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~objectivec_ios~enum~ZegoVideoBufferType) of [ZegoCustomVideoCaptureConfig](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~objective-c_ios~class~ZegoCustomVideoCaptureConfig) takes the value "ZegoVideoBufferTypeCVPixelBuffer".
