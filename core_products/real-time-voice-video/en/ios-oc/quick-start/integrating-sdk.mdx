...
1. Install CocoaPods. For common problems during installation, please refer to [CocoaPods Common Questions - Installing CocoaPods](/faq/cocoapods-issues).
...
5. Execute the `pod install` command to install the SDK.
    ...
    - If the "CDN: trunk URL couldn't be downloaded" problem occurs, please refer to [CocoaPods Common Questions - Problem connecting to trunk CDN](/faq/cocoapods-issues).
    - If the "Unable to find a specification for 'ZegoExpressEngine'" problem occurs, please refer to [CocoaPods Common Questions - Problem finding project](/faq/cocoapods-issues).
    - If the "CocoaPods could not find compatible versions for pod "ZegoExpressEngine"" problem occurs, please refer to [CocoaPods Common Questions - Problem finding project](/faq/cocoapods-issues).
    </Note>
</Accordion>
...
- [How to reduce the App size of integrating Native SDK?](/faq/reduce-app-size)
- [Why does building a project with iOS simulator fail in Xcode 12.3 and later versions?](/faq/xcode-12-3-simulator-issue)
