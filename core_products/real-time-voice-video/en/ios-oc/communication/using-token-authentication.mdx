...
When running the Java source code for generating Token, if the exception "java.security.InvalidKeyException:illegal Key Size" appears, please refer to the [related FAQ document](https://doc-zh.zego.im/faq/java_illegal_key_size_solution?product=ExpressVideo&platform=all) to solve it.
</Warning>
