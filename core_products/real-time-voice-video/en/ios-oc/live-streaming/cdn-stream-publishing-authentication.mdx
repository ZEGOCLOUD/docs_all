...
- AppID 主营业务地区为 `大陆`，请参考 [腾讯云鉴权说明](/real-time-video-ios-oc/live-streaming/cdn-stream-publishing-authentication) 或 [华为云鉴权说明](/real-time-video-ios-oc/live-streaming/cdn-stream-publishing-authentication)。
- AppID 主营业务地区为 `港澳台或海外`，请参考 [网宿云鉴权说明](/real-time-video-ios-oc/live-streaming/cdn-stream-publishing-authentication)。
