...
<p>该参数与 <a href="/real-time-video-server/callback/room/logged-in">登录房间回调</a>、<a href="/real-time-video-server/callback/room/logged-out">退出房间回调</a> 中的参数 room_seq 一致。</p></td>
</tr>
<tr>
<td>close_reason</td>
<td>UInt32</td>
...
<li>3：房间内的最后一个用户被 <a href="/real-time-video-server/api-reference/room/kick-out-user">Kickout</a>，房间无人，所以关闭。</li>
</ul>
</td>
</tr>
<tr>
