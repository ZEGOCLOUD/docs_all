...
若指定场景后，开发者有对 SDK 音视频配置精细化控制的需求，可通过其他 API 进行配置，优先级高于场景化配置，详情请参考 [常用视频配置](/real-time-video-cocos-creator/video/common-video-configuration)、[流量控制](/real-time-voice-cocos-creator/communication/traffic-control) 文档。
