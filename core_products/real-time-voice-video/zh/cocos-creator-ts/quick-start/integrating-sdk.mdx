...
<Note title="说明">
    请勿使用 Cocos Creator v3.6.2 版本，详情请参考下方 <a href="#Q6">常见问题 6</a>。
</Note>
...
1. 请参考 [下载 SDK](/real-time-video-cocos-creator/client-sdk/download-sdk) 文档，下载最新版本的 SDK。
...
修改音频设备配置时需要使用该权限。
<Warning title="注意">
<p>SDK 无修改音频设备的权限，会导致应用无法在听筒、扬声器及其他音频路由之间切换。</p>
</Warning>
</td>
</tr>
<tr>
...
按照实际需要添加摄像头和麦克风权限声明，详情请参考 [iOS](/real-time-video-cocos-creator/quick-start/integrating-sdk)。
...
3. 请参考 [导入 SDK](/real-time-video-cocos-creator/quick-start/integrating-sdk) 的“第 6 步”中关于 Android 工程的提示：通过终端输入 `open -a "Android Studio"` 来启动 Android Studio。
...
未完整集成 SDK，请参考 [导入 SDK](/real-time-video-cocos-creator/quick-start/integrating-sdk) 的“第 6 步”中关于 Android 工程的额外处理步骤。
...
请参考 [导入 SDK](/real-time-video-cocos-creator/quick-start/integrating-sdk) 中的“第 6 步”，关于 iOS 工程的额外处理步骤进行处理。
