...
<Note title="说明">
    请勿使用 Cocos Creator v3.6.2 版本，详情请参考下方 <a href="!Integration/SDK_Integration#Q6">常见问题 6</a>。
</Note>
...
- 根据需要运行的平台，确保对应的开发环境和设备。
  ...
  - 满足 Express Web SDK 兼容性的浏览器（具体请参考 [浏览器兼容性和已知问题](/real-time-video-web/over-view/browser-restrictions)），推荐使用最新版本的 Google Chrome 浏览器。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Common/cocos_dashboard_new_project.png" /></Frame>
</Accordion>
...
1. 请参考 [下载 SDK](!DownloadSDK/DownloadSDK) 文档，下载最新版本的 SDK。

2. 打开 “Extensions > Extensions Manager”，在项目选项卡下，单击加号，添加扩展，选择上一步下载下来的 SDK 压缩包。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_extension_manager.png" /></Frame>
...
3. 添加完成后，确认扩展管理器中有 zego_express_cocos_creator_sdk 并处于启用状态，然后查看资源管理器，在 assets 目录下，应当存在一个 “zego_express_engine” 目录，里面为 SDK 的 TypeScript 层源码。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_scripts_in_assets.png" /></Frame>
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_gitignore.png" /></Frame>
...
5. 将 “native/engine” 原生工程配置文件纳入 git 跟踪。
    ...
    <a name="step6"></a>
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Common/cocos_gitignore_native_engine.png" /></Frame>
...
6. 部分平台需要做一些额外处理。
    ...
    - Android
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_gradle_jni_libs.png" /></Frame>
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_gradle_jar.png" /></Frame>
    ...
    - iOS
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Common/cocos_cmake_set_ios_variant.png" /></Frame>
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Common/cocos_ios_target_os_config.png" /></Frame>
...
以下简单示例在 App 启动时申请权限，也可以根据实际情况在合适的时机申请（在调用 SDK 的 [createEngine](@createEngine) 前申请即可）。
...
2. 单击 “+” 添加按钮，根据实际应用需要，添加摄像头和麦克风权限。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/iOS/ZegoExpressEngine/Common/privacy-description-done.png" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Common/cocos_apple_privacy_info_plist.png" /></Frame>

### macOS

按照实际需要添加摄像头和麦克风权限声明，详情请参考 [iOS](!Integration/SDK_Integration#3_2)。
...
3. 请参考 [导入 SDK](!Integration/SDK_Integration#step6) 的“第 6 步”中关于 Android 工程的提示：通过终端输入 `open -a "Android Studio"` 来启动 Android Studio。
4. 启动 Android Studio 后，先在菜单栏中，选择 “Build > Clean Project” 清理构建缓存，然后在菜单栏中，选择 “File > Invalidate Caches...”，清除 IDE 缓存并重启 Android Studio。

<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_android_src.png" /></Frame>
...
未完整集成 SDK，请参考 [导入 SDK](!Integration/SDK_Integration#step6) 的“第 6 步”中关于 Android 工程的额外处理步骤。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Common/cocos_project_setting_antialias.png" /></Frame>
...
请参考 [导入 SDK](!Integration/SDK_Integration#step6) 中的“第 6 步”，关于 iOS 工程的额外处理步骤进行处理。
