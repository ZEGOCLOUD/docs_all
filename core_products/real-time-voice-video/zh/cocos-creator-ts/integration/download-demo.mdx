...
## 获取示例源码
<CardGroup cols={2}>
<Card title="示例源码" href="https://storage.zego.im/express/example/video/cocos_creator/ZegoExpressDemo_cocos_creator.zip" target="_blank">
本地下载
</Card>
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_add_project.png" /></Frame>

4. 加载示例工程后，控制台会报大量错误，原因是下载的示例源码中缺少 SDK，因此需要先 [下载 SDK 包](!DownloadSDK/DownloadSDK) （无需解压）。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_extension_manager.png" /></Frame>

<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_import_sdk.png" /></Frame>

7. 示例源码中缺少 SDK 初始化所需的 AppID 和 AppSign，请使用 VS Code 打开示例源码工程，修改 assets/KeyCenter.ts 文件，请使用本文 [前提条件](!ExpressVideoSDK-DownloadDemo/DownloadDemo#1_2) 已获取的 AppID 和 AppSign 正确填写，否则示例源码无法正常运行。

<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_key_center.png" /></Frame>
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_home_scene.png" /></Frame>
...
<Note title="说明">
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_build_manager.png" /></Frame>
...
<Note title="说明">
        若生成失败，请参考 [集成 SDK](/real-time-video-cocos-creator/integration/sdk-integration#常见问题) 文档中的常见问题 1、2、3 进行操作。

        
</Note>

        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_run_android.png" /></Frame>
...
<Warning title="注意">
        ...
        - 若要构建 iOS 模拟器架构，请参考 [集成 SDK](!Integration/SDK_Integration#step6_ios) 文档 “2.2 导入 SDK” 中关于 iOS 工程的额外处理步骤。
        - 若生成失败，请参考 [集成 SDK](!Integration/SDK_Integration#Q7) 文档中的常见问题 7 进行操作。
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_run_xcode.png" /></Frame>

        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_run_ios.png" /></Frame>
...
<Note title="说明">
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_run_macos.png" /></Frame>
    ...
    - 运行到 Windows 设备：
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/CocosCreator/Express/cocos_express_demo_run_windows.png" /></Frame>
