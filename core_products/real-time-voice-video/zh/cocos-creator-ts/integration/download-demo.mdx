    ...
    <div class="download-selector">
      ...
      <div class="download-select-wrapper">
        ...
        <ul class="download-dropdown-list">
          <li data-href="https://storage.zego.im/express/example/video/cocos_creator/ZegoExpressDemo_cocos_creator.zip"
            class="dropdown-option">
            本地下载
          </li>
          <li data-href="https://github.com/zegoim/zego_express_cocos_creator_sdk/releases/"
            class="dropdown-option">
            Github
          </li>
        </ul>
...
- 使用 [Cocos Creator\|_blank](https://www.cocos.com/creator-download) v3.6.0 或以上版本（建议通过 Cocos Dashboard 下载最新的版本）。
...
您可以从 [Github\|_blank](https://github.com/zegoim/zego_express_cocos_creator_sdk/releases/) 下载其他 Cocos Creator 编辑器版本的示例 Demo 源码。
...
<img src="/Pics/CocosCreator/Express/cocos_express_demo_add_project.png">

4. 加载示例工程后，控制台会报大量错误，原因是下载的示例源码中缺少 SDK，因此需要先 [下载 SDK 包\|_blank](!DownloadSDK/DownloadSDK) （无需解压）。
...
<img src="/Pics/CocosCreator/Express/cocos_express_demo_extension_manager.png">

<img src="/Pics/CocosCreator/Express/cocos_express_demo_import_sdk.png">
...
<img src="/Pics/CocosCreator/Express/cocos_express_demo_key_center.png">
...
<img src="/Pics/CocosCreator/Express/cocos_express_demo_home_scene.png">

10. 在菜单栏选择“Project > Build”，先根据 Cocos Creator [安装配置原生开发环境\|_blank](https://docs.cocos.com/creator/manual/zh/editor/publish/setup-native-development.html) 文档配置好开发环境，然后再根据 [发布到原生平台\|_blank](https://docs.cocos.com/creator/manual/zh/editor/publish/native-options.html) 文档和实际情况，构建出原生平台工程。
    ...
    <img src="/Pics/CocosCreator/Express/cocos_express_demo_build_manager.png">
...
11. 开始运行。
    ...
    - 运行到 Android 设备：
        ...
        若生成失败，请参考 [集成 SDK\|_blank](16919#Q1) 文档中的常见问题 1、2、3 进行操作。

        </div>

        <img src="/Pics/CocosCreator/Express/cocos_express_demo_run_android.png">
    ...
    - 运行到 iOS 设备：
        ...
        - 若要构建 iOS 模拟器架构，请参考 [集成 SDK\|_blank](!Integration/SDK_Integration#step6_ios) 文档 “2.2 导入 SDK” 中关于 iOS 工程的额外处理步骤。
        - 若生成失败，请参考 [集成 SDK\|_blank](!Integration/SDK_Integration#Q7) 文档中的常见问题 7 进行操作。

        </div>

        <img src="/Pics/CocosCreator/Express/cocos_express_demo_run_xcode.png">

        <img src="/Pics/CocosCreator/Express/cocos_express_demo_run_ios.png">
    ...
    - 运行到 macOS 设备：
        ...
        <img src="/Pics/CocosCreator/Express/cocos_express_demo_run_macos.png">
    ...
    - 运行到 Windows 设备：
        ...
        <img src="/Pics/CocosCreator/Express/cocos_express_demo_run_windows.png">
