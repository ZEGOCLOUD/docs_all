...
<ParamField
  name="destroyEngine"
  prototype="  destroyEngine(callback?: ZegoDestroyCompletionCallback): void"
...
<ParamField
  name="uploadLog"
  prototype="  uploadLog(callback?: ZegoUploadLogResultCallback): void"
...
<ParamField
  name="loginRoom"
  prototype="  loginRoom(roomID: string, user: [ZegoUser](./struct#zegouser), config?: [ZegoRoomConfig](./struct#zegoroomconfig), callback?: ZegoRoomLoginCallback): void"
...
<ParamField
  name="logoutRoom"
  prototype="  logoutRoom(roomID?: string, callback?: ZegoRoomLogoutCallback): void"
...
<ParamField
  ...
  prototype="  setRoomExtraInfo(roomID: string, key: string, value: string, callback?: ZegoRoomSetRoomExtraInfoCallback): void"
  desc="设置房间附加消息。"
  parent_file="Declared in \`ZegoExpressEngine.ts\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="  setStreamExtraInfo(extraInfo: string, channel?: [ZegoPublishChannel](./enum#zegopublishchannel), callback?: ZegoPublisherSetStreamExtraInfoCallback): void"
  desc="设置指定推流通道的流附加信息。"
  parent_file="Declared in \`ZegoExpressEngine.ts\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="  sendCustomCommand(roomID: string, command: string, toUserList: [ZegoUser](./struct#zegouser)[], callback?: ZegoIMSendCustomCommandCallback): void"
  desc="发送自定义信令。"
  parent_file="Declared in \`ZegoExpressEngine.ts\`"
  parent_name="ZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="  loadResourceWithConfig(resource: [ZegoMediaPlayerResource](./struct#zegomediaplayerresource), callback?: ZegoMediaPlayerLoadResourceCallback): void"
