...
若您需要使用基础美颜功能，则必须在 [startPreview\|_blank](@startPreview) 开始预览前或者 [startPublishingStream\|_blank](@startPublishingStream) 推流前，调用 [startEffectsEnv\|_blank](@startEffectsEnv) 接口初始化美颜环境。
