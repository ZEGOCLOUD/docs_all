...
请参考 [网络与性能](/real-time-video-android-java/communication-capability/testing-network) 进行操作。
...
* @param errorCode 错误码，请参考常见错误码：/real-time-video-android-java/error-code#7。
*/
...
* @param state 播放器状态。
* @param errorCode 错误码，详情请参考常见错误码文档：/real-time-video-android-java/error-code#7。
*/
