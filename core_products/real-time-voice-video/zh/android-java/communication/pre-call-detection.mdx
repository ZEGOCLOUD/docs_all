...
* @param errorCode 错误码，请参考常见错误码：/real-time-video-android-java/client-sdk/error-code#1006xxx-设备错误。
*/
...
* @param state 播放器状态。
* @param errorCode 错误码，详情请参考常见错误码文档：/real-time-video-android-java/client-sdk/error-code#1006xxx-设备错误。
*/
