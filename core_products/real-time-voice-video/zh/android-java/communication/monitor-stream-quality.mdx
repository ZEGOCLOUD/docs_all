...
[onNetworkQuality](@onNetworkQuality) 不适用于使用 CDN 进行直播的场景，您可以参考 [进阶质量报告 - 推流质量报告](/real-time-video-android-java/communication/monitor-stream-quality) 监测 CDN 的推流质量。
</Warning>
...
## MOS 音质评分 <a id="mos-audio-quality-score" />
