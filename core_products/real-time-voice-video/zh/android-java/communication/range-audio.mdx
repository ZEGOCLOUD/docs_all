...
<p>上图仅以范围语音模式为“全世界”时为例，更多不同模式组合关系下的声音可达情况请参考 <a href="#可选设置通用语音模式">设置通用语音模式</a>。</p>
</td>
</tr>
<tr>
<td>3D 音效</td>
...
<Note title="说明">
<ul><li>队友之间的通话不受“范围”和 “3D 音效” 的影响，详情请查看 <a href="#可选设置通用语音模式">设置通用语音模式</a>。</li><li>如果您希望自定义语音收发能力，请参考 <a href="#可选设置自定义语音模式">设置自定义语音模式</a>。</li></ul>
</Note>
</td>
</tr>
</tbody></table>
