    ...
    void loginRoom() {
        ...
        engine.loginRoom(roomID, user, roomConfig, (int error, JSONObject extendedData)->{
            ...
            if (error == 0) {
                ...
                // 登录失败，请参考 errorCode 说明 /real-time-video-android-java/error-code
                Toast.makeText(this, "登录失败，请参考 errorCode 说明 /real-time-video-android-java/error-code", Toast.LENGTH_LONG).show();
            }
        });
    }
...
<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/QuickStart/express_quickstart_video_call.png" />
</Frame>
