...
##### 前置条件
- 已在项目中集成 ZEGO Express SDK，实现基本的实时音视频功能，详情请参考 [快速开始 - 集成](https://doc-zh.zego.im/article/196) 和 [快速开始 - 实现流程](https://doc-zh.zego.im/article/7628)。
...
秒拉方案的具体的实现步骤，如下图：
![/Pics/quickplay1.png](http://doc.oa.zego.im/Pics/quickplay1.png)
...
大厅模式的步骤流程图如下：
![/Pics/quickplay2.png](http://doc.oa.zego.im/Pics/quickplay2.png)
