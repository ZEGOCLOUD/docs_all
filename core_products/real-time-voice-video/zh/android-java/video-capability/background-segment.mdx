...
<tr>
<th>图示</th>
<td><Frame width="512" height="512" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/subject_segmentation/people_with_greenscreen.png" /></Frame></td>
<td><Frame width="512" height="512" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/subject_segmentation/people_with_realenvironment.jpg" /></Frame></td>
</tr>
</tbody></table>
...
请参考 [下载示例源码](/real-time-video-android-java/integration/download-demo) 获取源码。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/subject_segmentation/subject_segmentation_android.png" /></Frame>
...
通过以下方式，实现自定义渲染的性能较低，ZEGO 建议您使用 OpenGL ES 进行渲染，提升渲染性能，具体可参考 [跑通示例源码](/real-time-video-android-java/integration/download-demo) 实现。
</Note>
