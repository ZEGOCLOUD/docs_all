...
[ZegoWatermark](@-ZegoWatermark) 对象中的 [imageURL](@imageURL) 参数支持传三种路径格式：绝对路径、Assets、Android URI 路径。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Android/ExpressSDK/WaterMark/android_asset.png" /></Frame>
...
1. **[ZegoWatermark](@-ZegoWatermark) 中的 [imageURL](@imageURL) 如何指定？**
...
2. **[ZegoWatermark](@-ZegoWatermark) 中的 layout 如何指定？**
