...
2. 进入 “app” 目录，打开 “build.gradle” 文件，在 “dependencies” 中添加 `implementation 'im.zego:express-video:x.y.z'`，请从 [发布日志](/real-time-video-android-java/client-sdk/release-notes) 查询 SDK 最新版本，并将 `x.y.z` 修改为具体的版本号。
