...
1. 调用 [pause ](@pause) 方法可以暂停播放 audioEffectID 指定的音效，调用 [pauseAll ](/zh/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-audio-effect-player#pause-all) 方法则暂停所有正在播放的音效。
