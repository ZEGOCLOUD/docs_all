...
<ParamField
  ...
  parent_type="class">
<Tip title="Return">AI 变声器实例编号。</Tip>
</ParamField>
<ParamField
...
<ParamField
  ...
  prototype="public  void onGetSpeakerList([IZegoAIVoiceChanger](#IZegoAIVoiceChanger)* aiVoiceChanger, int errorCode, const std::vector<[ZegoAIVoiceChangerSpeakerInfo](./struct.mdx#ZegoAIVoiceChangerSpeakerInfo)>& speakerList)"
...
| aiVoiceChanger | [IZegoAIVoiceChanger](#IZegoAIVoiceChanger)* | 回调的 AI 变声器实例。 |
| errorCode | int | 错误码，详情请参考 常见错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html) |
| speakerList | const std::vector\<[ZegoAIVoiceChangerSpeakerInfo](./struct.mdx#ZegoAIVoiceChangerSpeakerInfo)>& | 可用音色列表。 |
...
<ParamField
  name="onEvent"
  prototype="public  void onEvent([IZegoAIVoiceChanger](#IZegoAIVoiceChanger)* aiVoiceChanger, [ZegoAIVoiceChangerEvent](./enum.mdx#ZegoAIVoiceChangerEvent) event)"
  desc="AI 变声事件回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoAIVoiceChangerEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| aiVoiceChanger | [IZegoAIVoiceChanger](#IZegoAIVoiceChanger)* | 回调的 AI 变声器实例。 |
| event | [ZegoAIVoiceChangerEvent](./enum.mdx#ZegoAIVoiceChangerEvent) | AI 变声事件。 |
...
<ParamField
  ...
  prototype="public  void onCapturedAudioData(const unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
...
| param | [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) | 音频帧参数。 |
...
<ParamField
  ...
  prototype="public  void onPlaybackAudioData(const unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
...
<ParamField
  ...
  prototype="public  void onMixedAudioData(const unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
...
<ParamField
  ...
  prototype="public  void onPlayerAudioData(const unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param, std::string streamID)"
...
<ParamField
  name="start"
  prototype="public  void start(unsigned int audioEffectID, std::string path, [ZegoAudioEffectPlayConfig](./struct.mdx#ZegoAudioEffectPlayConfig) config)"
  desc="开始播放音效。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoAudioEffectPlayer"
  parent_type="class">
...
| config | [ZegoAudioEffectPlayConfig](./struct.mdx#ZegoAudioEffectPlayConfig) | 音效播放配置。&lt;br&gt;默认值：传空则仅播放一次，且不会混音入推流中。 |
...
<ParamField
  name="seekTo"
  prototype="public  void seekTo(unsigned int audioEffectID, unsigned long long millisecond, [ZegoAudioEffectPlayerSeekToCallback](./interface.mdx#ZegoExpressDefines#zego-audio-effect-player-seek-to-callback) callback)"
  desc="设置播放进度。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoAudioEffectPlayer"
  parent_type="class">
...
| callback | [ZegoAudioEffectPlayerSeekToCallback](./interface.mdx#ZegoExpressDefines#zego-audio-effect-player-seek-to-callback) | 指定播放进度结果。 |
...
<ParamField
  name="loadResource"
  prototype="public  void loadResource(unsigned int audioEffectID, std::string path, [ZegoAudioEffectPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-audio-effect-player-load-resource-callback) callback)"
  desc="加载音效资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoAudioEffectPlayer"
  parent_type="class">
...
| callback | [ZegoAudioEffectPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-audio-effect-player-load-resource-callback) | 加载音效资源结果回调。 |
...
<ParamField
  ...
  prototype="public  void onAudioEffectPlayStateUpdate([IZegoAudioEffectPlayer](#IZegoAudioEffectPlayer)* audioEffectPlayer, unsigned int audioEffectID, [ZegoAudioEffectPlayState](./enum.mdx#ZegoAudioEffectPlayState) state, int errorCode)"
  desc="音效播放状态回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| state | [ZegoAudioEffectPlayState](./enum.mdx#ZegoAudioEffectPlayState) | 音效的播放状态。 |
| errorCode | int | 错误码，详情请参考 常见错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html) |
...
<ParamField
  ...
  prototype="public  void onAudioMixingCopyData([ZegoAudioMixingData](./struct.mdx#ZegoAudioMixingData)* data)"
  desc="混音数据回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| data | [ZegoAudioMixingData](./struct.mdx#ZegoAudioMixingData)* | 混音数据。注意此参数为入参，需要开发者修改其中的值。 |
...
<Tip title="Return">开发者提供的期望混入推流中的音频数据。</Tip>
</ParamField>
...
<ParamField
  ...
  prototype="public  void initCopyrightedMusic([ZegoCopyrightedMusicConfig](./struct.mdx#ZegoCopyrightedMusicConfig) config, [ZegoCopyrightedMusicInitCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-init-callback) callback)"
  desc="初始化版权音乐模块。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicConfig](./struct.mdx#ZegoCopyrightedMusicConfig) | 版权音乐配置。 |
| callback | [ZegoCopyrightedMusicInitCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-init-callback) | 初始化结果 |
...
<Tip title="Return">缓存文件大小，单位 byte。</Tip>
</ParamField>
<ParamField
  name="clearCache"
...
<ParamField
  ...
  prototype="public  void sendExtendedRequest(std::string command, std::string params, [ZegoCopyrightedMusicSendExtendedRequestCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-send-extended-request-callback) callback)"
  desc="发送扩展功能请求。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| command | std::string | 请求命令，具体支持的命令请参考 [https://doc-zh.zego.im/article/15077](https://doc-zh.zego.im/article/15077) |
| params | std::string | 请求参数，每个请求命令具备对应的请求参数，请参考 [https://doc-zh.zego.im/article/15077](https://doc-zh.zego.im/article/15077) |
| callback | [ZegoCopyrightedMusicSendExtendedRequestCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-send-extended-request-callback) | 发送扩展功能请求结果 |
...
<ParamField
  name="getLrcLyric"
  prototype="public  void getLrcLyric(std::string songID, [ZegoCopyrightedMusicVendorID](./enum.mdx#ZegoCopyrightedMusicVendorID) vendorID, [ZegoCopyrightedMusicGetLrcLyricCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-lrc-lyric-callback) callback)"
  desc="获取 lrc 格式歌词。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| vendorID | [ZegoCopyrightedMusicVendorID](./enum.mdx#ZegoCopyrightedMusicVendorID) | 版权方。 |
| callback | [ZegoCopyrightedMusicGetLrcLyricCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-lrc-lyric-callback) | 获取 lrc 格式歌词结果 |
...
<ParamField
  name="getLrcLyric"
  prototype="public  void getLrcLyric([ZegoCopyrightedMusicGetLyricConfig](./struct.mdx#ZegoCopyrightedMusicGetLyricConfig) config, [ZegoCopyrightedMusicGetLrcLyricCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-lrc-lyric-callback) callback)"
  desc="获取 lrc 格式歌词。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicGetLyricConfig](./struct.mdx#ZegoCopyrightedMusicGetLyricConfig) | 获取歌词的配置。 |
| callback | [ZegoCopyrightedMusicGetLrcLyricCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-lrc-lyric-callback) | 获取 lrc 格式歌词结果 |
...
<ParamField
  ...
  prototype="public  void getKrcLyricByToken(std::string krcToken, [ZegoCopyrightedMusicGetKrcLyricByTokenCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-krc-lyric-by-token-callback) callback)"
  desc="获取逐字歌词。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| krcToken | std::string | 通过调用 [requestResource] 点伴奏或点高潮片段、或调用 [getSharedResource] 接口获取分享资源时获取的 krcToken。详情请参考 [https://doc-zh.zego.im/article/15079#2_2](https://doc-zh.zego.im/article/15079#2_2) |
| callback | [ZegoCopyrightedMusicGetKrcLyricByTokenCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-krc-lyric-by-token-callback) | 获取逐字格式歌词结果。 |
...
<ParamField
  ...
  prototype="public  void requestResource([ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) config, [ZegoCopyrightedMusicResourceType](./enum.mdx#ZegoCopyrightedMusicResourceType) type, [ZegoCopyrightedMusicRequestResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-resource-callback) callback)"
  desc="获取音乐资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) | 获取音乐资源的配置。 |
| type | [ZegoCopyrightedMusicResourceType](./enum.mdx#ZegoCopyrightedMusicResourceType) | 版权音乐资源类型。 |
| callback | [ZegoCopyrightedMusicRequestResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-resource-callback) | 获取音乐资源结果回调。 |
...
<ParamField
  name="requestResource"
  prototype="public  void requestResource([ZegoCopyrightedMusicRequestConfigV2](./struct.mdx#ZegoCopyrightedMusicRequestConfigV2) config, [ZegoCopyrightedMusicRequestResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-resource-callback) callback)"
  desc="获取音乐资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfigV2](./struct.mdx#ZegoCopyrightedMusicRequestConfigV2) | 获取音乐资源的配置。 |
| callback | [ZegoCopyrightedMusicRequestResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-resource-callback) | 获取音乐资源结果回调。 |
...
<ParamField
  ...
  prototype="public  void getSharedResource([ZegoCopyrightedMusicGetSharedConfig](./struct.mdx#ZegoCopyrightedMusicGetSharedConfig) config, [ZegoCopyrightedMusicResourceType](./enum.mdx#ZegoCopyrightedMusicResourceType) type, [ZegoCopyrightedMusicGetSharedResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-shared-resource-callback) callback)"
  desc="获取分享歌曲资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicGetSharedConfig](./struct.mdx#ZegoCopyrightedMusicGetSharedConfig) | 获取分享歌曲资源的配置。 |
| type | [ZegoCopyrightedMusicResourceType](./enum.mdx#ZegoCopyrightedMusicResourceType) | 版权音乐资源类型。 |
| callback | [ZegoCopyrightedMusicGetSharedResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-shared-resource-callback) | 获取分享音乐资源结果回调。 |
...
<ParamField
  name="getSharedResource"
  prototype="public  void getSharedResource([ZegoCopyrightedMusicGetSharedConfigV2](./struct.mdx#ZegoCopyrightedMusicGetSharedConfigV2) config, [ZegoCopyrightedMusicGetSharedResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-shared-resource-callback) callback)"
  desc="获取分享歌曲资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicGetSharedConfigV2](./struct.mdx#ZegoCopyrightedMusicGetSharedConfigV2) | 获取分享歌曲资源的配置。 |
| callback | [ZegoCopyrightedMusicGetSharedResourceCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-shared-resource-callback) | 获取分享音乐资源结果回调。 |
...
<ParamField
  name="download"
  prototype="public  void download(std::string resourceID, [ZegoCopyrightedMusicDownloadCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-download-callback) callback)"
  desc="下载音乐资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| callback | [ZegoCopyrightedMusicDownloadCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-download-callback) | 下载载歌曲或伴奏结果。 |
...
<ParamField
  name="queryCache"
  prototype="public  bool queryCache([ZegoCopyrightedMusicQueryCacheConfig](./struct.mdx#ZegoCopyrightedMusicQueryCacheConfig) config)"
  desc="查询资源是否有缓存。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicQueryCacheConfig](./struct.mdx#ZegoCopyrightedMusicQueryCacheConfig) | 查询资源缓存的配置。 |
...
<ParamField
  name="queryCache"
  prototype="public  bool queryCache([ZegoCopyrightedMusicQueryCacheConfigV2](./struct.mdx#ZegoCopyrightedMusicQueryCacheConfigV2) config)"
  desc="查询资源是否有缓存。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicQueryCacheConfigV2](./struct.mdx#ZegoCopyrightedMusicQueryCacheConfigV2) | 查询资源缓存的配置。 |
...
<ParamField
  ...
  prototype="public  void getStandardPitch(std::string resourceID, [ZegoCopyrightedMusicGetStandardPitchCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-standard-pitch-callback) callback)"
  desc="获取标准音高数据。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoCopyrightedMusic"
  parent_type="class">
...
| --- | --- | --- |
| resourceID | std::string | 伴奏或高潮片段对应的资源 ID。 |
| callback | [ZegoCopyrightedMusicGetStandardPitchCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-standard-pitch-callback) | 获取标准音高数据结果。 |
...
<ParamField
  name="requestSong"
  prototype="public  void requestSong([ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) config, [ZegoCopyrightedMusicRequestSongCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-song-callback) callback)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) | 请求配置。 |
| callback | [ZegoCopyrightedMusicRequestSongCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-song-callback) | 点歌结果 |
...
<ParamField
  ...
  prototype="public  void requestAccompaniment([ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) config, [ZegoCopyrightedMusicRequestAccompanimentCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-accompaniment-callback) callback)"
...
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) | 请求配置。 |
| callback | [ZegoCopyrightedMusicRequestAccompanimentCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-accompaniment-callback) | 点伴奏结果。 |
...
<ParamField
  ...
  prototype="public  void requestAccompanimentClip([ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) config, [ZegoCopyrightedMusicRequestAccompanimentClipCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-accompaniment-clip-callback) callback)"
...
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfig](./struct.mdx#ZegoCopyrightedMusicRequestConfig) | 请求配置。 |
| callback | [ZegoCopyrightedMusicRequestAccompanimentClipCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-request-accompaniment-clip-callback) | 点伴奏高潮片段结果。 |
...
<ParamField
  ...
  prototype="public  void getMusicByToken(std::string shareToken, [ZegoCopyrightedMusicGetMusicByTokenCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-music-by-token-callback) callback)"
...
| callback | [ZegoCopyrightedMusicGetMusicByTokenCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-music-by-token-callback) | 获取歌曲或伴奏结果。 |
...
<ParamField
  name="getLrcLyric"
  prototype="public  void getLrcLyric(std::string songID, [ZegoCopyrightedMusicGetLrcLyricCallback](./interface.mdx#ZegoExpressDefines#zego-copyrighted-music-get-lrc-lyric-callback) callback)"
...
<ParamField
  name="queryCache"
  prototype="public  bool queryCache(std::string songID, [ZegoCopyrightedMusicType](./enum.mdx#ZegoCopyrightedMusicType) type)"
...
| --- | --- | --- |
| songID | std::string | 歌曲或伴奏的 ID，一首歌的歌曲和伴奏共用同一个 ID。 |
| type | [ZegoCopyrightedMusicType](./enum.mdx#ZegoCopyrightedMusicType) | 歌曲资源类型。 |
...
<ParamField
  name="queryCache"
  prototype="public  bool queryCache(std::string songID, [ZegoCopyrightedMusicType](./enum.mdx#ZegoCopyrightedMusicType) type, [ZegoCopyrightedMusicVendorID](./enum.mdx#ZegoCopyrightedMusicVendorID) vendorID)"
...
<ParamField
  ...
  prototype="public  void onProcessCapturedAudioData(unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam)* param, double timestamp)"
...
<ParamField
  ...
  prototype="public  void onProcessCapturedAudioDataAfterUsedHeadphoneMonitor(unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam)* param, double timestamp)"
...
<ParamField
  ...
  prototype="public  void onBeforeAudioPrepAudioData(const unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
...
<ParamField
  ...
  prototype="public  void onProcessRemoteAudioData(unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam)* param, std::string streamID, double timestamp)"
...
<ParamField
  ...
  prototype="public  void onProcessPlaybackAudioData(unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam)* param, double timestamp)"
...
<ParamField
  name="onStart"
  prototype="public  void onStart([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="自定义视频采集开始的通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  name="onStop"
  prototype="public  void onStop([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="自定义视频采集结束的通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoCustomVideoCaptureHandler"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void onEncodedDataTrafficControl([ZegoTrafficControlInfo](./struct.mdx#ZegoTrafficControlInfo) trafficControlInfo, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| trafficControlInfo | [ZegoTrafficControlInfo](./struct.mdx#ZegoTrafficControlInfo) | 流控参数。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void onCapturedUnprocessedRawData(const unsigned char** data, unsigned int* dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) param, unsigned long long referenceTimeMillisecond, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="当获取到原始视频数据时回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| param | [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) | 视频帧参数。 |
...
<ParamField
  ...
  prototype="public  void onCapturedUnprocessedCVPixelBuffer(void * buffer, unsigned long long referenceTimeMillisecond, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void onCapturedVideoFrameRawData(unsigned char** data, unsigned int* dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) param, [ZegoVideoFlipMode](./enum.mdx#ZegoVideoFlipMode) flipMode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| param | [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) | 视频帧参数。 |
| flipMode | [ZegoVideoFlipMode](./enum.mdx#ZegoVideoFlipMode) | 视频帧翻转模式。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void onRemoteVideoFrameRawData(unsigned char** data, unsigned int* dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) param, std::string streamID)"
...
<ParamField
  ...
  prototype="public  void onRemoteVideoFrameEncodedData(const unsigned char* data, unsigned int dataLength, [ZegoVideoEncodedFrameParam](./struct.mdx#ZegoVideoEncodedFrameParam) param, unsigned long long referenceTimeMillisecond, std::string streamID)"
...
| dataLength | unsigned int | 数据的长度。 |
| param | [ZegoVideoEncodedFrameParam](./struct.mdx#ZegoVideoEncodedFrameParam) | 视频帧参数。 |
| referenceTimeMillisecond | unsigned long long | 视频帧的索引时间，UNIX 时间戳，单位为毫秒。 |
| streamID | std::string | 拉流的流 ID。 |
...
<ParamField
  ...
  prototype="public  void onCapturedDataRecordStateUpdate([ZegoDataRecordState](./enum.mdx#ZegoDataRecordState) state, int errorCode, [ZegoDataRecordConfig](./struct.mdx#ZegoDataRecordConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| state | [ZegoDataRecordState](./enum.mdx#ZegoDataRecordState) | 文件录制状态。 |
| errorCode | int | 错误码，详情请参考 常见错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html) |
| config | [ZegoDataRecordConfig](./struct.mdx#ZegoDataRecordConfig) | 录制配置对象。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void onCapturedDataRecordProgressUpdate([ZegoDataRecordProgress](./struct.mdx#ZegoDataRecordProgress) progress, [ZegoDataRecordConfig](./struct.mdx#ZegoDataRecordConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="录制进度更新回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoDataRecordEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| progress | [ZegoDataRecordProgress](./struct.mdx#ZegoDataRecordProgress) | 文件录制过程进度，开发者可以此对用户界面进行 UI 的提示等。 |
| config | [ZegoDataRecordConfig](./struct.mdx#ZegoDataRecordConfig) | 录制配置对象。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void onEngineStateUpdate([ZegoEngineState](./enum.mdx#ZegoEngineState) state)"
  desc="音视频引擎状态更新的回调通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| state | [ZegoEngineState](./enum.mdx#ZegoEngineState) | 音视频引擎状态。 |
...
<ParamField
  ...
  prototype="public  void onRoomStateUpdate(std::string roomID, [ZegoRoomState](./enum.mdx#ZegoRoomState) state, int errorCode, std::string extendedData)"
  desc="房间状态变化通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| state | [ZegoRoomState](./enum.mdx#ZegoRoomState) | 变化后的房间状态。 |
...
<ParamField
  ...
  prototype="public  void onRoomStateChanged(std::string roomID, [ZegoRoomStateChangedReason](./enum.mdx#ZegoRoomStateChangedReason) reason, int errorCode, std::string extendedData)"
...
| --- | --- | --- |
| roomID | std::string | 房间 ID，最大长度为 128 字节的字符串。 |
| reason | [ZegoRoomStateChangedReason](./enum.mdx#ZegoRoomStateChangedReason) | 房间状态变化原因。 |
...
<ParamField
  ...
  prototype="public  void onRoomUserUpdate(std::string roomID, [ZegoUpdateType](./enum.mdx#ZegoUpdateType) updateType, const std::vector<[ZegoUser](./struct.mdx#ZegoUser)>& userList)"
...
| updateType | [ZegoUpdateType](./enum.mdx#ZegoUpdateType) | 更新类型（添加/删除）。 |
| userList | const std::vector\<[ZegoUser](./struct.mdx#ZegoUser)>& | 当前房间内变更的用户列表。 |
...
<ParamField
  ...
  prototype="public  void onRoomStreamUpdate(std::string roomID, [ZegoUpdateType](./enum.mdx#ZegoUpdateType) updateType, const std::vector<[ZegoStream](./struct.mdx#ZegoStream)>& streamList, std::string extendedData)"
...
| roomID | std::string | 用户已登录的房间 ID，最大长度为 128 字节的字符串。 |
| updateType | [ZegoUpdateType](./enum.mdx#ZegoUpdateType) | 更新类型（添加/删除）。 |
| streamList | const std::vector\<[ZegoStream](./struct.mdx#ZegoStream)>& | 更新的流列表。 |
...
<ParamField
  ...
  prototype="public  void onRoomStreamExtraInfoUpdate(std::string roomID, const std::vector<[ZegoStream](./struct.mdx#ZegoStream)>& streamList)"
  desc="房间内流附加信息更新通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| roomID | std::string | 用户已登录的房间 ID，最大长度为 128 字节的字符串。 |
| streamList | const std::vector\<[ZegoStream](./struct.mdx#ZegoStream)>& | 流附加信息更新的流列表。 |
...
<ParamField
  ...
  prototype="public  void onRoomExtraInfoUpdate(std::string roomID, const std::vector<[ZegoRoomExtraInfo](./struct.mdx#ZegoRoomExtraInfo)>& roomExtraInfoList)"
  desc="房间附加信息更新通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| roomID | std::string | 用户已登录的房间 ID，最大长度为 128 字节的字符串。 |
| roomExtraInfoList | const std::vector\<[ZegoRoomExtraInfo](./struct.mdx#ZegoRoomExtraInfo)>& | 更新的房间附加信息列表。 |
...
<ParamField
  ...
  prototype="public  void onPublisherStateUpdate(std::string streamID, [ZegoPublisherState](./enum.mdx#ZegoPublisherState) state, int errorCode, std::string extendedData)"
  desc="推流状态回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| state | [ZegoPublisherState](./enum.mdx#ZegoPublisherState) | 推流状态。 |
...
<ParamField
  ...
  prototype="public  void onPublisherQualityUpdate(std::string streamID, const [ZegoPublishStreamQuality](./struct.mdx#ZegoPublishStreamQuality)& quality)"
  desc="推流质量回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 推流的流 ID。 |
| quality | const [ZegoPublishStreamQuality](./struct.mdx#ZegoPublishStreamQuality)& | 推流质量，包含了音视频帧率、码率、RTT 等值。 |
...
<ParamField
  ...
  prototype="public  void onPublisherCapturedVideoFirstFrame([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="视频采集首帧回调接口。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道，如果只推一路音视频流，可以不关注该参数。 |
...
<ParamField
  ...
  prototype="public  void onPublisherSendAudioFirstFrame([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="推流端音频发送首帧回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道，如果只推一路音频流，可以不关注该参数。 |
...
<ParamField
  ...
  prototype="public  void onPublisherSendVideoFirstFrame([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="推流端视频发送首帧回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道，如果只推一路视频流，可以不关注该参数。 |
...
<ParamField
  ...
  prototype="public  void onPublisherRenderVideoFirstFrame([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="推流端视频渲染首帧回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void onPublisherVideoSizeChanged(int width, int height, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="采集视频大小变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void onPublisherRelayCDNStateUpdate(std::string streamID, const std::vector<[ZegoStreamRelayCDNInfo](./struct.mdx#ZegoStreamRelayCDNInfo)>& infoList)"
...
| --- | --- | --- |
| streamID | std::string | 推流的流 ID。 |
| infoList | const std::vector\<[ZegoStreamRelayCDNInfo](./struct.mdx#ZegoStreamRelayCDNInfo)>& | 当前 CDN 正在转推的信息列表。 |
...
<ParamField
  ...
  prototype="public  void onPublisherVideoEncoderChanged([ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) fromCodecID, [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) toCodecID, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="视频编码器变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| fromCodecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 变更前的视频编码器 ID。 |
| toCodecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 变更后的视频编码器 ID。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道，如果只推一路音视频流，可以不关注该参数。 |
...
<ParamField
  ...
  prototype="public  void onPublisherStreamEvent([ZegoStreamEvent](./enum.mdx#ZegoStreamEvent) eventID, std::string streamID, std::string extraInfo)"
  desc="推流事件回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| eventID | [ZegoStreamEvent](./enum.mdx#ZegoStreamEvent) | 推流事件ID |
| streamID | std::string | 推流的流 ID。 |
...
<ParamField
  ...
  prototype="public  void onVideoObjectSegmentationStateChanged([ZegoObjectSegmentationState](./enum.mdx#ZegoObjectSegmentationState) state, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel, int errorCode)"
  desc="视频主体分割状态变化。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| state | [ZegoObjectSegmentationState](./enum.mdx#ZegoObjectSegmentationState) | 主体分割状态。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道，如果只推一路音视频流，可以不关注该参数。 |
...
<ParamField
  ...
  prototype="public  void onPublisherLowFpsWarning([ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) codecID, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="视频编码低帧率警告。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| codecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 视频编码器 ID。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道，如果只推一路音视频流，可以不关注该参数。 |
...
<ParamField
  ...
  prototype="public  void onPublisherDummyCaptureImagePathError(int errorCode, std::string path, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void onPlayerStateUpdate(std::string streamID, [ZegoPlayerState](./enum.mdx#ZegoPlayerState) state, int errorCode, std::string extendedData)"
  desc="拉流状态变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| state | [ZegoPlayerState](./enum.mdx#ZegoPlayerState) | 拉流状态。 |
...
<ParamField
  ...
  prototype="public  void onPlayerQualityUpdate(std::string streamID, const [ZegoPlayStreamQuality](./struct.mdx#ZegoPlayStreamQuality)& quality)"
  desc="拉流质量回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 拉流的流 ID。 |
| quality | const [ZegoPlayStreamQuality](./struct.mdx#ZegoPlayStreamQuality)& | 拉流质量，包含了音视频帧率、码率、RTT 等值。 |
...
<ParamField
  ...
  prototype="public  void onPlayerMediaEvent(std::string streamID, [ZegoPlayerMediaEvent](./enum.mdx#ZegoPlayerMediaEvent) event)"
  desc="拉流媒体事件回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 拉流的流 ID。 |
| event | [ZegoPlayerMediaEvent](./enum.mdx#ZegoPlayerMediaEvent) | 拉流时收到的具体事件。 |
...
<ParamField
  ...
  prototype="public  void onPlayerRecvMediaSideInfo(const [ZegoMediaSideInfo](./struct.mdx#ZegoMediaSideInfo)& info)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| info | const [ZegoMediaSideInfo](./struct.mdx#ZegoMediaSideInfo)& | SEI 回调信息。 |
...
<ParamField
  ...
  prototype="public  void onPlayerLowFpsWarning([ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) codecID, std::string streamID)"
  desc="拉流低帧率警告。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| codecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 视频解码器 ID。 |
| streamID | std::string | 拉流的流 ID。 |
...
<ParamField
  ...
  prototype="public  void onPlayerStreamEvent([ZegoStreamEvent](./enum.mdx#ZegoStreamEvent) eventID, std::string streamID, std::string extraInfo)"
  desc="拉流事件回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| eventID | [ZegoStreamEvent](./enum.mdx#ZegoStreamEvent) | 拉流事件ID |
| streamID | std::string | 拉流的流 ID。 |
| extraInfo | std::string | 附加信息。JSON 格式的字符串。目前包括的信息有 "url"表示地址, "streamProtocol"表示流协议，包括rtmp,flv,avertp，hls，webrtc等, "netProtocol"表示网络协议，包括tcp,udp,quic, "resourceType"表示资源类型，包括cdn,rtc,l3。 |
...
<ParamField
  ...
  prototype="public  void onPlayerVideoSuperResolutionUpdate(std::string streamID, [ZegoSuperResolutionState](./enum.mdx#ZegoSuperResolutionState) state, int errorCode)"
  desc="拉流视频超分辨率开启状态变化。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 拉流的流 ID。 |
| state | [ZegoSuperResolutionState](./enum.mdx#ZegoSuperResolutionState) | 超分状态。 |
| errorCode | int | 错误码，详情请参考 常见错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html) |
...
<ParamField
  ...
  prototype="public  void onMixerRelayCDNStateUpdate(std::string taskID, const std::vector<[ZegoStreamRelayCDNInfo](./struct.mdx#ZegoStreamRelayCDNInfo)>& infoList)"
...
| infoList | const std::vector\<[ZegoStreamRelayCDNInfo](./struct.mdx#ZegoStreamRelayCDNInfo)>& | 当前 CDN 正在混流的信息列表。 |
...
<ParamField
  ...
  prototype="public  void onAudioDeviceStateChanged([ZegoUpdateType](./enum.mdx#ZegoUpdateType) updateType, [ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, const [ZegoDeviceInfo](./struct.mdx#ZegoDeviceInfo)& deviceInfo)"
  desc="音频设备状态改变"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| updateType | [ZegoUpdateType](./enum.mdx#ZegoUpdateType) | 更新类型（添加/删除） |
| deviceType | [ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) | 音频设备类型 |
| deviceInfo | const [ZegoDeviceInfo](./struct.mdx#ZegoDeviceInfo)& | 音频设备信息 |
...
<ParamField
  ...
  prototype="public  void onAudioDeviceVolumeChanged([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID, int volume)"
  desc="音频设备音量变更。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void onVideoDeviceStateChanged([ZegoUpdateType](./enum.mdx#ZegoUpdateType) updateType, const [ZegoDeviceInfo](./struct.mdx#ZegoDeviceInfo)& deviceInfo)"
  desc="视频设备状态改变。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| updateType | [ZegoUpdateType](./enum.mdx#ZegoUpdateType) | 更新类型（添加/删除） |
| deviceInfo | const [ZegoDeviceInfo](./struct.mdx#ZegoDeviceInfo)& | 视频设备信息 |
...
<ParamField
  ...
  prototype="public  void onCapturedSoundLevelInfoUpdate(const [ZegoSoundLevelInfo](./struct.mdx#ZegoSoundLevelInfo)& soundLevelInfo)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| soundLevelInfo | const [ZegoSoundLevelInfo](./struct.mdx#ZegoSoundLevelInfo)& | 本地采集的声浪值，取值范围为 0.0 ~ 100.0（该取值仅表示回调的声浪取值范围，不表示精度）。 |
...
<ParamField
  ...
  prototype="public  void onRemoteSoundLevelInfoUpdate(const std::unordered_map<std::string, [ZegoSoundLevelInfo](./struct.mdx#ZegoSoundLevelInfo)>& soundLevelInfos)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| soundLevelInfos | const std::unordered_map\<std::string, [ZegoSoundLevelInfo](./struct.mdx#ZegoSoundLevelInfo)>& | 远端的声浪键值对，key 为流 ID，value 为对应的流的声浪值，value 取值范围为 0.0 ~ 100.0（该取值仅表示回调的声浪取值范围，不表示精度）。 |
...
<ParamField
  ...
  prototype="public  void onLocalDeviceExceptionOccurred([ZegoDeviceExceptionType](./enum.mdx#ZegoDeviceExceptionType) exceptionType, [ZegoDeviceType](./enum.mdx#ZegoDeviceType) deviceType, std::string deviceID)"
  desc="本地设备异常通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| exceptionType | [ZegoDeviceExceptionType](./enum.mdx#ZegoDeviceExceptionType) | 设备异常类型。 |
| deviceType | [ZegoDeviceType](./enum.mdx#ZegoDeviceType) | 发生异常的设备类型。 |
...
<ParamField
  ...
  prototype="public  void onRemoteCameraStateUpdate(std::string streamID, [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) state)"
  desc="远端摄像头设备状态通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 拉流的流 ID。 |
| state | [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) | 远端摄像头状态。 |
...
<ParamField
  ...
  prototype="public  void onRemoteMicStateUpdate(std::string streamID, [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) state)"
  desc="远端麦克风设备状态通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 拉流的流 ID。 |
| state | [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) | 远端麦克风状态。 |
...
<ParamField
  ...
  prototype="public  void onRemoteSpeakerStateUpdate(std::string streamID, [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) state)"
  desc="远端扬声器设备状态通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 拉流的流 ID。 |
| state | [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) | 远端扬声器状态。 |
...
<ParamField
  ...
  prototype="public  void onAudioRouteChange([ZegoAudioRoute](./enum.mdx#ZegoAudioRoute) audioRoute)"
  desc="音频设备路由变更通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| audioRoute | [ZegoAudioRoute](./enum.mdx#ZegoAudioRoute) | 当前音频路由。 |
...
<ParamField
  ...
  prototype="public  void onAudioVADStateUpdate([ZegoAudioVADStableStateMonitorType](./enum.mdx#ZegoAudioVADStableStateMonitorType) type, [ZegoAudioVADType](./enum.mdx#ZegoAudioVADType) state)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| type | [ZegoAudioVADStableStateMonitorType](./enum.mdx#ZegoAudioVADStableStateMonitorType) | 语音检测器类型 |
| state | [ZegoAudioVADType](./enum.mdx#ZegoAudioVADType) | 语音检测结果 |
...
<ParamField
  ...
  prototype="public  void onRecvRoomTransparentMessage(std::string roomID, const [ZegoRoomRecvTransparentMessage](./struct.mdx#ZegoRoomRecvTransparentMessage)& message)"
  desc="接收房间透传消息。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| message | const [ZegoRoomRecvTransparentMessage](./struct.mdx#ZegoRoomRecvTransparentMessage)& | 收到的消息。 |
...
<ParamField
  ...
  prototype="public  void onIMRecvBroadcastMessage(std::string roomID, std::vector<[ZegoBroadcastMessageInfo](./struct.mdx#ZegoBroadcastMessageInfo)> messageList)"
  desc="接收房间广播消息通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| roomID | std::string | 房间 ID。取值范围：最大长度为 128 字节。 |
| messageList | std::vector\<[ZegoBroadcastMessageInfo](./struct.mdx#ZegoBroadcastMessageInfo)> | 收到的消息列表。取值范围：每次最多接收 50 条消息。 |
...
<ParamField
  ...
  prototype="public  void onIMRecvBarrageMessage(std::string roomID, std::vector<[ZegoBarrageMessageInfo](./struct.mdx#ZegoBarrageMessageInfo)> messageList)"
  desc="接收房间弹幕消息通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| roomID | std::string | 房间 ID。取值范围：最大长度为 128 字节。 |
| messageList | std::vector\<[ZegoBarrageMessageInfo](./struct.mdx#ZegoBarrageMessageInfo)> | 收到的消息列表。取值范围：每次最多接收 50 条消息。 |
...
<ParamField
  ...
  prototype="public  void onIMRecvCustomCommand(std::string roomID, [ZegoUser](./struct.mdx#ZegoUser) fromUser, std::string command)"
  desc="接收自定义信令通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| roomID | std::string | 房间 ID。取值范围：最大长度为 128 字节。 |
| fromUser | [ZegoUser](./struct.mdx#ZegoUser) | 信令的发送人。 |
...
<ParamField
  ...
  prototype="public  void onPerformanceStatusUpdate(const [ZegoPerformanceStatus](./struct.mdx#ZegoPerformanceStatus)& status)"
  desc="系统性能监控回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| status | const [ZegoPerformanceStatus](./struct.mdx#ZegoPerformanceStatus)& | 系统性能监控状态。 |
...
<ParamField
  ...
  prototype="public  void onNetworkModeChanged([ZegoNetworkMode](./enum.mdx#ZegoNetworkMode) mode)"
  desc="网络模式变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoNetworkMode](./enum.mdx#ZegoNetworkMode) | 当前网络模式。 |
...
<ParamField
  ...
  prototype="public  void onNetworkSpeedTestError(int errorCode, [ZegoNetworkSpeedTestType](./enum.mdx#ZegoNetworkSpeedTestType) type)"
  desc="网络测速异常回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| type | [ZegoNetworkSpeedTestType](./enum.mdx#ZegoNetworkSpeedTestType) | 上行或下行网络。 |
...
<ParamField
  ...
  prototype="public  void onNetworkSpeedTestQualityUpdate(const [ZegoNetworkSpeedTestQuality](./struct.mdx#ZegoNetworkSpeedTestQuality)& quality, [ZegoNetworkSpeedTestType](./enum.mdx#ZegoNetworkSpeedTestType) type)"
  desc="网络测速质量回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| quality | const [ZegoNetworkSpeedTestQuality](./struct.mdx#ZegoNetworkSpeedTestQuality)& | 网速测速质量. |
| type | [ZegoNetworkSpeedTestType](./enum.mdx#ZegoNetworkSpeedTestType) | 上行或下行网络。 |
...
<ParamField
  ...
  prototype="public  void onNetworkQuality(std::string userID, [ZegoStreamQualityLevel](./enum.mdx#ZegoStreamQualityLevel) upstreamQuality, [ZegoStreamQualityLevel](./enum.mdx#ZegoStreamQualityLevel) downstreamQuality)"
...
| upstreamQuality | [ZegoStreamQualityLevel](./enum.mdx#ZegoStreamQualityLevel) | 上行网络质量 |
| downstreamQuality | [ZegoStreamQualityLevel](./enum.mdx#ZegoStreamQualityLevel) | 下行网络质量 |
...
<ParamField
  name="onRtcStats"
  prototype="public  void onRtcStats(const [ZegoRtcStatsInfo](./struct.mdx#ZegoRtcStatsInfo)& info)"
  desc="RTC 网络统计信息回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| info | const [ZegoRtcStatsInfo](./struct.mdx#ZegoRtcStatsInfo)& | 统计信息. |
...
<ParamField
  ...
  prototype="public  void onScreenCaptureExceptionOccurred([ZegoScreenCaptureExceptionType](./enum.mdx#ZegoScreenCaptureExceptionType) exceptionType)"
  desc="屏幕采集异常通知。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoEventHandler"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| exceptionType | [ZegoScreenCaptureExceptionType](./enum.mdx#ZegoScreenCaptureExceptionType) | 采集源异常类型。 |
...
<ParamField
  ...
  prototype="public  void setRoomScenario([ZegoScenario](./enum.mdx#ZegoScenario) scenario)"
  desc="设置房间场景。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| scenario | [ZegoScenario](./enum.mdx#ZegoScenario) | 房间场景。 |
...
<ParamField
  name="uploadLog"
  prototype="public  void uploadLog([ZegoUploadLogResultCallback](./interface.mdx#ZegoExpressDefines#zego-upload-log-result-callback) callback)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoUploadLogResultCallback](./interface.mdx#ZegoExpressDefines#zego-upload-log-result-callback) | 日志上传结果回调。 |
...
<Tip title="Return">返回的参数，格式为 JSON 字符串，具体可咨询 ZEGO 技术支持。</Tip>
</ParamField>
<ParamField
  name="loginRoom"
  prototype="public  void loginRoom(std::string roomID, [ZegoUser](./struct.mdx#ZegoUser) user)"
...
| user | [ZegoUser](./struct.mdx#ZegoUser) | 用户对象实例，配置用户 ID、用户名。 注意事项：注意用户 ID 需要在相同的 appID 下全局唯一，否则会出现后登录的用户踢掉先登录的用户的情况。 |
...
<ParamField
  name="loginRoom"
  prototype="public  void loginRoom(std::string roomID, [ZegoUser](./struct.mdx#ZegoUser) user, [ZegoRoomConfig](./struct.mdx#ZegoRoomConfig) config, [ZegoRoomLoginCallback](./interface.mdx#ZegoExpressDefines#zego-room-login-callback) callback)"
...
| roomID | std::string | 房间 ID，不得为空，最大长度小于 128 字节的字符串。\</br>  注意事项：\</br>  1.房间 ID 由您自己定义。\</br>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '\`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。\</br>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| user | [ZegoUser](./struct.mdx#ZegoUser) | 用户对象实例，配置用户 ID、用户名。 注意事项：注意用户 ID 需要在相同的 appID 下全局唯一，否则会出现后登录的用户踢掉先登录的用户的情况。 |
| config | [ZegoRoomConfig](./struct.mdx#ZegoRoomConfig) | 房间进阶配置。 |
| callback | [ZegoRoomLoginCallback](./interface.mdx#ZegoExpressDefines#zego-room-login-callback) | 本次登录结果的回调（2.18.0 及以上版本支持），如果需要详细的房间状态，请关注 [onRoomStateChanged] 回调。是否必填：否。默认值：nullptr。注意事项：如果因为网络问题导致多次重试连接，重试状态将不会通过此回调抛出。 |
...
<ParamField
  name="logoutRoom"
  prototype="public  void logoutRoom([ZegoRoomLogoutCallback](./interface.mdx#ZegoExpressDefines#zego-room-logout-callback) callback)"
  desc="退出房间，带回调。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoRoomLogoutCallback](./interface.mdx#ZegoExpressDefines#zego-room-logout-callback) | 本次登出房间结果的回调，如果需要详细房间状态，请关注 [onRoomStateChagned] 回调。是否必填：否。默认值：NULL。 |
...
<ParamField
  name="logoutRoom"
  prototype="public  void logoutRoom(std::string roomID, [ZegoRoomLogoutCallback](./interface.mdx#ZegoExpressDefines#zego-room-logout-callback) callback)"
...
<ParamField
  name="switchRoom"
  prototype="public  void switchRoom(std::string fromRoomID, std::string toRoomID, [ZegoRoomConfig](./struct.mdx#ZegoRoomConfig)* config)"
...
<ParamField
  ...
  prototype="public  void setRoomExtraInfo(std::string roomID, std::string key, std::string value, [ZegoRoomSetRoomExtraInfoCallback](./interface.mdx#ZegoExpressDefines#zego-room-set-room-extra-info-callback) callback)"
  desc="设置房间附加消息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| callback | [ZegoRoomSetRoomExtraInfoCallback](./interface.mdx#ZegoExpressDefines#zego-room-set-room-extra-info-callback) | 设置房间附加消息结果回调。 |
...
<ParamField
  ...
  prototype="public  [ZegoRoomStreamList](./struct.mdx#ZegoRoomStreamList) getRoomStreamList(std::string roomID, [ZegoRoomStreamListType](./enum.mdx#ZegoRoomStreamListType) streamListType)"
  desc="获取房间内流列表。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| roomID | std::string | 房间 ID。 |
| streamListType | [ZegoRoomStreamListType](./enum.mdx#ZegoRoomStreamListType) | 获取类型 |
...
<Tip title="Return">返回的列表</Tip>
</ParamField>
<ParamField
  name="startPublishingStream"
  prototype="public  void startPublishingStream(std::string streamID, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开始推流，可选择推第二路流。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="startPublishingStream"
  prototype="public  void startPublishingStream(std::string streamID, [ZegoPublisherConfig](./struct.mdx#ZegoPublisherConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开始推流，支持多房间模式"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 流 ID，长度不超过 256 的字符串。\</br>  注意事项：\</br>  1. 流 ID 由您自己定义。\</br>  2. 需要在整个 AppID 内全局唯一，若出现在同一个 AppID 内，不同的用户各推了一条流且流名相同，将会导致后推流的用户推流失败。\</br>  3. 仅支持数字，英文字符 和 '-', '_'。 |
| config | [ZegoPublisherConfig](./struct.mdx#ZegoPublisherConfig) | 推流进阶配置。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void startPublishingStreamInScene(std::string streamID, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel, [ZegoScenePublisherConfig](./struct.mdx#ZegoScenePublisherConfig) config)"
  desc="在范围场景内推流。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| streamID | std::string | 流 ID，长度不超过 256 的字符串。\</br>  注意事项：\</br>  1. 流 ID 由您自己定义。\</br>  2. 需要在整个 AppID 内全局唯一，若出现在同一个 AppID 内，不同的用户各推了一条流且流名相同，将会导致后推流的用户推流失败。\</br>  3. 仅支持数字，英文字符 和 '-', '_'。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
| config | [ZegoScenePublisherConfig](./struct.mdx#ZegoScenePublisherConfig) | 场景推流进阶配置。 |
...
<ParamField
  ...
  prototype="public  void stopPublishingStream([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void setStreamExtraInfo(std::string extraInfo, [ZegoPublisherSetStreamExtraInfoCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-set-stream-extra-info-callback) callback, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置指定推流通道的流附加信息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| callback | [ZegoPublisherSetStreamExtraInfoCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-set-stream-extra-info-callback) | 设置流附加信息执行结果通知。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  name="startPreview"
  prototype="public  void startPreview([ZegoCanvas](./struct.mdx#ZegoCanvas) canvas, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| canvas | [ZegoCanvas](./struct.mdx#ZegoCanvas) | 启动预览时用于显示画面的视图，视图设置为 null 则不进行预览。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  name="stopPreview"
  prototype="public  void stopPreview([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  name="setVideoConfig"
  prototype="public  void setVideoConfig([ZegoVideoConfig](./struct.mdx#ZegoVideoConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoVideoConfig](./struct.mdx#ZegoVideoConfig) | 视频配置，SDK 提供常用的分辨率、帧率和码率的组合值，也可自定义分辨率、帧率和码率。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  name="getVideoConfig"
  prototype="public  [ZegoVideoConfig](./struct.mdx#ZegoVideoConfig) getVideoConfig([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<Tip title="Return">视频配置对象</Tip>
</ParamField>
<ParamField
  name="setPublishDualStreamConfig"
  prototype="public  void setPublishDualStreamConfig(const std::vector<[ZegoPublishDualStreamConfig](./struct.mdx#ZegoPublishDualStreamConfig)>& configList, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置大小流配置信息"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| configList | const std::vector\<[ZegoPublishDualStreamConfig](./struct.mdx#ZegoPublishDualStreamConfig)>& | 配置信息。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void setVideoMirrorMode([ZegoVideoMirrorMode](./enum.mdx#ZegoVideoMirrorMode) mirrorMode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mirrorMode | [ZegoVideoMirrorMode](./enum.mdx#ZegoVideoMirrorMode) | 预览或推流的镜像模式。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void setAppOrientation([ZegoOrientation](./enum.mdx#ZegoOrientation) orientation, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| orientation | [ZegoOrientation](./enum.mdx#ZegoOrientation) | 视频的朝向。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  name="setAudioConfig"
  prototype="public  void setAudioConfig([ZegoAudioConfig](./struct.mdx#ZegoAudioConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoAudioConfig](./struct.mdx#ZegoAudioConfig) | 音频质量配置。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  name="getAudioConfig"
  prototype="public  [ZegoAudioConfig](./struct.mdx#ZegoAudioConfig) getAudioConfig([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<Tip title="Return">音频质量配置。</Tip>
</ParamField>
<ParamField
  name="setPublishStreamEncryptionKey"
  prototype="public  void setPublishStreamEncryptionKey(std::string key, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void takePublishStreamSnapshot([ZegoPublisherTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-take-snapshot-callback) callback, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="对指定推流通道的推流画面截图。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoPublisherTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-take-snapshot-callback) | 推流画面截图结果回调。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void takePublishStreamSnapshotByConfig([ZegoPublisherTakeSnapshotConfig](./struct.mdx#ZegoPublisherTakeSnapshotConfig) config, [ZegoPublisherTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-take-snapshot-callback) callback, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="对指定推流通道的推流画面截图。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoPublisherTakeSnapshotConfig](./struct.mdx#ZegoPublisherTakeSnapshotConfig) | 推流画面截图配置 |
| callback | [ZegoPublisherTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-take-snapshot-callback) | 推流画面截图结果回调。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void mutePublishStreamAudio(bool mute, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void mutePublishStreamVideo(bool mute, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void setStreamAlignmentProperty(int alignment, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开启或关闭流精准对齐功能"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void enableTrafficControl(bool enable, int property, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void setMinVideoBitrateForTrafficControl(int bitrate, [ZegoTrafficControlMinVideoBitrateMode](./enum.mdx#ZegoTrafficControlMinVideoBitrateMode) mode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| mode | [ZegoTrafficControlMinVideoBitrateMode](./enum.mdx#ZegoTrafficControlMinVideoBitrateMode) | 低于最低码率时的视频发送模式。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void setMinVideoFpsForTrafficControl(int fps, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void setMinVideoResolutionForTrafficControl(int width, int height, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void setTrafficControlFocusOn([ZegoTrafficControlFocusOnMode](./enum.mdx#ZegoTrafficControlFocusOnMode) mode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoTrafficControlFocusOnMode](./enum.mdx#ZegoTrafficControlFocusOnMode) | 选择 LOCAL_ONLY 时，只关注本地网络状况。选择 REMOTE 时，不仅关注本地网络，同时也兼顾远端网络。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<Tip title="Return">音量增益百分比</Tip>
</ParamField>
<ParamField
  name="setAudioCaptureStereoMode"
  prototype="public  void setAudioCaptureStereoMode([ZegoAudioCaptureStereoMode](./enum.mdx#ZegoAudioCaptureStereoMode) mode)"
  desc="设置音频采集双声道模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoAudioCaptureStereoMode](./enum.mdx#ZegoAudioCaptureStereoMode) | 双声道采集模式。 |
...
<ParamField
  ...
  prototype="public  void addPublishCdnUrl(std::string streamID, std::string targetURL, [ZegoPublisherUpdateCdnUrlCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-update-cdn-url-callback) callback)"
...
| callback | [ZegoPublisherUpdateCdnUrlCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-update-cdn-url-callback) | 更新 CDN 转推结果通知。 |
...
<ParamField
  name="addPublishCdnUrl"
  prototype="public  void addPublishCdnUrl(std::string streamID, std::string targetURL, int timeout, [ZegoPublisherUpdateCdnUrlCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-update-cdn-url-callback) callback)"
  desc="增加转推至 CDN 的 URL。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void removePublishCdnUrl(std::string streamID, std::string targetURL, [ZegoPublisherUpdateCdnUrlCallback](./interface.mdx#ZegoExpressDefines#zego-publisher-update-cdn-url-callback) callback)"
...
<ParamField
  ...
  prototype="public  void enablePublishDirectToCDN(bool enable, [ZegoCDNConfig](./struct.mdx#ZegoCDNConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| config | [ZegoCDNConfig](./struct.mdx#ZegoCDNConfig) | CDN 配置，若为 null 则使用 Zego 的后台配置。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void setPublishWatermark([ZegoWatermark](./struct.mdx#ZegoWatermark) watermark, bool isPreviewVisible, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| watermark | [ZegoWatermark](./struct.mdx#ZegoWatermark) | 水印布局左上角为坐标系原点，区域不能超过编码分辨率设置的大小。若为空表示取消水印。 |
...
<ParamField
  name="setSEIConfig"
  prototype="public  void setSEIConfig([ZegoSEIConfig](./struct.mdx#ZegoSEIConfig) config)"
  desc="设置媒体增强补充信息类型。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoSEIConfig](./struct.mdx#ZegoSEIConfig) | SEI 类型配置。默认使用 ZEGO 定义的 SEI。 |
...
<ParamField
  name="sendSEI"
  prototype="public  void sendSEI(const unsigned char* data, unsigned int dataLength, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void sendSEISyncWithCustomVideo(const unsigned char* data, unsigned int dataLength, unsigned long long timeStampNs, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void sendAudioSideInfo(const unsigned char* data, unsigned int dataLength, double timeStampMs, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="发送音频次要信息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void setCapturePipelineScaleMode([ZegoCapturePipelineScaleMode](./enum.mdx#ZegoCapturePipelineScaleMode) mode)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoCapturePipelineScaleMode](./enum.mdx#ZegoCapturePipelineScaleMode) | 采集缩放时机。 |
...
<ParamField
  ...
  prototype="public  void setDummyCaptureImagePath(std::string filePath, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void setDummyCaptureImageParams([ZegoDummyCaptureImageParams](./struct.mdx#ZegoDummyCaptureImageParams) params, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| params | [ZegoDummyCaptureImageParams](./struct.mdx#ZegoDummyCaptureImageParams) | 虚拟采集图片参数。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  bool isVideoEncoderSupported([ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) codecID)"
  desc="是否支持指定视频编码类型。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| codecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 视频编码类型。是否必填：是。 |
...
<Tip title="Return">是否支持指定视频编码。取值范围：true 表示支持，可以使用该编码进行推流；false 表示不支持，不可以使用该编码进行推流。</Tip>
</ParamField>
<ParamField
  name="isVideoEncoderSupported"
  prototype="public  int isVideoEncoderSupported([ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) codecID, [ZegoVideoCodecBackend](./enum.mdx#ZegoVideoCodecBackend) codecBackend)"
...
| --- | --- | --- |
| codecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 视频编码类型。是否必填：是。 |
| codecBackend | [ZegoVideoCodecBackend](./enum.mdx#ZegoVideoCodecBackend) | 编码器的后端实现。是否必填：是。 |
...
<Tip title="Return">是否支持指定视频编码格式；0 表示不支持，不可以使用该编码格式进行推流；1 表示支持，可以使用该编码格式进行推流；2 表示未确认，建议稍后再调用本接口。</Tip>
</ParamField>
<ParamField
  name="setAppOrientationMode"
  prototype="public  void setAppOrientationMode([ZegoOrientationMode](./enum.mdx#ZegoOrientationMode) mode)"
  desc="设置视频的朝向模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoOrientationMode](./enum.mdx#ZegoOrientationMode) | 视频的朝向模式。 |
...
<ParamField
  ...
  prototype="public  void setLowlightEnhancement([ZegoLowlightEnhancementMode](./enum.mdx#ZegoLowlightEnhancementMode) mode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置低照度增强。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoLowlightEnhancementMode](./enum.mdx#ZegoLowlightEnhancementMode) | 低照度增强模式。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void setLowlightEnhancementParams([ZegoExpLowlightEnhancementParams](./struct.mdx#ZegoExpLowlightEnhancementParams) params, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置低照度增强参数。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| params | [ZegoExpLowlightEnhancementParams](./struct.mdx#ZegoExpLowlightEnhancementParams) | 低照度增强参数。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  name="setVideoSource"
  prototype="public  int setVideoSource([ZegoVideoSourceType](./enum.mdx#ZegoVideoSourceType) source)"
  desc="设置视频采集源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| source | [ZegoVideoSourceType](./enum.mdx#ZegoVideoSourceType) | 视频采集源类型。 |
...
<ParamField
  name="setVideoSource"
  prototype="public  int setVideoSource([ZegoVideoSourceType](./enum.mdx#ZegoVideoSourceType) source, unsigned int instanceID)"
...
<ParamField
  name="setVideoSource"
  prototype="public  int setVideoSource([ZegoVideoSourceType](./enum.mdx#ZegoVideoSourceType) source, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置指定推流通道的视频采集源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="setVideoSource"
  prototype="public  int setVideoSource([ZegoVideoSourceType](./enum.mdx#ZegoVideoSourceType) source, unsigned int instanceID, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  name="setAudioSource"
  prototype="public  int setAudioSource([ZegoAudioSourceType](./enum.mdx#ZegoAudioSourceType) source)"
  desc="设置音频采集源"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| source | [ZegoAudioSourceType](./enum.mdx#ZegoAudioSourceType) | 音频采集源类型。 |
...
<ParamField
  name="setAudioSource"
  prototype="public  int setAudioSource([ZegoAudioSourceType](./enum.mdx#ZegoAudioSourceType) source, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="为指定推流通道设置音频采集源"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="setAudioSource"
  prototype="public  int setAudioSource([ZegoAudioSourceType](./enum.mdx#ZegoAudioSourceType) source, [ZegoAudioSourceMixConfig](./struct.mdx#ZegoAudioSourceMixConfig) config)"
  desc="设置音频采集源及混音配置"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| source | [ZegoAudioSourceType](./enum.mdx#ZegoAudioSourceType) | 音频采集源类型。 |
| config | [ZegoAudioSourceMixConfig](./struct.mdx#ZegoAudioSourceMixConfig) | 音频采集源混音配置。 |
...
<ParamField
  ...
  prototype="public  void enableVideoObjectSegmentation(bool enable, [ZegoObjectSegmentationType](./enum.mdx#ZegoObjectSegmentationType) type, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开启主体分割。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| type | [ZegoObjectSegmentationType](./enum.mdx#ZegoObjectSegmentationType) | 主体分割类型。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  name="enableVideoObjectSegmentation"
  prototype="public  void enableVideoObjectSegmentation(bool enable, [ZegoObjectSegmentationConfig](./struct.mdx#ZegoObjectSegmentationConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开启主体分割。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| enable | bool | 是否开启主体分割，默认关闭。 |
| config | [ZegoObjectSegmentationConfig](./struct.mdx#ZegoObjectSegmentationConfig) | 主体分割配置。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void enableAlphaChannelVideoEncoder(bool enable, [ZegoAlphaLayoutType](./enum.mdx#ZegoAlphaLayoutType) alphaLayout, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开启视频编码器透明通道支持。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| alphaLayout | [ZegoAlphaLayoutType](./enum.mdx#ZegoAlphaLayoutType) | 指定 Alpha 通道数据的布局位置。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void startPlayingStream(std::string streamID, [ZegoCanvas](./struct.mdx#ZegoCanvas) canvas)"
...
| canvas | [ZegoCanvas](./struct.mdx#ZegoCanvas) | 用于显示拉流画面的视图，视图设置为 [nullptr] 时不显示视频，只播放音频。该参数可以设置视图显示模式（viewMode）和背景色。 |
...
<ParamField
  name="startPlayingStream"
  prototype="public  void startPlayingStream(std::string streamID, [ZegoCanvas](./struct.mdx#ZegoCanvas) canvas, [ZegoPlayerConfig](./struct.mdx#ZegoPlayerConfig) config)"
...
| streamID | std::string | 流 ID，长度不超过 256 字节的字符串。\</br>  注意事项：\</br>  仅支持数字，英文字符 和 '-', '_'。 |
| canvas | [ZegoCanvas](./struct.mdx#ZegoCanvas) | 用于显示拉流画面的视图，视图设置为 [nullptr] 时不显示视频，只播放音频。该参数可以设置视图显示模式(viewMode)和背景色。 |
| config | [ZegoPlayerConfig](./struct.mdx#ZegoPlayerConfig) | 拉流进阶配置, [ZegoPlayerConfig] 中房间 [roomID] 为登录的房间ID。 |
...
<ParamField
  name="startPlayingStream"
  prototype="public  void startPlayingStream(std::string streamID, [ZegoPlayerConfig](./struct.mdx#ZegoPlayerConfig) config)"
...
| --- | --- | --- |
| streamID | std::string | 流 ID，长度不超过 256 字节的字符串。\</br>  注意事项：\</br>  仅支持数字，英文字符 和 '-', '_'。 |
| config | [ZegoPlayerConfig](./struct.mdx#ZegoPlayerConfig) | 拉流进阶配置。 |
...
<ParamField
  ...
  prototype="public  void startPlayingStreamInScene(std::string streamID, [ZegoCanvas](./struct.mdx#ZegoCanvas) canvas, [ZegoScenePlayerConfig](./struct.mdx#ZegoScenePlayerConfig) config)"
...
| streamID | std::string | 流 ID，长度不超过 256 字节的字符串。\</br>  注意事项：\</br>  仅支持数字，英文字符 和 '-', '_'。 |
| canvas | [ZegoCanvas](./struct.mdx#ZegoCanvas) | 用于显示拉流画面的视图，视图设置为 [nullptr] 时不显示视频，只播放音频。该参数可以设置视图显示模式（viewMode）和背景色。 |
| config | [ZegoScenePlayerConfig](./struct.mdx#ZegoScenePlayerConfig) | 场景拉流进阶配置。 |
...
<ParamField
  name="startPlayingStreamInScene"
  prototype="public  void startPlayingStreamInScene(std::string streamID, [ZegoScenePlayerConfig](./struct.mdx#ZegoScenePlayerConfig) config)"
...
<ParamField
  ...
  prototype="public  void switchPlayingStream(std::string fromStreamID, std::string toStreamID, [ZegoPlayerConfig](./struct.mdx#ZegoPlayerConfig) config)"
  desc="从拉某条流切换为拉另外的流。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void setPlayStreamCrossAppInfo(std::string streamID, [ZegoCrossAppInfo](./struct.mdx#ZegoCrossAppInfo) info)"
  desc="设置跨 App 拉流信息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 流 ID。 |
| info | [ZegoCrossAppInfo](./struct.mdx#ZegoCrossAppInfo) | 跨 App 拉流信息。 |
...
<ParamField
  ...
  prototype="public  void takePlayStreamSnapshot(std::string streamID, [ZegoPlayerTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-player-take-snapshot-callback) callback)"
  desc="拉流画面截图。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| callback | [ZegoPlayerTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-player-take-snapshot-callback) | 拉流画面截图结果回调。 |
...
<ParamField
  ...
  prototype="public  void setPlayStreamVideoType(std::string streamID, [ZegoVideoStreamType](./enum.mdx#ZegoVideoStreamType) streamType)"
  desc="设置播放视频流类型。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 流 ID。 |
| streamType | [ZegoVideoStreamType](./enum.mdx#ZegoVideoStreamType) | 视频流类型。 |
...
<ParamField
  ...
  prototype="public  void setAudioMixMode([ZegoAudioMixMode](./enum.mdx#ZegoAudioMixMode) mode, const std::vector<std::string>& streamList)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoAudioMixMode](./enum.mdx#ZegoAudioMixMode) | 混音模式。 |
...
<ParamField
  ...
  prototype="public  bool isVideoDecoderSupported([ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) codecID)"
  desc="是否支持指定视频解码格式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| codecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 视频解码类型。是否必填：是。 |
...
<Tip title="Return">是否支持指定视频解码格式；true 表示支持，可以使用该解码格式进行拉流；false 表示不支持，SDK 不建议用户拉取该编码格式的流，如果用户强制拉取，可能会出现低帧率的表现。</Tip>
</ParamField>
<ParamField
  name="isVideoDecoderSupported"
  prototype="public  int isVideoDecoderSupported([ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) codecID, [ZegoVideoCodecBackend](./enum.mdx#ZegoVideoCodecBackend) codecBackend)"
  desc="是否支持指定视频解码格式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| codecID | [ZegoVideoCodecID](./enum.mdx#ZegoVideoCodecID) | 视频解码类型。是否必填：是。 |
| codecBackend | [ZegoVideoCodecBackend](./enum.mdx#ZegoVideoCodecBackend) | 解码器的后端实现。是否必填：是。 |
...
<Tip title="Return">是否支持指定视频解码格式；0 表示不支持，不可以使用该解码格式进行拉流；1 表示支持，可以使用该解码格式进行拉流；2 表示未确认，建议稍后再调用本接口。</Tip>
</ParamField>
<ParamField
  name="setPlayStreamsAlignmentProperty"
  prototype="public  void setPlayStreamsAlignmentProperty([ZegoStreamAlignmentMode](./enum.mdx#ZegoStreamAlignmentMode) mode)"
  desc="设置拉流对齐属性。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoStreamAlignmentMode](./enum.mdx#ZegoStreamAlignmentMode) | 设置流对齐模式。 |
...
<ParamField
  ...
  prototype="public  int updatePlayingCanvas(std::string streamID, [ZegoCanvas](./struct.mdx#ZegoCanvas) canvas)"
  desc="更新拉流视图。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">错误码，详情请参考常用错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html)</Tip>
</ParamField>
<ParamField
  name="startMixerTask"
  prototype="public  void startMixerTask([ZegoMixerTask](./struct.mdx#ZegoMixerTask) task, [ZegoMixerStartCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-start-callback) callback)"
  desc="开始混流任务。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| task | [ZegoMixerTask](./struct.mdx#ZegoMixerTask) | 混流任务对象。是否必填：是。 |
| callback | [ZegoMixerStartCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-start-callback) | 开始混流任务结果通知。是否必填：否。注意事项：传 [nullptr] 则意味着不接收回调通知。 |
...
<ParamField
  name="stopMixerTask"
  prototype="public  void stopMixerTask([ZegoMixerTask](./struct.mdx#ZegoMixerTask) task, [ZegoMixerStopCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-stop-callback) callback)"
  desc="停止混流任务。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| task | [ZegoMixerTask](./struct.mdx#ZegoMixerTask) | 混流任务对象。是否必填：是。 |
| callback | [ZegoMixerStopCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-stop-callback) | 停止混流任务结果通知。是否必填：否。注意事项：传 [nullptr] 则意味着不接收回调通知。 |
...
<ParamField
  ...
  prototype="public  void startAutoMixerTask([ZegoAutoMixerTask](./struct.mdx#ZegoAutoMixerTask) task, [ZegoMixerStartCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-start-callback) callback)"
  desc="开始自动混流任务"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| task | [ZegoAutoMixerTask](./struct.mdx#ZegoAutoMixerTask) | 自动混流任务对象 |
| callback | [ZegoMixerStartCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-start-callback) | 开始自动混流任务结果通知 |
...
<ParamField
  ...
  prototype="public  void stopAutoMixerTask([ZegoAutoMixerTask](./struct.mdx#ZegoAutoMixerTask) task, [ZegoMixerStopCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-stop-callback) callback)"
  desc="停止自动混流任务"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| task | [ZegoAutoMixerTask](./struct.mdx#ZegoAutoMixerTask) | 自动混流任务对象 |
| callback | [ZegoMixerStopCallback](./interface.mdx#ZegoExpressDefines#zego-mixer-stop-callback) | 停止自动混流任务结果通知 |
...
<Tip title="Return">麦克风是否静音；"true" 表示麦克风静音；"false" 表示麦克风开启中（没有被静音）。</Tip>
</ParamField>
<ParamField
  name="muteSpeaker"
...
<Tip title="Return">音频输出是否静音；"true" 表示音频输出静音；"false" 表示音频输出开启中（没有被静音）。</Tip>
</ParamField>
<ParamField
  name="getAudioDeviceList"
  prototype="public  std::vector&lt;[ZegoDeviceInfo](./struct.mdx#ZegoDeviceInfo)&gt; getAudioDeviceList([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType)"
  desc="获取音频设备列表"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">音频设备列表</Tip>
</ParamField>
<ParamField
  name="getDefaultAudioDeviceID"
  prototype="public  std::string getDefaultAudioDeviceID([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType)"
  desc="获取默认音频设备 ID"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">默认音频设备 ID</Tip>
</ParamField>
<ParamField
  name="useAudioDevice"
  prototype="public  void useAudioDevice([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID)"
  desc="选择使用某个音频设备"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  int getAudioDeviceVolume([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID)"
  desc="获取音频设备音量"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">设备音量</Tip>
</ParamField>
<ParamField
  name="setAudioDeviceVolume"
  prototype="public  void setAudioDeviceVolume([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID, int volume)"
  desc="设置音频设备音量。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void startAudioDeviceVolumeMonitor([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID)"
  desc="开启音频设备音量监控。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void stopAudioDeviceVolumeMonitor([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID)"
  desc="停止音频设备音量监控。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void muteAudioDevice([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID, bool mute)"
  desc="静音或取消静音音频设备。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void setAudioDeviceMode([ZegoAudioDeviceMode](./enum.mdx#ZegoAudioDeviceMode) deviceMode)"
  desc="设置音频设备模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| deviceMode | [ZegoAudioDeviceMode](./enum.mdx#ZegoAudioDeviceMode) | 音频设备模式 |
...
<ParamField
  ...
  prototype="public  bool isAudioDeviceMuted([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType, std::string deviceID)"
  desc="检查音频设备是否静音"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">音频设备是否静音；"true" 表示音频设备静音；"false" 表示音频设备没有被静音。</Tip>
</ParamField>
<ParamField
...
<ParamField
  ...
  prototype="public  [ZegoAudioRoute](./enum.mdx#ZegoAudioRoute) getAudioRouteType()"
  desc="获取当前音频路由。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="enableCamera"
  prototype="public  void enableCamera(bool enable, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  name="useFrontCamera"
  prototype="public  void useFrontCamera(bool enable, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  bool isCameraFocusSupported([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="摄像头是否支持对焦"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">是否支持对焦，支持为 true，不支持为 false</Tip>
</ParamField>
<ParamField
  name="setCameraFocusMode"
  prototype="public  void setCameraFocusMode([ZegoCameraFocusMode](./enum.mdx#ZegoCameraFocusMode) mode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置摄像头对焦模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoCameraFocusMode](./enum.mdx#ZegoCameraFocusMode) | 对焦模式。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  ...
  prototype="public  void setCameraFocusPointInPreview(float x, float y, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置预览视图中的对焦点。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void setCameraExposureMode([ZegoCameraExposureMode](./enum.mdx#ZegoCameraExposureMode) mode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置摄像头曝光模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoCameraExposureMode](./enum.mdx#ZegoCameraExposureMode) | 曝光模式。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  ...
  prototype="public  void setCameraExposurePointInPreview(float x, float y, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="设置预览视图中的曝光点。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void setCameraExposureCompensation(float value, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void setCameraZoomFactor(float factor, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  float getCameraMaxZoomFactor([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<Tip title="Return">摄像头最大变焦倍数</Tip>
</ParamField>
<ParamField
  name="enableCameraAdaptiveFPS"
  prototype="public  void enableCameraAdaptiveFPS(bool enable, int minFPS, int maxFPS, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开启摄像头自适应帧率"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="useVideoDevice"
  prototype="public  void useVideoDevice(std::string deviceID, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  std::vector&lt;[ZegoDeviceInfo](./struct.mdx#ZegoDeviceInfo)&gt; getVideoDeviceList()"
  desc="获取视频设备列表"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">默认视频设备 ID</Tip>
</ParamField>
<ParamField
...
<ParamField
  name="startSoundLevelMonitor"
  prototype="public  void startSoundLevelMonitor([ZegoSoundLevelConfig](./struct.mdx#ZegoSoundLevelConfig) config)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoSoundLevelConfig](./struct.mdx#ZegoSoundLevelConfig) | 启动声浪监控的配置。 |
...
<ParamField
  ...
  prototype="public  void startAudioVADStableStateMonitor([ZegoAudioVADStableStateMonitorType](./enum.mdx#ZegoAudioVADStableStateMonitorType) type)"
  desc="开始语音的稳态检测。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="startAudioVADStableStateMonitor"
  prototype="public  void startAudioVADStableStateMonitor([ZegoAudioVADStableStateMonitorType](./enum.mdx#ZegoAudioVADStableStateMonitorType) type, int millisecond)"
...
<ParamField
  ...
  prototype="public  void stopAudioVADStableStateMonitor([ZegoAudioVADStableStateMonitorType](./enum.mdx#ZegoAudioVADStableStateMonitorType) type)"
  desc="停止语音的稳态检测。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  [ZegoDeviceInfo](./struct.mdx#ZegoDeviceInfo) getCurrentAudioDevice([ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) deviceType)"
  desc="获取当前使用的音频设备信息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| deviceType | [ZegoAudioDeviceType](./enum.mdx#ZegoAudioDeviceType) | 音频设备类型。是否必填：是。 |
...
<ParamField
  name="setAECMode"
  prototype="public  void setAECMode([ZegoAECMode](./enum.mdx#ZegoAECMode) mode)"
  desc="设置回声消除模式"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoAECMode](./enum.mdx#ZegoAECMode) | 回声消除模式 |
...
<ParamField
  name="setANSMode"
  prototype="public  void setANSMode([ZegoANSMode](./enum.mdx#ZegoANSMode) mode)"
  desc="设置音频噪声抑制模式"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoANSMode](./enum.mdx#ZegoANSMode) | 噪声抑制模式 |
...
<ParamField
  ...
  prototype="public  void setAudioMixingVolume(int volume, [ZegoVolumeType](./enum.mdx#ZegoVolumeType) type)"
...
| type | [ZegoVolumeType](./enum.mdx#ZegoVolumeType) | 混音本地播放音量/混音推流中的音量 |
...
<ParamField
  ...
  prototype="public  void setEffectsBeautyParam([ZegoEffectsBeautyParam](./struct.mdx#ZegoEffectsBeautyParam) param)"
  desc="设置美颜效果参数。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoEffectsBeautyParam](./struct.mdx#ZegoEffectsBeautyParam) | 美颜选项参数。 |
...
<ParamField
  ...
  prototype="public  void setVoiceChangerPreset([ZegoVoiceChangerPreset](./enum.mdx#ZegoVoiceChangerPreset) preset)"
  desc="通过预设枚举设置变声。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| preset | [ZegoVoiceChangerPreset](./enum.mdx#ZegoVoiceChangerPreset) | 变声预设枚举。 |
...
<ParamField
  ...
  prototype="public  void setVoiceChangerParam([ZegoVoiceChangerParam](./struct.mdx#ZegoVoiceChangerParam) param)"
  desc="设置变声的具体参数。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoVoiceChangerParam](./struct.mdx#ZegoVoiceChangerParam) | 变声参数。 |
...
<ParamField
  ...
  prototype="public  void setReverbPreset([ZegoReverbPreset](./enum.mdx#ZegoReverbPreset) preset)"
  desc="通过预设枚举设置混响。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| preset | [ZegoReverbPreset](./enum.mdx#ZegoReverbPreset) | 混响预设枚举。 |
...
<ParamField
  ...
  prototype="public  void setReverbAdvancedParam([ZegoReverbAdvancedParam](./struct.mdx#ZegoReverbAdvancedParam) param)"
  desc="设置混响的具体参数。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoReverbAdvancedParam](./struct.mdx#ZegoReverbAdvancedParam) | 混响高级参数。 |
...
<ParamField
  ...
  prototype="public  void setReverbEchoParam([ZegoReverbEchoParam](./struct.mdx#ZegoReverbEchoParam) param)"
  desc="设置混响回声效果的具体参数。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoReverbEchoParam](./struct.mdx#ZegoReverbEchoParam) | 混响回声效果参数。 |
...
<ParamField
  ...
  prototype="public  void setElectronicEffects(bool enable, [ZegoElectronicEffectsMode](./enum.mdx#ZegoElectronicEffectsMode) mode, int tonal)"
  desc="开启或关闭电音效果。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| mode | [ZegoElectronicEffectsMode](./enum.mdx#ZegoElectronicEffectsMode) | 电音参考的调式。 |
...
<ParamField
  ...
  prototype="public  void enableColorEnhancement(bool enable, [ZegoColorEnhancementParams](./struct.mdx#ZegoColorEnhancementParams) params, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="开启色彩增强。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| enable | bool | 是否开启；true 表示开启；false 表示关闭。 |
| params | [ZegoColorEnhancementParams](./struct.mdx#ZegoColorEnhancementParams) | 色彩增强参数。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<Tip title="Return">实时有序数据管理器对象，超过最大数量限制后将返回 nullptr</Tip>
</ParamField>
<ParamField
...
<ParamField
  ...
  prototype="public  void sendBroadcastMessage(std::string roomID, std::string message, [ZegoIMSendBroadcastMessageCallback](./interface.mdx#ZegoExpressDefines#zego-im-send-broadcast-message-callback) callback)"
  desc="发送房间广播消息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| callback | [ZegoIMSendBroadcastMessageCallback](./interface.mdx#ZegoExpressDefines#zego-im-send-broadcast-message-callback) | 发送广播消息结果通知。是否必填：否。注意事项：传 [nullptr] 则意味着不接收回调通知。 |
...
<ParamField
  ...
  prototype="public  void sendBarrageMessage(std::string roomID, std::string message, [ZegoIMSendBarrageMessageCallback](./interface.mdx#ZegoExpressDefines#zego-im-send-barrage-message-callback) callback)"
  desc="发送房间弹幕消息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| roomID | std::string | 房间 ID，不得为空，最大长度小于 128 字节的字符串。\</br>  注意事项：\</br>  1.房间 ID 由您自己定义。\</br>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '\`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。\</br>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| message | std::string | 消息内容。是否必填：是。取值范围：长度不超过 1024 字节。 |
| callback | [ZegoIMSendBarrageMessageCallback](./interface.mdx#ZegoExpressDefines#zego-im-send-barrage-message-callback) | 发送弹幕消息结果通知。是否必填：否。注意事项：传 [nullptr] 则意味着不接收回调通知。 |
...
<ParamField
  ...
  prototype="public  void sendCustomCommand(std::string roomID, std::string command, std::vector<[ZegoUser](./struct.mdx#ZegoUser)> toUserList, [ZegoIMSendCustomCommandCallback](./interface.mdx#ZegoExpressDefines#zego-im-send-custom-command-callback) callback)"
  desc="发送自定义信令。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| toUserList | std::vector\<[ZegoUser](./struct.mdx#ZegoUser)> | 信令的接收者列表。是否必填：是。取值范围：用户列表或者 [nullptr]。注意事项：为 [nullptr] 时 SDK 回向房间内所有用户发送自定义信令。 |
| callback | [ZegoIMSendCustomCommandCallback](./interface.mdx#ZegoExpressDefines#zego-im-send-custom-command-callback) | 发送信令结果通知。是否必填：否。注意事项：传 [nullptr] 则意味着不接收回调通知。 |
...
<ParamField
  ...
  prototype="public  void sendTransparentMessage(std::string roomID, const [ZegoRoomSendTransparentMessage](./struct.mdx#ZegoRoomSendTransparentMessage)& message, [ZegoRoomSendTransparentMessageCallback](./interface.mdx#ZegoExpressDefines#zego-room-send-transparent-message-callback) callback)"
  desc="发送透传消息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| roomID | std::string | 房间 ID，不得为空，最大长度小于 128 字节的字符串。\</br>  注意事项：\</br>  1.房间 ID 由您自己定义。\</br>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '\`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。\</br>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| message | const [ZegoRoomSendTransparentMessage](./struct.mdx#ZegoRoomSendTransparentMessage)& | 发送透传消息的结构信息。 |
| callback | [ZegoRoomSendTransparentMessageCallback](./interface.mdx#ZegoExpressDefines#zego-room-send-transparent-message-callback) | 发送信令结果通知。是否必填：否。注意事项：传 [nullptr] 则意味着不接收回调通知。 |
...
<Tip title="Return">媒体播放器实例，超过最大数量限制后将返回 nullptr。</Tip>
</ParamField>
<ParamField
...
<Tip title="Return">音效播放器实例，超过最大数量限制后将返回 nullptr。</Tip>
</ParamField>
<ParamField
...
<Tip title="Return">媒体数据推流器实例。</Tip>
</ParamField>
<ParamField
  name="createMediaDataPublisher"
  prototype="public  [IZegoMediaDataPublisher](#IZegoMediaDataPublisher)* createMediaDataPublisher([ZegoMediaDataPublisherConfig](./struct.mdx#ZegoMediaDataPublisherConfig) config)"
  desc="创建媒体数据推流器实例对象"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoMediaDataPublisherConfig](./struct.mdx#ZegoMediaDataPublisherConfig) | 配置媒体数据推流器。 |
...
<ParamField
  ...
  prototype="public  void startRecordingCapturedData([ZegoDataRecordConfig](./struct.mdx#ZegoDataRecordConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void stopRecordingCapturedData([ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
  desc="结束录制本端音频或音视频。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void startNetworkProbe([ZegoNetworkProbeConfig](./struct.mdx#ZegoNetworkProbeConfig) config, [ZegoNetworkProbeResultCallback](./interface.mdx#ZegoExpressDefines#zego-network-probe-result-callback) callback)"
  desc="启动网络探测。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoNetworkProbeConfig](./struct.mdx#ZegoNetworkProbeConfig) | 网络探测配置。 |
| callback | [ZegoNetworkProbeResultCallback](./interface.mdx#ZegoExpressDefines#zego-network-probe-result-callback) | 网络探测结果回调。 |
...
<ParamField
  ...
  prototype="public  void testNetworkConnectivity([ZegoTestNetworkConnectivityCallback](./interface.mdx#ZegoExpressDefines#zego-test-network-connectivity-callback) callback)"
  desc="测试网络连通性"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoTestNetworkConnectivityCallback](./interface.mdx#ZegoExpressDefines#zego-test-network-connectivity-callback) | 网络连通性测试结果通知 |
...
<ParamField
  ...
  prototype="public  void startNetworkSpeedTest([ZegoNetworkSpeedTestConfig](./struct.mdx#ZegoNetworkSpeedTestConfig) config, unsigned int interval)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoNetworkSpeedTestConfig](./struct.mdx#ZegoNetworkSpeedTestConfig) | 网络测速度配置。 |
...
<ParamField
  ...
  prototype="public  [ZegoNetworkTimeInfo](./struct.mdx#ZegoNetworkTimeInfo) getNetworkTimeInfo()"
  desc="获取同步网络时间信息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  name="startDumpData"
  prototype="public  void startDumpData([ZegoDumpDataConfig](./struct.mdx#ZegoDumpDataConfig) config)"
  desc="转储音视频数据。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoDumpDataConfig](./struct.mdx#ZegoDumpDataConfig) | 转储数据配置 |
...
<ParamField
  ...
  prototype="public  void enableCustomVideoRender(bool enable, [ZegoCustomVideoRenderConfig](./struct.mdx#ZegoCustomVideoRenderConfig)* config)"
  desc="开始或停止自定义视频渲染。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| --- | --- | --- |
| enable | bool | 是否开启 |
| config | [ZegoCustomVideoRenderConfig](./struct.mdx#ZegoCustomVideoRenderConfig)* | 自定义渲染配置 |
...
<ParamField
  ...
  prototype="public  void enableCapturedVideoCustomVideoRender(bool enable, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void enableCustomVideoCapture(bool enable, [ZegoCustomVideoCaptureConfig](./struct.mdx#ZegoCustomVideoCaptureConfig)* config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| --- | --- | --- |
| enable | bool | 是否开启 |
| config | [ZegoCustomVideoCaptureConfig](./struct.mdx#ZegoCustomVideoCaptureConfig)* | 自定义采集配置 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  ...
  prototype="public  void sendCustomVideoCaptureRawData(const unsigned char* data, unsigned int dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) params, unsigned long long referenceTimeMillisecond, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| params | [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) | 视频帧的参数 |
| referenceTimeMillisecond | unsigned long long | 视频帧的索引时间，UNIX 时间戳，单位为毫秒 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  ...
  prototype="public  int sendCustomVideoCaptureD3DTextureData(void* texture, int rotation, unsigned long long referenceTimeMillisecond, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<Tip title="Return">错误码，详情请参考 常见错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html)。</Tip>
</ParamField>
<ParamField
  name="sendCustomVideoCaptureEncodedData"
  prototype="public  void sendCustomVideoCaptureEncodedData(const unsigned char* data, unsigned int dataLength, [ZegoVideoEncodedFrameParam](./struct.mdx#ZegoVideoEncodedFrameParam) params, unsigned long long referenceTimeMillisecond, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| data | const unsigned char* | 要向 SDK 发送的视频帧数据 |
| dataLength | unsigned int | 视频帧数据长度 |
| params | [ZegoVideoEncodedFrameParam](./struct.mdx#ZegoVideoEncodedFrameParam) | 视频帧的参数 |
| referenceTimeMillisecond | unsigned long long | 视频帧的索引时间，UNIX 时间戳，单位为毫秒 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  ...
  prototype="public  void setCustomVideoCaptureFillMode([ZegoViewMode](./enum.mdx#ZegoViewMode) mode, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoViewMode](./enum.mdx#ZegoViewMode) | 画面填充缩放模式 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  ...
  prototype="public  void setCustomVideoCaptureDeviceState(bool isEnable, [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) state, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| state | [ZegoRemoteDeviceState](./enum.mdx#ZegoRemoteDeviceState) | 设备状态。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。 |
...
<ParamField
  ...
  prototype="public  void setCustomVideoCaptureRegionOfInterest(std::vector<[ZegoRoiRect](./struct.mdx#ZegoRoiRect)> rectList, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| rectList | std::vector\<[ZegoRoiRect](./struct.mdx#ZegoRoiRect)> | ROI 矩形区域列表，当前最多支持 6 个区域。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道 |
...
<ParamField
  ...
  prototype="public  void enableCustomVideoProcessing(bool enable, [ZegoCustomVideoProcessConfig](./struct.mdx#ZegoCustomVideoProcessConfig)* config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| config | [ZegoCustomVideoProcessConfig](./struct.mdx#ZegoCustomVideoProcessConfig)* | 自定义视频前处理配置。是否必填：是。注意事项：传 nullptr 则使用平台默认值。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。是否必填：否。默认值：主推流通道。 |
...
<ParamField
  ...
  prototype="public  void sendCustomVideoProcessedRawData(const unsigned char** data, unsigned int* dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) params, unsigned long long referenceTimeMillisecond, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  name="sendCustomVideoProcessedRawData"
  prototype="public  void sendCustomVideoProcessedRawData(const unsigned char** data, unsigned int* dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) params, unsigned long long referenceTimeMillisecond, [ZegoProcessedDataUsageType](./enum.mdx#ZegoProcessedDataUsageType) usage, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| params | [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) | 视频帧的参数。 |
| referenceTimeMillisecond | unsigned long long | 视频帧的索引时间，UNIX 时间戳，单位为毫秒。 |
| usage | [ZegoProcessedDataUsageType](./enum.mdx#ZegoProcessedDataUsageType) | 数据的用途 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 推流通道。是否必填：否。默认值：主推流通道。 |
...
<ParamField
  ...
  prototype="public  void sendCustomVideoProcessedCVPixelBuffer(void* buffer, unsigned long long timestamp, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  name="sendCustomVideoProcessedCVPixelBuffer"
  prototype="public  void sendCustomVideoProcessedCVPixelBuffer(void* buffer, unsigned long long timestamp, [ZegoProcessedDataUsageType](./enum.mdx#ZegoProcessedDataUsageType) usage, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
<ParamField
  ...
  prototype="public  void enableCustomAudioCaptureProcessing(bool enable, [ZegoCustomAudioProcessConfig](./struct.mdx#ZegoCustomAudioProcessConfig)* config)"
...
| config | [ZegoCustomAudioProcessConfig](./struct.mdx#ZegoCustomAudioProcessConfig)* | 自定义音频处理配置。 |
...
<ParamField
  ...
  prototype="public  void enableCustomAudioCaptureProcessingAfterHeadphoneMonitor(bool enable, [ZegoCustomAudioProcessConfig](./struct.mdx#ZegoCustomAudioProcessConfig)* config)"
...
<ParamField
  ...
  prototype="public  void enableBeforeAudioPrepAudioData(bool enable, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
...
| param | [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) | 音频帧参数。目前支持 0、16k、32k、44.1k、48k 的采样率，0 表示使用 SDK 内部使用的采样率；支持未知声道、单声道、双声道，未知声道表示使用 SDK 内部使用的声道数。 |
...
<ParamField
  ...
  prototype="public  void enableCustomAudioRemoteProcessing(bool enable, [ZegoCustomAudioProcessConfig](./struct.mdx#ZegoCustomAudioProcessConfig)* config)"
  desc="开启远端拉流自定义音频处理。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void enableCustomAudioPlaybackProcessing(bool enable, [ZegoCustomAudioProcessConfig](./struct.mdx#ZegoCustomAudioProcessConfig)* config)"
...
<ParamField
  ...
  prototype="public  void startAudioDataObserver(unsigned int observerBitMask, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
  desc="开启音频数据回调监测。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void enableCustomAudioIO(bool enable, [ZegoCustomAudioConfig](./struct.mdx#ZegoCustomAudioConfig) config, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| config | [ZegoCustomAudioConfig](./struct.mdx#ZegoCustomAudioConfig) | 自定义音频 IO 的配置。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 指定要开启自定义音频 IO 的推流通道。 |
...
<ParamField
  ...
  prototype="public  void sendCustomAudioCaptureAACData(unsigned char * data, unsigned int dataLength, unsigned int configLength, unsigned long long referenceTimeMillisecond, unsigned int samples, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| param | [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) | 该 AAC 音频帧的参数。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 采集音频帧的推流通道。 |
...
<ParamField
  ...
  prototype="public  void sendCustomAudioCapturePCMData(unsigned char * data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param, [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) channel)"
...
| dataLength | unsigned int | buffer 数据的总长度。 |
| param | [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) | 该 PCM 音频帧的参数。 |
| channel | [ZegoPublishChannel](./enum.mdx#ZegoPublishChannel) | 采集音频帧的推流通道。 |
...
<ParamField
  ...
  prototype="public  void fetchCustomAudioRenderPCMData(unsigned char * data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
...
| param | [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) | 指定从 SDK 取的音频帧的参数。ZegoAudioFrameParam 中参数sampleRate必填。 |
...
<ParamField
  ...
  prototype="public  void sendReferenceAudioPCMData(unsigned char * data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
...
<Tip title="Return">范围语音实例，超过最大数量限制后将返回 nullptr。</Tip>
</ParamField>
<ParamField
...
<Tip title="Return">版权音乐实例，多次调用此函数返回同一个对象。</Tip>
</ParamField>
<ParamField
...
<ParamField
  ...
  prototype="public  std::vector&lt;[ZegoScreenCaptureSourceInfo](./struct.mdx#ZegoScreenCaptureSourceInfo)&gt; getScreenCaptureSources(int thumbnailWidth, int thumbnailHeight, int iconWidth, int iconHeight)"
...
<Tip title="Return">采集源对象信息列表。</Tip>
</ParamField>
<ParamField
  name="freeScreenCaptureSources"
  prototype="public  void freeScreenCaptureSources(std::vector<[ZegoScreenCaptureSourceInfo](./struct.mdx#ZegoScreenCaptureSourceInfo)>& sourceList)"
  desc="释放屏幕采集源列表"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| sourceList | std::vector\<[ZegoScreenCaptureSourceInfo](./struct.mdx#ZegoScreenCaptureSourceInfo)>& | 屏幕采集源列表 |
...
<ParamField
  ...
  prototype="public  [IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* createScreenCaptureSource(void * sourceId, [ZegoScreenCaptureSourceType](./enum.mdx#ZegoScreenCaptureSourceType) sourceType)"
  desc="创建屏幕采集源"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
| sourceType | [ZegoScreenCaptureSourceType](./enum.mdx#ZegoScreenCaptureSourceType) | 指定的屏幕源类型。 |
...
<Tip title="Return">屏幕采集源对象，超过最大数量限制后将返回 nullptr</Tip>
</ParamField>
<ParamField
...
<ParamField
  ...
  prototype="public  void startScreenCaptureInApp([ZegoScreenCaptureConfig](./struct.mdx#ZegoScreenCaptureConfig) config)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoScreenCaptureConfig](./struct.mdx#ZegoScreenCaptureConfig) | 屏幕采集参数配置。 |
...
<ParamField
  ...
  prototype="public  void startScreenCapture([ZegoScreenCaptureConfig](./struct.mdx#ZegoScreenCaptureConfig) config)"
  desc="开始屏幕采集。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void updateScreenCaptureConfig([ZegoScreenCaptureConfig](./struct.mdx#ZegoScreenCaptureConfig) config)"
  desc="更新屏幕采集参数配置。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoExpressEngine"
  parent_type="class">
...
<Tip title="Return">设备支持运行 AI 变声功能时返回 true，否则返回 false。</Tip>
</ParamField>
<ParamField
...
<Tip title="Return">当前文件的播放进度。</Tip>
</ParamField>
<ParamField
  name="getIndex"
  prototype="public  int getIndex()"
...
<ParamField
  ...
  prototype="public  void setVideoHandler(std::shared_ptr<[IZegoMediaPlayerVideoHandler](#IZegoMediaPlayerVideoHandler)> handler, [ZegoVideoFrameFormat](./enum.mdx#ZegoVideoFrameFormat) format)"
  desc="设置媒体播放器的视频数据回调。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| format | [ZegoVideoFrameFormat](./enum.mdx#ZegoVideoFrameFormat) | 视频数据的视频帧格式 |
...
<ParamField
  name="loadResource"
  prototype="public  void loadResource(std::string path, [ZegoMediaPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-load-resource-callback) callback)"
  desc="加载本地或者网络媒体资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| callback | [ZegoMediaPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-load-resource-callback) | 资源加载结果的通知。 |
...
<Tip title="Return">加载媒体资源结果回调。</Tip>
</ParamField>
<ParamField
  name="loadResourceWithPosition"
  prototype="public  void loadResourceWithPosition(std::string path, long startPosition, [ZegoMediaPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-load-resource-callback) callback)"
...
<ParamField
  ...
  prototype="public  void loadResourceFromMediaData(unsigned char * mediaData, int mediaDataLength, long startPosition, [ZegoMediaPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-load-resource-callback) callback)"
  desc="加载二进制的音频媒体资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void loadCopyrightedMusicResourceWithPosition(std::string resourceID, long startPosition, [ZegoMediaPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-load-resource-callback) callback)"
  desc="加载版权音乐资源。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void loadResourceWithConfig([ZegoMediaPlayerResource](./struct.mdx#ZegoMediaPlayerResource) resource, [ZegoMediaPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-load-resource-callback) callback)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| resource | [ZegoMediaPlayerResource](./struct.mdx#ZegoMediaPlayerResource) | 需要加载的多媒体资源。 |
| callback | [ZegoMediaPlayerLoadResourceCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-load-resource-callback) | 资源加载结果的通知。 |
...
<ParamField
  name="seekTo"
  prototype="public  void seekTo(unsigned long long millisecond, [ZegoMediaPlayerSeekToCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-seek-to-callback) callback)"
  desc="设置指定的播放进度"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| --- | --- | --- |
| millisecond | unsigned long long | 指定的播放进度的时间点 |
| callback | [ZegoMediaPlayerSeekToCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-seek-to-callback) | 设置指定的播放进度的结果通知 |

**详情**

单位为毫秒

<Tip title="Return">设置指定的播放进度的结果通知</Tip>
</ParamField>
<ParamField
  name="enableRepeat"
...
<ParamField
  ...
  prototype="public  void setPlayerCanvas([ZegoCanvas](./struct.mdx#ZegoCanvas) * canvas)"
  desc="设置播放器播放视频的视图"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| canvas | [ZegoCanvas](./struct.mdx#ZegoCanvas) * | 视频渲染的画布对象 |
</ParamField>
<ParamField
  name="setVolume"
...
<ParamField
  ...
  prototype="public  void setAudioTrackMode([ZegoMediaPlayerAudioTrackMode](./enum.mdx#ZegoMediaPlayerAudioTrackMode) mode)"
  desc="设置播放器的音轨模式"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoMediaPlayerAudioTrackMode](./enum.mdx#ZegoMediaPlayerAudioTrackMode) | 音轨模式。 |
...
<ParamField
  ...
  prototype="public  void enableVoiceChanger([ZegoMediaPlayerAudioChannel](./enum.mdx#ZegoMediaPlayerAudioChannel) audioChannel, bool enable, [ZegoVoiceChangerParam](./struct.mdx#ZegoVoiceChangerParam) param)"
  desc="开启变声，设置变声的具体参数。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| audioChannel | [ZegoMediaPlayerAudioChannel](./enum.mdx#ZegoMediaPlayerAudioChannel) | 要进行变声的声道 |
...
<ParamField
  ...
  prototype="public  [ZegoMediaPlayerState](./enum.mdx#ZegoMediaPlayerState) getCurrentState()"
  desc="获取当前播放状态"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
<Tip title="Return">当前播放器状态</Tip>
</ParamField>
<ParamField
  name="getIndex"
  prototype="public  int getIndex()"
...
<Tip title="Return">媒体播放器索引。</Tip>
</ParamField>
<ParamField
  name="takeSnapshot"
  prototype="public  void takeSnapshot([ZegoMediaPlayerTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-take-snapshot-callback) callback)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoMediaPlayerTakeSnapshotCallback](./interface.mdx#ZegoExpressDefines#zego-media-player-take-snapshot-callback) | 媒体播放器播放画面截图的回调 |
...
<ParamField
  ...
  prototype="public  void enableAccurateSeek(bool enable, [ZegoAccurateSeekConfig](./struct.mdx#ZegoAccurateSeekConfig) * config)"
...
| config | [ZegoAccurateSeekConfig](./struct.mdx#ZegoAccurateSeekConfig) * | 精准 seek 的属性设置，只有 enable 为 true 时有效。 |
...
<ParamField
  ...
  prototype="public  [ZegoNetWorkResourceCache](./struct.mdx#ZegoNetWorkResourceCache) * getNetWorkResourceCache()"
  desc="获取当前网络素材缓存队列的缓存数据可播放的时长和缓存数据大小"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
<Tip title="Return">返回当前缓存的信息，包括数据可播放的时长和缓存数据大小</Tip>
</ParamField>
<ParamField
...
<ParamField
  ...
  prototype="public  void setActiveAudioChannel([ZegoMediaPlayerAudioChannel](./enum.mdx#ZegoMediaPlayerAudioChannel) audioChannel)"
  desc="设置播放声道。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| audioChannel | [ZegoMediaPlayerAudioChannel](./enum.mdx#ZegoMediaPlayerAudioChannel) | 播放声道，默认全部声道。 |
...
<ParamField
  name="getMediaInfo"
  prototype="public  [ZegoMediaPlayerMediaInfo](./struct.mdx#ZegoMediaPlayerMediaInfo) getMediaInfo()"
...
<ParamField
  ...
  prototype="public  void setPlayMediaStreamType([ZegoMediaStreamType](./enum.mdx#ZegoMediaStreamType) streamType)"
  desc="设置播放的媒体流类型。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| streamType | [ZegoMediaStreamType](./enum.mdx#ZegoMediaStreamType) | 流类型。 |
...
<ParamField
  ...
  prototype="public  void enableLiveAudioEffect(bool enable, [ZegoLiveAudioEffectMode](./enum.mdx#ZegoLiveAudioEffectMode) mode)"
  desc="开启现场音效。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
| mode | [ZegoLiveAudioEffectMode](./enum.mdx#ZegoLiveAudioEffectMode) | 现场音效模式。 |
...
<ParamField
  ...
  prototype="public  [ZegoMediaPlayerStatisticsInfo](./struct.mdx#ZegoMediaPlayerStatisticsInfo) getPlaybackStatistics()"
  desc="获取播放统计信息。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
  parent_type="class">
...
<ParamField
  name="setVoiceChangerParam"
  prototype="public  void setVoiceChangerParam([ZegoMediaPlayerAudioChannel](./enum.mdx#ZegoMediaPlayerAudioChannel) audioChannel, [ZegoVoiceChangerParam](./struct.mdx#ZegoVoiceChangerParam) param)"
  desc="【已废弃】设置变声的具体参数"
  suffixes={["deprecated"]}
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoMediaPlayer"
...
<ParamField
  name="onAudioFrame"
  prototype="public  void onAudioFrame([IZegoMediaPlayer](#IZegoMediaPlayer)* mediaPlayer, const unsigned char* data, unsigned int dataLength, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) param)"
  desc="播放器抛音频数据的回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
<Tip title="Return">buffer 的大小, 失败返回 -1。</Tip>
</ParamField>
...
<ParamField
  ...
  prototype="public  void onMediaPlayerStateUpdate([IZegoMediaPlayer](#IZegoMediaPlayer)* mediaPlayer, [ZegoMediaPlayerState](./enum.mdx#ZegoMediaPlayerState) state, int errorCode)"
  desc="媒体播放器播放状态回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| --- | --- | --- |
| mediaPlayer | [IZegoMediaPlayer](#IZegoMediaPlayer)* | 回调的播放器实例。 |
| state | [ZegoMediaPlayerState](./enum.mdx#ZegoMediaPlayerState) | 播放器状态。 |
| errorCode | int | 错误码，详情请参考 常见错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html) |
...
<ParamField
  ...
  prototype="public  void onMediaPlayerNetworkEvent([IZegoMediaPlayer](#IZegoMediaPlayer)* mediaPlayer, [ZegoMediaPlayerNetworkEvent](./enum.mdx#ZegoMediaPlayerNetworkEvent) networkEvent)"
  desc="媒体播放器网络状态事件回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoMediaPlayerEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| mediaPlayer | [IZegoMediaPlayer](#IZegoMediaPlayer)* | 回调的播放器实例。 |
| networkEvent | [ZegoMediaPlayerNetworkEvent](./enum.mdx#ZegoMediaPlayerNetworkEvent) | 网络状态事件。 |
...
<ParamField
  ...
  prototype="public  void onMediaPlayerFirstFrameEvent([IZegoMediaPlayer](#IZegoMediaPlayer)* mediaPlayer, [ZegoMediaPlayerFirstFrameEvent](./enum.mdx#ZegoMediaPlayerFirstFrameEvent) event)"
  desc="媒体播放器播放首帧回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoMediaPlayerEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| mediaPlayer | [IZegoMediaPlayer](#IZegoMediaPlayer)* | 回调的播放器实例。 |
| event | [ZegoMediaPlayerFirstFrameEvent](./enum.mdx#ZegoMediaPlayerFirstFrameEvent) | 首帧回调事件类型。 |
...
<ParamField
  name="onVideoFrame"
  prototype="public  void onVideoFrame([IZegoMediaPlayer](#IZegoMediaPlayer)* mediaPlayer, const unsigned char** data, unsigned int* dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) param)"
  desc="播放器抛视频数据的回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
<ParamField
  name="onVideoFrame"
  prototype="public  void onVideoFrame([IZegoMediaPlayer](#IZegoMediaPlayer)* mediaPlayer, const unsigned char** data, unsigned int* dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) param, const char* extraInfo)"
...
<ParamField
  ...
  parent_name="IZegoPictureCapturer"
  parent_type="class">
<Tip title="Return">图片采集器实例编号。</Tip>
</ParamField>
...
<ParamField
  name="setAudioReceiveRange"
  prototype="public  int setAudioReceiveRange([ZegoReceiveRangeParam](./struct.mdx#ZegoReceiveRangeParam) param)"
  desc="设置音频接收范围的配置。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeAudio"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoReceiveRangeParam](./struct.mdx#ZegoReceiveRangeParam) | 音频接收范围的配置。 |
...
<Tip title="Return">错误码，详情请参考常用 错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html)</Tip>
</ParamField>
<ParamField
...
<ParamField
  name="setStreamVocalRange"
  prototype="public  int setStreamVocalRange(std::string streamID, [ZegoVocalRangeParam](./struct.mdx#ZegoVocalRangeParam) param)"
  desc="设置流的发声范围"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeAudio"
  parent_type="class">
...
| --- | --- | --- |
| streamID | std::string | 拉流 ID。 |
| param | [ZegoVocalRangeParam](./struct.mdx#ZegoVocalRangeParam) | 流发声范围。 |
...
<ParamField
  ...
  prototype="public  void setRangeAudioMode([ZegoRangeAudioMode](./enum.mdx#ZegoRangeAudioMode) mode)"
  desc="设置范围语音模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeAudio"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoRangeAudioMode](./enum.mdx#ZegoRangeAudioMode) | 范围语音模式。 |
...
<ParamField
  ...
  prototype="public  void setRangeAudioCustomMode([ZegoRangeAudioSpeakMode](./enum.mdx#ZegoRangeAudioSpeakMode) speakMode, [ZegoRangeAudioListenMode](./enum.mdx#ZegoRangeAudioListenMode) listenMode)"
  desc="设置范围语音的高阶自定义模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeAudio"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| speakMode | [ZegoRangeAudioSpeakMode](./enum.mdx#ZegoRangeAudioSpeakMode) | 范围语音发声模式。 |
| listenMode | [ZegoRangeAudioListenMode](./enum.mdx#ZegoRangeAudioListenMode) | 范围语音收听模式。 |
...
<ParamField
  ...
  prototype="public  void onRangeAudioMicrophoneStateUpdate([IZegoRangeAudio](#IZegoRangeAudio)* rangeAudio, [ZegoRangeAudioMicrophoneState](./enum.mdx#ZegoRangeAudioMicrophoneState) state, int errorCode)"
  desc="范围语音麦克风使用状态回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| state | [ZegoRangeAudioMicrophoneState](./enum.mdx#ZegoRangeAudioMicrophoneState) | 麦克风使用状态。 |
| errorCode | int | 错误码，详情请参考 常见错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html) |
...
<Tip title="Return">范围场景流管理实例。</Tip>
</ParamField>
<ParamField
...
<Tip title="Return">范围场景小队管理实例。</Tip>
</ParamField>
<ParamField
...
<Tip title="Return">范围场景物品管理实例。</Tip>
</ParamField>
<ParamField
...
<Tip title="Return">设置范围场景回调结果。true: 成功, false: 失败。</Tip>
</ParamField>
<ParamField
  name="loginScene"
  prototype="public  int loginScene([ZegoSceneParam](./struct.mdx#ZegoSceneParam) param, [ZegoRangeSceneLoginSceneCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-login-scene-callback) callback)"
  desc="登录场景。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoSceneParam](./struct.mdx#ZegoSceneParam) | 场景参数。 |
| callback | [ZegoRangeSceneLoginSceneCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-login-scene-callback) | 登录场景结果回调。 |
...
<ParamField
  name="logoutScene"
  prototype="public  int logoutScene([ZegoRangeSceneLogoutSceneCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-logout-scene-callback) callback)"
  desc="退出场景。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoRangeSceneLogoutSceneCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-logout-scene-callback) | 退出场景结果回调。 |
...
<ParamField
  ...
  prototype="public  int updateUserStatus([ZegoPosition](./struct.mdx#ZegoPosition) position, unsigned int channel, const unsigned char* status, unsigned int statusLength)"
  desc="更新用户的状态。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| position | [ZegoPosition](./struct.mdx#ZegoPosition) | 用户当前位置。 |
...
<ParamField
  ...
  prototype="public  int updateUserCommand([ZegoPosition](./struct.mdx#ZegoPosition) position, unsigned int channel, const unsigned char* command, unsigned int commandLength)"
  desc="更新用户的指令。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  int updateUserPosition([ZegoPosition](./struct.mdx#ZegoPosition) position)"
  desc="更新用户的位置。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
<ParamField
  name="getUserCount"
  prototype="public  int getUserCount([ZegoRangeSceneGetUserCountCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-get-user-count-callback) callback)"
  desc="获取场景内总人数。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoRangeSceneGetUserCountCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-get-user-count-callback) | 获取场景内总人数结果回调。 |
...
<ParamField
  ...
  prototype="public  int getUserListInView([ZegoRangeSceneGetUserListInViewCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-get-user-list-in-view-callback) callback)"
  desc="获取范围内用户列表。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoRangeSceneGetUserListInViewCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-get-user-list-in-view-callback) | 获取范围内用户列表结果回调。 |
...
<ParamField
  name="sendCustomCommand"
  prototype="public  int sendCustomCommand(const unsigned char* command, unsigned int commandLength, [ZegoRangeSceneSendCustomCommandCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-send-custom-command-callback) callback)"
  desc="发送用户自定义信令。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
| callback | [ZegoRangeSceneSendCustomCommandCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-send-custom-command-callback) | 发送用户自定义信令结果回调。 |
...
<ParamField
  ...
  prototype="public  int setStreamConfig([ZegoSceneStreamConfig](./struct.mdx#ZegoSceneStreamConfig) config)"
  desc="设置场景推拉流模式。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeScene"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoSceneStreamConfig](./struct.mdx#ZegoSceneStreamConfig) | 场景推拉流模式。 |
...
<ParamField
  ...
  prototype="public  void onSceneStateUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, [ZegoSceneState](./enum.mdx#ZegoSceneState) state, int errorCode)"
  desc="场景状态变化通知"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| state | [ZegoSceneState](./enum.mdx#ZegoSceneState) | 当前场景状态。 |
| errorCode | int | 错误码，详情请参考常用 错误码文档 [https://doc-zh.zego.im/zh/4378.html](https://doc-zh.zego.im/zh/4378.html) |
...
<ParamField
  name="onEnterView"
  prototype="public  void onEnterView([IZegoRangeScene](#IZegoRangeScene)* rangeScene, const [ZegoUser](./struct.mdx#ZegoUser)& user, const [ZegoPosition](./struct.mdx#ZegoPosition)& position)"
...
| --- | --- | --- |
| rangeScene | [IZegoRangeScene](#IZegoRangeScene)* | 触发此次回调的范围场景实例。 |
| user | const [ZegoUser](./struct.mdx#ZegoUser)& | 用户对象。 |
| position | const [ZegoPosition](./struct.mdx#ZegoPosition)& | 用户位置。 |
...
<ParamField
  ...
  prototype="public  void onUserStatusUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, std::string userID, const [ZegoPosition](./struct.mdx#ZegoPosition)& position, unsigned int channel, const unsigned char* status, unsigned int statusLength)"
  desc="用户状态变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoRangeSceneEventHandler"
  parent_type="class">
...
| rangeScene | [IZegoRangeScene](#IZegoRangeScene)* | 触发此次回调的范围场景实例。 |
| userID | std::string | 用户 ID。 |
| position | const [ZegoPosition](./struct.mdx#ZegoPosition)& | 用户当前位置。 |
...
<ParamField
  ...
  prototype="public  void onUserCommandUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, std::string userID, const [ZegoPosition](./struct.mdx#ZegoPosition)& position, unsigned int channel, const unsigned char* command, unsigned int commandLength)"
  desc="用户指令变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoRangeSceneEventHandler"
  parent_type="class">
...
<Tip title="Return">设置范围场景物品管理回调结果。true: 成功, false: 失败。</Tip>
</ParamField>
<ParamField
  name="createItem"
  prototype="public  int createItem([ZegoItemParam](./struct.mdx#ZegoItemParam) param, [ZegoRangeSceneCreateItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-create-item-callback) callback)"
  desc="创建物品。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneItem"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoItemParam](./struct.mdx#ZegoItemParam) | 物品参数。 |
| callback | [ZegoRangeSceneCreateItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-create-item-callback) | 创建物品结果回调。 |
...
<ParamField
  name="destroyItem"
  prototype="public  int destroyItem(long long itemID, [ZegoRangeSceneDestroyItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-destroy-item-callback) callback)"
  desc="销毁物品。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneItem"
  parent_type="class">
...
| callback | [ZegoRangeSceneDestroyItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-destroy-item-callback) | 销毁物品结果回调。 |
...
<ParamField
  name="bindItem"
  prototype="public  int bindItem(long long itemID, [ZegoRangeSceneBindItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-bind-item-callback) callback)"
  desc="申请绑定物品。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneItem"
  parent_type="class">
...
| --- | --- | --- |
| itemID | long long | 物品 ID。 |
| callback | [ZegoRangeSceneBindItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-bind-item-callback) | 申请绑定物品结果回调。 |
...
<ParamField
  name="unbindItem"
  prototype="public  int unbindItem(long long itemID, [ZegoRangeSceneUnbindItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-unbind-item-callback) callback)"
  desc="申请解绑物品。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneItem"
  parent_type="class">
...
| --- | --- | --- |
| itemID | long long | 物品 ID。 |
| callback | [ZegoRangeSceneUnbindItemCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-unbind-item-callback) | 销毁物品结果回调。 |
...
<ParamField
  ...
  prototype="public  int updateItemStatus(long long itemID, [ZegoPosition](./struct.mdx#ZegoPosition) position, unsigned int channel, const unsigned char* status, unsigned int statusLength, [ZegoRangeSceneUpdateItemStatusCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-update-item-status-callback) callback)"
  desc="更新物品的状态。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneItem"
  parent_type="class">
...
| --- | --- | --- |
| itemID | long long | 物品 ID。 |
| position | [ZegoPosition](./struct.mdx#ZegoPosition) | 物品当前位置。 |
| channel | unsigned int | 状态所属通道，从0开始，不能超过最大通道号。 |
| status | const unsigned char* | 物品当前状态数据。 |
| statusLength | unsigned int | 物品当前状态数据长度。 |
| callback | [ZegoRangeSceneUpdateItemStatusCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-update-item-status-callback) | 更新物品状态结果回调。 |
...
<ParamField
  ...
  prototype="public  int updateItemCommand(long long itemID, [ZegoPosition](./struct.mdx#ZegoPosition) position, unsigned int channel, const unsigned char* command, unsigned int commandLength, [ZegoRangeSceneUpdateItemCommandCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-update-item-command-callback) callback)"
  desc="更新物品的指令。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneItem"
  parent_type="class">
...
| callback | [ZegoRangeSceneUpdateItemCommandCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-update-item-command-callback) | 更新物品下一步命令结果回调。 |
...
<ParamField
  ...
  prototype="public  void onItemEnterView([IZegoRangeScene](#IZegoRangeScene)* rangeScene, long long itemID, unsigned int capacity, const [ZegoPosition](./struct.mdx#ZegoPosition)& position, const std::vector<std::string>& userList)"
  desc="物品进入当前用户视野范围回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| position | const [ZegoPosition](./struct.mdx#ZegoPosition)& | 物品位置。 |
...
<ParamField
  ...
  prototype="public  void onItemStatusUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, long long itemID, const [ZegoPosition](./struct.mdx#ZegoPosition)& position, unsigned int channel, const unsigned char* status, unsigned int statusLength)"
  desc="物品状态变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoRangeSceneItemEventHandler"
  parent_type="class">
...
| rangeScene | [IZegoRangeScene](#IZegoRangeScene)* | 触发此次回调的范围场景实例。 |
| itemID | long long | 物品 ID。 |
| position | const [ZegoPosition](./struct.mdx#ZegoPosition)& | 物品当前位置。 |
| channel | unsigned int | 状态所属通道。 |
| status | const unsigned char* | 物品当前状态数据。 |
| statusLength | unsigned int | 物品当前状态数据长度。 |
...
<ParamField
  ...
  prototype="public  void onItemCommandUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, long long itemID, const [ZegoPosition](./struct.mdx#ZegoPosition)& position, unsigned int channel, const unsigned char* command, unsigned int commandLength)"
  desc="物品指令变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoRangeSceneItemEventHandler"
  parent_type="class">
...
<Tip title="Return">设置范围场景流管理回调结果。true: 成功, false: 失败。</Tip>
</ParamField>
<ParamField
...
<ParamField
  name="setReceiveRange"
  prototype="public  int setReceiveRange([ZegoReceiveRangeParam](./struct.mdx#ZegoReceiveRangeParam) param)"
  desc="设置音视频流的接收范围。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneStream"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| param | [ZegoReceiveRangeParam](./struct.mdx#ZegoReceiveRangeParam) | 音频接受范围配置。 |
...
<ParamField
  ...
  prototype="public  void onUserStreamStateUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, std::string userID, std::string streamID, [ZegoStreamState](./enum.mdx#ZegoStreamState) state)"
...
| state | [ZegoStreamState](./enum.mdx#ZegoStreamState) | 用户流状态。 |
...
<ParamField
  ...
  prototype="public  void onUserMicUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, std::string userID, [ZegoDeviceState](./enum.mdx#ZegoDeviceState) state)"
  desc="用户麦克风状态变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoRangeSceneStreamEventHandler"
  parent_type="class">
...
| rangeScene | [IZegoRangeScene](#IZegoRangeScene)* | 触发此次回调的范围场景实例。 |
| userID | std::string | 用户 ID。 |
| state | [ZegoDeviceState](./enum.mdx#ZegoDeviceState) | 设备状态。 |
...
<ParamField
  ...
  prototype="public  void onUserCameraUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, std::string userID, [ZegoDeviceState](./enum.mdx#ZegoDeviceState) state)"
  desc="用户摄像头状态变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoRangeSceneStreamEventHandler"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  void onUserSpeakerUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, std::string userID, [ZegoDeviceState](./enum.mdx#ZegoDeviceState) state)"
  desc="用户扬声器状态变更回调。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoRangeSceneStreamEventHandler"
  parent_type="class">
...
<Tip title="Return">设置范围场景小队管理回调结果。true: 成功, false: 失败。</Tip>
</ParamField>
<ParamField
  name="joinTeam"
  prototype="public  int joinTeam([ZegoTeamParam](./struct.mdx#ZegoTeamParam) config, [ZegoRangeSceneJoinTeamCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-join-team-callback) callback)"
  desc="加入小队。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneTeam"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoTeamParam](./struct.mdx#ZegoTeamParam) | 小队参数。 |
| callback | [ZegoRangeSceneJoinTeamCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-join-team-callback) | 加入小队结果回调。 |
...
<ParamField
  name="leaveTeam"
  prototype="public  int leaveTeam(unsigned int teamID, [ZegoRangeSceneLeaveTeamCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-leave-team-callback) callback)"
  desc="离开小队。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoRangeSceneTeam"
  parent_type="class">
...
| callback | [ZegoRangeSceneLeaveTeamCallback](./interface.mdx#ZegoExpressDefines#zego-range-scene-leave-team-callback) | 离开小队结果回调。 |
...
<ParamField
  ...
  prototype="public  void onTeamStateUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, unsigned int teamID, [ZegoTeamState](./enum.mdx#ZegoTeamState) state, int errorCode)"
  desc="小队状态变化通知"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| rangeScene | [IZegoRangeScene](#IZegoRangeScene)* | 触发此次回调的范围场景实例。 |
| teamID | unsigned int | 小队 ID。 |
| state | [ZegoTeamState](./enum.mdx#ZegoTeamState) | 变化后的小队状态。 |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/zh/4378.html)。 |
...
<ParamField
  ...
  prototype="public  void onTeamMemberUpdate([IZegoRangeScene](#IZegoRangeScene)* rangeScene, unsigned int teamID, [ZegoUpdateType](./enum.mdx#ZegoUpdateType) updateType, const std::vector<[ZegoUser](./struct.mdx#ZegoUser)>& userList)"
...
| teamID | unsigned int | 小队 ID。 |
| updateType | [ZegoUpdateType](./enum.mdx#ZegoUpdateType) | 更新类型（添加/删除）。 |
| userList | const std::vector\<[ZegoUser](./struct.mdx#ZegoUser)>& | 当前小队内变更的用户列表。 |
...
<ParamField
  ...
  prototype="public  void sendRealTimeSequentialData(const unsigned char* data, unsigned int dataLength, std::string streamID, [ZegoRealTimeSequentialDataSentCallback](./interface.mdx#ZegoExpressDefines#zego-real-time-sequential-data-sent-callback) callback)"
...
| callback | [ZegoRealTimeSequentialDataSentCallback](./interface.mdx#ZegoExpressDefines#zego-real-time-sequential-data-sent-callback) | 发送实时有序数据结果通知。 |
...
<ParamField
  ...
  parent_name="IZegoRealTimeSequentialDataManager"
  parent_type="class">
<Tip title="Return">实时有序数据管理器索引。</Tip>
</ParamField>
...
<ParamField
  ...
  prototype="public  void updateCaptureSource(void * sourceId, [ZegoScreenCaptureSourceType](./enum.mdx#ZegoScreenCaptureSourceType) sourceType)"
  desc="更新屏幕采集源"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoScreenCaptureSource"
  parent_type="class">
...
<ParamField
  ...
  prototype="public  [ZegoRect](./struct.mdx#ZegoRect) getCaptureSourceRect()"
  desc="获取屏幕采集源的矩形。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoScreenCaptureSource"
  parent_type="class">
...
<Tip title="Return">采集资源的矩形信息</Tip>
</ParamField>
<ParamField
  name="updateCaptureRegion"
  prototype="public  void updateCaptureRegion([ZegoRect](./struct.mdx#ZegoRect) rect)"
  desc="更新屏幕采集的区域。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoScreenCaptureSource"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| rect | [ZegoRect](./struct.mdx#ZegoRect) | 待采集区域相对于整个屏幕或窗口的位置。 |
...
<ParamField
  ...
  prototype="public  void updatePublishRegion([ZegoRect](./struct.mdx#ZegoRect) rect)"
  desc="更新屏幕采集的推流区域。"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoScreenCaptureSource"
  parent_type="class">
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| rect | [ZegoRect](./struct.mdx#ZegoRect) | 待推流区域相对于采集画面左上角的位置，实际采集画面尺寸可以通过 [onAvailableFrame] 获取 |
...
<ParamField
  ...
  prototype="public  void enableHightLight(bool enable, [ZegoLayerBorderConfig](./struct.mdx#ZegoLayerBorderConfig) config)"
  desc="设置是否高亮采集区域"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoScreenCaptureSource"
  parent_type="class">
...
| config | [ZegoLayerBorderConfig](./struct.mdx#ZegoLayerBorderConfig) | 高亮采集区域边框配置。 |
...
<ParamField
  ...
  prototype="public  void enableAudioCapture(bool enable, [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) audioParam)"
  desc="窗口采集时是否采集窗口进程的声音"
  parent_file="Declared in \`ZegoExpressInterface.h\`"
  parent_name="IZegoScreenCaptureSource"
  parent_type="class">
**参数**
...
| audioParam | [ZegoAudioFrameParam](./struct.mdx#ZegoAudioFrameParam) | 音频采集参数。 |
...
<ParamField
  ...
  prototype="public  void onAvailableFrame([IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* source, const void * data, unsigned int dataLength, [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) param)"
  desc="屏幕采集数据的回调"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
...
| dataLength | unsigned int | 数据的长度（例：RGBA 只需考虑 dataLength[0]，I420 需考虑 dataLength[0,1,2]）。 |
| param | [ZegoVideoFrameParam](./struct.mdx#ZegoVideoFrameParam) | 屏幕采集图像帧参数。 |
...
<ParamField
  ...
  prototype="public  void onExceptionOccurred([IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* source, [ZegoScreenCaptureSourceExceptionType](./enum.mdx#ZegoScreenCaptureSourceExceptionType) exceptionType)"
  desc="屏幕采集异常通知"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoScreenCaptureSourceEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| source | [IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* | 回调的屏幕采集源实例。 |
| exceptionType | [ZegoScreenCaptureSourceExceptionType](./enum.mdx#ZegoScreenCaptureSourceExceptionType) | 采集源异常类型。 |
...
<ParamField
  ...
  prototype="public  void onCaptureTypeExceptionOccurred([IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* source, [ZegoScreenCaptureSourceType](./enum.mdx#ZegoScreenCaptureSourceType) sourceType, [ZegoScreenCaptureSourceExceptionType](./enum.mdx#ZegoScreenCaptureSourceExceptionType) exceptionType)"
  desc="屏幕采集采集源异常通知"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoScreenCaptureSourceEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| source | [IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* | 回调的屏幕采集源实例。 |
| sourceType | [ZegoScreenCaptureSourceType](./enum.mdx#ZegoScreenCaptureSourceType) | 采集源类型。 |
| exceptionType | [ZegoScreenCaptureSourceExceptionType](./enum.mdx#ZegoScreenCaptureSourceExceptionType) | 采集源异常类型。 |
...
<ParamField
  ...
  prototype="public  void onWindowStateChanged([IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* source, [ZegoScreenCaptureWindowState](./enum.mdx#ZegoScreenCaptureWindowState) windowState, [ZegoRect](./struct.mdx#ZegoRect) windowRect)"
  desc="采集目标窗口状态发生改变。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoScreenCaptureSourceEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| source | [IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* | 回调的屏幕采集源实例。 |
| windowState | [ZegoScreenCaptureWindowState](./enum.mdx#ZegoScreenCaptureWindowState) | 采集的窗口状态。 |
| windowRect | [ZegoRect](./struct.mdx#ZegoRect) | 采集的窗口矩形。 |
...
<ParamField
  name="onRectChanged"
  prototype="public  void onRectChanged([IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* source, [ZegoRect](./struct.mdx#ZegoRect) captureRect)"
  desc="采集区域发生改变。"
  parent_file="Declared in \`ZegoExpressEventHandler.h\`"
  parent_name="IZegoScreenCaptureSourceEventHandler"
  parent_type="class">
...
| --- | --- | --- |
| source | [IZegoScreenCaptureSource](#IZegoScreenCaptureSource)* | 回调的屏幕采集源实例。 |
| captureRect | [ZegoRect](./struct.mdx#ZegoRect) | 采集的区域矩形。 |
...
<ParamField
  name="createEngine"
  prototype="public  [IZegoExpressEngine](#IZegoExpressEngine)* createEngine([ZegoEngineProfile](./struct.mdx#ZegoEngineProfile) profile, std::shared_ptr<[IZegoEventHandler](#IZegoEventHandler)> eventHandler)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| profile | [ZegoEngineProfile](./struct.mdx#ZegoEngineProfile) | 用来创建引擎的基础配置信息。 |
...
<Tip title="Return">引擎单例对象。</Tip>
</ParamField>
<ParamField
  name="destroyEngine"
  prototype="public  void destroyEngine([IZegoExpressEngine](#IZegoExpressEngine)*& engine, [ZegoDestroyCompletionCallback](./interface.mdx#ZegoExpressDefines#zego-destroy-completion-callback) callback)"
...
| callback | [ZegoDestroyCompletionCallback](./interface.mdx#ZegoExpressDefines#zego-destroy-completion-callback) | 销毁引擎完成的通知回调，可监听此回调以确保设备硬件资源(麦克风、扬声器、摄像头等)被释放完成，若开发者不关注引擎资源的释放时机，该参数可传[nullptr]。 |
...
<ParamField
  ...
  prototype="public  void setEngineConfig([ZegoEngineConfig](./struct.mdx#ZegoEngineConfig) config)"
  desc="设置引擎进阶配置。"
  prefixes={["static"]}
  parent_file="Declared in \`ZegoExpressSDK.h\`"
  parent_name="ZegoExpressSDK"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoEngineConfig](./struct.mdx#ZegoEngineConfig) | 引擎进阶配置 |
...
<ParamField
  name="setLogConfig"
  prototype="public  void setLogConfig([ZegoLogConfig](./struct.mdx#ZegoLogConfig) config)"
  desc="设置日志配置。"
  prefixes={["static"]}
  parent_file="Declared in \`ZegoExpressSDK.h\`"
  parent_name="ZegoExpressSDK"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| config | [ZegoLogConfig](./struct.mdx#ZegoLogConfig) | 日志配置。 |
...
<ParamField
  ...
  prototype="public  void setLocalProxyConfig(const std::vector<[ZegoProxyInfo](./struct.mdx#ZegoProxyInfo)>& proxyList, bool enable)"
  desc="设置本地代理配置"
  prefixes={["static"]}
  parent_file="Declared in \`ZegoExpressSDK.h\`"
  parent_name="ZegoExpressSDK"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| proxyList | const std::vector\<[ZegoProxyInfo](./struct.mdx#ZegoProxyInfo)>& | 代理详细信息。 |
| enable | bool | 是否开启代理。 |
...
<ParamField
  ...
  prototype="public  void setCloudProxyConfig(const std::vector<[ZegoProxyInfo](./struct.mdx#ZegoProxyInfo)>& proxyList, std::string token, bool enable)"
  desc="设置云代理配置"
  prefixes={["static"]}
  parent_file="Declared in \`ZegoExpressSDK.h\`"
  parent_name="ZegoExpressSDK"
...
<ParamField
  name="setRoomMode"
  prototype="public  void setRoomMode([ZegoRoomMode](./enum.mdx#ZegoRoomMode) mode)"
  desc="设置房间模式。"
  prefixes={["static"]}
  parent_file="Declared in \`ZegoExpressSDK.h\`"
  parent_name="ZegoExpressSDK"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| mode | [ZegoRoomMode](./enum.mdx#ZegoRoomMode) | 房间模式。详情描述：用于设置房间模式。业务场景：当需要同时进入多个房间进行推拉流时，可以通过本接口开启多房间模式。是否必填：是。默认值：ZEGO_ROOM_MODE_SINGLE_ROOM。 |
...
<ParamField
  name="setGeoFence"
  prototype="public  void setGeoFence([ZegoGeoFenceType](./enum.mdx#ZegoGeoFenceType) type, std::vector<int> areaList)"
  desc="设置地理围栏。"
  prefixes={["static"]}
  parent_file="Declared in \`ZegoExpressSDK.h\`"
  parent_name="ZegoExpressSDK"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| type | [ZegoGeoFenceType](./enum.mdx#ZegoGeoFenceType) | 地理围栏类型。详情描述：用于设置地理围栏类型。 |
...
<ParamField
  ...
  prototype="public  bool isFeatureSupported([ZegoFeatureType](./enum.mdx#ZegoFeatureType) featureType)"
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| featureType | [ZegoFeatureType](./enum.mdx#ZegoFeatureType) | 要查询的功能特性类型。 |
...
<Tip title="Return">是否支持指定功能特性。true 表示支持；false 表示不支持。</Tip>
</ParamField>
<ParamField
  name="loadLibrary"
...
<ParamField
  name="createEngine"
  prototype="public  [IZegoExpressEngine](#IZegoExpressEngine)* createEngine(unsigned int appID, std::string appSign, bool isTestEnv, [ZegoScenario](./enum.mdx#ZegoScenario) scenario, std::shared_ptr<[IZegoEventHandler](#IZegoEventHandler)> eventHandler)"
...
| appSign | std::string | 每个 AppID 对应的应用签名，请从 ZEGO 管理控制台申请。该参数为包含 64 个字符的字符串，字符取值范围：'0' ~ '9', 'a' ~ 'z'。例："9dc9a25bh2f2137446897071c8c033fa33b91c3dd2a85e0c000ae82c0dad3"。2.17.0 及以上版本 appSign 允许传空或者不传。如果传空或者不传，则必须在调用 [loginRoom] 接口登录房间时将 token 填入 [ZegoRoomConfig] 参数中，用于鉴权。token 的生成方式请参考 [使用 Token 鉴权](https://doc-zh.zego.im/article/10360) 。 |
...
| scenario | [ZegoScenario](./enum.mdx#ZegoScenario) | 房间场景，SDK 会针对指定的场景的做一些音视频配置优化以达成在此场景下最优的效果。指定场景后，开发者可以使用 [setRoomScenario] 来实现在不销毁引擎 [destroyEngine] 的前提下切换其他场景。指定场景后，开发者可以调用其他 API 来继续调整音视频配置。各个场景之间的差异以及如何选择合适的场景请参考 [https://doc-zh.zego.im/article/16316](https://doc-zh.zego.im/article/16316) |
| eventHandler | std::shared_ptr\<[IZegoEventHandler](#IZegoEventHandler)> | 事件通知回调。传 [nullptr] 则意味着不接收任何回调通知，之后也可通过 [setEventHandler] 进行设置。如果重复调用 [createEngine] 且第二次调用前未调用 [destroyEngine] 函数销毁引擎，则 eventHandler 不会被更新。 |
