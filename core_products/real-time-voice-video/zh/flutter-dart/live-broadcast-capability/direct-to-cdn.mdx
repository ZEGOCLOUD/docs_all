...
| 方法 | 描述 |
|-------|--------|
| [enablePublishDirectToCDN ](/zh/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#enable-publish-direct-to-cdn) | 使能直推 CDN |
...
| [stopPublishingStream ](/zh/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#stop-publishing-stream) | 停止推流 |
