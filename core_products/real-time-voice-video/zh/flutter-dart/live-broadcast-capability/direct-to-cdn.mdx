...
- 接口原型
     ...
     * @param state 推流状态
     * @param errorCode 推流状态变更对应的错误码。请参考常见错误码文档 [https://doc-zh.zego.imhttps://doc-zh.zego.im/article/4378.html]
...
- 当开发者使用第三方 CDN 进行直推时，则可以通过 URL 进行拉流，请参考 [推拉流进阶 - 通过 URL 拉流 ](https://doc-zh.zego.im/article/1182)。
