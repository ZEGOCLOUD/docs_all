...
在进行自定义视频采集前，请参考 [撰写双端平台代码（插件编写实现）\|_blank](https://docs.flutter.cn/platform-integration/platform-channels) 文档，创建平台通道。
...
- 本文仅说明如何在 Flutter 端开启自定义视频采集功能，进阶功能请参考 [iOS 自定义视频采集\|_blank](#3676) 及 [Android 自定义视频采集\|_blank](#3677) 文档。

</div>

### 1 开启自定义视频采集功能

调用 [ZegoCustomVideoCaptureConfig\|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoCustomVideoCaptureConfig-class.html) 接口创建自定义视频采集对象，设置属性 [bufferType\|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoCustomVideoCaptureConfig/bufferType.html)，向 SDK 提供视频帧数据类型；调用接口 [enableCustomVideoCapture\|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngineCustomVideoIO/enableCustomVideoCapture.html) 开启自定义视频采集功能。
