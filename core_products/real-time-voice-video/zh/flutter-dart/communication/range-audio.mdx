...
sequenceDiagram
    ...
    App->>SDK: 创建范围语音实例对象 <br/> createRangeAudio
    App->>SDK: 监听范围语音事件回调 <br/> ZegoExpressEngine.onRangeAudioMicrophoneStateUpdate
...
<Note title="说明">
        ...
        请参考 [媒体播放器](/real-time-video-flutter/other/media-player) 了解如何创建媒体播放器与加载媒体资源。
...
<Note title="说明">
        ...
        请参考 [音效文件播放器](/real-time-video-flutter/other/audio-effect-player) 了解如何创建音效播放器与加载音效资源。
