...
创建 ZegoExpressEngine 引擎流程，请参考实现视频通话的 [创建引擎](/real-time-video-flutter/quick-start/implementing-video-call)。
...
登录房间及推流流程，请参考实现视频通话的 [登录房间](/real-time-video-flutter/quick-start/implementing-video-call) 及 [推流](/real-time-video-flutter/quick-start/implementing-video-call) 。
...
结束推流流程，请参考实现视频通话的 [停止推拉流](/real-time-video-flutter/quick-start/implementing-video-call)。
...
如需采集屏幕视频与系统声音，请参考 [屏幕共享](/real-time-video-flutter/video/screen-sharing)。
