...
在创建 SDK 之前，调用 [setGeoFence](/unique-api/express-video-sdkhttps://doc-zh.zego.im/article/dart_flutter/zego_express_engine/ZegoExpressEngine/setGeoFence.html) 接口，设置地理围栏信息。



<div class="mk-warning">

请在调用 [createEngineWithProfile](/unique-api/express-video-sdkhttps://doc-zh.zego.im/article/dart_flutter/zego_express_engine/ZegoExpressEngine/createEngineWithProfile.html) 之前配置地理围栏信息，否则无效。
</div>
