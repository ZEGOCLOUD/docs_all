...
sequenceDiagram
    ...
    ZEGO Express SDK-->>拉流端: (可选) 在拉流端设置<br/>Alpha 通道渲染并拉流 <br/> ZegoCanvas.alphaBlend = true、<br/>startPlayingStream
...
初始化和登录房间的具体流程，请参考实现视频通话文档中的 “[创建引擎](/real-time-video-flutter/quick-start/implementing-video-call)”及“[登录房间](/real-time-video-flutter/quick-start/implementing-video-call)”。
