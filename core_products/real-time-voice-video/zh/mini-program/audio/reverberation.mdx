...
在使用混响前，请确保已在项目中实现了基本的音视频推拉流功能，详情请参考 [微信小程序 - 集成 SDK](/real-time-video-miniprogram/quick-start/we-chat/integrating-sdk) 和 [微信小程序 - 实现流程](/real-time-video-miniprogram/quick-start/we-chat/implementing-video-call)。
