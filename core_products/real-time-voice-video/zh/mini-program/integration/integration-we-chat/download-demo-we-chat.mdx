...
请到 [ZEGO 控制台](https://console.zego.im/) 注册账号并申请初始化 SDK 时需要的 AppID 与 Server，申请流程请参考 [项目管理](https://doc-zh.zego.im/article/12107)。
...
- 登录房间所需 Token 的获取请参考 [使用 Token 鉴权](#8940)，若需要快速调试，可使用控制台生成的临时 Token，详情请参考 [控制台 - 开发辅助](https://doc-zh.zego.im/article/16309)。
