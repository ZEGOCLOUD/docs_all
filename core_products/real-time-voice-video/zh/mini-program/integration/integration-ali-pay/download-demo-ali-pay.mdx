...
3. 输入从支付宝 BD 获取到的 MRTC 参数，以及身份验证签名 signature。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Express/wx_program/appid_server.jpeg" /></Frame>

4. 使用支付宝小程序开发者工具打开示例源码，在“详情”中，勾选如下图左下角的两个选项。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Express/wx_program/web_view_details.jpeg" /></Frame>
