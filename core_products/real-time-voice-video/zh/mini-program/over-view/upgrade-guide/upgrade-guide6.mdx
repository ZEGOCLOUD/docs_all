...
1. 打开 [微信公众平台\|_blank](https://mp.weixin.qq.com/?token=\&lang=zh_CN)，使用小程序对应微信账号，扫码进入 “小程序管理平台”，选择“开发 > 开发设置 > 服务器域名 > request 合法域名”。
2. 进入修改页面，添加以下 request 服务域名。
    ```javascript
    // request 服务域名
    https://weblogger-wss.coolfcloud.com
    ```
    <img src="/Pics/Express/wx_program/request_log.jpeg" />
