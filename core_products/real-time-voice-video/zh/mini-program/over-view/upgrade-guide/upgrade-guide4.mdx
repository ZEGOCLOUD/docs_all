...
- 开发者 `不能` 通过 3.0.0 以前的版本 `平滑升级` 到 3.0.0 或以上的版本。
    ...
    您需要在微信小程序的开发设置里，将部分域名添加至服务器域名，详情请参考下文 [添加服务器域名](!upgrade_guide4#2)。
...
打开 [微信公众平台\|_blank](https://mp.weixin.qq.com/?token=&lang=zh_CN)，扫码进入 “小程序管理平台”，选择菜单 “开发管理 > 开发设置 > 服务器域名 > socket服务器域名”，进入修改页面，添加以下 socket 合法服务器域名：
...
```
<img src="/Pics/Express/wx_program/socket.jpeg" />
