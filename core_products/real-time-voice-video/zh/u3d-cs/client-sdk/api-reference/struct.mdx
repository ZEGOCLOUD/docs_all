...
<ParamField
  ...
  parent_name="ZegoPlayStreamQuality"
  parent_type="class">
音频 MOS (平均主观意见分) 评估方法对拉流音频的质量评分，取值范围 [-1, 5]，其中 -1 表示未知，[0, 5] 表示有效的评分，分数越高，音频质量越好。评分对应的主观感受请查阅 [https://doc-zh.zego.im/article/1074#4_4](https://doc-zh.zego.im/article/1074#4_4) （2.16.0 及以上版本支持）。WebGL没有该信息。
</ParamField>
<ParamField
  name="rtt"
