...
<ParamField
  ...
  prototype="public abstract  void SendRealTimeSequentialData(IntPtr data,uint dataLength,string streamID,OnRealTimeSequentialDataSent callback)"
...
| callback | OnRealTimeSequentialDataSent | 发送实时有序数据结果通知。 |
