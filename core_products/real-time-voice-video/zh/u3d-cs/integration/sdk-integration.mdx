...
1. 请参考 [下载 SDK 包](!Integration/SDK_Integration)，下载最新版本的 SDK，下载完成后进行解压。
...
3. 对于不同的运行平台，需要做一些额外处理。
    ...
    - **Windows**
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/multiple_dll_error.png" /></Frame>
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/windows_all_archs.png" /></Frame>

        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/windows_one_arch.png" /></Frame>
    ...
    - **macOS**
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/macos_dylib.png" /></Frame>

    - **iOS**

        导出 Xcode 工程后，直接运行可能会报如下错误：

        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/ios_multiple_archs_error.png" /></Frame>

        iOS 平台的 XCFramework 中有三个文件夹：

        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/QuickStart/ios_xcframework.png" /></Frame>
    ...
    - **Android**
        ...
        <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/android_win_dll_error.png" /></Frame>

        构建 Android App 时也可能会提示存在多个 Windows dll 文件的问题，请按照上述 [Windows 的处理方式](!Integration/SDK_Integration#Windows) 操作。
...
2. **导出 iOS Xcode 工程后还需要集成 ZegoExpressEngine.framework 吗？**
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/ios_add_embedded_framework.png" /></Frame>
...
3. **为什么集成 SDK 后，在 Unity Editor 调试过程中创建 SDK 经常失败？**
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Unity3D/ZegoExpressEngine/Unity_Editor.png" /></Frame>

    如果按图中勾选了对应设置，Unity Editor 在停止调试后一段时间会缓存静态变量，导致 SDK 内部静态变量没有重置而出现异常，表现为首次 [CreateEngine](@CreateEngine) 成功，Unity Player 停止运行后再启动 [CreateEngine](@CreateEngine) 失败，详情请参考 [域重新加载](https://docs.unity3d.com/cn/current/Manual/DomainReloading.html)。
