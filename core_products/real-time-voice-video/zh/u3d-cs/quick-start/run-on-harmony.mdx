...
1. [下载 ZEGO Express Unity3D SDK](/real-time-video-u3d-cs/client-sdk/download-sdk)，并解压 ZegoExpressUnity3D.zip 文件。
...
请确保 `导入 SDK 步骤` 执行正确。并确保导出的工程中，“entry/libs/” 目录下，包含 “libZegoExpressEngine.so” 文件；“entry/src/main/ets/” 目录下，包含 “zegoets” 以及相关文件。
