...
```
 ...
 /**
  * 设备异常通知
  * @param errorCode 设备异常的错误码，请参考常见错误码文档：https://doc-zh.zego.im/article/5643#7
 ...
 * @param state 音效的播放状态。
 * @param errorCode 错误码，详情请参考 常见错误码文档 https://doc-zh.zego.imhttps://doc-zh.zego.im/article/4378.html 。
 */
