...
<img src="/Pics/Common/RangeAudio/AudioRange.png" width="70%" /><p>上图仅以范围语音模式为“全世界”时为例，更多不同模式组合关系下的声音可达情况请参考 <a href="!AudioAdvanced/Range_Voice#setRangeAudioMode">5.10.2 设置语音模式</a>。</p>
</td>
</tr>
<tr>
<td>3D 音效</td>
...
<div class="mk-hint">队友之间的通话不受“范围”和 “3D 音效” 的影响，详情请查看 <a href="!AudioAdvanced/Range_Voice#setRangeAudioMode">5.10.2 设置语音模式</a>。</li></ul></div>
</td>
</tr>
</tbody></table>
...
![/Pics/Express/RangeVoice_u3d.png](//doc.oa.zego.im/Pics/Express/RangeVoice_u3d.png)
