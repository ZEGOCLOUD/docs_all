...
1. 安装 CocoaPods，安装时如遇到问题，请参考 [CocoaPods 常见问题 - 安装 CocoaPods](https://doc-zh.zego.im/faq/cocoapods-issues)。
...
4. 执行 `pod repo update` 命令更新本地索引，确保能安装最新版本的 SDK，最新版本号请参考 [下载文档](/real-time-video-macos-oc/client-sdk/download-sdk) 中的发布历史。
...
5. 执行 `pod install` 命令安装 SDK。
    ...
    - 若出现 “CocoaPods could not find compatible versions for pod "ZegoExpressEngine-macOS"” 问题，请参考 [CocoaPods 常见问题 - 无法找到项目的问题](https://doc-zh.zego.im/faq/cocoapods-issues)。
    </Note>
