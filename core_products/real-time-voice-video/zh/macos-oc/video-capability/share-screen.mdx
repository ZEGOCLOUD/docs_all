...
SDK 可以通过 [getScreenCaptureSourcesWithThumbnailSize\|_blank](@getScreenCaptureSourcesWithThumbnailSize) 获取当前可共享的所有窗口信息。
...
调用 [setEventHandler\|_blank](@setEventHandler-ZegoScreenCaptureSource) 接口设置共享源事件回调。
