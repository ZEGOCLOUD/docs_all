...
您可以根据需要调用 [IZegoRangeScene.setEventHandler](@setEventHandler-IZegoRangeScene) 及 [IZegoRangeSceneStream.setEventHandler](@setEventHandler-IZegoRangeSceneStream) 接口分别设置范围场景、范围场景流管理事件回调，用于监听范围场景、范围场景流管理事件回调。
