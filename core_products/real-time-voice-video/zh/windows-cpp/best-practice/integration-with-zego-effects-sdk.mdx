...
2. 获取视频原始数据，可通过 ZEGO Express SDK 的 [自定义视频采集](/real-time-video-windows-cpp/video/custom-video-capture) 或 [自定义视频前处理](/real-time-video-windows-cpp/video-capability/custom-video-processing) 两种方式获取。
