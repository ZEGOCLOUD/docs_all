...
- 已在项目中集成 ZEGO Effects SDK，详情请参考“AI 美颜”的 [快速开始 - 集成](https://doc-zh.zego.im/article/9575)。
- 已获取到 ZEGO Effects SDK 唯一的鉴权文件，详情请参考“AI 美颜”的 [快速开始 - 在线鉴权](https://doc-zh.zego.im/article/11988)。
...
2. 获取视频原始数据，可通过 ZEGO Express SDK 的 [自定义视频采集](https://doc-zh.zego.im/article/3678) 或 [自定义视频前处理](https://doc-zh.zego.im/article/10357) 两种方式获取。
...
1. 导入 Effects 模型和资源。
    ...
    ZEGO Effects SDK 支持的所有资源和模型请参考“AI 美颜”的 [快速开始 - 导入资源和模型](https://doc-zh.zego.im/article/10189)。
...
- **方式一：自定义视频前处理**
    ...
    具体的原理可参考“实时音视频”的 [自定义视频前处理](https://doc-zh.zego.im/article/10357)。

<a id="CustomCollection"></a>

- **方式二：自定义视频采集**

    自定义视频采集，主要依赖开发者自行采集视频数据，具体方式请参考“实时音视频”的 [自定义视频采集](https://doc-zh.zego.im/article/3678)。
...
- **方式一：自定义视频前处理**
    ...
    在 [onCapturedUnprocessedRawData](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-custom-video-process-handler#on-captured-unprocessed-raw-data) 回调中，获取到视频原始数据后，调用 ZEGO Effects SDK 的相关接口，进行 AI 美颜处理（请参考 [美颜](https://doc-zh.zego.im/article/11769)、[美型](https://doc-zh.zego.im/article/11770)、[背景分割](https://doc-zh.zego.im/article/11771)、[人脸检测](https://doc-zh.zego.im/article/11772)、[挂件](https://doc-zh.zego.im/article/11773)、[滤镜](https://doc-zh.zego.im/article/11774)），并将处理后的数据，返回给 ZEGO Express SDK。
