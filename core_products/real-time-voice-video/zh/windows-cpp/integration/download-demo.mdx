      ...
      <div class="download-selector">
        <div class="download-select-wrapper" style="padding-right: 0;">
          ...
          <ul class="download-dropdown-list">
            <li data-href="https://storage.zego.im/express/example/video/qt_cpp/ZegoExpressDemo_qt_cpp.zip"
...
* Linux：任意具有 GLIBC 2.16 或以上版本的 Linux 发行版系统，支持 x86_64, aarch64, armhf 架构。
    ...
    - 您可以参考 [自定义视频渲染 \|_blank](https://doc-zh.zego.im/article/6872) 文档和此 Demo “ZegoExpressExample/Examples/AdvancedVideoProcessing/CustomVideoRendering” 目录下的示例代码，来实现在 Linux Qt 上渲染显示预览或拉流的画面。
    </div>

- 其他通用要求：
    * 安装了 CMake：[下载 CMake\|_blank](https://cmake.org/download/)。
    * 安装了 Qt（5.9 ~ 5.15 版本）：[下载 Qt\|_blank](https://download.qt.io/archive/qt/)，首次使用 Qt 的开发者可阅读其 [官方教程\|_blank](https://doc.qt.io/qt-5/gettingstarted.html) 学习使用。
    * 麦克风、摄像头等支持音视频功能的外部设备正常。

    <div class = 'mk-warning'>

    QtCreator 8.0.1 之前的版本，在 macOS 12 Monterey 或以上的系统上，可能会遇到在调试此 Demo 时无法请求摄像头、麦克风权限从而导致 Demo 崩溃的问题，详情参考 [此 issue\|_blank](https://bugreports.qt.io/browse/QTCREATORBUG-26743)。

    解决方案：可下载安装 QtCreator 8.0.2 或以上版本，而不要使用 Qt5 安装包自带的 QtCreator。

    开发者可以从 [QtCreator Github Release\|_blank](https://github.com/qt-creator/qt-creator/releases) 或 [Qt 官网\|_blank](https://download.qt.io/official_releases/qtcreator/) 下载，或者使用 HomeBrew 安装：`brew update && brew install --cask qt-creator`
...
1. 修改 “/ZegoExpressExample/KeyCenter.cpp” 文件，填写 SDK 初始化所需的 “AppID” 和 “AppSign”。
    ...
    请使用本文 [前提条件](3128#1_2) 已获取的 AppID 和 AppSign 正确填写，否则示例源码无法正常运行。  
    </div>
