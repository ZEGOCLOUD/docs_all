...
- 已在项目中集成 ZEGO Express SDK，实现基本的实时音视频功能，详情请参考 [快速开始 - 集成](/real-time-video-ios-swift/quick-start/integrating-sdk)。
...
如果用户在音视频通话的过程中，遇到相关错误，可查询 [错误码](/real-time-video-ios-swift/client-sdk/error-code)。

</Accordion>

## 相关文档
- [常见错误码](/real-time-video-ios-swift/client-sdk/error-code)
