...
| 方法 | 描述 |
|-------|--------|
| [enablePublishDirectToCDN ](/zh/api?doc=Express_Video_SDK_API~Java_linux~class~im-zego-zegoexpress-zego-express-engine#enable-publish-direct-to-cdn) | 使能直推CDN |
| [startPublishingStream ](/zh/api?doc=Express_Video_SDK_API~Java_linux~class~im-zego-zegoexpress-zego-express-engine#start-publishing-stream) | 开始推流 |
| [stopPublishingStream ](/zh/api?doc=Express_Video_SDK_API~Java_linux~class~im-zego-zegoexpress-zego-express-engine#stop-publishing-stream) | 停止推流 |
