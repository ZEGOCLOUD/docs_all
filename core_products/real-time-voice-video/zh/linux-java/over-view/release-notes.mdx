...
API 名称修改后可能存在兼容性问题，详情请参考 [3.8.0 及以上版本升级指南](!upgrade_guide5)。
...
相关 API 请参考 [createMediaPlayer](@createMediaPlayer), [destroyMediaPlayer](@destroyMediaPlayer)
