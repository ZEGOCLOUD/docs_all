...
请参考 [快速开始 - 实现流程\|_blank](7679#3_2) 的 “3.2 创建引擎”。
...
请参考 [快速开始 - 实现流程\|_blank](7679#3_3) 的 “3.3 登录房间”、“3.4 推流”和“3.5 拉流”。
...
| 方法 | 描述 |
|-------|--------|
| [enableCustomAudioIO \|_blank](@enableCustomAudioIO) | 开启自定义音频采集渲染 |
| [sendCustomAudioCaptureAACData \|_blank](@sendCustomAudioCaptureAACData) | 向 SDK 发送自定义采集的 AAC 数据 |
| [sendCustomAudioCapturePCMData \|_blank](@sendCustomAudioCapturePCMData) | 向 SDK 发送自定义采集的 PCM 数据 |
| [fetchCustomAudioRenderPCMData \|_blank](@fetchCustomAudioRenderPCMData) | 从 SDK 获取要自定义渲染的 PCM 数据 |
