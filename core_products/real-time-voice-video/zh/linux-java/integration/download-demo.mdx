...
2. 在 [下载](https://doc-zh.zego.im/article/5569) 页面获取 SDK 包，解压后，将 “ZegoExpressEngine.jar” 文件安装到本地 maven。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Linux/Express/run_express_java_se_cli_demo.png" /></Frame>
