...
<ParamField
  ...
  prototype="public abstract  void InitCopyrightedMusic([ZegoCopyrightedMusicConfig](./struct#zegocopyrightedmusicconfig) config,[OnCopyrightedMusicInit](./interface.mdx#oncopyrightedmusicinit) callback)"
  desc="初始化版权音乐模块。"
...
| callback | [OnCopyrightedMusicInit](./interface.mdx#oncopyrightedmusicinit) | 初始化结果 |
...
<ParamField
  ...
  prototype="public abstract  void SendExtendedRequest(string command,string param,[OnCopyrightedMusicSendExtendedRequest](./interface.mdx#oncopyrightedmusicsendextendedrequest) callback)"
  desc="发送扩展功能请求。"
  parent_file="Declared in \`ZegoCopyrightedMusic.cs\`"
  parent_name="ZegoCopyrightedMusic"
  parent_type="class">
...
| param | string | 请求参数，每个请求命令具备对应的请求参数，请参考 [/online-ktv-android/client-api/send-extended-request](/online-ktv-android/client-api/send-extended-request) |
| callback | [OnCopyrightedMusicSendExtendedRequest](./interface.mdx#oncopyrightedmusicsendextendedrequest) | 发送扩展功能请求结果 |
...
<ParamField
  name="GetLrcLyric"
  prototype="public abstract  void GetLrcLyric(string songID,[ZegoCopyrightedMusicVendorID](./enum#zegocopyrightedmusicvendorid) vendorID,[OnCopyrightedMusicGetLrcLyric](./interface.mdx#oncopyrightedmusicgetlrclyric) callback)"
  desc="获取 lrc 格式歌词。"
  parent_file="Declared in \`ZegoCopyrightedMusic.cs\`"
  parent_name="ZegoCopyrightedMusic"
  parent_type="class">
...
| callback | [OnCopyrightedMusicGetLrcLyric](./interface.mdx#oncopyrightedmusicgetlrclyric) | 获取 lrc 格式歌词结果 |
...
<ParamField
  ...
  prototype="public abstract  void GetKrcLyricByToken(string krcToken,[OnCopyrightedMusicGetKrcLyricByToken](./interface.mdx#oncopyrightedmusicgetkrclyricbytoken) callback)"
  desc="获取逐字歌词。"
  parent_file="Declared in \`ZegoCopyrightedMusic.cs\`"
  parent_name="ZegoCopyrightedMusic"
  parent_type="class">
...
| callback | [OnCopyrightedMusicGetKrcLyricByToken](./interface.mdx#oncopyrightedmusicgetkrclyricbytoken) | 获取逐字格式歌词结果。 |
...
<ParamField
  name="Download"
  prototype="public abstract  void Download(string resourceID,[OnCopyrightedMusicDownload](./interface.mdx#oncopyrightedmusicdownload) callback)"
  desc="下载音乐资源。"
  parent_file="Declared in \`ZegoCopyrightedMusic.cs\`"
  parent_name="ZegoCopyrightedMusic"
  parent_type="class">
...
| callback | [OnCopyrightedMusicDownload](./interface.mdx#oncopyrightedmusicdownload) | 下载载歌曲或伴奏结果。 |
...
<ParamField
  name="RequestSong"
  prototype="public abstract  void RequestSong([ZegoCopyrightedMusicRequestConfig](./struct#zegocopyrightedmusicrequestconfig) config,[OnCopyrightedMusicRequestSong](./interface.mdx#oncopyrightedmusicrequestsong) callback)"
...
| callback | [OnCopyrightedMusicRequestSong](./interface.mdx#oncopyrightedmusicrequestsong) | 点歌结果 |
...
<ParamField
  ...
  prototype="public abstract  void RequestAccompaniment([ZegoCopyrightedMusicRequestConfig](./struct#zegocopyrightedmusicrequestconfig) config,[OnCopyrightedMusicRequestAccompaniment](./interface.mdx#oncopyrightedmusicrequestaccompaniment) callback)"
...
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfig](./struct#zegocopyrightedmusicrequestconfig) | 请求配置。 |
| callback | [OnCopyrightedMusicRequestAccompaniment](./interface.mdx#oncopyrightedmusicrequestaccompaniment) | 点伴奏结果。 |
...
<ParamField
  ...
  prototype="public abstract  void GetMusicByToken(string shareToken,[OnCopyrightedMusicGetMusicByToken](./interface.mdx#oncopyrightedmusicgetmusicbytoken) callback)"
...
| callback | [OnCopyrightedMusicGetMusicByToken](./interface.mdx#oncopyrightedmusicgetmusicbytoken) | 获取歌曲或伴奏结果。 |
...
<ParamField
  name="GetLrcLyric"
  prototype="public abstract  void GetLrcLyric(string songID,[OnCopyrightedMusicGetLrcLyric](./interface.mdx#oncopyrightedmusicgetlrclyric) callback)"
...
<Warning title="">
- **支持版本**：1.2.1 及以上。
- **使用限制**：同一房间内的广播消息发送频率不能高于 10条/s。单个用户在客户端调用此接口的最大QPS为2，关于此函数的使用限制，请参考 [/real-time-video-android-java/best-practice/restrictions](/real-time-video-android-java/best-practice/restrictions) 或联系 ZEGO 技术支持。不适用于 WebGL。
</Warning>
</ParamField>
<ParamField
...
<Warning title="">
- **支持版本**：1.5.0 及以上。
- **使用限制**：同一房间内的弹幕消息发送频率不能高于 20条/s。关于此函数的使用限制，请参考 [/real-time-video-android-java/best-practice/restrictions](/real-time-video-android-java/best-practice/restrictions) 或联系 ZEGO 技术支持。不适用于 WebGL。
</Warning>
</ParamField>
<ParamField
...
<Warning title="">
- **支持版本**：1.2.1 及以上。
- **使用限制**：同一房间内向单个用户发送的自定义消息频率不能高于 200条/s，向多个用户发送的自定义消息不能高于 10条/s。关于此函数的使用限制，请参考 [/real-time-video-android-java/best-practice/restrictions](/real-time-video-android-java/best-practice/restrictions) 或联系 ZEGO 技术支持。不适用于 WebGL。
</Warning>
</ParamField>
<ParamField
