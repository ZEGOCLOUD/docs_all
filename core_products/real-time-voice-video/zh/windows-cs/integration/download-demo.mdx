...
* Visual Studio 已安装 C# 开发环境和 Newtonsoft NuGet 程序包（详情请参考 [常见问题](/real-time-video-windows-cs/integration/download-demo#常见问题)）。
...
<Card title="示例源码" href="https://storage.zego.im/express/video/windows-csharp/zego-express-video-windows-csharp.zip" target="_blank">
本地下载
</Card>
## 前提条件

已在 [ZEGO 控制台](https://console.zego.im/) 创建项目，并申请有效的 AppID 和 AppSign，详情请参考 [控制台 - 项目管理](/console/guide-doc2)。
...
1. 请参考 [下载文档](/real-time-video-windows-cs/download)，下载最新版本的 SDK 和示例源码，并解压。
...
<Warning title="注意">
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/dotnet/ZegoExpressEngine/Common/RunDemo_4_2.png" /></Frame>
...
2. 搜索 “Newtonsoft.Json”，勾选示例源码项目 “ZegoCsharpWinformDemo”后，单击“安装”。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/dotnet/ZegoExpressEngine/Common/RunDemo_6_1.png" /></Frame>
