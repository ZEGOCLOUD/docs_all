...
- 浏览器的兼容性，请参考 [ZEGO Express Web SDK 支持哪些浏览器？](https://doc-zh.zego.im/faq/web-sdk-browser-support_1)。

</Note>

<Warning title="注意">

- 如果您只需要使用 uni-app 开发 Web 平台应用，建议使用 [Web SDK](/real-time-video-web/introduction/entry) 以获得更及时的功能更新。
...
<Note title="说明">
    ...
    其他常见问题，请参考 [在 Windows 平台上集成 Express uni-app SDK 后，使用 dev 证书云打包运行 iOS 应用时出错，该如何处理？](https://doc-zh.zego.im/faq/windows-uniapp-ios-packaging-issue)
...
1. 导入 JS 封装层。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/8ff3f5d466.png" /></Frame>

    导入的 JS 封装层将存储在 `uni_modules` 目录中，目录结构如下。

    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/d19d1a5c0c.png" /></Frame>
