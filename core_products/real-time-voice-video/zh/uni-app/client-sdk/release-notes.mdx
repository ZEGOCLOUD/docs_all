...
1. Web 端补齐 Native 端已有的功能接口
    ...
    | 启动声浪监控。（不支持 enableVAD ） | <ul><li>[startSoundLevelMonitor](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#startsoundlevelmonitor)</li><li>[capturedSoundLevelInfoUpdate](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#capturedsoundlevelinfoupdate)</li><li>[remoteSoundLevelInfoUpdate](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#remotesoundlevelinfoupdate)</li></ul> |
    | 停止声浪监控。 | [stopSoundLevelMonitor](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#stopsoundlevelmonitor)  |
    | 开/关硬件解码。 |[enableHardwareDecoder](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#enablehardwaredecoder) |
    | 自动混流接口 | <ul><li>[startAutoMixerTask](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#startautomixertask)</li><li>[stopAutoMixerTask](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#stopautomixertask)</li></ul> |
    | 开/关自动增益控制 | [enableAGC](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#enableagc) |
...
1. [mutePlayStreamAudio](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#muteplaystreamaudio)、[mutePlayStreamVideo](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#muteplaystreamvideo) 支持在拉流成功前调用

2. [setCaptureVolume](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#setcapturevolume)、[enableAEC](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#enableaec)、[enableANS](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#enableans) 支持在预览或推流前进行调用设置
...
1. 修复初始化引擎后无法通过调用 [getVideoConfig](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#getvideoconfig)  接口获取默认的场景化配置值的问题

2. 修复 [setVideoConfig](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#setvideoconfig)、[mutePublishStreamAudio](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#mutepublishstreamaudio)、[mutePublishStreamVideo](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#mutepublishstreamvideo) 在预览或推流前调用会触发摄像头采集的问题

3. 修复 [setCaptureVolume](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#setcapturevolume)、[enableAEC](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#enableaec)、[enableANS](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#enableans) 在预览或推流前设置音量不生效的问题
...
1. Web 端支持切换前后置摄像头。
    ...
    相关 API 请参考： [useFrontCamera](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengine_.zegoexpressengine.html#usefrontcamera)
