...
[addPublishCdnUrl](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html)、[removePublishCdnUrl](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html) 修改参数格式。3.21.5 版本之前 Web 端第一个参数为 targetUrl ，第二个参数为 streamID ；3.21.5 版本之后第一个参数为 streamID ，第二个参数为 targetURL。
