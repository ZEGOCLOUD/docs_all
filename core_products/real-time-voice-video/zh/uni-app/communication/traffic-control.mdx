...
- 已在项目中集成 ZEGO Express SDK，详情请参考 [快速开始-集成](/real-time-video-uniapp/quick-start/integrating-sdk) 和 [快速开始-实现流程](/real-time-video-uniapp/integration/solution-implementation)。
