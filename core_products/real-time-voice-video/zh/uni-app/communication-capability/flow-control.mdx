...
分层编码的使用请参考 [视频进阶 - 视频编解码](https://doc-zh.zego.im/article/10338)。
</Note>
...
- 已在项目中集成 ZEGO Express SDK，详情请参考 [快速开始-集成](https://doc-zh.zego.im/article/7774) 和 [快速开始-实现流程](https://doc-zh.zego.im/article/10330)。
