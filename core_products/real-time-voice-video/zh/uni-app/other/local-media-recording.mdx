...
<tr>
<td>
[客户端本地录制](/real-time-video-uniapp/other/local-media-recording)
</td>
<td>
...
<tr>
<td>
[云端录制](/real-time-video-uniapp/other/local-media-recording)
</td>
<td>
...
<tr>
<td>
[CDN 录制](/real-time-video-uniapp/other/local-media-recording)
</td>
<td>
...
<tr>
<td>
[本地服务端录制](/real-time-video-uniapp/other/local-media-recording)
</td>
...
在调用 [startRecordingCapturedData](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html) 开始录制之后才会收到所设置的录制回调信息。
...
开发者需要调用 [startRecordingCapturedData](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html) 以开始录制。
...
开发者需要调用 [stopRecordingCapturedData](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html) 来结束录制。

<Warning title="注意">


在录制过程中，若退出房间 [logoutRoom](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html)，SDK 内部会主动停止录制。
...
* 调用 ZegoExpressEngine 中的 ZegoMediaPlayer 组件进行播放，详情可参考 [媒体播放器](/real-time-video-uniapp/other/media-player)。
...
5. **使用外部采集时的录制需要注意什么？**
  ...
  使用外部采集时，也需要在录制之前调用 SDK 的 [startPreview](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/javascript_uni-app/classes/_zegoexpressengineapp_.zegoexpressengine.html) 方法来启动。
