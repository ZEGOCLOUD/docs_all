...
2. 打开终端，执行示例代码的可执行二进制文件，然后按照打印的帮助信息继续操作。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/core_products/real-time-voice-video/zh/linux-cpp/quick-start/20260127-165204.png" /></Frame>
