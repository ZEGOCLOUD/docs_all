...
此示例源码为一个简单的命令行程序，您可以参考桌面端跨 C++ 平台的 [示例源码文档](/real-time-video-windows-cpp/integration/download-demo)，获取更丰富的 Qt 示例源码。
...
### 获取示例源码
<Card title="示例源码" href="https://storage.zego.im/express/example/video/linux_cli_cpp/ZegoExpressDemo_linux_cli_cpp.zip" target="_blank">
本地下载
</Card>
### 示例源码目录结构
...
2. 打开终端，执行示例代码的可执行二进制文件，然后按照打印的帮助信息继续操作。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Linux/Express/run_express_cpp_cli_demo.png" /></Frame>
