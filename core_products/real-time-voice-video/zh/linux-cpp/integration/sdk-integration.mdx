...
使用 Qt + qmake 集成 SDK 时，请下载 [Qt\|_blank](http://download.qt.io/official_releases/qt) 5.9 ～ 5.15 之间的任意版本，详细信息请参考 [Getting Started with Qt\|_balnk](https://doc.qt.io/qt-5/gettingstarted.html)。

## 2 集成 SDK

1. 请通过 [下载\|_blank](#5568) 文档下载最新版本的 SDK。

    建议参考 [跑通示例源码\|_blank](#14176) 的工程来集成 SDK。
