...
请参考 [快速开始 - 实现流程](/real-time-video-linux-cpp/integration/solution-implementation#创建引擎) 的 “创建引擎”、“登录房间”。
...
请参考 [快速开始 - 实现流程](/real-time-video-linux-cpp/integration/solution-implementation#推流) 的 “推流”。
 ...
 * @param state 推流状态
 * @param errorCode 推流状态变更对应的错误码。请参考常见错误码文档 [https://doc-zh.zego.im/real-time-video-windows-cpp/error-code.html]
...
- 当开发者使用 Zego 配置的 CDN 进行直推时，则可以直接通过 StreamID 进行拉流。请参考 [快速开始 - 实现流程](/real-time-video-linux-cpp/integration/solution-implementation#拉流) 的 “拉流”。
- 当开发者使用第三方 CDN 进行直推时，则可以通过 URL 进行拉流。请参考 [推拉流进阶 - 通过 URL 拉流](/real-time-video-linux-cpp/live-broadcast-capability/playing-stream-by-cdn)。
