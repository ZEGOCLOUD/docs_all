...
如果需要设置自定义变声，请查看 [设置自定义变声](/real-time-video-linux-cpp/audio/audio-effects)。
...
如果需要设置预设变声，请查看 [设置预设变声](/real-time-video-linux-cpp/audio/audio-effects)。
...
如果需要设置自定义混响，请查看 [设置自定义混响](/real-time-video-linux-cpp/audio/audio-effects)。
...
如果需要设置预设混响，请查看 [设置预设混响](/real-time-video-linux-cpp/audio/audio-effects)。
