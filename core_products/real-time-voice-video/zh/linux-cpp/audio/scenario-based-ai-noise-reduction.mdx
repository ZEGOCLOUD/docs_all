...
2. 初始化和登录房间的具体流程，请参考实现视频通话文档中的 “[创建引擎](/real-time-video-linux-cpp/quick-start/implementing-video-call)” 及 “[登录房间](/real-time-video-linux-cpp/quick-start/implementing-video-call)”。
