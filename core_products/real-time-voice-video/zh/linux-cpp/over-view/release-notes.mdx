...
相关 API 请参考 [getAudioDeviceList\|_blank](@getAudioDeviceList), [useAudioDevice\|_blank](@useAudioDevice)
...
相关 API 请参考 [addMediaFilePath\|_blank](@addMediaFilePath)
...
媒体播放器在播放本地文件之外，还支持播放在线资源并将媒体播放器中的流推到远端 ，详情请参考 [媒体播放器\|blank](!Other_Functions/MediaPlayer)。
...
相关 API 请参考 [enableCustomAudioIO\|_blank](@enableCustomAudioIO), [sendCustomAudioCaptureAACData\|_blank](@sendCustomAudioCaptureAACData), [sendCustomAudioCapturePCMData\|_blank](@sendCustomAudioCapturePCMData), [fetchCustomAudioRenderPCMData\|_blank](@fetchCustomAudioRenderPCMData)
...
相关 API 请参考 [sendBroadcastMessage\|_blank](@sendBroadcastMessage), [sendBarrageMessage\|_blank](@sendBarrageMessage), [sendCustomCommand\|_blank](@sendCustomCommand)
