...
详情请参考 [快速开始 - 实现流程\|_blank](!Integration/Solution_Implementation#createroom) 的“登录房间”章节。
...
- 当开发者使用 ZEGO 配置的 CDN 进行直推时，则可以直接通过 streamID 进行拉流，请参考 [快速开始 - 实现视频通话\|_blank](!Integration/Solution_Implementation#4_4) 的 “3.4 拉流”。
