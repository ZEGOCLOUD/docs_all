...
##### 前置条件
- 已在项目中集成 ZEGO Express SDK，实现基本的实时音视频功能，详情请参考 [快速开始 - 集成](/real-time-video-ios-oc/integration/sdk-integration) 和 [快速开始 - 实现流程](/real-time-video-ios-oc/integration/solution-implementation)。
