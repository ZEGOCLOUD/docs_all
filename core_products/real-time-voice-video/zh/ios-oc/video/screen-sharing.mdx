...
- 如果您已经通过 ZEGO 旧版 [屏幕共享](https://doc-zh.zego.im/article/11151) 产品实现屏幕共享功能，或者需要自己实现屏幕共享功能，请参考 [如何通过自定义采集实现屏幕共享？](https://doc-zh.zego.im/faq/custom-capture-screen-share)。
