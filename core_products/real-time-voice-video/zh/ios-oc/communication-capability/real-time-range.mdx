...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Express/rangeScene_ios.png" /></Frame>
...
您可以根据需要调用 [setReceiveRange](@setReceiveRange)、[setReceiveRangeWithParam](@setReceiveRangeWithParam)、以及 [enableRangeSpatializer](@enableRangeSpatializer) 接口设置范围场景参数，控制当前用户音视频的接收范围、设置 3D 音效距离的衰减范围区间 [min, max]、是否开启 3D 音效。
