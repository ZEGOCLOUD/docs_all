...
请参考 [网络与性能](/real-time-video-ios-oc/communication-capability/testing-network) 进行操作。
...
// 设备异常通知。
// @param errorCode 错误码，请参考常见错误码：/real-time-video-ios-oc/error-code。
...
// @param state 播放器状态。
// @param errorCode 错误码，详情请参考常见错误码：/real-time-video-ios-oc/error-code。
