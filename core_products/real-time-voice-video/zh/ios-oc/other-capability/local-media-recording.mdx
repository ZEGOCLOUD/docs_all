...
<img src="/Pics/ios/express_record_process_iOS.png" width=30%>
...
开发者可以根据此回调 [onCapturedDataRecordStateUpdate\|_blank](@onCapturedDataRecordStateUpdate) 判断文件录制的状态或者用户界面进行 UI 的提示等。
