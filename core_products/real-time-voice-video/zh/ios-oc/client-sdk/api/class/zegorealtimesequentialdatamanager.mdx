...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| handler | nullable id\<[ZegoRealTimeSequentialDataEventHandler](../../api-reference/class#zegorealtimesequentialdataeventhandler)\> | 实时有序数据管理器回调 |
...
| callback | nullable [ZegoRealTimeSequentialDataSentCallback](../../api-reference/class#zegorealtimesequentialdatasentcallback) | 发送实时有序数据结果通知。 |
