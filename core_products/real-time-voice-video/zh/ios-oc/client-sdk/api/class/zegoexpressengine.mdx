...
| eventHandler | nullable id\<[ZegoEventHandler](../../api-reference/protocol#zegoeventhandler)\> | 事件通知回调。传 [nil] 则意味着不接收任何回调通知，之后也可通过 [setEventHandler] 进行设置。如果重复调用 [createEngine] 且第二次调用前未调用 [destroyEngine] 函数销毁引擎，则 eventHandler 不会被更新。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable [ZegoDestroyCompletionCallback](../../api-reference/class#zegodestroycompletioncallback) | 销毁引擎完成的通知回调，可监听此回调以确保设备硬件资源(麦克风、扬声器、摄像头等)被释放完成，若开发者不关注引擎资源的释放时机，该参数可传[nil]。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| proxyList | NSArray\<[ZegoProxyInfo](../../api-reference/class#zegoproxyinfo) *\> * | 代理详细信息。 |
| enable | BOOL | 是否开启代理。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable id\<[ZegoApiCalledEventHandler](../../api-reference/protocol#zegoapicalledeventhandler)\> | 方法执行结果的回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| eventHandler | nullable id\<[ZegoEventHandler](../../api-reference/protocol#zegoeventhandler)\> | 事件通知回调。传 [nil] 则清空已设置的回调。开发者应根据自身业务场景，监听相应的回调。SDK 主要的回调函数都在这里。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable [ZegoUploadLogResultCallback](../../api-reference/class#zegouploadlogresultcallback) | 日志上传结果回调。 |
...
| user | [ZegoUser](../../api-reference/class#zegouser) * | 用户对象实例，配置用户 ID、用户名。 注意事项：注意用户 ID 需要在相同的 appID 下全局唯一，否则会出现后登录的用户踢掉先登录的用户的情况。 |
| config | [ZegoRoomConfig](../../api-reference/class#zegoroomconfig) * | 房间进阶配置。 |
| callback | [ZegoRoomLoginCallback](../../api-reference/class#zegoroomlogincallback) | 本次登录结果的回调，如果需要详细的房间状态，请关注 [onRoomStateChanged] 回调。是否必填：否。默认值：nil。注意事项：如果因为网络问题导致多次重试连接，重试状态将不会通过此回调抛出。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoRoomLogoutCallback](../../api-reference/class#zegoroomlogoutcallback) | 本次登出房间结果的回调，如果需要详细房间状态，请关注 [onRoomStateChagned] 回调。是否必填：否。默认值：nil。 |
...
| key | NSString * | 附加消息键。 |
| roomID | NSString * | 房间 ID。 |
| callback | nullable [ZegoRoomSetRoomExtraInfoCallback](../../api-reference/class#zegoroomsetroomextrainfocallback) | 设置房间附加消息结果回调。 |
...
| callback | nullable [ZegoPublisherSetStreamExtraInfoCallback](../../api-reference/class#zegopublishersetstreamextrainfocallback) | 更新流附加信息执行结果通知。 |
...
| extraInfo | NSString * | 流附加信息，长度不超过1024的字符串。 |
| channel | [ZegoPublishChannel](../../api-reference/enum#zegopublishchannel) | 推流通道。 |
| callback | nullable [ZegoPublisherSetStreamExtraInfoCallback](../../api-reference/class#zegopublishersetstreamextrainfocallback) | 设置流附加信息执行结果通知。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| canvas | [ZegoCanvas](../../api-reference/class#zegocanvas) * | 启动预览时用于显示画面的视图，视图设置为 nil 则不进行预览。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| configList | NSArray\<[ZegoPublishDualStreamConfig](../../api-reference/class#zegopublishdualstreamconfig) *\> * | 配置信息。 |
| channel | [ZegoPublishChannel](../../api-reference/enum#zegopublishchannel) | 推流通道。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoPublisherTakeSnapshotCallback](../../api-reference/class#zegopublishertakesnapshotcallback) | 推流画面截图结果回调。 |
...
| property | [ZegoTrafficControlProperty](../../api-reference/enum#zegotrafficcontrolproperty) | 流量控制的属性，位掩码或运算格式。具体可设置为 [ZegoTrafficControlProperty] 的属性的一个或多个枚举组合。默认为 AdaptiveFPS。 |
...
| --- | --- | --- |
| enable | BOOL | 是否使用流量控制；true 表示开启流控；false 表示关闭流控；默认为 true。 |
| property | [ZegoTrafficControlProperty](../../api-reference/enum#zegotrafficcontrolproperty) | 流量控制的属性，位掩码格式。具体可设置为 [ZegoTrafficControlProperty] 的属性的一个或多个枚举组合。默认为 AdaptiveFPS。 |
| channel | [ZegoPublishChannel](../../api-reference/enum#zegopublishchannel) | 推流通道。 |
...
| callback | nullable [ZegoPublisherUpdateCdnUrlCallback](../../api-reference/class#zegopublisherupdatecdnurlcallback) | 更新 CDN 转推结果通知。 |
...
| config | [ZegoCDNConfig](../../api-reference/class#zegocdnconfig) * | CDN 配置，若为 nil 则使用 Zego 的后台配置。 |
...
| codecID | [ZegoVideoCodecID](../../api-reference/enum#zegovideocodecid) | 视频编码类型。是否必填：是。 |
| codecBackend | [ZegoVideoCodecBackend](../../api-reference/enum#zegovideocodecbackend) | 编码器的后端实现。是否必填：是。 |
| callback | nullable [ZegoPublisherGetVideoEncoderSupportedCallback](../../api-reference/class#zegopublishergetvideoencodersupportedcallback) | 是否支持指定视频编码结果的回调。 |
...
| canvas | [ZegoCanvas](../../api-reference/class#zegocanvas) * | 用于显示拉流画面的视图，视图设置为 [nil] 时不显示视频，只播放音频。该参数可以设置视图显示模式（viewMode）和背景色。 |
...
| callback | [ZegoPlayerTakeSnapshotCallback](../../api-reference/class#zegoplayertakesnapshotcallback) | 拉流画面截图结果回调。 |
...
| codecID | [ZegoVideoCodecID](../../api-reference/enum#zegovideocodecid) | 视频解码类型。是否必填：是。 |
| codecBackend | [ZegoVideoCodecBackend](../../api-reference/enum#zegovideocodecbackend) | 解码器的后端实现。是否必填：是。 |
| callback | nullable [ZegoPlayerGetVideoDecoderSupportedCallback](../../api-reference/class#zegoplayergetvideodecodersupportedcallback) | 是否支持指定视频解码结果的回调。 |
...
| callback | nullable [ZegoMixerStartCallback](../../api-reference/class#zegomixerstartcallback) | 开始混流任务结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| --- | --- | --- |
| task | [ZegoMixerTask](../../api-reference/class#zegomixertask) * | 混流任务对象。是否必填：是。 |
| callback | nullable [ZegoMixerStopCallback](../../api-reference/class#zegomixerstopcallback) | 停止混流任务结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| callback | nullable [ZegoMixerStartCallback](../../api-reference/class#zegomixerstartcallback) | 开始自动混流任务结果通知 |
...
| --- | --- | --- |
| task | [ZegoAutoMixerTask](../../api-reference/class#zegoautomixertask) * | 自动混流任务对象 |
| callback | nullable [ZegoMixerStopCallback](../../api-reference/class#zegomixerstopcallback) | 停止自动混流任务结果通知 |
...
| --- | --- | --- |
| enable | BOOL | 是否开启音频采集设备；"true" 表示打开音频采集设备；"false" 表示关闭音频采集设备。 |
| callback | [ZegoAudioCaptureDeviceEnableCallback](../../api-reference/class#zegoaudiocapturedeviceenablecallback) | 开/关完成回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| deviceType | [ZegoAudioDeviceType](../../api-reference/enum#zegoaudiodevicetype) | 音频设备类型。是否必填：是。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| handler | nullable id\<[ZegoAudioMixingHandler](../../api-reference/protocol#zegoaudiomixinghandler)\> | 混音回调 |
...
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoIMSendBroadcastMessageCallback](../../api-reference/class#zegoimsendbroadcastmessagecallback) | 发送广播消息结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| message | NSString * | 消息内容。是否必填：是。取值范围：长度不超过 1024 字节。 |
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoIMSendBarrageMessageCallback](../../api-reference/class#zegoimsendbarragemessagecallback) | 发送弹幕消息结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| toUserList | nullable NSArray\<[ZegoUser](../../api-reference/class#zegouser) *\> * | 信令的接收者列表。是否必填：是。取值范围：用户列表或者 [nil]。注意事项：为 [nil] 时 SDK 会向房间内所有用户发送自定义信令。 |
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoIMSendCustomCommandCallback](../../api-reference/class#zegoimsendcustomcommandcallback) | 发送信令结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoRoomSendTransparentMessageCallback](../../api-reference/class#zegoroomsendtransparentmessagecallback) | 发送信令结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| eventHandler | nullable id\<[ZegoDataRecordEventHandler](../../api-reference/protocol#zegodatarecordeventhandler)\> | 数据录制事件回调。 |
...
| callback | nullable [ZegoNetworkProbeResultCallback](../../api-reference/class#zegonetworkproberesultcallback) | 网络探测结果回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoTestNetworkConnectivityCallback](../../api-reference/class#zegotestnetworkconnectivitycallback) | 网络连通性测试结果通知 |
...
| --- | --- | --- |
| enable | BOOL | 是否开启 |
| config | nullable [ZegoCustomVideoRenderConfig](../../api-reference/class#zegocustomvideorenderconfig) * | 自定义渲染配置 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| handler | nullable id\<[ZegoCustomVideoRenderHandler](../../api-reference/protocol#zegocustomvideorenderhandler)\> | 自定义视频渲染回调对象 |
...
| --- | --- | --- |
| enable | BOOL | 是否开启 |
| config | nullable [ZegoCustomVideoCaptureConfig](../../api-reference/class#zegocustomvideocaptureconfig) * | 自定义采集配置 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| handler | nullable id\<[ZegoCustomVideoCaptureHandler](../../api-reference/protocol#zegocustomvideocapturehandler)\> | 自定义视频采集回调对象 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| rectList | NSArray\<[ZegoRoiRect](../../api-reference/class#zegoroirect) *\> * | ROI 矩形区域列表，当前最多支持 6 个区域。 |
| channel | [ZegoPublishChannel](../../api-reference/enum#zegopublishchannel) | 推流通道 |
...
| config | nullable [ZegoCustomVideoProcessConfig](../../api-reference/class#zegocustomvideoprocessconfig) * | 自定义视频前处理配置。是否必填：是。注意事项：传 nil 则使用平台默认值。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| handler | nullable id\<[ZegoCustomVideoProcessHandler](../../api-reference/protocol#zegocustomvideoprocesshandler)\> | 自定义视频前处理回调对象。是否必填：是。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| handler | nullable id\<[ZegoCustomAudioProcessHandler](../../api-reference/protocol#zegocustomaudioprocesshandler)\> | 自定义音频处理回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| handler | nullable id\<[ZegoAudioDataHandler](../../api-reference/protocol#zegoaudiodatahandler)\> | 接收音频数据的回调对象。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| source | [ZegoScreenCaptureSource](../../api-reference/class#zegoscreencapturesource) * | 需要销毁的屏幕采集源对象 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| featureBitmask | [ZegoBeautifyFeature](../../api-reference/enum#zegobeautifyfeature) | 美颜特性，位掩码格式，可选择同时开启 [ZegoBeautifyFeature] 中的几个特性 |
