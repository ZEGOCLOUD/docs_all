...
1. 废弃 [ZegoScenario](@-ZegoScenario) 场景枚举中的 `General`、`Communication`、`Live` 三种场景，请参考 [场景化音视频配置](!video_proflie) 文档进行适配。
...
相关接口使用可参考 [设置视频编码方式](!ExpressVideoSDK-VideoAdvanced/video_codec_svc) 文档。
