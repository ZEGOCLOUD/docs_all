...
2. 视频帧率的表现情况
    ...
    ![](/Pics/Performance/SDK测试报告图片1103/丢包帧率1.png)

3. 端到端时延的表现情况

    ![](/Pics/Performance/SDK测试报告图片1103/丢包时延1.png)
...
2. 视频帧率的表现情况
    ...
    ![](/Pics/Performance/SDK测试报告图片1103/抖动帧率1.png)

3. 端到端时延的表现情况
![](/Pics/Performance/SDK测试报告图片1103/抖动时延1.png)
...
![](/Pics/Performance/SDK测试报告图片1103/APPCPU使用率1.png)

#### 2.3.2 APP 内存使用率

![](/Pics/Performance/SDK测试报告图片1103/APP内存使用率1.png)

#### 2.3.3 系统总 CPU 使用率

![](/Pics/Performance/SDK测试报告图片1103/系统总CPU使用率2.png)

#### 2.3.4 系统总内存使用率

![](/Pics/Performance/SDK测试报告图片1103/系统总内存使用率1.png)

#### 2.3.5 运行 30min 耗电量

机器满电状态下，每个场景运行 30 分钟，耗电量=100%电量-30分钟后电量

![](/Pics/Performance/SDK测试报告图片1103/30min耗电量1.png)

#### 2.3.6 运行 30min 发热增量

未启动 APP 使用测温枪统计当前温度，启动 APP 在每个场景下运行 30 分钟，发热增量=30分钟后的温度-未启动 APP 时温度

![](/Pics/Performance/SDK测试报告图片1103/30min发热增量1.png)
