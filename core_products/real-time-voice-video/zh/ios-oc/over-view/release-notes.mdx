...
**2.从此版本开始 Express 实时音视频 Video SDK 的 CocoaPods 的项目名称由 `ZegoExpressEngine/Video` 变更为 `ZegoExpressEngine`，详情请查看 [集成 SDK](/real-time-video-ios-oc/integration/sdk-integration) 文档。**
...
**3.删除了 [setDebugVerbose]、[setPlayStreamVideoLayer]、[enableAudioDataCallback] 等接口，详情请参考 [v3.0.0升级指南](!upgrade_guide4)。**
