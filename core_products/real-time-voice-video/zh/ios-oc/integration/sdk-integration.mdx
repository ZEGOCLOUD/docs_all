...
4. 执行 `pod repo update` 命令更新本地索引，确保能安装最新版本的 SDK，最新版本号请参考 [下载 SDK 包 ](/real-time-video-rn/download) 中的发布历史。
...
1. 请参考 [下载](/real-time-video-rn/download) 文档，下载最新版本的 SDK 并解压。
