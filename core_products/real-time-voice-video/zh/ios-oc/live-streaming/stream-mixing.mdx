...
请参考 [快速开始 - 实现流程](/real-time-video-ios-oc/quick-start/implementing-video-call) 的 “创建引擎” 和 “登录房间” 完成房间登录。
...
请参考 [快速开始 - 实现流程](/real-time-video-ios-oc/quick-start/implementing-video-call) 中的的 “创建引擎” 和 “登录房间” 完成初始化和房间登录。
