...
如需从 CDN 拉流场景切换为连麦场景，请参考 [从 CDN 拉流切换到连麦场景](/real-time-video-ios-oc/best-practice/switch-cdn-to-rtc) 文档。
</Note>
...
- 已将音视频流推送到 CDN，并知晓相应的 URL，详情请参考 [使用 CDN 直播](/real-time-video-ios-oc/live-streaming/using-cdn-for-live-streaming)。
