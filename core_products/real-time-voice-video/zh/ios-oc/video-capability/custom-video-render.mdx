...
API 接口调用的时序图如下：
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Common/ZegoExpressEngine/custom_video_render_uml_iOS_new.png" /></Frame>

### 设置自定义视频渲染配置

 #### 1.1 创建 [ZegoCustomVideoRenderConfig](@-ZegoCustomVideoRenderConfig) 对象并配置参数。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/share/strides_new.png" /></Frame>
