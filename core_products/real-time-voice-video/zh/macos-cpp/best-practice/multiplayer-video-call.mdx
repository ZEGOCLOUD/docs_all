...
为实现多人视频通话功能，需要监听房间内用户和流的增减并做出相应处理，可通过 [setEventHandler\|_blank](@setEventHandler) 设置相关回调。
...
| [loginRoom \|_blank](@loginRoom)| 登录房间，推拉流前必须登录房间  |
| [ZegoRoomConfig \|_blank](@ZegoRoomConfig) | 房间进阶配置  |
| [setEventHandler\|_blank](@setEventHandler) | 设置事件通知回调   |
| [onRoomUserUpdate\|_blank](@onRoomUserUpdate)| 房间内其他用户增加或减少的通知回调 |
| [onRoomStreamUpdate\|_blank](@onRoomStreamUpdate)| 相同房间内其他用户推的流增加或减少的通知 |
| [startPlayingStream\|_blank](@startPlayingStream) | 开始推流| 
