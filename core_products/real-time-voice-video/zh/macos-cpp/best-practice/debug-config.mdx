...
在创建引擎前，可通过调用 [setLogConfig_](@setLogConfig) 设置日志属性。
...
调用 [getVersion_](@getVersion) 可获得 SDK 版本号。开发者可将 SDK 版本号信息作为 App 所使用的 engine 的版本信息，以便统计线上各版本 App 对应的各版本 SDK。
...
|[ZegoLogConfig_](@-ZegoLogConfig)|设置日志属性|
