...
2. 获取视频原始数据，可通过 ZEGO Express SDK 的 [自定义视频采集](/real-time-video-macos-cpp/video-capability/custom-video-capture) 或 [自定义视频前处理](/real-time-video-macos-cpp/video-capability/custom-video-processing) 两种方式获取。
...
- **方式一：自定义视频前处理**
    ...
    具体的原理可参考“实时音视频”的 [自定义视频前处理](/real-time-video-macos-cpp/video-capability/custom-video-processing)。

<a id="CustomCollection"></a>

- **方式二：自定义视频采集**

    自定义视频采集，主要依赖开发者自行采集视频数据，具体方式请参考“实时音视频”的 [自定义视频采集](/real-time-video-macos-cpp/video-capability/custom-video-capture)。
