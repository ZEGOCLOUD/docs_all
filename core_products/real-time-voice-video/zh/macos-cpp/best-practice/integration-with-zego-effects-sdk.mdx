...
- 已在项目中集成 ZEGO Express SDK，并实现了基本的音视频推拉流功能，详情请参考 [快速开始 - 集成](/real-time-video-macos-cpp/quick-start/integrating-sdk) 和 [快速开始 - 实现视频通话](/real-time-video-macos-cpp/quick-start/implementing-video-call)。
...
ZEGO Express SDK 可通过 [自定义视频前处理](/real-time-video-macos-cpp/best-practice/integration-with-zego-effects-sdk) 和 [自定义视频采集](/real-time-video-macos-cpp/best-practice/integration-with-zego-effects-sdk) 两种方式获取视频原始数据。
