...
| 业务参数 | 类型 | 描述 |
|---|---|---|
| task_id | String | 转码任务的唯一标识 ID，与 <a href="!Start_onDemand_transcoding" target="balnk">开始点播转码</a> 响应结果中的 task_id 保持一致。 |
...
| video | Object | 转码后的视频信息，与 <a href="!Start_onDemand_transcoding" target="balnk">开始点播转码</a> 请求参数中的 Resolution 配置相关。 |
...
| audio | Object | 转码后的音频信息，与 <a href="!Start_onDemand_transcoding" target="balnk">开始点播转码</a> 请求参数中的 Resolution 配置相关。 |
