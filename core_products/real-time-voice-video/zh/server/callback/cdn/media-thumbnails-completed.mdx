...
开发者通过 [开始点播截图](/real-time-video-server/api-reference/cdn/media-thumbnails) 接口完成媒体文件转码后，可以通过该回调查询截图信息。
...
| 业务参数 | 类型 | 描述 |
|---|---|---|
| task_id | String | 截图任务 ID，与 <a href="/real-time-video-server/api-reference/cdn/media-thumbnails" target="balnk">开始点播截图</a> 响应结果中的 task_id 保持一致。 |
