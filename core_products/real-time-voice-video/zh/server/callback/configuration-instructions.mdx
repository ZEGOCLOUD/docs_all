...
- **2021-11-16** 之后注册 [ZEGO 控制台\](https://console.zego.im) 的用户，请参考 [控制台 - 服务端回调配置\](#14215)。
- **2021-11-16** 及之前注册 [ZEGO 控制台\](https://console.zego.im) 的用户，请参考 [控制台（旧版） - 项目管理\](#1265#4) 中的 “高级配置”。
</div>
