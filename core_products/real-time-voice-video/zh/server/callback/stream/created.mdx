...
<Warning title="注意">
开始混流时不会触发此回调，监听混流相关的回调请参考 [混流开始回调](./../stream-mixing/started.mdx)。
</Warning>
...
<ul><li>0：H.264。</li><li>1：H.264 分层视频编码。</li><li>2：VP8 编码。</li><li>3：H.265。</li></ul>
</td>
</tr>
<tr>
<td>stream_seq</td>
...
<td>String</td>
<td>
客户端推流时最新的流附加信息，可通过 [setStreamExtraInfo](/real-time-video-android-java/client-sdk/api-reference/class#setstreamextrainfo-zegoexpressengine) 设置流附加信息。
<Warning title="注意">
如果客户端在推流前未设置流附加信息，则该字段为空字符串。
</Warning>
...
<td>
是否重复推流。
<ul><li>1：表示客户端重新推了一条服务器已存在的流。</li><li>0：表示新流。</li></ul>

<Note title="说明">
如果遇到网络异常，且SDK 在 90 秒内重试成功，服务器会续推已存旧流，recreate 为 1，90 秒后 SDK 重试、强杀 App 重开推流、结束推流 / 退房后重推，服务器会推新流，recreate 为 0。
</Note>
</td>
</tr>
<tr>
