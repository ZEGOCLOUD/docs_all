...
<tbody>
  ...
  <tr>
    <td>SignatureNonce</td>
    <td>随机字符串，即公共参数里的 SignatureNonce。16 位 16 进制随机字符串（8 字节随机数的 hex 编码）。生成算法可参考 <a href="#signature-example">签名示例</a>。</td>
  </tr>
  <tr>
    <td>ServerSecret</td>
  ...
  <tr>
    <td>Timestamp</td>
    <td>
    当前 Unix 时间戳，即公共参数里的 Timestamp，单位为秒。生成算法可参考 <a href="#signature-example">签名示例</a>，最多允许 10 分钟的误差。
    </td>
  </tr>
</tbody>
</table>
