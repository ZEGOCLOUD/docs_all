...
“客户端”的混流功能，请参考 [混流 - 自动混流](/real-time-video-android-java/live-broadcast-capability/mixer)；“服务端”的相关回调，请参考 [混流开始回调](!Callback/Callback_StartMix) 和 [混流结束回调](!Callback/Callback_StopMix)。
