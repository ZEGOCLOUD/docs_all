...
本接口用于查询 [合并媒体文件\|_blank](!Media_File/MergeMedia)、[开始点播转码\|_blank](!Start_onDemand_transcoding) 及 [开始点播截图\|_blank](!MediaThumbnails) 任务的详细信息，作为 [媒体文件合并完成回调\|_blank](!Callback/compose) 和 [点播转码完成回调\|_blank](!Callback_onDemand_transcoding) 的补充。
