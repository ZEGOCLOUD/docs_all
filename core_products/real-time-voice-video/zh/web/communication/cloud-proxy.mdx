...
通过设置 SDK 的云代理接口，将 SDK 对应的所有流量通过云端的代理服务器中转，实现与 RTC、L3（[超低延迟直播](/real-time-video-web/live-streaming/low-latency-live-streaming)）通信。
