...
- 已在 [ZEGO 控制台](https://console.zego.im) 创建项目，并申请有效的 AppID 和 Server 地址，详情请参考 [控制台 - 项目信息](/console/guide-doc2)。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Express/RangeVoice_web.png" /></Frame>
...
登录房间需要用于验证身份的 Token，获取方式请参考 [用户权限控制](/real-time-video-web/communication-capability/general-reference)。如需快速调试，可使用控制台生成临时 Token。
