...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Express/Cloud_Proxy.png" /></Frame>
...
调用 [setCloudProxyConfig](@setCloudProxyConfig) 配置云代理。

<Warning title="注意">


此接口必须在创建 [ZegoExpressEngine](@-ZegoExpressEngine) 引擎实例前，**通过类静态方法的方式调用**。
...
- 确保在创建 [ZegoExpressEngine](@-ZegoExpressEngine) 引擎实例前，正确设置云代理，不支持中途修改。
</Accordion>
