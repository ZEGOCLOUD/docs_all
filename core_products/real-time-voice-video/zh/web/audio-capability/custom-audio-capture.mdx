...
调用 [createZegoStream ](@createZegoStream) 接口创建第三方媒体流，再调用 [startPublishingStream](@startPublishingStream) 接口推流。
...
调用 [createZegoStream ](@createZegoStream) 接口创建第三方音频，再调用 [startPublishingStream](@startPublishingStream) 接口推流。
