...
ZEGO 播放器插件，由深圳市即构科技有限公司提供，您可以在本页面获取适用于 Web 平台的播放器插件资源，发布日志请参考 [播放器插件 - 发布日志](/real-time-video-web/player-plugin/release-notes)，合规事宜请参考 [《即构云服务隐私政策》](https://doc-zh.zego.im/policies-and-agreements/zego-privacy-policy)。
