...
WebRTC 技术在 Chrome 平台支持度最好，建议开发者使用最新版本的 [Chrome 浏览器](https://www.google.com/intlhttps://doc-zh.zego.im/article-CN/chrome/)，下载最新版本的 [Web SDK](https://doc-zh.zego.im/article/3209)。
