...
SDK 支持的浏览器兼容版本，请参考 [下载示例源码](/real-time-video-web/integration/download-demo#1_1) 中的 “准备环境”。
...
登录房间需要用于验证身份的 Token，获取方式请参考 [使用 Token 鉴权](/real-time-video-web/communication-capability/general-reference)。如需快速调试，可使用控制台生成临时 Token。
