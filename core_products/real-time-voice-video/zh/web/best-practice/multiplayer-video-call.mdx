...
- API 调用时序图如下: 
  ...
  <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Web/ExpressSDK/Advanced_Features /Video_for_Multiple_Users_Web_new.png" /></Frame>
...
请参考 [快速开始 - 实现流程](/real-time-video-web/integration/solution-implementation) 依次完成登录房间、推流和拉流相关操作。
