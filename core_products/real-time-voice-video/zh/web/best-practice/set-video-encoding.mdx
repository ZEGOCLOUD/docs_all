...
转码，是指将视频信号从一种格式转换成另一种格式。在 ZEGO 服务中，支持音视频编码格式、分辨率、码率等的转换，开发者可以参考 [单流转码](https://doc-zh.zego.im/real-time-video-web/live-streaming/single-stream-transcoding)。如有疑问，请联系 ZEGO 技术支持。
