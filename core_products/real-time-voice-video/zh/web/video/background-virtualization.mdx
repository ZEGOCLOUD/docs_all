...
<tr>
<td>背景虚化-弱</td>
<td><Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/b669d10113.png" /></Frame></td>
</tr>
<tr>
<td>背景虚化-中</td>
<td><Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/6364d2bc42.png" /></Frame></td>
</tr>
<tr>
<td>背景虚化-强</td>
<td><Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/c624f44d28.png" /></Frame></td>
</tr>
<tr>
<td>虚拟背景</td>
<td><Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/de1e9cf26f.png" /></Frame></td>
</tr>
</tbody></table>
...
1. 集成背景处理模块。
    ...
    - 方式 2：在官网 [下载 SDK 包](/real-time-video-web/client-sdk/download-sdk)，手动集成。
    ```javascript
...
2. 动态加载背景虚化及虚拟背景依赖的 wasm 等资源文件。
    ...
    将 [示例源码](/real-time-video-web/quick-start/run-example-code) 中 `zego-express-engine-webrtc/background-process/assets` 目录下的所有资源文件，发布至 CDN 或者静态资源服务器中，且需发布至同一资源目录下，并生成 URL。
