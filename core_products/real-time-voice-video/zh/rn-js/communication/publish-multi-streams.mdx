...
请参考 [下载示例源码](/real-time-video-rn/quick-start/run-example-code) 获取源码。
...
请参考 [快速开始 - 实现视频通话](/real-time-video-rn/quick-start/implementing-video-call#创建引擎) 的 “3.1 创建引擎”。
