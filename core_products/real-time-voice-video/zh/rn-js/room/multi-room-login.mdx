...
- 已在项目中集成 ZEGO Express SDK（2.9.0 及以上版本），并实现了基本的音视频推拉流功能，详情请参考 [快速开始 - 集成](/real-time-video-rn/quick-start/integrating-sdk) 和 [快速开始 - 实现视频通话](/real-time-video-rn/quick-start/implementing-video-call)。
...
请参考 [快速开始 - 实现流程](/real-time-video-rn/quick-start/implementing-video-call) 的 “初始化”  进行 SDK 的初始化。
...
多房间与单房间发送、接收实时消息的实现一致，详情请参考 [房间实时消息](/real-time-video-rn/room/messaging-and-signaling)。
