...
- 已在项目中集成 ZEGO Express Electron SDK，并实现了基本的音视频推拉流功能，详情请参考 [快速开始 - 集成](/real-time-video-electron-js/quick-start/integrating-sdk) 和 [快速开始 - 实现视频通话](/real-time-video-electron-js/quick-start/implementing-video-call)。
...
通过监听 [onExceptionOccurred](/real-time-video-electron-js/quick-start/setting-callback) 回调，接收采集异常相关通知。
