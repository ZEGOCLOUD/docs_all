...
## 获取示例源码
<Card title="示例源码" href="https://artifact-sdk.zego.im/express/example/video/ohos_ets/ZegoExpressDemo_ohos_ets.zip" target="_blank">
本地下载
</Card>
## 运行示例源码
...
1. **DevEco Studio 运行下载的示例源码时有如下报错，该如何处理？**
    ...
    由于下载的示例源码中，AppID 和 AppSign 没有具体的值，请参考本文 “[运行示例源码](/real-time-video-harmonyos-arkts/quick-start/run-example-code)” 章节中的步骤 4 进行处理。
