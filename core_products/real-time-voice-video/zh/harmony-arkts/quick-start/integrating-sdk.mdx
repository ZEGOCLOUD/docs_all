...
1. 打开 DevEco Studio，选择 “File > New > Create Project” 菜单，新建工程。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/c9c9584bf2.jpeg" /></Frame>

2. 选择项目模版为 “Empty Ability”。

    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/4cebd36b22.jpeg" /></Frame>

3. 填写您项目名称、设备类型等信息。

    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/docuo/03f53ea813.jpeg" /></Frame>
...
1. 请参考 [下载 SDK 包](/real-time-video-harmonyos-arkts/client-sdk/download-sdk) ，下载最新版本的 SDK。
...
以上代码中的 `@zego/zego-express-engine` 版本号仅为示例，最新的版本号请查看 [OpenHarmony 三方库中心仓](https://ohpm.openharmony.cn/#/cn/detail/@zego%2Fzego-express-engine)。
