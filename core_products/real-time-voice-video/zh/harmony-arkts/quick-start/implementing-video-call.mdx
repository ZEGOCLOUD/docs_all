...
调用 [createEngine ](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/ets_ohos/classes/_zegoexpressengine_.zegoexpressengine.html#createengine) 方法，将 [前提条件](!Integration/Solution_Implementation#2) 中申请到的 AppID 传入参数 “appID”，创建引擎单例对象。
