...
本文罗列了您在集成 ZEGO [Express HarmonyOS SDK\|_blank](!DownloadSDK/DownloadSDK) 时可能会遇到的已知问题、及相关解决方案，建议您在开始接入前仔细阅读。如有疑问，请联系 ZEGO 技术支持咨询。
...
#### 1. 如果其他 App 应用处于前台、畅连使用小窗口进行通话。当畅连挂断后，其他 App 应用没有恢复采集播放。

HarmonyOS NEXT 系统的 BUG，[华为畅连\|_blank](https://consumer.huawei.com/cn/mobileservices/meetime/) 挂断后没有触发相关事件。
