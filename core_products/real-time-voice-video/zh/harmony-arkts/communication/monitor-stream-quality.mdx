...
[onNetworkQuality](https://doc-zh.zego.im/unique-api/express-video-sdk/zh/ets_ohos/interfaces/_zegoexpresseventhandler_.zegoeventlistener.html#onnetworkquality) 不适用于使用 CDN 进行直播的场景，您可以参考 [进阶质量报告 - 推流质量报告](/real-time-video-harmonyos-arkts/communication/monitor-stream-quality) 监测 CDN 的推流质量。
