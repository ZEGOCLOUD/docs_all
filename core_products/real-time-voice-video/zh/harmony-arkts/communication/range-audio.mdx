...
<p>上图仅以范围语音模式为“全世界”时为例，更多不同模式组合关系下的声音可达情况请参考 <a href="#setrangeaudiomode">设置通用语音模式</a>。</p>
</td>
</tr>
<tr>
<td>3D 音效</td>
...
<Note title="说明">
<ul><li>队友之间的通话不受“范围”和 “3D 音效” 的影响，详情请查看 <a href="#setrangeaudiomode">设置通用语音模式</a>。</li><li>如果您希望自定义语音收发能力，请参考 <a href="#set-custom-voice-mode">设置自定义语音模式</a>。</li></ul>
</Note>
</td>
</tr>
</tbody></table>
...
请参考 [下载示例源码](/real-time-video-harmonyos-arkts/quick-start/run-example-code) 获取源码。
...
<Note title="说明">
        ...
        请参考 [媒体播放器](/real-time-video-harmonyos-arkts/other/media-player) 了解如何创建媒体播放器与加载媒体资源。
...
<Note title="说明">
        ...
        请参考 [音效文件播放器](../other/audio-effect-player.mdx) 了解如何创建音效播放器与加载音效资源。
