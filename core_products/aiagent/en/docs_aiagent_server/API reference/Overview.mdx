...
| Interface Name                                                            | Interface Function           | Default QPS limit |
| ------------------------------------------------------------------- | ------------------ | ---------------- |
| [Trigger LLM](./Agent%20Instance%20Control%5CSend%20Agent%20instance%20LLM.mdx)               | Trigger the LLM service as a user, and based on the response content from the LLM, proactively invoke the TTS service as an agent to send voice messages to the user.      | 10 times/second         |
| [Trigger TTS](./Agent%20Instance%20Control%5CSend%20Agent%20instance%20TTS.mdx)               | Trigger the TTS service as an agent to send voice messages to the user.     | 10 times/second         |
...
| ------------- | -------------------- |
| [Receiving Callback](./..%5CCallbacks%5CReceiving%20Callback.mdx) |   With this callback, listen to events that occur during the user's conversation with the agent.       |
