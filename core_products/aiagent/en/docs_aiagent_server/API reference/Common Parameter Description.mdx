...
| Parameter | Type | Required | Description   |
| ----------------------- | --------------- | -------- | ----- |
| Vendor                    | String          | Yes      | Text-to-speech (TTS) service provider. Options:<ul><li>`Aliyun`: Aliyun.</li><li>`ByteDance`: Volcano Engine (Large Model Speech Synthesis API).</li><li>`ByteDanceFlowing`: BytePlus Voice (Streaming Text-to-Speech API (WebSocket)).</li><li>`MiniMax`: MiniMax.</li></ul> |
...
| Parameter | Type | Required | Description |
|------|------|----------|------|
| app_key | String | Yes | Read the Aliyun docs [Intelligent Speech Interaction - Create a project](https://www.alibabacloud.com/help/en/isi/getting-started/start-here?spm=a2c4g.11186623.0.0.44f34b4f40XABA#659bb8103941q) to create a project and get the AppKey from the Intelligent Speech Interaction console, and pass it here.|
| ak_id | String | Yes | Read the Aliyun docs [Intelligent Speech Interaction - Activate Intelligent Speech Interaction - Procedure](https://www.alibabacloud.com/help/en/isi/activate-intelligent-speech-interaction-1#h2-699-vc6-tgh) to obtain the AccessKey ID and pass it here.|
| ak_key | String | Yes | Read the Aliyun docs [Intelligent Speech Interaction - Activate Intelligent Speech Interaction - Procedure](https://www.alibabacloud.com/help/en/isi/activate-intelligent-speech-interaction-1#h2-699-vc6-tgh) to obtain the AccessKey Secret and pass it here.|
</Tab>
<Tab title="ByteDance">

| Parameter | Type | Required | Description |
|------|------|----------|------|
| appid | String | Yes | Read the Volcano Engine docs [Voice Technology - Quick Start - Console Usage FAQ](https://www.volcengine.com/docs/6561/196768#q1%EF%BC%9A%E5%93%AA%E9%87%8C%E5%8F%AF%E4%BB%A5%E8%8E%B7%E5%8F%96%E5%88%B0%E4%BB%A5%E4%B8%8B%E5%8F%82%E6%95%B0appid%EF%BC%8Ccluster%EF%BC%8Ctoken%EF%BC%8Cauthorization-type%EF%BC%8Csecret-key-%EF%BC%9F) under "Where can I get the following parameters: appid, cluster, token, authorization_type, secret_key?". |
| token | String | Yes | Same as above. |
...
| Parameter | Type | Required | Description |
|------|------|----------|------|
| appid | String | Yes | Read the BytePlus Voice docs [Voice Console Guide - Step 2: Trial Use](https://docs.byteplus.com/en/docs/byteplusvoice/Voice_Console_Guide#step-2-trial-use) to get the App ID, and pass it here.|
| token | String | Yes | Same as above. |
...
| Parameter | Type | Required | Description |
|------|------|----------|------|
| group_id | String | Yes | Read the MiniMax docs [Quick Start](https://www.minimax.io/platform/document/platform%20introduction?key=66701c8e1d57f38758d58198#fxvi2gssBBRAIx5V60y7dYfo) to get the Group ID, and pass it here. |
| api_key | String | Yes | Read the MiniMax docs [Quick Start](https://www.minimax.io/platform/document/platform%20introduction?key=66701c8e1d57f38758d58198#fxvi2gssBBRAIx5V60y7dYfo) to get the API Key, and pass it here. |
</Tab>
</Tabs>
