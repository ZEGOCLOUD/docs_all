...
- Request method: POST
- Request endpoint: `https://aigc-aiagent-api.zegotech.cn?Action=UpdateAgentInstance`
...
|-------------------|----------|----------|-----------------------------------------------------------------------------|
| AgentInstanceId  | String   | Yes      | The unique identifier of the agent instance, obtained through the response parameter of the [Create An AI Agent Instance](./Create%20Agent%20instance.mdx) interface. |
