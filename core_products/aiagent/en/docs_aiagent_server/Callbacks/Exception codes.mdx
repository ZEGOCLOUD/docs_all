...
| --- | --- | --- |
| 1001 | ZEGO Real-time Interaction AI Agent General Error | Refer to the `Message` field for details. |
...
| 1101 | IM General Error | Please provide the `Message` field to ZEGO Technical Support. |
| 1201 | RTC General Error | Please provide the `Message` field to ZEGO Technical Support. |
...
| 1204 | AI agent instance failed to log into the RTC room. | Please provide the `Message` field to ZEGO Technical Support. |
| 1205 | AI agent instance disconnected from the RTC room. | Please provide the `Message` field to ZEGO Technical Support. |
| 1206 | AI agent instance failed to push stream. | Please provide the `Message` field to ZEGO Technical Support. |
| 1207 | AI agent instance failed to pull stream. | Please provide the `Message` field to ZEGO Technical Support. |
| 2101 | ASR General Error | Please provide the `Message` field to ZEGO Technical Support. |
