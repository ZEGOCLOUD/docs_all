...
- Request method: POST
- Request endpoint: `https://aigc-aiagent-api.zegotech.cn?Action=ListAgents`
...
|-------------------|--------|----------|-----------------------------------------------------------------------------|
| Limit             | Int    | No       | The number of AI agent information entries to retrieve in one request. The value range is [0, 10]. If not filled or the value is 0, it defaults to 5. If the value is less than 0 or greater than 10, the API request will return an error. |
