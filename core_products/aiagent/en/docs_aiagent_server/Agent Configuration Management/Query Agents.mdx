...
- Request method: POST
- Request endpoint: `https://aigc-aiagent-api.zegotech.cn?Action=QueryAgents`
...
| └Agents | Array of Object | List of AI agents. For the structure of this parameter, please refer to [Frequently Used Parameters - Agents](./../Common%20Parameter%20Description.mdx#agents). |
