...
|------|------|------|
| Code | Number | The return code. 0 indicates success, and other values indicate failure. For error codes and response processing suggestions, see [Return codes](./../Return%20codes.mdx). |
