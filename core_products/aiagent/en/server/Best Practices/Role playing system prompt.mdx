...
- Passed into the `LLM.SystemPrompt` parameter via the [Register An Agent](./../API%20reference/Agent%20Configuration%20Management/Register%20Agent.mdx) interface.
- Passed into the `LLM.SystemPrompt` parameter via the [Modify An Agent](./../API%20reference/Agent%20Configuration%20Management/Update%20Agent.mdx) interface.
- Passed into the `LLM.SystemPrompt` parameter via the [Create An Agent Instance](./../API%20reference/Agent%20Instance%20Management/Create%20Agent%20instance.mdx) interface.
- Passed into the `LLM.SystemPrompt` parameter via the [Modify An Agent Instance](./../API%20reference/Agent%20Instance%20Management/Update%20Agent%20instance.mdx) interface.
