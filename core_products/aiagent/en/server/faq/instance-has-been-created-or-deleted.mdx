...
You can monitor these two events to track the creation and deletion status of agent instances. For more details, please refer to [Get AI Agent Status and Latency Data](./../Guides/Get%20AI%20Agent%20status.mdx#listen-for-agent-related-events).
