...
| Optional Information | SDK log files. For details, please refer to [How to set up and get SDK logs and stack information](https://www.zegocloud.com/docs/faq/express-logs-stacktrace). |
