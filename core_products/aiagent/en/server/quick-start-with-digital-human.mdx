...
After completing this step, you have successfully created a digital human agent instance. After integrating the client, you can interact with the digital human agent instance in real-time video.
</Step>
...
Congratulations🎉! After completing this step, you have successfully integrated the client SDK and can interact with the digital human agent instance in real-time video. You can ask the digital human any question, and the digital human will answer your question!
</Step>
