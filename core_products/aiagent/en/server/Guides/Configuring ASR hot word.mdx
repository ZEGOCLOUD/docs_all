...
You can set the hot word list through the `HotWord` parameter in the `ASR` section when [registering an AI agent](./../API%20reference/Agent%20Configuration%20Management/Register%20Agent.mdx) or [creating an AI agent instance](./../API%20reference/Agent%20Instance%20Management/Create%20Agent%20instance.mdx).
