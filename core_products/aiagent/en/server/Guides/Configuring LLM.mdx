...
You can set LLM parameters when registering an AI agent ([RegisterAgent](./../API%20reference/Agent%20Configuration%20Management/Register%20Agent.mdx)) or creating an AI agent instance ([CreateAgentInstance](./../API%20reference/Agent%20Instance%20Management/Create%20Agent%20instance.mdx)).
