...
| ---------------------- | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Vendor                 | String | No       | ASR vendor, default is Tencent：<ul><li>Tencent: Tencent</li><li>AliyunParaformer: Aliyun Paraformer</li><li>AliyunFunASR: Aliyun FunASR</li><li>AliyunQwenASR: Aliyun Qwen ASR</li><li>VolcSeedASR: Volcengine Seed ASR</li><li>Microsoft: Microsoft ASR</li></ul>                                                                 |
