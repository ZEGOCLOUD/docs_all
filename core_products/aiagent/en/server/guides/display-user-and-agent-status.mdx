...
To receive user and agent instance status callback results, when [creating an agent instance](./../api-reference/agent-instance-management/create-agent-instance.mdx), set the [CallbackConfig.UserSpeakAction](./../api-reference/agent-instance-management/create-agent-instance.mdx#callbackconfig) and [CallbackConfig.AgentInstanceStatus](./../api-reference/agent-instance-management/create-agent-instance.mdx#callbackconfig) parameters to `1`.
