...
| ------------------ | ------ | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| payload.model      | string | Yes       | Specify model. Supported models include cosyvoice-v3.5-plus, cosyvoice-v3.5-flash, cosyvoice-v3-plus, cosyvoice-v3-flash, cosyvoice-v2, cosyvoice-v1. For more models, see [All Models](https://help.aliyun.com/zh/model-studio/tts-model/?spm=a2c4g.11186623.0.0.25912a7ckKFOCs#tts08-rec01).<br/><Warning title="Note">Each model only supports a specific set of voices. You cannot mix voices from one model with another. For details, see [CosyVoice Voice List](https://help.aliyun.com/zh/model-studio/cosyvoice-voice-list?spm=a2c4g.11186623.help-menu-2400256.d_0_3_5_5_0.5bd348b2rgi384).</Warning> |
