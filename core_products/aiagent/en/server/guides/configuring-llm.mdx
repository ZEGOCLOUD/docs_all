...
async registerAgent(agentId: string, agentName: string) {
    ...
    // The sendRequest method encapsulates the request URL and public parameters. For details, please refer to: https://www.zegocloud.com/docs/aiagent-server/api-reference/accessing-server-apis
