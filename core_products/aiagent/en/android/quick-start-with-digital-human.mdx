...
dependencies {
    ...
    implementation "im.zego:digitalmobile:1.2.1.25"
}
```
</Step>
</Steps>
...
<Steps>
  <Step title="Download the Latest Version of SDK">
    Please download the latest version of the [SDK](https://artifact-node.zego.cloud/generic/digithuman/public/ZegoDigitalMobile/release/ios/ZegoDigitalMobile.zip?version=1.2.1.21).
  </Step>
