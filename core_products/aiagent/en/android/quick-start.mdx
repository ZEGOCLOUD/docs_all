...
Please refer to [Integrate SDK > Method 2](https://www.zegocloud.com/docs/video-call/sdk-integration?platform=web&language=javascript#2_2) to use npm to integrate SDK v3.11.0-aiagent.187. After integrating the SDK, initialize ZegoExpressEngine as follows.
