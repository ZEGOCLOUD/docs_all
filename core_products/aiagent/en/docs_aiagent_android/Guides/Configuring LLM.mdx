...
You can set LLM parameters when registering an AI agent ([RegisterAgent](en/aiagent-server/agent-configuration-management/register-agent)) or creating an AI agent instance ([CreateAgentInstance](/en/aiagent-server/agent-instance-management/create-agent-instance)). Parameters are as follows:
