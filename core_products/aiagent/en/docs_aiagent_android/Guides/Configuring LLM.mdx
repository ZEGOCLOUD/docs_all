...
You can set LLM parameters when registering an AI agent ([RegisterAgent](en/aiagent-server/agent-configuration-management/register-agent)) or creating an AI agent instance ([CreateAgentInstance](/en/aiagent-server/agent-instance-management/create-agent-instance)). Common parameters are as follows:
...
When registering an AI agent ([RegisterAgent](/en/aiagent-server/agent-configuration-management/register-agent)) or creating an AI agent instance ([CreateAgentInstance](/en/aiagent-server/agent-instance-management/create-agent-instance)), set the configuration for the custom LLM.
