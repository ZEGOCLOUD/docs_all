...
- A project has been created in the [ZEGO Console](https://console.zegocloud.com/) and a valid AppID and AppSign have been applied for. For more details, please refer to [CHow to view project info - Admin Console ](https://www.zegocloud.com/docs/admin-console/view-project-information?platform=all&language=all).
- Contact ZEGO technical support to activate AI Agent-related services and obtain LLM and TTS configuration information.
...
<Warning title="Attention">Please contact ZEGO technical support to get the version of ZEGO Express SDK that supports AI noise reduction and AI echo cancellation, and enable AI noise reduction and AI echo cancellation during integration for better voice interaction results.</Warning>
...
Server example code. It includes the most basic capabilities such as obtaining ZEGO Token, registering an intelligent agent, creating an intelligent agent instance, and deleting an intelligent agent instance.
</Card>
</CardGroup>
...
<Note title="Note">
Please ensure that the roomID, userID, and streamID are unique under one ZEGO APPID.
...
engineConfig.advancedConfig = @{
    ...
    @"enforce_audio_loopback_in_sync": @"true", /** This configuration is used for response delay optimization and requires the corresponding version of ZegoExpressEngine SDK. Please contact ZEGO support **/
...
// Note: Enabling AI noise reduction and AI echo cancellation requires contacting ZEGO technical support to obtain the corresponding ZegoExpressionEngine.xcframework, as versions with these capabilities have not yet been released.
