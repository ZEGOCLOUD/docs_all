...
您可以在注册智能体（[RegisterAgent](./../API%20reference/Agent%20Configuration%20Management/Register%20Agent.mdx)）或创建智能体实例（[CreateAgentInstance](./../API%20reference/Agent%20Instance%20Management/Create%20Agent%20instance.mdx)）时通过 `ASR` 参数中的 `HotWord` 设置热词表。
