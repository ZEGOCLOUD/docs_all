...
您可以在注册智能体（[RegisterAgent](./../api-reference/agent-configuration-management/register-agent.mdx)）或创建智能体实例（[CreateAgentInstance](./../api-reference/agent-instance-management/create-agent-instance.mdx)）时通过 `ASR` 参数中的 `HotWord` 设置热词表。
