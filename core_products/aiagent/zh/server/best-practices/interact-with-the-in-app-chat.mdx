...
<Frame width="auto" height="512" caption="">
  <img src="https://doc-media.zego.im/docuo/de20e70f45.png" alt="im_with_agent.png"/>
</Frame>
...
以下是实现后的效果：
<Video src="https://doc-media.zego.im/docuo/4282e79adb.mp4" />
...
<Warning title="注意">请先参考[快速开始](./../quick-start.mdx)文档实现与 AI 进行语音通话功能。</Warning>
