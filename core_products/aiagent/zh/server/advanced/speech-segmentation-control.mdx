...
影响用户说话结束判断的两个参数在注册/更新智能体、创建/更新智能体实例的 ASR 参数中。可参考[注册智能体 > Body > ASR 参数说明](/aiagent-server/api-reference/agent-configuration-management/register-agent)。详细说明如下：
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
