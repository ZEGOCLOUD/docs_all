...
通过向本接口，您可以创建数字人智能体实例，并将数字人智能体实例加入到语音（RTC）对话之中。

import PostPrototype from '/snippets/common/zh/server/post-prototype.mdx'

<PostPrototype link="https://aigc-aiagent-api.zegotech.cn?Action=CreateDigitalHumanAgentInstance" />
