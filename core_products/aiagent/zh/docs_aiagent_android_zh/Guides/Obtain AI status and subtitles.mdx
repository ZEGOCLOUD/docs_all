...
本文介绍如何通过监听 ZEGO Express SDK 的 [onIMRecvCustomCommand](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~java_android~class~IZegoEventHandler#on-im-recv-custom-command) 回调展示 AI 状态和字幕。
