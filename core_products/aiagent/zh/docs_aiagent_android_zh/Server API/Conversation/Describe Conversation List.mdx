...
| PageSize | Number | 否 | 返回结果包含的会话详情数量上线。默认为 100。 |
...
| CustomAgentConfig | Object | 自定义智能体参数。本参数结构请见 [通用参数说明 - CustomAgentConfig](./../Common%20Parameter%20Description.mdx#customagentconfig)。 |
| IsChatting | Bool | 是否进行中。 |
