...
详情请查看 [发布日志](./Release%20Notes.mdx)。
</Note>
...
<tr>
<td>[单人发起智能体语音通话](./../Quick%20start.mdx)</td>
...
<td>搭自动过滤对话过程中用户侧产生的嘈杂音，并消除远场人声，实现更精准的语音打断效果、更准确的 ASR 语音识别效果。</td>
</tr>
<tr>
<td>自然语音打断</td>
