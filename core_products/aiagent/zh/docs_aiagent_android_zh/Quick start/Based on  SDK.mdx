...
1. 在开始使用 AI Agent 之前，您需要完成以下步骤：
    ...
    <Warning title="注意">
    在实现 AI Agent 的功能之前，请确保已经完成了 [ZEGO Express Web SDK 初始化](https://doc-zh.zego.im/article/7636#2_1)。
    </Warning>
...
```
3. 此时会话已经成功建立，用户可以通过 ZEGO Express SDK 的 `onIMRecvCustomCommand` 回调来获取并且展示语音聊天的文本内容,具体的展示逻辑见 [获取AI状态 & 字幕](../Guides/Obtain%20AI%20status%20and%20subtitles.mdx)
```java
