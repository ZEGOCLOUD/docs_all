...
本接口可用于获取指定会话中 LLM 使用的上下文（至多 100 条历史消息）。如需重置上下文，请参考 [重置会话上下文消息](./Reset%20ConversationMsg.mdx)。
## 接口原型
...
| Data | Object | 返回数据。 |
| &nbsp;└Total | Number | 消息总数。 |
| &nbsp;└MessageList | Array of [Message](#message) | 供 LLM 使用的上下文，目前最多返回 100 条历史消息。其中消息排序方式如下：<ol><li>用户问题 1</li><li>智能体应答 1</li><li>用户问题 2</li><li>智能体应答 2</li><li>...</li></ol> |
