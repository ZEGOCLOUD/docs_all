...
| Reason | Int32 | 被打断的原因：<ul><li>1：用户讲话。</li><li>2：[主动调用 LLM](./../API%20reference/Agent%20Instance%20Control/Send%20Agent%20instance%20LLM.mdx)。</li><li>3：[主动调用 TTS](./../API%20reference/Agent%20Instance%20Control/Send%20Agent%20instance%20TTS.mdx)。</li><li>4：[主动调用打断智能体实例](./../API%20reference/Agent%20Instance%20Control/Interrupt%20Agent%20Instance.mdx)。</li></ul> |
</Tab>
