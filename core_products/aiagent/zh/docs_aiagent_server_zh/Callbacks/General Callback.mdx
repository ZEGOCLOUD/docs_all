...
| EventType | Number | 事件通知类型。<ul><li>101：语音对话结束。</li><li>204：回调 LLM 结果。</li><li>301：异常事件。</li></ul> |
...
| 参数   | 类型 | 描述                       |
|--------|------|----------------------------|
| Reason | Int  | 语音对话结束原因。<ul><li>1：调用了结束语音对话接口主动结束。</li><li>2：心跳超时，服务端结束会话。</li></ul> |
</Tab>
<Tab title="204">
| 参数 | 类型 | 描述 |
|------|------|------|
