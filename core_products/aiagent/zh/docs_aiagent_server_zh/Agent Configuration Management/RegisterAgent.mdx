...
| AgentConfig | Object | 否    | 自定义智能体参数，本参数结构，请见 [常用参数说明 - AgentConfig](./../Common%20Parameter%20Description.mdx#agentconfig)。若 `AgentTemplateId` 不为空，则在该模版基础上，根据本参数所传内容做修改。                  |
