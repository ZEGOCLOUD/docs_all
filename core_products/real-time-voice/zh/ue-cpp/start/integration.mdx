...
2. 选择 “第一人称游戏”，类型为 “C++”，选择项目路径，填写项目名称为 “first_person_game”，点击 “创建”。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Express/UE/ue_create_project.png" /></Frame>
...
1. 请参考 [下载 SDK 包](!DownloadSDK/DownloadSDK)，下载最新版本的 SDK，下载完成后进行解压。
...
3. 重新启动 Unreal Engine Editor，打开您的项目 “first_person_game”。编译完成后，选择菜单 “编辑 > 插件”，确保已勾选 “ZegoExpressSDKPlugin” 文件。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/Express/UE/ue_plugin_import_1.png" /></Frame>
