...
可参考 [快速开始 - 实现流程\|_blank](!Integration/Solution_Implementation#2_1) 的 “2.1 创建引擎” 和 “2.2 登录房间” 完成房间登录。
...
请参考 [快速开始 - 实现流程\|_blank](!Integration/Solution_Implementation#2_1) 中的的 “2.1 创建引擎” 和 “2.2 登录房间” 完成初始化和房间登录。
