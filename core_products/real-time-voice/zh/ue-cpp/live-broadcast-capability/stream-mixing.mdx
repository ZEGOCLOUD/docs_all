...
本篇文档主要介绍通过客户端发起混流的操作说明，如果你需要通过自己的服务端发起混流，请参考 [服务端 API - 开始混流](/zh/real-time-voice-video-server/mix-stream/start-mix)。
...
可参考 [快速开始 - 实现流程](!Integration/Solution_Implementation#2_1) 的 “创建引擎” 和 “登录房间” 完成房间登录。
...
请参考 [快速开始 - 实现流程](!Integration/Solution_Implementation#2_1) 中的的 “创建引擎” 和 “登录房间” 完成初始化和房间登录。
