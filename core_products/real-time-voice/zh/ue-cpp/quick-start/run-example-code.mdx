...
1. 下载的示例源码中缺少 SDK，需要先 [下载 SDK](/real-time-voice-ue/client-sdk/download-sdk)，并解压。

    请参考 [集成 SDK](/real-time-voice-ue/quick-start/integrating-sdk) 的 “导入 SDK”，将解压后的 SDK 包拷贝到工程的 “Plugins” 目录下，如下图所示：

    <Frame width="512" height="auto" caption=""><img src="https://doc-media.zego.im/sdk-doc/Pics/Express/UE/ue_copy_plugin.png" /></Frame>

2.  修改 “/Source/KeyCenter.cpp” 文件，填写 SDK 初始化所需的 “AppID” 和 “AppSign”。请使用本文 [前提条件](/real-time-voice-ue/quick-start/run-example-code) 已获取的 AppID 和 AppSign 正确填写，否则示例源码无法正常运行。
