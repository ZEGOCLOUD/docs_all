...
设置 [ZegoPlayerConfig](@-ZegoPlayerConfig) 的 “resourceMode” 参数为 “ZEGO_STREAM_RESOURCE_MODE_ONLY_L3”，调用 [startPlayingStream](@startPlayingStream) 接口，根据传入的流 ID 参数 “streamID”，拉取远端推送的低延迟直播流，即可实现超低延迟直播功能。
