...
ZEGO Express HarmonyOS SDK 当前为 `Beta` 公测阶段，使用前，请您仔细阅读 [已知问题及解决方案](!known_issues_and_solutions)。如果您有其他问题或业务需求，请联系 ZEGO 技术支持咨询。
...
<td>SDK 包体积</td>
<td>
<p>Express-Audio SDK 全功能安装包集成到 App 后，App 的增量大小如下：</p><ul><li>iOS（arm64）：6.22 MB</li><li>Android（arm64）：7.16 MB</li><li>Android（armv7）：6.47 MB</li><li>macOS（x86_64）：8.0 MB</li><li>Windows（x86）：7.1 MB</li><li>Windows（x86_64）：8.74 MB</li></ul>
