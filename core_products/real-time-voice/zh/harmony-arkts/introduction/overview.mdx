...
ZEGO Express HarmonyOS SDK 当前为 `Beta` 公测阶段，使用前，请您仔细阅读 [已知问题及解决方案](/real-time-voice-harmonyos/introduction/known-issues-and-solutions)。如果您有其他问题或业务需求，请联系 ZEGO 技术支持咨询。
