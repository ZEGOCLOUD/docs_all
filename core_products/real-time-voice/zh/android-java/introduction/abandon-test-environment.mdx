...
[SetUseTestEnv](https://doc-zh.zego.im/API/ServerRecord/html/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#a67f490d5db300dffbdfc0bfde4d88076) 即将废弃，请删除该接口的相关代码，还可参考下文 “常见问题” 中的 “如何做项目的数据隔离？”进行区分正式/测试环境。
