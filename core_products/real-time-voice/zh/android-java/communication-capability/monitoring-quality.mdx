...
| 方法 | 描述 |
|-------|--------|
| [onPublisherQualityUpdate](/zh/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-callback-i-zego-event-handler#on-publisher-quality-update) | 推流质量回调 |
| [onPlayerQualityUpdate](/zh/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-callback-i-zego-event-handler#on-player-quality-update) | 拉流质量更新回调 |
