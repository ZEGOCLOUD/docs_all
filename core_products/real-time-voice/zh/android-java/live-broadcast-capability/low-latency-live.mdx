...
设置 [ZegoPlayerConfig](/zh/api?doc=Express_Audio_SDK_API~Java_android~class~im-zego-zegoexpress-entity-zego-player-config) 的 “resourceMode” 参数为 “ONLY_L3”，调用 [startPlayingStream](/zh/api?doc=Express_Audio_SDK_API~Java_android~class~im-zego-zegoexpress-zego-express-engine#start-playing-stream) 接口，根据传入的流 ID 参数 “streamID”，拉取远端推送的低延迟直播流。
