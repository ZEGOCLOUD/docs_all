...
| 方法 | 描述 |
|-------|--------|
| [startMixerTask](/zh/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#start-mixer-task) | 开始混流任务 |
| [stopMixerTask](/zh/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#stop-mixer-task) | 停止混流任务 |
