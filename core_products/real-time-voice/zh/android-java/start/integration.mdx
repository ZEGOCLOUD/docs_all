...
1. 请参考 [下载](/real-time-video-android-java/download) 文档，下载最新版本的 SDK 并解压。
...
<Note title="说明">
    ...
    - 其他文件：供您在采用 [方式 3：复制 SDK JAR + SO 文件手动集成](/real-time-video-android-java/integration/sdk-integration#Integration_3) 使用。
