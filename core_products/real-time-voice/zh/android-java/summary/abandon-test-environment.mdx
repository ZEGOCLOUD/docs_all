...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-ios-oc/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-android-java/integration/sdk-integration)。
...
- 如果您使用的是 Objective-C：
    ...
    1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-macos/integration/sdk-integration)。
...
- 如果您使用的是 C++：
    ...
    1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-macos-cpp/integration/sdk-integration)。
...
- 如果您使用的是 C++：
    ...
    1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-windows/integration/sdk-integration)。
...
- 如果您使用的是 C#：
    ...
    1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-windows-cs/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-flutter/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-electron/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-u3d/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-uniapp/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-video-rn/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-ios-oc/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-android/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-macos/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-windows/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-flutter/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-electron/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-u3d/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时语音 - 下载 SDK](/real-time-voice-uniapp/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [实时音视频 - 下载 SDK](/real-time-voice-rn/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [低延迟直播 - 下载 SDK](/live-streaming-ios/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [低延迟直播 - 下载 SDK](/live-streaming-android/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [低延迟直播 - 下载 SDK](/live-streaming-macos/integration/sdk-integration)。
...
1. 已集成最新版本的 SDK，请参考 [低延迟直播 - 下载 SDK](/live-streaming-windows/integration/sdk-integration)。
...
- **2021-11-16** 及之前在 [ZEGO 控制台\|_blank](https://console.zego.im) 创建的项目，测试环境下本平台的功能是默认开启的，可直接使用，正式环境下本平台的功能不是默认开启的，如需使用按原有流程开通。
- **2021-11-16** 之后在 [ZEGO 控制台\|_blank](https://console.zego.im) 创建的项目，不再区分正式/测试环境，但是本平台的功能不是默认开启的，使用前请联系 ZEGO 技术支持开通。
...
1. 已集成最新版本的 SDK，请参考 [互动白板 - 下载 SDK](https://doc-zh.zego.im/4406)。
...
1. 已集成最新版本的 SDK，请参考 [互动白板 - 下载 SDK](https://doc-zh.zego.im/4405)。
...
1. 已集成最新版本的 SDK，请参考 [互动白板 - 下载 SDK](https://doc-zh.zego.im/6213)。
...
1. 已集成最新版本的 SDK，请参考 [互动白板 - 下载 SDK](https://doc-zh.zego.im/6435)。
...
1. 已集成最新版本的 SDK，请参考 [互动白板 - 下载 SDK](https://doc-zh.zego.im/6497)。
...
1. 已集成最新版本的 SDK，请参考 [文件共享 - 下载 SDK](https://doc-zh.zego.im/4408)。
...
1. 已集成最新版本的 SDK，请参考 [文件共享 - 下载 SDK](https://doc-zh.zego.im/4407)。
...
1. 已集成最新版本的 SDK，请参考 [文件共享 - 下载 SDK](https://doc-zh.zego.im/4424)。
...
1. 已集成最新版本的 SDK，请参考 [互动白板 - 下载 SDK](https://doc-zh.zego.im/6498)。
...
[SetUseTestEnv\|_blank](https://doc-zh.zego.im/API/ServerRecord/namespace_z_e_g_o_1_1_l_i_v_e_r_o_o_m.html#a67f490d5db300dffbdfc0bfde4d88076) 即将废弃，请删除该接口的相关代码，还可参考下文 “常见问题” 中的 “如何做项目的数据隔离？”进行区分正式/测试环境。
