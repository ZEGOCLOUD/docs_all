...
#### 2. 从此版本开始 Express 实时语音 Audio SDK 的 Gradle 仓库由 https://jitpack.io 变更为 https://storage.zego.im/maven，依赖的项目名称由 `com.github.zegolibrary:express-audio:x.y.z` 变更为 `im.zego:express-audio:x.y.z`，详情请查看 [集成 SDK\|_blank](#3575) 文档。
