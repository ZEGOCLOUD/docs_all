...
设置 [ZegoWebPlayOption\|_blank](@-ZegoWebPlayOption) 的 “resourceMode” 参数为 “2” 后，调用 [startPlayingStream\|_blank](@startPlayingStream) 接口，根据传入的流 ID 参数 “streamID”，拉取远端推送的低延迟直播流。
