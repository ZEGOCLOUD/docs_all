...
| 方法 | 描述 |
|-------|--------|
| [publishQualityUpdate](@publishQualityUpdate) | 推流质量回调 |
| [ZegoPublishVideoStats](@-ZegoPublishVideoStats) | 推流视频数据 |
| [ZegoPublishAudioStats](@-ZegoPublishAudioStats) | 推流音频数据 |
| [playQualityUpdate](@playQualityUpdate) | 拉流质量回调 |
| [ZegoPlayVideoStats](@-ZegoPlayVideoStats) | 拉流视频数据 |
| [ZegoPlayAudioStats](@-ZegoPlayAudioStats) | 拉流音频数据 |
