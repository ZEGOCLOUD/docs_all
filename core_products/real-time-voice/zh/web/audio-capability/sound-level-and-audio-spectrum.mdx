...
| 方法 | 描述 |
|-------|--------|
| [soundLevelUpdate\|_blank](@soundLevelUpdate)| 音浪更新回调 |
| [setSoundLevelDelegate\|_blank](/zh/api?doc=Express_Video_SDK_API~javascript_web_web~class~ZegoExpressEngine#set-sound-level-delegate)| 设置音浪回调 |
