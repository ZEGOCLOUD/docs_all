...
|-------|--------|--------|--------|
| 广播消息 | 向同一房间内所有用户发送文本消息，默认最多支持前 500 个加入房间的用户能收到该消息。 | 一般当直播房间人数小于 500 时发送该类消息。 | 请参考 [限制说明\|_blank](#15216)。 |
| 弹幕消息 | 观众在直播过程中可以发表自己的评论，并以滑动而过的字幕显示出来，增加了观众之间的互动性。 | 一般用于房间内有大量消息收发，且不需要保证消息可靠性的场景，例如直播弹幕。 | 请参考 [限制说明\|_blank](#15216)。 |
| 自定义信令 | 向同一房间内指定的单个或多个用户发送信令消息。 | 一般用于远程控制信令或向特定的用户发送消息，例如，在线娃娃机场景中，远程控制娃娃机夹子的移动。 | 请参考 [限制说明\|_blank](#15216)。 |
...
- 已在项目中集成 ZEGO Express SDK，实现基本的实时音视频功能，详情请参考 [快速开始 - 集成\|_blank](!Integration/SDK_Integration) 和 [快速开始 - 实现语音通话\|_blank](!Integration/Solution_Implementation)。
...
| 方法 | 描述 |
|-------|--------|
| [sendBroadcastMessage \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngineIM/sendBroadcastMessage.html) | 发送房间广播消息 |
| [ZegoIMSendBroadcastMessageResult \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoIMSendBroadcastMessageResult-class.html) | 发送房间广播消息的结果 |
| [onIMRecvBroadcastMessage \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngine/onIMRecvBroadcastMessage.html) | 接收房间广播消息通知 |
| [sendBarrageMessage \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngineIM/sendBarrageMessage.html) | 发送房间弹幕消息 |
| [ZegoIMSendBarrageMessageResult \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoIMSendBarrageMessageResult-class.html) | 发送房间弹幕消息的结果 |
| [onIMRecvBarrageMessage \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngine/onIMRecvBarrageMessage.html) | 接收房间弹幕消息通知 |
| [sendCustomCommand \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngineIM/sendCustomCommand.html) | 发送自定义信令 |
| [ZegoIMSendCustomCommandResult \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoIMSendCustomCommandResult-class.html) | 发送房间自定义信令的结果 |
| [onIMRecvCustomCommand \|_blank](/unique-api/express-video-sdk/zh/dart_flutter/zego_express_engine/ZegoExpressEngine/onIMRecvCustomCommand.html) | 接收自定义信令通知 |
