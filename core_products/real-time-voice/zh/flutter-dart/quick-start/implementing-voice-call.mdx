...
- 已在项目中集成 ZEGO Express SDK，实现基本的实时音视频功能，详情请参考 [快速开始 - 集成](/real-time-voice-flutter/quick-start/integrating-sdk)。
...
更多信息请参考文档 [实时音视频 SDK 与实时语音 SDK 的差异](/real-time-voice-flutter/introduction/difference-between-audio-and-video-sdk)。

若您对 Express Flutter SDK 包体大小有较高要求，可联系技术支持进行定制裁包，关于 SDK 包大小数据请参考 [概述](/real-time-voice-flutter/introduction/overview) 文档。
