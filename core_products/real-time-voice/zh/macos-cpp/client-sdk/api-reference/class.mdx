...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| command | std::string | 请求命令，具体支持的命令请参考 [/online-ktv-android/client-api/send-extended-request](/online-ktv-android/client-api/send-extended-request) |
| params | std::string | 请求参数，每个请求命令具备对应的请求参数，请参考 [/online-ktv-android/client-api/send-extended-request](/online-ktv-android/client-api/send-extended-request) |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| krcToken | std::string | 通过调用 [requestResource] 点伴奏或点高潮片段、或调用 [getSharedResource] 接口获取分享资源时获取的 krcToken。详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-word-by-word-lyrics](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-word-by-word-lyrics) |
