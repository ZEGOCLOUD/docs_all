...
4. 执行 `pod repo update` 命令更新本地索引，确保能安装最新版本的 SDK，最新版本号请参考 [下载 SDK 包 ](https://doc-zh.zego.im/article/3563) 中的发布历史。
...
1. 请参考 [下载 SDK 包](https://doc-zh.zego.im/article/3563)，下载最新版本的 SDK 并解压。
