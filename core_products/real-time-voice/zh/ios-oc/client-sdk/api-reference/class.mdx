...
| [ZegoCopyrightedMusicEventHandler](#zegocopyrightedmusiceventhandler) | [ZegoCopyrightedMusicGetLyricConfig](#zegocopyrightedmusicgetlyricconfig) |
...
| audioEffectID | unsigned int | 音效资源的 ID。 |
| callback | nullable [ZegoAudioEffectPlayerSeekToCallback](#zegoaudioeffectplayerseektocallback) | 指定播放进度结果。 |
...
| audioEffectID | unsigned int | 音效资源的 ID。 |
| callback | nullable [ZegoAudioEffectPlayerLoadResourceCallback](#zegoaudioeffectplayerloadresourcecallback) | 加载音效资源结果回调。 |
...
| callback | nullable [ZegoCopyrightedMusicInitCallback](#zegocopyrightedmusicinitcallback) | 初始化结果 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| command | NSString * | 请求命令，具体支持的命令请参考 [/online-ktv-android/client-api/send-extended-request](/online-ktv-android/client-api/send-extended-request) |
| params | NSString * | 请求参数，每个请求命令具备对应的请求参数，请参考 [/online-ktv-android/client-api/send-extended-request](/online-ktv-android/client-api/send-extended-request) |
| callback | nullable [ZegoCopyrightedMusicSendExtendedRequestCallback](#zegocopyrightedmusicsendextendedrequestcallback) | 发送扩展功能请求结果 |
...
| callback | nullable [ZegoCopyrightedMusicGetLrcLyricCallback](#zegocopyrightedmusicgetlrclyriccallback) | 获取 lrc 格式歌词结果 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| krcToken | NSString * | 通过调用 [requestResource] 点伴奏或点高潮片段、或调用 [getSharedResource] 接口获取分享资源时获取的 krcToken。详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-word-by-word-lyrics](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-word-by-word-lyrics) |
| callback | nullable [ZegoCopyrightedMusicGetKrcLyricByTokenCallback](#zegocopyrightedmusicgetkrclyricbytokencallback) | 获取逐字格式歌词结果。 |
...
| callback | nullable [ZegoCopyrightedMusicRequestResourceCallback](#zegocopyrightedmusicrequestresourcecallback) | 获取音乐资源结果回调。 |
...
| type | [ZegoCopyrightedMusicResourceType](./enum#zegocopyrightedmusicresourcetype) | 版权音乐资源类型。 |
| callback | nullable [ZegoCopyrightedMusicGetSharedResourceCallback](#zegocopyrightedmusicgetsharedresourcecallback) | 获取分享音乐资源结果回调。 |
...
| callback | nullable [ZegoCopyrightedMusicDownloadCallback](#zegocopyrightedmusicdownloadcallback) | 下载载歌曲或伴奏结果。 |
...
| --- | --- | --- |
| resourceID | NSString * | 伴奏或高潮片段对应的资源 ID。 |
| callback | nullable [ZegoCopyrightedMusicGetStandardPitchCallback](#zegocopyrightedmusicgetstandardpitchcallback) | 获取标准音高数据结果。 |
...
| callback | nullable [ZegoCopyrightedMusicRequestSongCallback](#zegocopyrightedmusicrequestsongcallback) | 点歌结果 |
...
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfig](#zegocopyrightedmusicrequestconfig) * | 请求配置。 |
| callback | nullable [ZegoCopyrightedMusicRequestAccompanimentCallback](#zegocopyrightedmusicrequestaccompanimentcallback) | 点伴奏结果。 |
...
| --- | --- | --- |
| config | [ZegoCopyrightedMusicRequestConfig](#zegocopyrightedmusicrequestconfig) * | 请求配置。 |
| callback | nullable [ZegoCopyrightedMusicRequestAccompanimentClipCallback](#zegocopyrightedmusicrequestaccompanimentclipcallback) | 点伴奏高潮片段结果。 |
...
| callback | nullable [ZegoCopyrightedMusicGetMusicByTokenCallback](#zegocopyrightedmusicgetmusicbytokencallback) | 获取歌曲或伴奏结果。 |
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| command | NSString * | 请求命令，具体支持的命令详见 [/online-ktv-android/client-api/send-extended-request](/online-ktv-android/client-api/send-extended-request) |
| result | NSString * | 请求结果，每个请求命令具备对应的请求结果，详细见 [/online-ktv-android/client-api/send-extended-request](/online-ktv-android/client-api/send-extended-request) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| lyrics | NSString * | lrc 格式歌词，专用于逐行格式歌词场景，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-line-by-line-lyrics](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-line-by-line-lyrics) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| lyrics | NSString * | 逐字歌词，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-word-by-word-lyrics](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-word-by-word-lyrics) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 点歌服务返回的 JSON 字符串，包含歌曲资源信息，详细请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-song-resource-with-vocal](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-song-resource-with-vocal) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 伴奏资源信息，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-song-accompaniment-resource](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-song-accompaniment-resource) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 伴奏长分片高潮片段资源信息，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-long-clip-chorus-resource](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-long-clip-chorus-resource) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 歌曲、伴奏或高潮片段资源信息，详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-short-clip-chorus-resource](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-short-clip-chorus-resource) |
</ParamField>
<ParamField
...
| --- | --- | --- |
| errorCode | int | 错误码，详情请参考 [常见错误码](https://doc-zh.zego.im/real-time-video-android-java/client-sdk/error-code) |
| resource | NSString * | 点歌服务返回的 JSON 字符串，包含歌曲资源信息，详细请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-short-clip-chorus-resource](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#get-short-clip-chorus-resource) |
</ParamField>
<ParamField
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable [ZegoDestroyCompletionCallback](#zegodestroycompletioncallback) | 销毁引擎完成的通知回调，可监听此回调以确保设备硬件资源(麦克风、扬声器、摄像头等)被释放完成，若开发者不关注引擎资源的释放时机，该参数可传[nil]。 |
...
| appSign | NSString * | 每个 AppID 对应的应用签名，请从 ZEGO 管理控制台申请。该参数为包含 64 个字符的字符串，字符取值范围：'0' ~ '9', 'a' ~ 'z'。例："9dc9a25bh2f2137446897071c8c033fa33b91c3dd2a85e0c000ae82c0dad3"。2.17.0 及以上版本 appSign 允许传空或者不传。如果传空或者不传，则必须在调用 [loginRoom] 接口登录房间时将 token 填入 [ZegoRoomConfig] 参数中，用于鉴权。token 的生成方式请参考 [使用 Token 鉴权](/real-time-video-android-java/communication/using-token-authentication) 。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable [ZegoUploadLogResultCallback](#zegouploadlogresultcallback) | 日志上传结果回调。 |
...
| user | [ZegoUser](#zegouser) * | 用户对象实例，配置用户 ID、用户名。 注意事项：注意用户 ID 需要在相同的 appID 下全局唯一，否则会出现后登录的用户踢掉先登录的用户的情况。 |
| config | [ZegoRoomConfig](#zegoroomconfig) * | 房间进阶配置。 |
| callback | [ZegoRoomLoginCallback](#zegoroomlogincallback) | 本次登录结果的回调，如果需要详细的房间状态，请关注 [onRoomStateChanged] 回调。是否必填：否。默认值：nil。注意事项：如果因为网络问题导致多次重试连接，重试状态将不会通过此回调抛出。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoRoomLogoutCallback](#zegoroomlogoutcallback) | 本次登出房间结果的回调，如果需要详细房间状态，请关注 [onRoomStateChagned] 回调。是否必填：否。默认值：nil。 |
...
| key | NSString * | 附加消息键。 |
| roomID | NSString * | 房间 ID。 |
| callback | nullable [ZegoRoomSetRoomExtraInfoCallback](#zegoroomsetroomextrainfocallback) | 设置房间附加消息结果回调。 |
...
| callback | nullable [ZegoPublisherSetStreamExtraInfoCallback](#zegopublishersetstreamextrainfocallback) | 更新流附加信息执行结果通知。 |
...
| extraInfo | NSString * | 流附加信息，长度不超过1024的字符串。 |
| channel | [ZegoPublishChannel](./enum#zegopublishchannel) | 推流通道。 |
| callback | nullable [ZegoPublisherSetStreamExtraInfoCallback](#zegopublishersetstreamextrainfocallback) | 设置流附加信息执行结果通知。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoPublisherTakeSnapshotCallback](#zegopublishertakesnapshotcallback) | 推流画面截图结果回调。 |
...
| callback | nullable [ZegoPublisherUpdateCdnUrlCallback](#zegopublisherupdatecdnurlcallback) | 更新 CDN 转推结果通知。 |
...
| codecID | [ZegoVideoCodecID](./enum#zegovideocodecid) | 视频编码类型。是否必填：是。 |
| codecBackend | [ZegoVideoCodecBackend](./enum#zegovideocodecbackend) | 编码器的后端实现。是否必填：是。 |
| callback | nullable [ZegoPublisherGetVideoEncoderSupportedCallback](#zegopublishergetvideoencodersupportedcallback) | 是否支持指定视频编码结果的回调。 |
...
| callback | [ZegoPlayerTakeSnapshotCallback](#zegoplayertakesnapshotcallback) | 拉流画面截图结果回调。 |
...
| codecID | [ZegoVideoCodecID](./enum#zegovideocodecid) | 视频解码类型。是否必填：是。 |
| codecBackend | [ZegoVideoCodecBackend](./enum#zegovideocodecbackend) | 解码器的后端实现。是否必填：是。 |
| callback | nullable [ZegoPlayerGetVideoDecoderSupportedCallback](#zegoplayergetvideodecodersupportedcallback) | 是否支持指定视频解码结果的回调。 |
...
| callback | nullable [ZegoMixerStartCallback](#zegomixerstartcallback) | 开始混流任务结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| --- | --- | --- |
| task | [ZegoMixerTask](#zegomixertask) * | 混流任务对象。是否必填：是。 |
| callback | nullable [ZegoMixerStopCallback](#zegomixerstopcallback) | 停止混流任务结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| callback | nullable [ZegoMixerStartCallback](#zegomixerstartcallback) | 开始自动混流任务结果通知 |
...
| --- | --- | --- |
| task | [ZegoAutoMixerTask](#zegoautomixertask) * | 自动混流任务对象 |
| callback | nullable [ZegoMixerStopCallback](#zegomixerstopcallback) | 停止自动混流任务结果通知 |
...
| --- | --- | --- |
| enable | BOOL | 是否开启音频采集设备；"true" 表示打开音频采集设备；"false" 表示关闭音频采集设备。 |
| callback | [ZegoAudioCaptureDeviceEnableCallback](#zegoaudiocapturedeviceenablecallback) | 开/关完成回调。 |
...
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoIMSendBroadcastMessageCallback](#zegoimsendbroadcastmessagecallback) | 发送广播消息结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| message | NSString * | 消息内容。是否必填：是。取值范围：长度不超过 1024 字节。 |
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoIMSendBarrageMessageCallback](#zegoimsendbarragemessagecallback) | 发送弹幕消息结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| toUserList | nullable NSArray\<[ZegoUser](#zegouser) *\> * | 信令的接收者列表。是否必填：是。取值范围：用户列表或者 [nil]。注意事项：为 [nil] 时 SDK 会向房间内所有用户发送自定义信令。 |
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoIMSendCustomCommandCallback](#zegoimsendcustomcommandcallback) | 发送信令结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| roomID | NSString * | 房间 ID，不得为空，最大长度小于 128 字节的字符串。<br/>  注意事项：<br/>  1.房间 ID 由您自己定义。<br/>  2. 仅支持数字，英文字符 和 '~', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '_', '+', '=', '-', '`', ';', '’', ',', '.', '&lt;', '&gt;', '\'。<br/>  3. 如果需要与 Web SDK 互通，请不要使用 '%'。 |
| callback | nullable [ZegoRoomSendTransparentMessageCallback](#zegoroomsendtransparentmessagecallback) | 发送信令结果通知。是否必填：否。注意事项：传 [nil] 则意味着不接收回调通知。 |
...
| callback | nullable [ZegoNetworkProbeResultCallback](#zegonetworkproberesultcallback) | 网络探测结果回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoTestNetworkConnectivityCallback](#zegotestnetworkconnectivitycallback) | 网络连通性测试结果通知 |
...
| callback | nullable [ZegoMediaPlayerLoadResourceCallback](#zegomediaplayerloadresourcecallback) | 资源加载结果的通知。 |
...
| --- | --- | --- |
| millisecond | unsigned long long | 指定的播放进度的时间点 |
| callback | nullable [ZegoMediaPlayerSeekToCallback](#zegomediaplayerseektocallback) | 设置指定的播放进度的结果通知 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | [ZegoMediaPlayerTakeSnapshotCallback](#zegomediaplayertakesnapshotcallback) | 媒体播放器播放画面截图的回调 |
...
| callback | nullable [ZegoRangeSceneLoginSceneCallback](#zegorangesceneloginscenecallback) | 登录场景结果回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable [ZegoRangeSceneLogoutSceneCallback](#zegorangescenelogoutscenecallback) | 退出场景结果回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable [ZegoRangeSceneGetUserCountCallback](#zegorangescenegetusercountcallback) | 获取场景内总人数结果回调。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| callback | nullable [ZegoRangeSceneGetUserListInViewCallback](#zegorangescenegetuserlistinviewcallback) | 获取范围内用户列表结果回调。 |
...
| callback | nullable [ZegoRangeSceneSendCustomCommandCallback](#zegorangescenesendcustomcommandcallback) | 发送用户自定义信令结果回调。 |
...
| callback | nullable [ZegoRangeSceneCreateItemCallback](#zegorangescenecreateitemcallback) | 创建物品结果回调。 |
...
| --- | --- | --- |
| itemID | long long | 物品 ID。 |
| callback | nullable [ZegoRangeSceneDestroyItemCallback](#zegorangescenedestroyitemcallback) | 销毁物品结果回调。 |
...
| --- | --- | --- |
| itemID | long long | 物品 ID。 |
| callback | nullable [ZegoRangeSceneBindItemCallback](#zegorangescenebinditemcallback) | 申请绑定物品结果回调。 |
...
| --- | --- | --- |
| itemID | long long | 物品 ID。 |
| callback | nullable [ZegoRangeSceneUnbindItemCallback](#zegorangesceneunbinditemcallback) | 销毁物品结果回调。 |
...
| callback | nullable [ZegoRangeSceneUpdateItemStatusCallback](#zegorangesceneupdateitemstatuscallback) | 更新物品状态结果回调。 |
...
| callback | nullable [ZegoRangeSceneUpdateItemCommandCallback](#zegorangesceneupdateitemcommandcallback) | 更新物品下一步命令结果回调。 |
...
| callback | nullable [ZegoRangeSceneJoinTeamCallback](#zegorangescenejointeamcallback) | 加入小队结果回调。 |
...
| --- | --- | --- |
| teamID | unsigned int | 小队 ID。 |
| callback | nullable [ZegoRangeSceneLeaveTeamCallback](#zegorangesceneleaveteamcallback) | 离开小队结果回调。 |
...
| callback | nullable [ZegoRealTimeSequentialDataSentCallback](#zegorealtimesequentialdatasentcallback) | 发送实时有序数据结果通知。 |
...
| config | [ZegoScreenCaptureAudioConfig](#zegoscreencaptureaudioconfig) * | 音频采集参数。 |
