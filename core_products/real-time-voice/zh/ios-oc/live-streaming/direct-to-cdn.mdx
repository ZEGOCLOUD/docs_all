...
请参考 [快速开始 - 实现流程](../quick-start/implementing-voice-call.mdx#使用步骤) 的 “创建引擎” 和 “登录房间”。
...
- 接口原型
   ...
   /// 推流状态回调
    ...
    ///
    /// @param state 推流状态
    /// @param errorCode 推流状态变更对应的错误码。请参考常见错误码文档 [https://doc-zh.zego.im/article/4377.html]
...
- 当开发者使用 ZEGO 配置的 CDN 进行直推时，可以直接通过 streamID 进行拉流，请参考 [快速开始 - 实现流程](../quick-start/implementing-voice-call.mdx#拉流) 的 “拉流”。
- 当开发者使用第三方 CDN 进行直推时，则可以通过 URL 进行拉流，请参考 [推拉流进阶 - 通过 URL 拉流 ](./playing-stream-by-url.mdx)。
