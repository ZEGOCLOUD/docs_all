...
**2. 从此版本开始 Express 实时语音 Audio SDK 的 CocoaPods 的项目名称由 `ZegoExpressEngine/Audio` 变更为 `ZegoExpressAudio`，详情请查看 [集成 SDK](/real-time-video-ios-oc/start/integration) 文档。**
