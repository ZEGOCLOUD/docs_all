...
| 方法 | 描述 |
|-------|--------|
| [enableAudioDataCallback ](/zh/api?doc=express_video_sdk_API~ObjectiveC_ios~class~zego-express-engine#enable-audio-data-callback-callback-bit-mask-param) | 开启获取原始音频数据功能 |
| [setAudioDataHandler ](/zh/api?doc=express_video_sdk_API~ObjectiveC_ios~class~zego-express-engine#set-audio-data-handler) | 设置原始音频数据回调 |
