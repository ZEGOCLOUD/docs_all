...
import Content from '/core_products/real-time-voice/zh/snippets/overview-pre.mdx'
...
<tr>
<td>Linux</td>
<td>任意具有 GLIBC 2.17 或以上版本的 Linux 发行版系统</td>
<td>
<ul>
...
</li><li>Windows 7 或以上版本（注意：目前 SDK 在 Windows 上仅支持音频功能，暂不支持视频功能）</li><li>Web： Chrome 58 或以上版本、Firefox 56 或以上版本、Safari 11 或以上版本、Opera 45 或以上版本、QQ 浏览器 Windows 10.1 或以上版本/macOS 4.4 或以上版本、360 安全浏览器极速模式</li><li>HarmonyOS 5.0 或以上版本 <Warning title="注意">需要支持鸿蒙平台的 Flutter SDK ，请联系 ZEGO 技术支持。</Warning></li></ul></td>
<td>-</td>
</tr>
<tr>
<td>Electron</td>
