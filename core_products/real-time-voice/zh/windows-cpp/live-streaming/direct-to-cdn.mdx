...
- 接口原型
     ...
     * @param state 推流状态
     * @param errorCode 推流状态变更对应的错误码。请参考常见错误码文档 [https://doc-zh.zego.im/article/4380.html]
...
| 方法 | 描述 |
|-------|--------|
| [enablePublishDirectToCDN ](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~CPP~class~zego-express-i-zego-express-engine) | 使能直推 CDN |
| [startPublishingStream ](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~CPP~class~zego-express-i-zego-express-engine) | 开始推流 |
| [stopPublishingStream ](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~CPP~class~zego-express-i-zego-express-engine) | 停止推流 |
