...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| krcToken | std::string | 通过调用 [requestResource] 点伴奏或点高潮片段、或调用 [getSharedResource] 接口获取分享资源时获取的 krcToken。详情请参考 [/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#获取逐字歌词](/online-ktv-ios/client-api/apis-to-obtain-songs-and-lyrics#获取逐字歌词) |
