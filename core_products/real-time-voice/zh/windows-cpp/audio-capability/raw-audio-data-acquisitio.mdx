...
| 方法 | 描述 |
|-------|--------|
| [enableAudioDataCallback ](/zh/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#enable-audio-data-callback) | 开启获取原始音频数据功能 |
| [setAudioDataHandler ](/zh/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-audio-data-handler) | 设置原始音频数据回调 |
