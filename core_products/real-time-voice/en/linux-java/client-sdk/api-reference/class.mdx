...
| --- | --- | --- |
| mediaPlayer | [ZegoMediaPlayer](#zegomediaplayer) | Callback player object. |
| spectrumList | float[] | Locally captured frequency spectrum value list. Spectrum value range is [0-2^31]. |
...
<ParamField
  ...
  parent_type="class">
User ID, a utf8 string with a maximum length of 64 bytes or less.
<Note title="">
