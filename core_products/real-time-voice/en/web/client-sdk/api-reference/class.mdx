...
Error code, please refer to the common error code document for details. https://www.zegocloud.com/docs/real-time-video-web/client-sdk/error-code
</ParamField>
<ParamField
  name="on"
...
| Name | Type | Description |
| --- | --- | --- |
| command | string | Request commands. For specific supported commands, please refer to https://www.zegocloud.com/docs/online-ktv-web/client-api/send-extended-request. |
| params | any | Request parameters, each request command has corresponding request parameters, please refer to https://www.zegocloud.com/docs/online-ktv-web/client-api/send-extended-request. |
...
| Name | Type | Description |
| --- | --- | --- |
| krcToken | string | Get the krcToken obtained from the music resource [requestResource]. For details, please refer to the lyrics resource interface description https://www.zegocloud.com/docs/online-ktv-electron/client-api/apis-to-obtain-songs-and-lyrics#2_2. |
...
<Warning title="Deprecated">Deprecated since 3.0.0, please refer to [Upgrade guide v3.0.0+](https://www.zegocloud.com/docs/real-time-video-web/introduction/overview).</Warning>
...
- **Default value**: None
 ...
 Usage restriction: For the usage restriction of this interface, please refer to https://www.zegocloud.com/docs/real-time-video-web/introduction/overview or contact ZEGO technical support.
