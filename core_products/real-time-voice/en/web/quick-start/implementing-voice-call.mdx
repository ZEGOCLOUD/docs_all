...
Before implementing publishing and playing functionality, developers can call the [checkSystemRequirements](https://www.zegocloud.com/article/api?doc=Express_Audio_SDK_API~javascript_web~class~ZegoExpressEngine#check-system-requirements) interface to check browser compatibility.
...
- [camera](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~javascript_web~interface~ZegoStreamOptions#camera): Camera and microphone capture stream related configuration

- [screen](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~javascript_web~interface~ZegoStreamOptions#screen): Screen capture stream related configuration

- [custom](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~javascript_web~interface~ZegoStreamOptions#custom): Third-party stream capture related configuration
</Accordion>
