...
- A project has been created in the [ZEGOCLOUD Console](https://console.zegocloud.com/) and a valid AppID and AppSign have been obtained. 
...
Call the [setVoiceChangerPreset ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-voice-changer-preset) method to use SDK preset voice changer effects.
...
If the SDK preset voice changer effects cannot meet your needs, developers can call the [ZegoVoiceChangerParam ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_macos~struct~zego-express-zego-voice-changer-param) method to set custom voice changer through the pitch parameter `pitch`. The value range of this parameter is [-8.0, 8.0]. The larger the value, the sharper the sound. The default value is 0.0 (i.e., no voice changer).
...
Call [setReverbPreset ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-reverb-preset) to set reverb through preset enumerations.
...
If the SDK preset reverb types cannot meet your needs, developers can call the [ZegoReverbAdvancedParam ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~struct~zego-express-zego-reverb-advanced-param) method and combine settings through related parameters to achieve the reverb effects developers need (for detailed parameter descriptions, please refer to the API documentation).
...
After setting custom reverb parameters, the preset reverb effects set when enabling reverb will become invalid. If you want to use SDK preset parameters again, you can use the [setReverbPreset ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-reverb-preset) preset enumeration method from version 4.2.1 to set.
...
Call the [setReverbEchoParam ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-reverb-echo-param) method and combine settings through related parameters to achieve the reverb echo effects developers need (for detailed parameter descriptions, please refer to the API documentation).
...
If you need to enable virtual stereo functionality, you must first call the [setAudioConfig ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP~class~zego-express-i-zego-express-engine&jumpType=route#set-audio-config) method before publishing to set the audio encoding channel to Stereo dual channel (default is Mono single channel).

The following example sets it to dual channel through preset enumeration to construct [ZegoAudioConfig ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP~struct~zego-express-zego-audio-config):
...
After setting the audio encoding channel to dual channel, call the [enableVirtualStereo ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP~class~zego-express-i-zego-express-engine&jumpType=route#enable-virtual-stereo) method, use the enable parameter to enable virtual stereo, and set the virtual stereo sound source angle through the angle parameter to achieve stereo effects. The angle range is 0~180. Generally, it can be set to 90 degrees (i.e., directly in front).
...
| Method                                                         | Description           |
| ------------------------------------------------------------ | -------------- |
| [setVoiceChangerPreset ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-voice-changer-preset) | Set voice changer through preset enumeration   |
| [ZegoVoiceChangerParam ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_macos~struct~zego-express-zego-voice-changer-param) | Voice changer parameter |
| [setReverbPreset ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-reverb-preset) | Set reverb through preset enumeration  |
| [ZegoReverbAdvancedParam ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~struct~zego-express-zego-reverb-advanced-param) | Audio reverb advanced parameters  |
| [setReverbEchoParam ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP_windows~class~zego-express-i-zego-express-engine#set-reverb-echo-param) | Set reverb echo effect |
| [setAudioConfig ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP~class~zego-express-i-zego-express-engine&jumpType=route#set-audio-config) | Set audio configuration   |
| [enableVirtualStereo ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~CPP~class~zego-express-i-zego-express-engine&jumpType=route#enable-virtual-stereo) | Set virtual stereo |
