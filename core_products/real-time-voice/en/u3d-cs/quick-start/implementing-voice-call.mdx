...
<Note title="Note">
If you need to know about Express microphone/audio/speaker related interfaces, please refer to [FAQ - How to implement camera/video screen/microphone/audio/speaker on/off?](https://www.zegocloud.com/docs/faq/device-switching).
</Note>
