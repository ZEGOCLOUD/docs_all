...
| Name | Type | Description |
| --- | --- | --- |
| audioSpectrums | Map\<string, number[]\> | Remote audio spectrum hash map, key is the streamID, value is the audio spectrum list of the corresponding streamID. Spectrum value range is [0-2^31] |
