...
| Method | Description |
|-------|--------|
| [onPublisherQualityUpdate](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~ObjectiveC~protocol~zego-event-handler#on-publisher-quality-update-stream-id) | Publish stream quality callback |
