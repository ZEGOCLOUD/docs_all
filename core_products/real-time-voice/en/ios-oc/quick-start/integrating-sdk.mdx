...
1. Install CocoaPods. For common installation issues, please refer to [CocoaPods FAQ - Installing CocoaPods](/faq/cocoapods-issues).
...
<Note title="Note">
    - If the "CDN: trunk URL couldn't be downloaded" issue occurs, please refer to [CocoaPods FAQ - Connection to trunk CDN issue](/faq/cocoapods-issues).
    - If the "Unable to find a specification for 'ZegoExpressEngine'" issue occurs, please refer to [CocoaPods FAQ - Unable to find project issue](/faq/cocoapods-issues).
    - If the "CocoaPods could not find compatible versions for pod "ZegoExpressEngine"" issue occurs, please refer to [CocoaPods FAQ - Unable to find project issue](/faq/cocoapods-issues).
</Note>
</Accordion>
