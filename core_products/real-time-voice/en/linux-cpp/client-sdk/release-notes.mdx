...
5. The audio player supports separate settings for streaming volume and local volume.
...
3. Support for getting audio device list.
...
4. Added support for audio files in AAC encoding format in Media Streamer.
...
2. Scenario-based audio and video configuration adds [StandardVoiceCall] standard voice call scenario.
...
2. Supports linearly increasing volume gain.
...
3. Supports automatic censorship of audio and video at the stream level.
...
2. New room real-time message function.
