...
- ZEGO Express SDK has been integrated in the project to implement basic Voice Call functions. For details, please refer to [Quick Start - Integration](/real-time-voice-android/quick-start/integrating-sdk) and [Quick Start - Implementation](/real-time-voice-android/quick-start/implementing-voice-call).
- A project has been created on [ZEGOCLOUD Console](https://console.zegocloud.com), and a valid AppID and AppSign have been applied for. 
...
| Method | Description |
|-------|--------|
| [enableAudioMixing ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#enable-audio-mixing) | Enable/Disable audio mixing |
| [setAudioMixingHandler ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#set-audio-mixing-handler) | Set audio mixing callback |
| [setAudioMixingVolume ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#set-audio-mixing-volume) | Set audio mixing volume |
| [muteLocalAudioMixing ](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-zego-express-engine#mute-local-audio-mixing) | Mute audio mixing local playback |
