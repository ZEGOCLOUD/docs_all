...
| Method | Description |
|-------|--------|
| [onPublisherQualityUpdate](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-callback-i-zego-event-handler#on-publisher-quality-update) | Publish stream quality callback |
| [onPlayerQualityUpdate](https://www.zegocloud.com/article/api?doc=Express_Video_SDK_API~Java~class~im-zego-zegoexpress-callback-i-zego-event-handler#on-player-quality-update) | Play stream quality update callback |
