...
<Warning title="注意">
本方案是基于 ZegoExpressSDK 和 ZIM SDK 从而实现抢唱功能，如果开发者选择自行集成相关 SDK 到项目，请查看 [Express SDK 集成](./../../quick-starts/integrate-the-sdk/express-video.mdx) 和 [即时通讯 - 实现基本消息收发](https://doc-zh.zego.im/zim-android/send-and-receive-messages)。
</Warning>
...
ZEGO 针对抢唱玩法提供了 [体验 App 源码](./../../quick-starts/run-the-demo-app-source-code/grab-the-mic.mdx)，以供开发者进一步了解 ZEGO 在线 KTV 抢唱方案。 
