...
2. 同步演唱者进度信息
    ...
    观众通过 [onPlayerRecvSEI](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~java_android~class~IZegoEventHandler#on-player-recv-sei) 回调收到 SEI 信息，获取进度信息，用于歌词同步。
