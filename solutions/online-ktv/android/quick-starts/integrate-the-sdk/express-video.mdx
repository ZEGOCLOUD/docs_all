...
2. 进入 “app” 目录，打开 “build.gradle” 文件，在 “dependencies” 中添加 `implementation 'im.zego:express-private:3.23.0.47735'`。

    ```groovy title="app/build.gradle"
    ...
    dependencies {
        ...
        implementation 'im.zego:express-private:3.23.0.47735'
    }
    ```
</Tab>
