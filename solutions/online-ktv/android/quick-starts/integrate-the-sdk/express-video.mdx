...
1. 打开 Android Studio，选择 “File > New > New Project” 菜单。
    ...
    <Frame width="512" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/android_new_project.png" alt="android_new_project.png"/></Frame>

2. 填写项目名及项目存储路径。

    <Frame width="512" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/android_new_project_finish.png" alt="android_new_project_finish.png"/></Frame>
...
2. 进入 “app” 目录，打开 “build.gradle” 文件，在 “dependencies” 中添加 `implementation 'im.zego:express-private:3.21.0.44963'`。

    ```groovy title="app/build.gradle"
    ...
    dependencies {
        ...
        implementation 'im.zego:express-private:3.21.0.44963'
    }
    ```
</Tab>
<Tab title="复制 SDK 文件手动集成">
1. 请参考 [下载](./../../downloads.mdx) ，下载最新版本的 SDK。

2. 解压 SDK 至项目目录，如 “app/libs”。

    <Frame width="512" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/ktv/plugin/android_video.png" alt="android_video.png"/></Frame>
...
3. 添加 SDK 引用，进入 “app” 目录，打开 “build.gradle” 文件。
    ...
    <Steps>
        <Step title="在 “defaultConfig” 节点添加 “ndk” 节点，指定支持的架构。">
            <Frame width="512" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/add_ndk_node.png" alt="add_ndk_node.png"/></Frame>
        ...
        <Step title="在 “android” 节点添加 “sourceSets” 节点，指定 “libs” 所在目录。">
            ...
            <Frame width="512" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/Android/ExpressSDK/Integration/add_sourceSets_node.png" alt="add_sourceSets_node.png"/></Frame>
