...
1. 进入项目根目录，打开 “settings.gradle” 文件，在 “dependencyResolutionManagement” 中加入如下代码。
    ...
    ```
2. 进入 “app” 目录，打开 “build.gradle” 文件，在 “dependencies” 中添加 `implementation 'im.zego:express-private:3.24.1.49825'`。

    ```groovy title="build.gradle"
    ...
    dependencies {
        ...
        implementation 'im.zego:express-private:3.24.1.49825'
    }
    ```
</Tab>
