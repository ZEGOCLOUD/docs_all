...
<Card title="示例源码" href="https://artifact-demo.zego.im/solutions/online-ktv/android/quick-starts/run-the-demo-app-source-code/GoSingTogether_Android_Sourcecode.zip" >使用 AppSign 鉴权</Card>
<Card title="示例源码" href="https://artifact-demo.zego.im/solutions/online-ktv/android/quick-starts/run-the-demo-app-source-code/GoSingTogether_Android_Sourcecode_Token.zip" >使用 Token 鉴权</Card>
