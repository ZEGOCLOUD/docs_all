...
<Card title="示例源码" href="https://artifact-demo.zego.im/solutions/online-ktv/ios/quick-starts/run-the-demo-app-source-code/GoSingTogether_iOS_Sourcecode.zip" target="_blank">本地下载</Card>
