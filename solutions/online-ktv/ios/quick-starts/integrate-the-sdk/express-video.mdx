...
3. 打开 Podfile 文件，在 “target” 下添加 `pod 'ZegoExpressPrivate', '3.23.1.47922'`，需要将 “MyProject” 替换为开发者的 Target 名称。

    ```ruby
    target 'MyProject' do
        use_frameworks!
        # 请填写具体的 SDK 版本号
        pod 'ZegoExpressPrivate', '3.23.1.47922'
    end
    ```
...
4. 执行 `pod install` 命令安装 SDK。
    ...
    <Note title="说明">
    - 若出现 “CDN: trunk URL couldn't be downloaded” 问题，请参考 [CocoaPods 常见问题 - 连接不上 trunk CDN 的问题](https://doc-zh.zego.im/faq/cocoapods-issues#2)。
    - 若出现 “Unable to find a specification for 'ZegoExpressEngine'” 问题，请参考 [CocoaPods 常见问题 - 无法找到项目的问题](https://doc-zh.zego.im/faq/cocoapods-issues#3)。
    - 若出现 “CocoaPods could not find compatible versions for pod "ZegoExpressEngine"” 问题，请参考 [CocoaPods 常见问题 - 无法找到项目的问题](https://doc-zh.zego.im/faq/cocoapods-issues#3)。
    </Note>
</Tab>
<Tab title="复制 SDK 文件手动集成">

1. 请参考 [下载](./../../downloads.mdx)，下载最新版本的 SDK 并解压。
...
- [如何减少集成 Native SDK 的 App 体积？](https://doc-zh.zego.im/faq/reduce-app-size)
- [在 Xcode 12.3 及之后版本中使用 iOS 模拟器构建项目为什么会失败？](https://doc-zh.zego.im/faq/xcode-12-3-simulator-issue)
- [从 2.8.0 之前的版本升级以后，Xcode 编译报错如何处理？](https://doc-zh.zego.im/faq/express-xcframework-upgrade)
- [打包 iOS 时 Xcode 报错提示 Bitcode 版本不兼容？](https://doc-zh.zego.im/faq/ios-bitcode-compatibility-issue)
