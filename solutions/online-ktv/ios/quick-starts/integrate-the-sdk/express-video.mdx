...
3. 打开 Podfile 文件，在 “target” 下添加 `pod 'ZegoExpressPrivate', '3.21.0.44963'`，需要将 “MyProject” 替换为开发者的 Target 名称。

    ```ruby
    target 'MyProject' do
        use_frameworks!
        # 请填写具体的 SDK 版本号
        pod 'ZegoExpressPrivate', '3.21.0.44963'
    end
    ```
...
4. 选择 “TARGETS > General > Frameworks,Libraries,and Embedded Content” 菜单，添加 “ZegoExpressEngine.xcframework” 和 “ZegoExpressVideoCopyrightedMusicPlugin.xcframework”，将 “Embed” 设置为 “Embed & Sign”。
    <Frame width="512" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/ktv/plugin/ios_video.png" /></Frame>
</Tab>
</Tabs>
