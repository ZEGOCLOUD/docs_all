...
针对评分功能，ZEGO 提供了评分 UI 组件（ZegoPitchView）支持显示音高线和评分效果，具体请参考 [ZEGO 内容中心 - 评分组件](./../zego-content-center/scoring-component.mdx)。如果您想要了解 SDK 接口逻辑，请参考 [ZEGO 内容中心 - 进阶功能](./../zego-content-center/advanced-features.mdx) 中的 “获取演唱分数”。
