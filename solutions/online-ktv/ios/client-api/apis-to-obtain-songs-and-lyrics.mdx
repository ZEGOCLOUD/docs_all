...
### 获取包含人声的歌曲资源 <a id="get-song-resource-with-vocal" />
...
copyrightedMusic?.requestResource(config, resourceType).then((ZegoCopyrightedMusicRequestResourceResult result) {
    // result.errorCode: 错误码，详细请参考错误码文档 https://doc-zh.zego.im/real-time-video-flutter/client-sdk/error-code
...
### 获取歌曲伴奏资源 <a id="get-song-accompaniment-resource" />
...
### 获取长分片高潮片段资源 <a id="get-long-clip-chorus-resource" />
...
### 获取短分片高潮片段资源 <a id="get-short-clip-chorus-resource" />
...
### 获取逐行歌词 <a id="get-line-by-line-lyrics" />
...
```
### 获取逐字歌词 <a id="get-word-by-word-lyrics" />
