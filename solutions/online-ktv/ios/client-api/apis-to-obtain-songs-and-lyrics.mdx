...
其中，[获取歌曲伴奏资源](./apis-to-obtain-songs-and-lyrics.mdx#获取歌曲伴奏资源)、[获取长分片高潮片段资源](./apis-to-obtain-songs-and-lyrics.mdx#获取长分片高潮片段资源)、[获取短分片高潮片段资源](./apis-to-obtain-songs-and-lyrics.mdx#获取短分片高潮片段资源) 可获取的资源片段，区别如下：
...
copyrightedMusic?.getLrcLyric(songID, vendorID: vendorID).then((ZegoCopyrightedMusicGetLrcLyricResult result) {
    // result.errorCode: 错误码，详细请参考错误码文档https://doc-zh.zego.im/article/4378。
