...
A由于客户端拉流建立链接需要短暂时间，因此为了保证拉流端的歌曲聆听体验，在某些状态会提前进行推流（状态 [round_preparing](./implementation/ktv-solutions/grab-the-mic.mdx#2-状态准备本轮游戏)、[next_song_preparing](./implementation/ktv-solutions/grab-the-mic.mdx#8-状态下一首)）；拉流同理。
</Accordion>
