...
| 功能项 | 功能描述 | 相关文档|
| -- | -- | -- |
|版权音乐支持 Web 平台 | 支持开发者使用 Express Unity3D SDK 开发 Web KTV 应用。 | [集成 SDK](https://doc-zh.zego.im/article/3234) |
...
<td><ul><li><a href="https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~cs_unity3d~class~ZegoCopyrightedMusic#send-extended-request">SendExtendedRequest</a></li><li><a href="./../Client%20API/Send%20Extended%20Request.mdx">发送扩展请求接口说明</a></li><li><a href="/online-ktv-server/query-song-plus">搜索多版权方的歌曲</a></li></ul></td>
</tr>
<tr>
<td>扩展获取到的歌曲资源信息</td>
...
<td><ul><li><a href="https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~cs_unity3d~class~ZegoCopyrightedMusic#send-extended-request">SendExtendedRequest</a></li><li><a href="./../Client%20API/Send%20Extended%20Request.mdx">发送扩展请求接口说明</a></li></ul></td>
</tr>
</tbody></table>
