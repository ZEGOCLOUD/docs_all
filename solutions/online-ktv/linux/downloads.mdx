...
- 本页面提供的 SDK 是基于 Express SDK。
    ...
    - 如需了解 Express SDK 版本变更详情，请参考 [实时音视频 - 发布日志](/real-time-video-linux-cpp/client-sdk/release-notes)、[实时语音 - 发布日志](https://doc-zh.zego.im/real-time-voice-linux/client-sdk/release-notes)。
