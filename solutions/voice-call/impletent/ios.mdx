...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/iOS/Applications-InstantAudio/5-InstantAudio-Implementation/flow.png" /></Frame>
...
具体可参考 [快速开始 - 实现流程](7631#2_1) 的 “2.1 创建引擎”。
...
具体可参考 [快速开始 - 实现流程](7631#2_2) 的 “2.2 登录房间”。
...
具体可参考 [快速开始 - 实现流程](7631#2_3) 的 “2.3 推流”。
...
具体可参考 [快速开始 - 实现流程](7631#2_4) 的 “2.4 拉流”。
