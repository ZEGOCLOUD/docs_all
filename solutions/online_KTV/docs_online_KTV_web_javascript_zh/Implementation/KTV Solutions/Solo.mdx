...
观众端也可以通过 [getSharedResource](@getSharedResource) 接口，传入演唱者端通过 [sendExtendedRequest](@sendExtendedRequest) 接口请求资源时获取到的 songID（请参考 [点歌](#点歌)），获取对应的歌词信息，详情请参考 [进阶功能 - 分享歌曲](./../../ZEGO%20Content%20Center/Advanced%20Features.mdx#分享歌曲)。
