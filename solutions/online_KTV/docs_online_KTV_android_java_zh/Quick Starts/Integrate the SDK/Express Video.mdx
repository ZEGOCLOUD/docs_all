...
2. 进入 “app” 目录，打开 “build.gradle” 文件，在 “dependencies” 中添加 `implementation 'im.zego:express-private:3.20.2.43680'`。

    ```groovy
    ...
    dependencies {
        ...
        implementation 'im.zego:express-private:3.20.2.43680'
    }
    ```

#### 方式二：复制 SDK 文件手动集成

1. 请参考 [下载\|_blank](!online_ktv_download) ，下载最新版本的 SDK。

2. 解压 SDK 至项目目录，如 “app/libs”。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ktv/plugin/android_video.png" /></Frame>

    <Note title="Note">

    "ZegoExpressEngine-sources.jar" 是源码包，可在 Android Studio 导入以获得更好的开发体验。

    具体可参考 [Express Android SDK 如何查看 API 注释和文档？\|_blank](/faq/express_android_java_api_doc?product=All&platform=android)
