...
2. 进入 “app” 目录，打开 “build.gradle” 文件，在 “dependencies” 中添加 `implementation 'im.zego:express-private:3.20.2.43681'`。

    ```groovy
    ...
    dependencies {
        ...
        implementation 'im.zego:express-private:3.20.2.43681'
    }
    ```

#### 方式二：复制 SDK 文件手动集成

1. 请参考 [下载 SDK 包\|_blank](#3564) ，下载最新版本的 SDK。
2. 解压 SDK 至项目目录，如 “app/libs”。

    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ktv/plugin/android_audio.jpeg" /></Frame>
