...
<details class="zg-primary">
    <summary>2. 为什么体验 App 中有些麦位的网络图标时有时无？</summary>
...
<details class="zg-primary">
    <summary>3. 歌曲的 segment_begin, segment_end, prelude_duration 这三者的关系？</summary>
...
![/Pics/GoEnjoy/KTVGrab/Common/grab_song_clip_rsc_exp.png](https://storage.zego.im/sdk-doc/Pics/GoEnjoy/KTVGrab/Common/grab_song_clip_rsc_exp.png)

</details>

<details class="zg-primary">
    <summary>4. 如何将麦克风人声和播放器进行混流？</summary>
...
```
更多详情可参考 ZegoExpressSDK API 文档的 [enableAux\|_blank](https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~java_android~class~ZegoMediaPlayer#enable-aux) 接口。
</details>

<details class="zg-primary">
    <summary>5. 为什么有些情况需要提前推流？</summary>

由于客户端拉流建立链接需要短暂时间，因此为了保证拉流端的歌曲聆听体验，在某些状态会提前进行推流（状态 [round_preparing\|_blank](15332#6_2)、[next_song_preparing\|_blank](15332#6_8)）。
