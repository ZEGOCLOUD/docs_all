...
<Frame width="auto" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/GoEnjoy/Grab/iOS/run_example/xcode14.jpg" /></Frame>

请如下图所示，分别选中所有蓝色的资源 bundle 图标（GoIMChat-GoIMChatRosource、GoKit-GoKit、KTVGrab-KTVGrabResource），然后在 "Team" 中选中并设置您的开发者账户。
<Frame width="auto" height="auto" ><img src="https://storage.zego.im/sdk-doc/Pics/GoEnjoy/Grab/iOS/run_example/faq_xcode14.jpg" /></Frame>
