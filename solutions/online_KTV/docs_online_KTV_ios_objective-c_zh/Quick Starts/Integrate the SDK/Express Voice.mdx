...
3. 打开 Podfile 文件，在 “target” 下添加 `pod 'ZegoExpressPrivate', '3.20.2.43681'`，需要将 “MyProject” 替换为开发者的 Target 名称。
    ...
    target 'MyProject' do
        use_frameworks!
        # 请填写具体的 SDK 版本号
        pod 'ZegoExpressPrivate', '3.20.2.43681'
    end
    ```
...
4. 选择 “TARGETS > General > Frameworks,Libraries,and Embedded Content” 菜单，添加 “ZegoExpressEngine.xcframework” 和 “ZegoExpressAudioCopyrightedMusicPlugin.xcframework”，将 “Embed” 设置为 “Embed & Sign”。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ktv/plugin/ios_audio.png" /></Frame>
