...
<Warning title="Warning">本方案是基于 ZegoExpressSDK 和 ZIM SDK 从而实现抢唱功能，如果开发者选择自行集成相关 SDK 到项目，请查看 [Express SDK 集成](https://doc-zh.zego.im/article/196) 和 [即时通讯 - 实现基本消息收发](https://doc-zh.zego.im/zim-ios/send-and-receive-messages)。</Warning>
...
ZEGO 针对抢唱玩法提供了 [体验 App 源码](./../../Quick%20Starts/Run%20the%20Demo%20App%20Source%20Code/Grab%20the%20Mic.mdx)，以供开发者进一步了解 ZEGO 在线 KTV 抢唱方案。 
...
[Express - 使用 Token 鉴权](https://doc-zh.zego.im/article/10359)

[Express - 实现视频通话](https://doc-zh.zego.im/article/7628)

[ZIM - 实现基本消息收发](https://doc-zh.zego.im/article/11567)

[功能总览 - 版权音乐](https://doc-zh.zego.im/article/15073)

### 2 房主开始新一轮抢唱游戏

<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/GoEnjoy/KTVGrab/Common/Host_Begin_Game.png" />
</Frame>

### 3 房主和麦上用户进行抢麦

<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/GoEnjoy/KTVGrab/Common/Host_and_User_Grab_Mic.png" />
</Frame>

##  常见问题

请参考 [常见问题 - 抢唱方案相关问题](./../../FAQ.mdx)。
