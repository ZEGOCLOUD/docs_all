...
<Warning title="注意">本方案是基于 ZegoExpressSDK 和 ZIM SDK 从而实现抢唱功能，如果开发者选择自行集成相关 SDK 到项目，请查看 [Express SDK 集成](https://doc-zh.zego.im/article/196) 和 [即时通讯 - 实现基本消息收发](https://doc-zh.zego.im/zim-ios/send-and-receive-messages)。</Warning>
