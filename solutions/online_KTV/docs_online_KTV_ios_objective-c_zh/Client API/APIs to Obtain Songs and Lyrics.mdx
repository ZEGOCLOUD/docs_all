...
import { getSharedResourceMap,requestResourceMap,ZegoCopyrightedMusicRequestResourceCallbackMap,ZegoCopyrightedMusicGetSharedResourceCallbackMap,getLrcLyricMap,ZegoCopyrightedMusicGetLrcLyricCallbackMap,getKrcLyricByTokenMap,ZegoCopyrightedMusicGetKrcLyricByTokenCallbackMap,ZegoCopyrightedMusicResourceSongMap,ZegoCopyrightedMusicResourceAccompanimentMap,ZegoCopyrightedMusicResourceAccompanimentClipMap,ZegoCopyrightedMusicResourceAccompanimentSegmentMap } from '/solutions/online_KTV/snippets/api-links.mdx'
