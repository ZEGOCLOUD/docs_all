...
<td><ul><li><a href="https://doc-zh.zego.im/article/api?doc=Express_Video_SDK_API~cs_unity3d~class~ZegoCopyrightedMusic#send-extended-request">SendExtendedRequest</a></li><li><a href="./../Client%20API/Send%20Extended%20Request.mdx">发送扩展请求接口说明</a></li><li><a href="/online_ktv_server/query-song-plus">搜索多版权方的歌曲</a></li></ul></td>
</tr>
<tr>
<td>扩展获取到的歌曲资源信息</td>
