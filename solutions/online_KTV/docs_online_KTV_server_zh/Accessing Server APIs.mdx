...
<table>
  ...
  <tr>
    ...
    <td>String</td>
    <td>是</td>
    <td>签名，签名的生成请参考 <a href="#3">3 签名机制</a>。</td>
  </tr>
  <tr>
...
<Note title="Note">计算签名所使用的 SignatureNonce 和 Timestamp 参数取值，需要和公共参数中的 SignatureNonce 和 Timestamp 参数取值保持一致。</Note>
