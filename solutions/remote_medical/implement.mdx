...
通过 ZEGO 实时音视频（Express-Video SDK）服务提供的 API 接口，可设置摄像头变焦倍数，在拍摄时，可以放大物体，达到“近在眼前”的效果。详情请参考 [如何调节摄像头的焦距（变焦功能）](https://doc-zh.zego.im/faq/camera-focal-length-adjustment)。
...
- [数据流录制](https://doc-zh.zego.im/faq/data-stream-recording-alternatives)
