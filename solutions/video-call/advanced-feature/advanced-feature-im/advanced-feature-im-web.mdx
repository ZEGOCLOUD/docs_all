...
- 本组件在 vue3 框架下开发
- 想要实现实时消息互动的更多功能，请参考 [即时通讯\|_blank](#12807)。
</div>

<img src="/Pics/GoCall/call/GoCall_Chat_web.png" width=50%>

## 前提条件

在集成实时消息互动组件之前，请确保：

- 已参考 [跑通示例源码\|_blank](#4459) 获取 GoCall 完整源码；
...
下载并解压 [web 端 GoCall 代码压缩包\|_blank](https://codestore.zego.im/project/14)，找到 chatBox.zip 压缩文件夹并解压到您的项目文件夹下。


### 3 配置 appID 和 appSign
