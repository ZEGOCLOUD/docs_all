...
- 已在项目中集成 ZEGO Express SDK，详情请参考 [快速开始 - 集成](/real-time-video-windows-cpp/quick-start/integrating-sdk)。
...
class MyEventHandler: public IZegoEventHandler{
  // 重写 IZegoEventHandler 中的虚函数,不需要实现所有的回调接口，根据实际需要实现其中的某些回调方法。
    ...
    * @param errorCode 错误码，详情请参考常用 [错误码文档](https://doc-zh.zego.im/article/4572.html)
