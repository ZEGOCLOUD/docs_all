...
更多初始化 SDK 的细节请参考：[快速开始 - 实现流程](/real-time-video-android-java/quick-start/implementing-video-call#3_1) 的 “3.1 初始化”。   
...
更多使用 SDK 实现登录房间的细节请参考：[快速开始 - 实现流程](/real-time-video-android-java/quick-start/implementing-video-call#3_2) 的 “3.2 登录房间”。   
...
更多使用 SDK 实现预览和推流的细节请参考：[快速开始 - 实现流程](/real-time-video-android-java/quick-start/implementing-video-call#3_3) 的 “3.3 预览自己的画面，并推送到 ZEGO 音视频云”。
...
更多使用 SDK 实现拉流的细节请参考：[快速开始 - 实现流程](/real-time-video-android-java/quick-start/implementing-video-call#3_4) 的 “3.4 拉取其他用户的音视频”。
...
更多使用 SDK 实现停止推流的细节请参考：[快速开始 - 实现流程](/real-time-video-android-java/quick-start/implementing-video-call#4_2) 的 “停止音视频通话”。
...
```
更多使用 SDK 实现停止拉流的细节请参考：[快速开始 - 实现流程](/real-time-video-android-java/quick-start/implementing-video-call#4_2) 的 “停止音视频通话”。
