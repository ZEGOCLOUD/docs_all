...
- 在 [管理控制台](https://console.zego.im/ProjectManage) 中注册并创建项目，同时开通 “ZEGO CDN” 服务。
  <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/zegocloud/console/console_cdn_zh.png" /></Frame>
...
1. 请参考 [下载](!ExpressVideoSDK-DownloadSDK/DownloadSDK) 文档，下载最新版本的 SDK 并解压。
...
4. 选择 “TARGETS > General > Frameworks,Libraries,and Embedded Content” 菜单，添加 “ZegoExpressEngine.xcframework”，将 “Embed” 设置为 “Embed & Sign”。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/iOS/ZegoExpressEngine/Common/embed_sign.png" /></Frame>
</Accordion>
...
<Frame width="256" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/zegocloud/live/quickstart/live_page.jpg" /></Frame>
