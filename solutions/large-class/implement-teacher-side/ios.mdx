...
GO课堂业务后台服务需要用户自己搭建，详情请参考 [GO课堂后台服务说明](/large-class/edu-cloud-service-paa-s/go-classroom)。
</Note>
...
完整的 API 请参考 [GO课堂后台服务说明 ](/large-class/edu-cloud-service-paa-s/go-classroom)。
</Note>
