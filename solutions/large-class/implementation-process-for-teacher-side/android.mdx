...
在线课堂示例 demo 业务后台服务需要用户自己搭建，详情请参考 [在线课堂示例 demo 堂后台服务说明](https://doc-zh.zego.im/article/6368)。
</Note>
...
|API|实现功能|
|-|-|
|[login_room ](https://doc-zh.zego.im/article/6359)| 登录教室。|
|[leave_room ](https://doc-zh.zego.im/article/6365)|离开课堂。|
|[end_teaching ](https://doc-zh.zego.im/article/6366)|结束教学。|
|[get_attendee_list ](https://doc-zh.zego.im/article/6360)|获取在线成员列表。|
|[get_join_live_list ](https://doc-zh.zego.im/article/6361)|获取连麦成员列表。|
|[set_user_info ](https://doc-zh.zego.im/article/6363)|设置某个用户设备状态。|

<Note title="说明">

 
完整的 API 请参考 [在线课堂示例 demo 后台服务说明](https://doc-zh.zego.im/article/6368)。
</Note>
