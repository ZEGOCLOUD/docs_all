...
```bash
npx -y @midscene/android@1 take_screenshot  --device-id emulator-xxx
```
...
npx -y @midscene/android@1 act --device-id emulator-xxx --prompt "type hello world in the search field and press Enter"
npx -y @midscene/android@1 act --device-id emulator-xxx --prompt "long press the message bubble and tap Delete in the popup menu"

# or target-driven instructions
npx -y @midscene/android@1 act --device-id emulator-xxx --prompt "open Settings and navigate to Wi-Fi settings, tell me the connected network name"
```
...
```bash
npx -y @midscene/android@1 act  --device-id emulator-xxx --prompt "fill in the username field with 'testuser' and the password field with 'pass123', then tap the Login button"
npx -y @midscene/android@1 take_screenshot  --device-id emulator-xxx
```
