...
CONFIG = {
    # 要替换的articleID列表
    "ids": ["11524", "6671", "14769", "14917", "7273"],
    
    # 引用语句 - 注意这里可以直接使用单引号，不需要转义
    "import_statement": """import Content from '/core_products/real-time-voice-video/zh/windows-cpp/communication-capability/testing-network.mdx'
